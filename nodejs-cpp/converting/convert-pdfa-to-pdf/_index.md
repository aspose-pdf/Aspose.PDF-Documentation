...
lastmod: "2023-11-01"
description: This topic show you how to Aspose.PDF allows to convert PDF/A file to PDF document with Node.js. 
sitemap:
    changefreq: "monthly"
    priority: 0.8
---
...
The following Node.js code snippet shows simple example of coverting PDF/A to PDF:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfAConvertToPDF](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfaconverttopdf/) function is executed.
