...
lastmod: "2023-11-01"
description: Aspose.PDF allows you to convert PDF to PPTX format using Node.js directly in the web.
sitemap:
    changefreq: "monthly"
    priority: 0.7
---
...
The following Node.js code snippet shows simple example of coverting PDF to PPTX files:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfToPptX](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftopptx/) function is executed.
