...
description: This topic shows you how to convert PDF file to other file formats like EPUB, LaTeX, Text, XPS etc using Node.js or Node.js.
sitemap:
    changefreq: "monthly"
    priority: 0.8
---
...
The following Node.js code snippet shows simple example of coverting PDF pages into EPUB files:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfToEPUB](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftoepub/) function is executed.
...
The following Node.js code snippet shows simple example of coverting PDF pages into TEX files:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfToTeX](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftotex/) function is executed.
...
The following Node.js code snippet shows simple example of coverting PDF pages into TXT files:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfToTxt](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftotxt/) function is executed.
...
The following Node.js code snippet shows simple example of coverting PDF pages into XPS files:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfToXps](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftoxps/) function is executed.
...
Convert PDF to black and white with Aspose.PDF for Node.js via C++ Web toolkit. 
...
The following Node.js code snippet shows simple example of coverting PDF pages into Grayscale PDF:

1. Select a PDF file for converting.
1. Create a 'FileReader'.
1. The [AsposePdfConvertToGrayscale](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfconverttograyscale/) function is executed.
