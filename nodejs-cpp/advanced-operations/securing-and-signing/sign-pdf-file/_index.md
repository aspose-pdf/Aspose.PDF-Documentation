---
title: Add digital signature or digitally sign PDF in Node.js via C++
linktitle: Digitally sign PDF
type: docs
weight: 70
url: /nodejs-cpp/sign-pdf/
description: Digitally sign PDF documents using Node.js via C++.
lastmod: "2023-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Aspose.PDF for Node.js via C++ supports the feature to digitally sign the PDF files using the [AsposePdfSignPKCS7](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfsignpkcs7/).
