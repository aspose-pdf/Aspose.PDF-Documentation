...
description: Optimize and compress PDF files for fast web-view using Node.js tool.
lastmod: "2022-12-15"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Toolkit by Aspose.PDF for Node.js via C++ allows you to optimize a PDF content for the Web. 
...
1. The [AsposePdfOptimize](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfoptimize/) function is executed.
