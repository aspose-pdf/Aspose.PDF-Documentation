---
title: Delete PDF Pages with Node.js via C++ 
linktitle: Delete PDF Pages
type: docs
weight: 30
url: /nodejs-cpp/delete-pages/
description: You can delete pages from your PDF file using Aspose.PDF for Node.js via C++  library.
lastmod: "2023-04-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
You can delete pages from a PDF file using Aspose.PDF for Node.js via C++. You can get the result directly in your browser.

1. Create a 'FileReader'.
1. Specify page numbers to delete.
1. The [AsposePdfDeletePages](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfdeletepages/) function is executed.
