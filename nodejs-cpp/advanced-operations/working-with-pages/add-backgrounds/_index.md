---
title: Add background to PDF with Node.js via C++
...
The following code snippets shows how to add a background image to PDF pages using the [AsposePdfAddBackgroundImage](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfaddbackgroundimage/) class with Node.js.
...
1. Create a 'FileReader'.
1. The [AsposePdfAddBackgroundImage](https://reference.aspose.com/pdf/nodejs-cpp/core/asposepdfaddbackgroundimage/) function is executed.
