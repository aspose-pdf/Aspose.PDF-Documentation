...
Aspose.PDF allows the creation of PDF Portfolio documents using [Document](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.document) class. It also offers the capability to extract files from PDF portfolio.
