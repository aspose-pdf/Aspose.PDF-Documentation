...
المثال يوضح [جديد](https://reference.aspose.com/pdf/go-cpp/core/new/) طريقة لإنشاء مستند PDF جديد، وهي ميزة أساسية لإنشاء المستندات ديناميكيًا، مثل التقارير أو الفواتير.
