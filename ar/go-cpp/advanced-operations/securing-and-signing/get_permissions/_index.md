...
description: قراءة وعرض صلاحيات الوصول لمستند PDF محمي بكلمة مرور باستخدام Aspose.PDF for Go عبر C++.
lastmod: "2026-07-04"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
يوضح هذا المثال كيفية استرجاع وتفسير وعرض صلاحيات الوصول لمستند PDF محمي بكلمة مرور في Go باستخدام Aspose.PDF for Go عبر C++.
