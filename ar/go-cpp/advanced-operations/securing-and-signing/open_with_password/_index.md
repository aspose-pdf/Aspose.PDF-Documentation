...
description: فتح ملف PDF محمي بكلمة مرور باستخدام Aspose.PDF for Go عبر C++.
lastmod: "2026-07-04"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
يفسر هذا المقتطف البرمجي كيفية فتح مستند PDF محمي بكلمة مرور باستخدام Aspose.PDF for Go عبر C++. يتم فتح المستند باستخدام كلمة مرور المالك، والتي توفر الوصول الكامل وتسمح بعمليات إضافية مثل قراءة البيانات الوصفية، فحص الأذونات، فك تشفير الملف، أو تعديل المحتوى.
