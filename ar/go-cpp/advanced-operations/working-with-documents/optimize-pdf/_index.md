---
title: تحسين ملف PDF باستخدام Aspose.PDF for Go عبر C++
...
1. ال [فتح](https://reference.aspose.com/pdf/go-cpp/core/open/) الطريقة تقوم بتحميل ملف PDF المحدد (sample.pdf) إلى الذاكرة.
