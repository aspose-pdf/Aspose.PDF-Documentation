...
يدعم Aspose.PDF لـ SharePoint إنشاء ملفات PDF آمنة. يؤدي تثبيت Aspose.PDF لـ SharePoint إلى إضافة خيار **إعدادات PDF الآمنة** في إعدادات الموقع. هنا، يمكنك تعيين كلمة مرور المستخدم وكلمة مرور المالك وأي قيمة من قائمة الخوارزمية لتشفير ملف PDF الناتج. توفر قائمة الخوارزميات مجموعات مختلفة من خوارزميات التشفير وأحجام المفاتيح. تمرير القيمة التي تختارها.
