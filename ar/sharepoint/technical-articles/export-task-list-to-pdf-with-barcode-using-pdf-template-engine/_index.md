---
title: تصدير قائمة المهام إلى PDF باستخدام الباركود باستخدام PDF Template Engine
linktitle: تصدير قائمة المهام إلى PDF باستخدام الباركود باستخدام PDF Template Engine
type: docs
weight: 40
...
لتصدير قائمة مهام إلى PDF باستخدام رمز شريطي باستخدام محرك القالب، اتبع الخطوات التالية:

1. إنشاء وتحميل القالب.
1. أكمل حقول القالب واحفظ القالب.
1. إنشاء وحفظ مهمة جديدة.
1. تصدير الوثيقة إلى PDF.

يتم إعطاء العملية بالتفصيل أدناه.
