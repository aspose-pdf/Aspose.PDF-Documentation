---
title: تنسيقات الملفات المدعومة من Aspose.PDF
...
يشير الجدول التالي إلى تنسيقات الملفات التي يمكن لـ Aspose.PDF لأندرويد عبر Java تحميلها وحفظها.
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|تنسيق ملف LaTex| |{{< emoticons/tick >}}| |
...
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق ملف التعريف المحسن (EMF)| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|يحفظ المستند بصيغة PNG| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|يحفظ المستند بصيغة BMP| |{{< emoticons/tick >}}| |
...
|[DICOM ](https://docs.fileformat.com/image/dicom/)|إضافة صور DICOM في مستند PDF| |{{< emoticons/tick >}}| |
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|يحفظ المستند بصيغة CSV| |{{< emoticons/tick >}}| |
|[Text](https://docs.fileformat.com/word-processing/txt/)|يحفظ المستند بصيغة نصية| |{{< emoticons/tick >}}| |