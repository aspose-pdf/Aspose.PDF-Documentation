...
يتم وصف دمج Aspose.PDF لـ JasperReports مع JasperServer أدناه.
...
6. قم بتشغيل JasperServer وافتح أي تقرير لعرضه. إذا تم تنفيذ الخطوات السابقة بشكل صحيح، فسترى أيقونة للتصدير عبر Aspose.PDF لـ JasperReports في قائمة التنسيقات المتاحة.
