...
لاستخدام Aspose.PDF for JasperReports في التطبيق الخاص بك، انسخ **aspose.pdf.jasperreports.jar** من المجلد \lib في **Aspose.PDF.JasperReports.zip** إلى دليل JasperReports\lib، أو إلى مجلد مكتبة التطبيق الخاص بك. بعد ذلك، يمكنك الوصول إلى المصدرين برمجيا.

{{% /alert %}}

يوضح المثال التالي الكود النموذجي المطلوب لتصدير تقرير إلى تنسيق PDF باستخدام Aspose.PDF for JasperReports. يمكن العثور على المزيد من الأمثلة في التقارير التجريبية المضمنة في تنزيل المنتج.
