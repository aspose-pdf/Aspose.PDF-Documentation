---
title: استخراج بيانات المتجهات من ملف PDF باستخدام C#
linktitle: استخراج بيانات المتجهات من PDF
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 80
url: /ar/net/extract-vector-data-from-pdf/
description: تجعل Aspose.PDF من السهل استخراج بيانات المتجهات من ملف PDF. يمكنك الحصول على بيانات المتجهات (مسار، مضلع، خط متعرج)، مثل الموقع، اللون، عرض الخط، إلخ.
lastmod: "2024-09-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "تقدم Aspose.PDF for .NET الآن ميزة مبتكرة تتيح للمستخدمين استخراج بيانات المتجهات من ملفات PDF بسلاسة. تشمل هذه الوظيفة الوصول التفصيلي إلى العناصر الرسومية، مثل المسارات والمضلعات، جنبًا إلى جنب مع خصائصها مثل الموقع، اللون، وعرض الخط، مما يمكّن المطورين من التعامل مع الرسوميات المتجهة بكفاءة في تطبيقاتهم",
    "author": {
        "@type": "Person",
    ...
    "description": "يمكن لـ Aspose.PDF أداء المهام البسيطة والسهلة فحسب، بل يمكنها أيضًا التعامل مع الأهداف الأكثر تعقيدًا. تحقق من القسم التالي للمستخدمين المتقدمين والمطورين."
}
</script>

## الوصول إلى بيانات المتجهات من مستند PDF

منذ إصدار 24.2، تتيح مكتبة Aspose.PDF for .NET استخراج بيانات المتجهات من ملف PDF.
تقوم مقتطفات الكود التالية بإنشاء كائن Document جديد باستخدام بعض بيانات الإدخال، وتقوم بتهيئة 'GraphicsAbsorber' (الذي يعيد بيانات المتجهات) للتعامل مع العناصر الرسومية، ثم تزور الصفحة الثانية من المستند لاستخراج وتحليل هذه العناصر.
تسترجع خصائص مختلفة من العنصر الرسومي الثاني، مثل المشغلين المرتبطين به، المستطيل، والموقع.
...
## استخراج بيانات المتجهات من مستند PDF

لاستخراج بيانات المتجهات من PDF، يمكننا استخدام مستخرج SVG:
...
### استخراج جميع المسارات الفرعية إلى صور بشكل منفصل
