...
تنطبق المعلومات في هذا الموضوع على السيناريوهات التي تريد فيها استخدام [Aspose.PDF for .NET](/pdf/net/) عبر COM Interop في أي من لغات البرمجة التالية:
...
كائنات Aspose.PDF هي كائنات .NET، ولكن عند استخدامها عبر COM Interop، تظهر ككائنات COM في لغة البرمجة الخاصة بك. لذلك، من الأفضل التأكد من أنك تعرف كيفية إنشاء واستخدام كائنات COM في لغة البرمجة الخاصة بك، قبل أن تبدأ في استخدام [Aspose.PDF for .NET](/pdf/net/).
