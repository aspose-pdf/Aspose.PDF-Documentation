...
{{% alert color="primary" %}}
قم بتهيئة PHP الخاص بك للعمل مع COM. انظر <http://www.php.net/manual/en/ref.com.php>. لمزيد من المعلومات، يرجى مراجعة المقال بعنوان [استخدام Aspose.pdf لـ .NET عبر COM Interop](/pdf/ar/net/use-aspose-pdf-for-net-via-com-interop/)
...
{{% alert color="primary" %}}
هذا تطبيق بسيط يوضح كيفية إنشاء ملف PDF جديد وإضافة نص إلى ملف PDF باستخدام [Aspose.PDF لـ .NET](/pdf/ar/net/) في PHP عبر COM Interop.
