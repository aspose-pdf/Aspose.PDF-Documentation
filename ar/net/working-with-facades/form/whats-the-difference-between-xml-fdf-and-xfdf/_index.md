...
في مساحة أسماء Aspose.Pdf.Facades، لدينا فئة تُسمى [FormEditor](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/formeditor) التي توفر القدرة على التلاعب بنموذج PDF. افتح نموذج PDF وأضف حقل نصي تحت كل حقل نموذج موجود واحفظ نموذج PDF باسم جديد.
