...
{{% alert color="primary" %}}
الحل لهذه المشكلة هو خاصية Box في فئة [FormFieldFacade](https://reference.aspose.com/pdf/net/aspose.pdf.facades/FormFieldFacade) ، التي تحتفظ بموقع الحقل. نحتاج إلى حفظ هذه القيم في مصفوفة من نوع المستطيل واستخدام هذه القيم لتحديد الموقع الذي نضيف فيه حقول النص الجديدة.

{{% /alert %}}

في مساحة أسماء [Aspose.Pdf.Facades](https://reference.aspose.com/pdf/net/aspose.pdf.facades) لدينا فئة تسمى [FormEditor](https://reference.aspose.com/pdf/net/aspose.pdf.facades/FormEditor) التي توفر القدرة على التلاعب بنماذج PDF. افتح نموذج PDF؛ أضف حقل نصي تحت كل حقل نموذج موجود واحفظ نموذج PDF باسم جديد.
