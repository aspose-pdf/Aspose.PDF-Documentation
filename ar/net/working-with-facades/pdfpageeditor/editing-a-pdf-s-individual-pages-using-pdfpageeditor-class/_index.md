...
تتيح مساحة أسماء Aspose.Pdf.Facades في [Aspose.PDF for .NET](/pdf/net/) لك التلاعب بالصفحات الفردية في ملف PDF. تساعدك هذه الميزة في العمل مع عرض الصفحة والمحاذاة والانتقال وما إلى ذلك. تساعد فئة PdfpageEditor في تحقيق هذه الوظيفة. في هذه المقالة، سننظر في الخصائص والأساليب التي توفرها هذه الفئة وعمل هذه الأساليب أيضًا.
