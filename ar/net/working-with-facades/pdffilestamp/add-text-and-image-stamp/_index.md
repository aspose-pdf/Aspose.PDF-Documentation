...
تتيح لك فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp) إضافة طابع نص على صفحات معينة من ملف PDF. لإضافة طابع نص، تحتاج أولاً إلى إنشاء كائنات من فئتي [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp) و [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). تحتاج أيضًا إلى إنشاء طابع النص باستخدام طريقة [BindLogo](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/stamp/methods/bindlogo) من فئة [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). يمكنك تعيين خصائص أخرى مثل الأصل، والدوران، والخلفية، إلخ. باستخدام كائن [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp) أيضًا. نظرًا لأنك تريد إضافة طابع نص على صفحات معينة من ملف PDF، تحتاج أيضًا إلى تعيين خاصية [Pages](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/stamp/properties/pages) من فئة [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). تتطلب هذه الخاصية مصفوفة صحيحة تحتوي على أرقام الصفحات التي تريد إضافة الطابع عليها. ثم يمكنك إضافة الطابع في ملف PDF باستخدام طريقة [AddStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp/methods/addstamp) من فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp). أخيرًا، احفظ ملف PDF الناتج باستخدام طريقة [Close](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/facade/methods/close) من فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp). يوضح مقتطف الكود التالي كيفية إضافة طابع نص على صفحات معينة في ملف PDF.
...
عند إضافة صورة ككائن طابع، يمكنك أيضًا التحكم في جودة الصورة. لتحقيق هذا المتطلب، تمت إضافة خاصية الجودة لفئة [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). تشير إلى جودة الصورة بالنسبة المئوية (القيم الصالحة هي 0..100).

## إضافة طابع صورة على صفحات معينة في ملف PDF

تتيح لك فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp) إضافة طابع صورة على صفحات معينة من ملف PDF. لإضافة طابع صورة، تحتاج أولاً إلى إنشاء كائنات من فئتي [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp) و [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). تحتاج أيضًا إلى إنشاء طابع الصورة باستخدام طريقة [BindImage](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/stamp/methods/bindimage/index) من فئة [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). يمكنك تعيين خصائص أخرى مثل الأصل، والدوران، والخلفية، إلخ. باستخدام كائن [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp) أيضًا. نظرًا لأنك تريد إضافة طابع صورة على صفحات معينة من ملف PDF، تحتاج أيضًا إلى تعيين خاصية [Pages](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/stamp/properties/pages) من فئة [Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/stamp). تتطلب هذه الخاصية مصفوفة صحيحة تحتوي على أرقام الصفحات التي تريد إضافة الطابع عليها. ثم يمكنك إضافة الطابع في ملف PDF باستخدام طريقة [AddStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/page/methods/addstamp) من فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp). أخيرًا، احفظ ملف PDF الناتج باستخدام طريقة [Close](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/facade/methods/close) من فئة [PdfFileStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf.facades/pdffilestamp). يوضح مقتطف الكود التالي كيفية إضافة طابع صورة على صفحات معينة في ملف PDF.
