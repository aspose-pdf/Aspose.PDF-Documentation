---
title: الحصول على بيانات XMP الوصفية لملف PDF
type: docs
...
<script type="application/ld+json">
{
    ...
    "abstract": "افتح رؤى مفصلة من ملفات PDF الخاصة بك مع ميزة بيانات XMP الوصفية الجديدة في Aspose.PDF for .NET. تتيح لك هذه الوظيفة استخراج خصائص بيانات XMP الوصفية المحددة بسهولة، مما يمكّن من إدارة وتصنيف مستنداتك بشكل أفضل. قم بتبسيط سير العمل الخاص بك وزيادة فائدة ملفات PDF الخاصة بك من خلال استخراج بيانات وصفية دقيقة",
    "author": {
        "@type": "Person",
