...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET يُقدم القدرة على إنشاء نماذج PDF قابلة للتعبئة من الصفر، مما يسمح للمطورين بدمج حقول النماذج القابلة للتخصيص مثل مربعات النص وأزرار الاختيار والقوائم المنسدلة في ملفات PDF الخاصة بهم بسلاسة. هذه الوظيفة تمكّن المستخدمين من تعزيز التفاعل في المستندات وتحسين جمع البيانات داخل تطبيقاتهم.",
    "author": {
        "@type": "Person",
    ...
    "description": "مع Aspose.PDF for .NET يمكنك إنشاء نموذج من البداية في ملف PDF الخاص بك"
}
</script>

The following code snippet also work with [Aspose.PDF.Drawing](/pdf/ar/net/drawing/) library.

## إنشاء نموذج من الصفر

### إضافة حقل نموذج في مستند PDF

يوفر صنف [Document](https://reference.aspose.com/pdf/ar/net/aspose.pdf/document) مجموعة تسمى [Form](https://reference.aspose.com/pdf/ar/net/aspose.pdf/document/properties/form) تساعدك في إدارة حقول النموذج في مستند PDF.
...
تظهر مقاطع التعليمات البرمجية التالية كيفية إضافة [RadioButtonField](https://reference.aspose.com/pdf/ar/net/aspose.pdf.forms/radiobuttonfield) في مستند PDF.
...
[TextBoxField](https://reference.aspose.com/pdf/ar/net/aspose.pdf.forms/textboxfield) يمكن إضافته مع بعض تعليقات الويدجت.
{{< tabs tabID="1" tabTotal="2" tabName1=".NET Core 3.1" tabName2=".NET 8" >}}
{{< tab tabNum="1" >}}
```csharp
...
يظهر مقطع التعليمات البرمجية التالي الخطوات لإضافة RadioButtonField مع ثلاثة خيارات ووضعها داخل خلايا الجدول.
...
يظهر مقطع التعليمات البرمجية التالي كيفية إضافة تسمية ستكون مرتبطة بـ RadioButtonField:
...
تظهر مقاطع التعليمات البرمجية التالية كيفية إضافة حقول مربع اختيار مجمعة في مستند PDF.
{{< tabs tabID="1" tabTotal="2" tabName1=".NET Core 3.1" tabName2=".NET 8" >}}
{{< tab tabNum="1" >}}
```csharp
// For complete examples and data files, visit https://github.com/aspose-pdf/Aspose.PDF-for-.NET
...
تظهر مقاطع التعليمات البرمجية التالية كيفية إضافة حقل ComboBox في مستند PDF.
...
يظهر مقطع التعليمات البرمجية التالي كيفية إضافة CheckboxField في مستند PDF.
...
يظهر مقطع التعليمات البرمجية التالي كيفية إضافة ListBoxField في مستند PDF.
...
يظهر مقطع التعليمات البرمجية التالي كيفية توقيع مستند PDF بواسطة SignatureField.
...
يوفر صنف Document مجموعة تسمى Form تدير حقول النموذج في مستند PDF. لإضافة تلميح إلى حقل نموذج، استخدم خاصية AlternateName للصنف Field. يستخدم Adobe Acrobat "الاسم البديل" كتلميح للحقل.

تظهر مقاطع التعليمات البرمجية التالية كيفية إضافة تلميح إلى حقل نموذج، أولاً باستخدام C# ثم Visual Basic.
