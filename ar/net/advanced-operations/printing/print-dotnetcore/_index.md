...
عند طباعة مستندات متعددة، يتم تجاهل خاصية [PrinterSettings.PrintRange](https://reference.aspose.com/pdf/ar/net/aspose.pdf.printing/printersettings/printrange/)، وتتم طباعة جميع المستندات بالكامل.
