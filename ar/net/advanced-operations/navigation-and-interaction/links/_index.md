...
- [إنشاء روابط](/pdf/net/create-links/) - تعلم ببساطة كيفية إنشاء روابط في ملف PDF الخاص بك باستخدام C#.
- [تحديث الروابط](/pdf/net/update-links/) - حاول تعيين الهدف إلى PDF، حاول تعيين وجهة الرابط إلى عنوان ويب، حاول تعيين هدف الرابط إلى ملف PDF آخر، تحديث لون نص الرابط.
- [استخراج الروابط](/pdf/net/extract-links) - استخراج الروابط من ملف PDF باستخدام فئة AnnotationSelector.
