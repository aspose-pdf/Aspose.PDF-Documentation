...
- [إنشاء روابط](/pdf/net/create-links/) - تعلم طريقة بسيطة لإنشاء روابط في ملف PDF باستخدام C#.
...
- [استخراج الروابط](/pdf/net/extract-links) - استخرج الروابط من ملف PDF باستخدام فئة AnnotationSelector.
