...
* إنشاء كائن [FileSpecification](https://reference.aspose.com/pdf/ar/net/aspose.pdf/filespecification/) من خلال توفير المسار ووصف لملف آخر يسمى "factur-x.xml"، والذي يحتوي على بيانات الفاتورة المتوافقة مع معيار ZUGFeRD.
