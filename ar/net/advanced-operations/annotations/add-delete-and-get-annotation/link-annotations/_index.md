...
يمثل [تعليق الارتباط](https://reference.aspose.com/pdf/ar/net/aspose.pdf.annotations/linkannotation) ارتباطًا تشعبيًا، وجهة في مكان آخر، ومستندًا. وفقًا لمعيار PDF، يمكن استخدام تعليق الارتباط في ثلاث حالات: فتح عرض الصفحة، فتح ملف، وفتح صفحة ويب.
