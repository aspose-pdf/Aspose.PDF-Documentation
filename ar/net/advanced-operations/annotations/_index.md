...
- [نظرة عامة على التعليقات التوضيحية](/pdf/net/overview-of-annotations/) - تعرف على أنواع التعليقات التوضيحية التي تحددها مواصفات PDF، وما يدعمه Aspose.PDF.
- [إضافة، حذف والحصول على التعليق التوضيحي](/pdf/net/add-delete-and-get-annotation/) - تشرح هذه القسم كيفية العمل مع جميع أنواع التعليقات التوضيحية المسموح بها.
- [إضافة، حذف والحصول على التعليق التوضيحي](/pdf/net/add-delete-and-get-annotation/) - يشرح هذا القسم كيفية التعامل مع جميع أنواع التعليقات التوضيحية المسموح بها.
- [استيراد وتصدير التعليق التوضيحي بتنسيق XFDF](/pdf/net/import-export-xfdf/) - توفر مكتبة Aspose.PDF طرقًا لاستيراد وتصدير بيانات التعليقات التوضيحية إلى ملفات XFDF.
