...
- [نظرة عامة على التعليقات التوضيحية](/pdf/net/overview-of-annotations/) - تعرف على أنواع التعليقات التوضيحية التي تحددها مواصفات PDF، وما تدعمه Aspose.PDF.
- [إضافة وحذف والحصول على التعليق التوضيحي](/pdf/net/add-delete-and-get-annotation/) - يشرح هذا القسم كيفية العمل مع جميع أنواع التعليقات التوضيحية المسموح بها.
- [استيراد وتصدير التعليقات التوضيحية بتنسيق XFDF](/pdf/net/import-export-xfdf/) - توفر مكتبة Aspose.PDF طرقًا لاستيراد وتصدير بيانات التعليقات التوضيحية إلى ملفات XFDF.
- [استيراد التعليقات التوضيحية بتنسيق FDF إلى PDF](/pdf/net/import-fdf/) - توفر مكتبة Aspose.PDF طريقة لاستيراد التعليقات التوضيحية بتنسيق FDF إلى ملفات PDF.
