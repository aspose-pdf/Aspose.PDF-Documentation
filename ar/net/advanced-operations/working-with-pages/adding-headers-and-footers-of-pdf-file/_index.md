Aspose.PDF for .NET يتيح لك إضافة ترويسات وتذييلات إلى ملف PDF موجود. يمكنك إدراج كل من الصور والنصوص في المستند.

تعمل مقتطفات الكود التالية أيضًا مع مكتبة [Aspose.PDF.Drawing](/pdf/ar/net/drawing/).

## إضافة ترويسات وتذييلات كقطع نصية

توضح مقتطفات الكود التالية كيفية إضافة ترويسات وتذييلات كقطع نصية في PDF باستخدام C#.
...
## إضافة ترويسات وتذييلات كقطع HTML

توضح مقتطفات الكود التالية كيفية إضافة ترويسات وتذييلات كقطع HTML إلى PDF باستخدام C#.
...
## إضافة ترويسات وتذييلات كصور

توضح مقتطفات الكود التالية كيفية إضافة ترويسات وتذييلات كصور إلى PDF باستخدام C#.
