...
يمكنك استخدام فئة [PageNumberStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/pagenumberstamp) لإضافة ختم رقم الصفحة في ملف PDF. توفر فئة [PageNumber Stamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/pagenumberstamp) الخصائص اللازمة لإنشاء ختم يعتمد على رقم الصفحة مثل التنسيق، الهوامش، المحاذاة، الرقم الابتدائي، إلخ. لإضافة ختم رقم الصفحة، تحتاج إلى إنشاء كائن [Document](https://reference.aspose.com/pdf/ar/net/aspose.pdf/document) وكائن [PageNumberStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/pagenumberstamp) باستخدام الخصائص المطلوبة. بعد ذلك، يمكنك استدعاء طريقة [AddStamp](https://reference.aspose.com/pdf/ar/net/aspose.pdf/page/methods/addstamp) من [Page](https://reference.aspose.com/pdf/ar/net/aspose.pdf/page) لإضافة الختم في PDF. يمكنك أيضًا تعيين سمات الخط لختم رقم الصفحة. يوضح لك مقتطف الشيفرة التالي كيفية إضافة أرقام الصفحات في ملف PDF.
