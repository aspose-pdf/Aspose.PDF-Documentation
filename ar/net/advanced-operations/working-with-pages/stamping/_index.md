...
ختم في مستند PDF مشابه لتطبيق ختم مطاطي على مستند ورقي.
الختم في ملف PDF يعطي معلومات إضافية لملف PDF، مثل حماية ملف PDF ليتم استخدامه من قبل الآخرين ولتأكيد أمان محتويات ملف PDF. **Aspose.PDF for .NET** يسمح بإضافة ختم الصورة أو النص في مستند PDF الخاص بك.
