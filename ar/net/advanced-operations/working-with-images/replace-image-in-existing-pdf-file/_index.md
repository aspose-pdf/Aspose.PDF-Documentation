...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "استبدال الصورة في ملف PDF موجود",
    "alternativeHeadline": "كيفية استبدال الصورة في PDF",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, dotnet, استبدال الصورة في pdf",
    "wordcount": "302",
...
يمكن العثور على مجموعة الصور في مجموعة موارد الصفحة. لاستبدال صورة:

1. افتح ملف PDF باستخدام كائن الوثيقة.
2. استبدل صورة معينة، احفظ ملف PDF المُحدث باستخدام طريقة حفظ كائن الوثيقة.

يوضح جزء الشيفرة التالي كيفية استبدال صورة في ملف PDF.
