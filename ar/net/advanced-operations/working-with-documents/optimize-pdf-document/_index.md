...
تظهر مقتطفات الشيفرة التالية كيفية تحسين مستند PDF للويب.
...
تتيح لك طريقة [OptimizeResources()](https://reference.aspose.com/pdf/net/aspose.pdf/document/methods/optimizeresources) تقليل حجم المستند عن طريق التخلص من المعلومات غير الضرورية. بشكل افتراضي، تعمل هذه الطريقة كما يلي:
...
أحيانًا يحتوي مستند PDF على كائنات PDF التي لا يتم الإشارة إليها من أي كائن آخر في المستند. قد يحدث هذا، على سبيل المثال، عندما تتم إزالة صفحة من شجرة صفحات المستند ولكن كائن الصفحة نفسه لم يتم إزالته. إزالة هذه الكائنات لا تجعل المستند غير صالح بل تقلل حجمه.
...
بالإضافة إلى ذلك، يمكننا استخدام إعدادات [AllowReusePageContent](https://reference.aspose.com/pdf/net/aspose.pdf.optimization/optimizationoptions/properties/allowreusepagecontent). إذا تم تعيين هذه الخاصية إلى true، فسيتم إعادة استخدام محتوى الصفحة عند تحسين المستند للصفحات المتطابقة.
...
إذا كان المستند يستخدم خطوطًا مدمجة، فهذا يعني أن جميع بيانات الخط موجودة في المستند. الميزة هي أن المستند يمكن رؤيته بغض النظر عما إذا كان الخط مثبتًا على جهاز المستخدم أم لا. ولكن تضمين الخطوط يجعل المستند أكبر. تقوم طريقة إزالة الخطوط المدمجة بإزالة جميع الخطوط المدمجة. وبالتالي، ينخفض حجم المستند ولكن قد يصبح المستند نفسه غير قابل للقراءة إذا لم يتم تثبيت الخط الصحيح.
...
يتكون ملف PDF من نصوص وصور ومرفقات وتعليقات ورسوم بيانية وكائنات أخرى. قد تواجه متطلبات لتحويل PDF من مساحة ألوان RGB إلى تدرج الرمادي بحيث يكون أسرع عند طباعة تلك الملفات PDF. أيضًا، عندما يتم تحويل الملف إلى تدرج الرمادي، ينخفض حجم المستند أيضًا، ولكن يمكن أن يتسبب ذلك أيضًا في انخفاض جودة المستند. هذه الميزة مدعومة حاليًا من خلال ميزة Pre-Flight في Adobe Acrobat، ولكن عند الحديث عن أتمتة المكتب، تعتبر Aspose.PDF الحل النهائي لتوفير مثل هذه المزايا لتلاعب المستندات. لتحقيق هذه المتطلبات، يمكن استخدام مقتطف الشيفرة التالية.
...
Aspose.PDF for .NET يوفر دعم ضغط FlateDecode لوظيفة تحسين PDF. توضح مقتطفات الشيفرة التالية كيفية استخدام الخيار في التحسين لتخزين الصور مع ضغط **FlateDecode**:
...
Aspose.PDF for .NET يوفر القدرة على تخزين صور جديدة في **XImageCollection** مع ضغط FlateDecode. لتمكين هذا الخيار، يمكنك استخدام علامة **ImageFilterType.Flate**. توضح مقتطفات الشيفرة التالية كيفية استخدام هذه الوظيفة:
