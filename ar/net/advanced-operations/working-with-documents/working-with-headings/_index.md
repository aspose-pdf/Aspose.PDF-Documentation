...
[Aspose.PDF for .NET](/pdf/ar/net/) يقدم العديد من أنماط الترقيم المعرفة مسبقاً. تُخزن هذه الأنماط المعرفة مسبقاً في تعداد، NumberingStyle. القيم المعرفة مسبقاً لتعداد NumberingStyle ووصفها موضحة أدناه:
