...
[Aspose.PDF for .NET](/pdf/ar/net/) يقدم العديد من أنماط الترقيم المحددة مسبقًا. يتم تخزين هذه الأنماط المحددة مسبقًا في تعداد، NumberingStyle. القيم المحددة مسبقًا لتعداد NumberingStyle ووصفها موضحة أدناه:
