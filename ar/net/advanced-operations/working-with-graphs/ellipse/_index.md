---
title: إضافة كائن بيضاوي إلى ملف PDF
linktitle: إضافة بيضاوي
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 60
url: /ar/net/add-ellipse/
description: يشرح هذا المقال كيفية إنشاء كائن بيضاوي في ملف PDF باستخدام Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "تقديم ميزة كائن البيضاوي الجديدة لـ Aspose.PDF في .NET، والتي تتيح للمطورين دمج أشكال البيضاوي بسهولة في مستندات PDF الخاصة بهم. تدعم هذه الوظيفة إضافة بيضاويات مملوءة وحتى نص داخل الأشكال، مما يعزز العرض المرئي وتخصيص ملفات PDF. قم بتحسين إنشاء مستنداتك مع عناصر رسومية غنية تعزز تفاعل المستخدم",
    "author": {
        "@type": "Person",
...
![بيضاوي مملوء](fill_ellipse.png)

## إضافة نص داخل البيضاوي

يدعم Aspose.PDF for .NET إضافة نص داخل كائن الرسم. توفر خاصية النص في كائن الرسم خيارًا لتعيين نص كائن الرسم. تظهر مقتطفات الشيفرة التالية كيفية إضافة نص داخل كائن مستطيل.
...
![نص داخل بيضاوي](text_ellipse.png)
