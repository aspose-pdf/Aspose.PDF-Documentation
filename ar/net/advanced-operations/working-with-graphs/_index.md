...
- [Arc](/pdf/net/add-arc/) - يُطلق عليه أحيانًا أيضًا علم وهو زوج مرتب من الرؤوس المتجاورة، ولكنه يُطلق عليه أحيانًا أيضًا خط موجه.
- [Circle](/pdf/net/add-circle/) - يعرض البيانات باستخدام دائرة مقسمة إلى قطاعات. نستخدم الرسم البياني الدائري (المعروف أيضًا باسم مخطط دائري) لإظهار كيف تمثل البيانات أجزاء من كل واحد أو مجموعة واحدة.
- [Curve](/pdf/net/add-curve/) - هو اتحاد متصل من الخطوط الإسقاطية، حيث يلتقي كل خط بثلاثة خطوط أخرى في نقاط مزدوجة عادية.
- [Line](/pdf/net/add-line) - تُستخدم الرسوم البيانية الخطية لعرض البيانات المستمرة ويمكن أن تكون مفيدة في التنبؤ بالأحداث المستقبلية عندما تُظهر الاتجاهات بمرور الوقت.
- [Rectangle](/pdf/net/add-rectangle/) - هو واحد من العديد من الأشكال الأساسية التي ستراها في الرسوم البيانية، ويمكن أن يكون مفيدًا جدًا في مساعدتك على حل مشكلة.
- [Ellipse](/pdf/net/add-ellipse/) - هو مجموعة من النقاط على مستوى، مما يخلق شكلًا بيضاويًا، منحني.

تدعم الأنواع التالية من العمليات لأنواع الأشكال:
- [Check bounds](/pdf/net/aspose-pdf-drawing-graph-shapes-bounds-check/) - تحقق من حدود الشكل في مجموعة الأشكال.
