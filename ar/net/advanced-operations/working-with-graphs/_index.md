...
[Aspose.PDF for .NET](/pdf/net/) يدعم أيضًا إضافة الرسوم البيانية إلى مستندات PDF. لهذا الغرض، يتم توفير فئة الرسم البياني. الرسم البياني هو عنصر على مستوى الفقرة ويمكن إضافته إلى مجموعة الفقرات في مثيل الصفحة. يحتوي مثيل الرسم البياني على مجموعة من الأشكال.
