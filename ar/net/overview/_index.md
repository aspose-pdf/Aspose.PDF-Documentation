...
لنلقي نظرة على صفحات الوثائق لمزيد من التفاصيل: [تحسين PDF](/pdf/ar/net/optimize-pdf/)
...
لنلقي نظرة على القسم التالي لمزيد من التفاصيل: [العمل مع الجداول](/pdf/ar/net/working-with-tables/)
...
لنلقي نظرة على صفحات الوثائق لمزيد من التفاصيل: [العمل مع الرسوم البيانية](/pdf/ar/net/graphs/)
...
لنلقي نظرة على القسم التالي لمزيد من التفاصيل: [الأفعال](/pdf/ar/net/actions/)
...
دعونا نراجع صفحات الوثائق لمزيد من التفاصيل: [تأمين وتوقيع](/pdf/ar/net/securing-and-signing/)
...
دعونا نفحص القسم التالي لمزيد من التفاصيل: [العلامات المرجعية](/pdf/ar/net/add-and-delete-bookmark/)
...
لنتحقق من صفحات الوثائق لمزيد من التفاصيل: [العمل مع جدول المحتويات](/pdf/ar/net/manipulate-pdf-document/)
...
لدى مكتبة Aspose.PDF لـ .NET مجموعة متنوعة من التلاعب بالتعليقات التوضيحية [التعليقات التوضيحية](/pdf/ar/net/annotations/). يمكنك إضافة الأنواع التالية:
...
لمزيد من التفاصيل تحقق من الصفحات التالية [صفحات الوثائق](/pdf/ar/net/attachments/).
للمزيد من التفاصيل راجع [صفحات الوثائق التالية](/pdf/ar/net/attachments/).
...
قم بإدارة [بيانات التعريف](/pdf/ar/net/pdf-file-metadata/) في مستند PDF بسهولة وسرعة باستخدام مكتبة **Aspose.PDF لـ .NET**.
...
يمكنك أيضًا إضافة، تغيير الموضع، حذف الصور، وإجراء المزيد من [الأفعال المعقدة](/pdf/ar/net/working-with-images/) مع الصور في ملف PDF الخاص بك.

### تقسيم، دمج، استخراج أو إدراج الصفحات

يشرح قسم [العمل مع صفحات PDF](/pdf/ar/net/working-with-pages/) في الوثائق كيف يمكنك إضافة، نقل، حذف، تدوير، أو تقسيم الصفحات في PDF.
...
مكتبة Aspose.PDF باستخدام DocumentDevice، أو ImageDevice لتحويل PDF إلى صورة.[تحويل PDF إلى صيغ صور مختلفة](/pdf/ar/net/convert-pdf-to-images-format/).
...
لنتحقق من القسم التالي لمزيد من التفاصيل: [طباعة مستندات PDF](/pdf/ar/net/printing-document/).
...
يرجى زيارة صفحة [الترخيص](/pdf/ar/net/licensing/) للحصول على معلومات حول التراخيص ومراجعة صفحة [معلومات الأسعار](https://purchase.aspose.com/pricing/pdf/family/) للتفاصيل حول الأسعار.

## الدعم الفني

لمزيد من المعلومات حول دعم Aspose.PDF الفني، راجع صفحة [الدعم](/pdf/ar/net/technical-support/).
