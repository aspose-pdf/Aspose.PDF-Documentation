...
[Aspose.PDF for C++](/pdf/ar/cpp/) يقدم العديد من أنماط الترقيم المعرفة مسبقًا. هذه الأنماط المحددة مسبقًا للترقيم مخزنة في تعداد، NumberingStyle. القيم المحددة مسبقًا لتعداد NumberingStyle ووصفها موضحة أدناه:
