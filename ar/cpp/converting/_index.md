...
- [تحويل PDF إلى Microsoft Word](/pdf/cpp/convert-pdf-to-word/) - يمكنك تحويل مستند PDF الخاص بك إلى تنسيق وورد باستخدام C++
...
- [تحويل PDF إلى Microsoft Excel](/pdf/cpp/convert-pdf-to-excel/) - يصف هذا القسم كيفية تحويل مستند PDF إلى XLSX، ODS، CSV و SpreadSheetML
...
- [تحويل PDF إلى Microsoft PowerPoint](/pdf/cpp/convert-pdf-to-powerpoint/) - هنا نتحدث عن تحويل PDF إلى PowerPoint بتتبع عملية التحويل
```
...
- [تحويل ملف PDF إلى تنسيق HTML](/pdf/cpp/convert-pdf-to-html/) - تحويل مستندات PDF الخاصة بك إلى ملفات HTML كصفحات منفصلة أو كصفحة واحدة
...
- [تحويل تنسيقات الصور إلى ملف PDF](/pdf/cpp/convert-images-format-to-pdf/) - تحويل تنسيقات الصور المختلفة إلى ملف PDF
- [تحويل PDF إلى تنسيقات الصور المختلفة](/pdf/cpp/convert-pdf-to-images-format/) - تحويل صفحات PDF كصور بصيغ JPEG وPNG وصيغ أخرى

تشمل هذه القسم تنسيقات مثل: EPUB، Markdown، PCL، XPS، LATex/TeX، النص، وPostScript.

- [تحويل تنسيقات الملفات الأخرى إلى PDF](/pdf/cpp/convert-other-files-to-pdf/) - يصف هذا الموضوع التحويل مع تنسيقات مختلفة مثل EPUB وXPS وPostscript والنصوص وغيرها

- [تحويل ملف PDF إلى تنسيقات أخرى](/pdf/cpp/convert-pdf-to-other-files/) - يصف هذا الموضوع طريقة لتحويل مستند PDF إلى تنسيقات مختلفة
...
- [تحويل PDF إلى تنسيقات PDF/A](/pdf/cpp/convert-pdf-to-pdfa/) - مكتبة C++ بواسطة Aspose.PDF توفر طريقة سهلة لتحويل PDF إلى PDF/A
- [تحويل PDF/A إلى تنسيق PDF](/pdf/cpp/convert-pdfa-to-pdf/) - تحويل PDF/A إلى تنسيق PDF باستخدام C++ بسهولة وسرعة وجودة عالية
