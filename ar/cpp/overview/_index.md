...
لنراجع صفحات Docs للمزيد من التفاصيل: [تحسين PDF](/pdf/ar/cpp/optimize-pdf/)
...
دعونا نتحقق من القسم التالي لمزيد من التفاصيل: [العمل مع الجداول](/pdf/ar/cpp/working-with-tables/)
...
دعونا نتحقق من صفحات الوثائق لمزيد من التفاصيل: [العمل مع الرسوم البيانية](/pdf/ar/cpp/graphs/)
...
لنراجع القسم التالي لمزيد من التفاصيل: [Actions](/pdf/ar/cpp/actions/)
...
لنلقِ نظرة على صفحات المستندات للحصول على مزيد من التفاصيل: [التأمين والتوقيع](/pdf/ar/cpp/securing-and-signing/)
...
لنلقِ نظرة على القسم التالي لمزيد من التفاصيل: [الإشارات المرجعية](/pdf/ar/cpp/add-and-delete-bookmark/)
...
دعونا نتحقق من صفحات المستندات لمزيد من التفاصيل: [العمل مع TOC](/pdf/ar/cpp/manipulate-pdf-document/)
...
مكتبة Aspose.PDF for C++ لديها مجموعة متنوعة من التلاعبات مع [التعليقات](/pdf/ar/cpp/annotations/). يمكنك إضافة أنواع مثل:
...
لمزيد من التفاصيل تحقق من [صفحات المستندات](/pdf/ar/cpp/attachments/).
...
قم بإدارة [البيانات الوصفية](/pdf/ar/cpp/pdf-file-metadata/) بسهولة وسرعة في مستند PDF باستخدام مكتبة **Aspose.PDF for C++**.
...
يمكنك أيضًا إضافة، تغيير موضع، حذف الصور، والقيام بالمزيد من [الإجراءات المعقدة](/pdf/ar/cpp/working-with-images/) مع الصور في ملف PDF الخاص بك.

### تقسيم، دمج، استخراج أو إدراج الصفحات
The [العمل مع صفحات PDF](/pdf/ar/cpp/working-with-pages/) القسم في الوثائق يشرح كيفية إضافة، تحريك، حذف، تدوير أو تقسيم الصفحات في PDF.
...
مكتبة Aspose.PDF تستخدم DocumentDevice أو ImageDevice لتحويل PDF إلى صورة.[تحويل PDF إلى صيغ صور مختلفة](/pdf/ar/cpp/convert-pdf-to-images-format/).
...
لنراجع القسم التالي لمزيد من التفاصيل: [طباعة مستندات PDF](/pdf/ar/cpp/printing-document/).
...
يرجى زيارة صفحة [الترخيص](/pdf/ar/cpp/licensing/) للحصول على معلومات حول التراخيص ومراجعة صفحة [معلومات التسعير](https://purchase.aspose.com/pricing/pdf/family/) للحصول على تفاصيل حول التسعير.

## الدعم الفني

لمزيد من المعلومات حول الدعم الفني لـ Aspose.PDF، ألق نظرة على [صفحة الدعم](/pdf/ar/cpp/technical-support/).

تعرف على المزيد حول:

- [تنسيقات الملفات المدعومة](/pdf/ar/cpp/supported-file-formats/)
- [الميزات الرئيسية لـ Aspose.PDF](/pdf/ar/cpp/key-features/)
- [متطلبات النظام](/pdf/ar/cpp/system-requirements/)
- [التثبيت](/pdf/ar/cpp/installation/)
- [الترخيص](/pdf/ar/cpp/licensing/)
- [الدعم الفني](/pdf/ar/cpp/technical-support/)