...
يشير الجدول التالي إلى تنسيقات الملفات التي يمكن لـ Aspose.PDF for JavaScript عبر C++ تحميلها وحفظها.
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|تنسيق ملف تنسيق LaTex| |{{< emoticons/tick >}}| |

|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسوميات متجهة قابلة للتوسع (تنسيق صورة متجهة يعتمد على XML)| |{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|يحفظ المستند كصورة TIFF لصفحة واحدة أو متعددة الصفحات| |{{< emoticons/tick >}}| |{{< emoticons/tick >}}| |
|Grayscale|يحفظ المستند بتدرج الرمادي| |{{< emoticons/tick >}}| |
...
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|يحفظ المستند كملف CSV| |{{< emoticons/tick >}}| |