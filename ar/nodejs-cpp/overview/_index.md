...
_هذه الصفحة هي نظرة عامة على ميزات Aspose.PDF for Node.js عبر C++._
...
كانت وحدات CommonJS هي الطريقة الكلاسيكية لمعالجة التبعية في Node.js، بينما وحدات ECMAScript هي الإضافة الأحدث وتتبع التنسيق القياسي المستخدم في المتصفحات الحديثة.
 'cjs'، 'mjs' - هي امتدادات تُستخدم لتحديد صيغ الوحدات (CommonJS و ECMAScript Modules) المستخدمة في ملفات JavaScript.
...
بالإضافة إلى ذلك، يمكن تطبيق Aspose.PDF لـ Node.js عبر C++ لتحويل مستندات PDF بسهولة إلى تنسيقات مختلفة مع أداء عالٍ وجودة مثالية. انظر القسم [تنسيقات الملفات المدعومة من Aspose.PDF](https://docs.aspose.com/pdf/nodejs-cpp/supported-file-formats/). أيضًا، تدعم هذه المجموعة أدوات تشفير وفك تشفير مستندات PDF.
