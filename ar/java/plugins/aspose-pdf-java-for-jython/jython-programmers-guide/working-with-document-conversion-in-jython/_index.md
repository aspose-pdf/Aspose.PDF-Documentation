...
linktitle: العمل مع تحويل المستندات في Jython
type: docs
weight: 10
url: /java/working-with-document-conversion-in-jython/
description: تعرف على كيفية تحويل مستندات PDF إلى تنسيقات مختلفة باستخدام Jython مع Aspose.PDF، مما يتيح معالجة مرنة للمستندات.
lastmod: "2026-06-09"
---
يتضمن هذا القسم المواضيع التالية:

- [تحويل PDF إلى تنسيق DOC أو DOCX في Jython](/pdf/java/convert-pdf-to-doc-or-docx-format-in-jython/)
- [تحويل PDF إلى مصنف Excel في Jython](/pdf/java/convert-pdf-to-excel-workbook-in-jython)
