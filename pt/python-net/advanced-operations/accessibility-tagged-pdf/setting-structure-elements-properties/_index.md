---
title: Definindo Propriedades dos Elementos de Estrutura
linktitle: Definindo Propriedades dos Elementos de Estrutura
type: docs
weight: 30
url: /pt/python-net/setting-structure-elements-properties/
description: Você pode definir diferentes propriedades dos elementos de estrutura em documentos PDF com Aspose.PDF para Python via .NET.
lastmod: "2025-06-17"
sitemap: 
    changefreq: "monthly"
    priority: 0.7
...
Para definir propriedades dos elementos de estrutura em um documento PDF marcado, o Aspose.PDF oferece os métodos [create_sect_element()](https://reference.aspose.com/pdf/python-net/aspose.pdf.tagged/itaggedcontent/#methods) e [create_header_element()](https://reference.aspose.com/pdf/python-net/aspose.pdf.tagged/itaggedcontent/#methods) da interface [ITaggedContent](https://reference.aspose.com/pdf/python-net/aspose.pdf.tagged/itaggedcontent/).

O trecho de código a seguir mostra como definir propriedades dos elementos de estrutura de um documento PDF marcado:
...
Para definir elementos de estrutura de texto em um documento PDF marcado, o Aspose.PDF oferece a classe [ParagraphElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/). O trecho de código a seguir mostra como definir elementos de estrutura de texto de um documento PDF marcado:
...
Este exemplo em Python usa o Aspose.PDF para criar um PDF marcado que inclui uma hierarquia estruturada de cabeçalhos e um parágrafo, aprimorando os recursos semânticos e de acessibilidade do documento.

Para definir elementos de estrutura de bloco de texto em um documento PDF marcado, o Aspose.PDF oferece as classes [HeaderElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/headerelement/) e [ParagraphElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/). Você pode adicionar objetos dessas classes como filho de um objeto [StructureElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/structureelement/).
O trecho de código a seguir mostra como definir elementos de estrutura de bloco de texto de um documento PDF marcado:
...
Para definir elementos de estrutura inline em um documento PDF marcado, o Aspose.PDF oferece as classes [SpanElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/spanelement/) e [ParagraphElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/). Você pode adicionar objetos dessas classes como filho de um objeto [StructureElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/structureelement/). O trecho de código a seguir mostra como definir elementos de estrutura inline de um documento PDF marcado:
...
Para definir um nome de tag personalizado para os elementos de um documento PDF marcado, o Aspose.PDF oferece o método [set_tag](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/structureelement/#methods) da classe [StructureElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/structureelement/) para os elementos.
...
## Adicionando Elemento de Estrutura aos Elementos

**Este recurso é suportado a partir da versão 19.4 ou superior.**

Para definir elementos de estrutura de link em um documento PDF marcado, o Aspose.PDF oferece o método [LinkElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/linkelement/) da interface [ITaggedContent](https://reference.aspose.com/pdf/python-net/aspose.pdf.tagged/itaggedcontent/). O trecho de código a seguir mostra como definir elementos de estrutura em um parágrafo com texto de um documento PDF marcado:
...
A API Aspose.PDF para Python via .NET também permite adicionar elementos de estrutura de link.

O trecho de código a seguir mostra como adicionar um elemento de estrutura de link em um documento PDF marcado:
...
A API Aspose.PDF para Python via .NET também permite adicionar [NoteElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/noteelement/) em um documento PDF marcado. O trecho de código a seguir mostra como adicionar um elemento de nota em um documento PDF marcado:
...
A API Aspose.PDF para Python via .NET também permite definir idioma e título para um documento de acordo com a especificação PDF/UA. O idioma pode ser definido tanto para o documento inteiro quanto para seus elementos estruturais separados. O trecho de código a seguir mostra como definir idioma e título em um documento PDF marcado:
