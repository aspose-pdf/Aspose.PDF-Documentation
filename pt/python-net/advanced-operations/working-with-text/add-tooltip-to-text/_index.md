---
title: Criando dicas de ferramenta em texto
linktitle: Dica de ferramenta PDF
type: docs
weight: 20
url: /pt/python-net/pdf-tooltip/
description: Aprenda como adicionar dica de ferramenta ao fragmento de texto em PDF usando Python e Aspose.PDF
lastmod: "2025-11-13"
sitemap: 
    changefreq: "monthly"
    priority: 0.7
TechArticle: true
AlternativeHeadline: Adicionar dica de ferramenta ao fragmento de texto em PDF usando Python
Abstract: Este artigo fornece dois exemplos de código Python para aprimorar a interatividade em documentos PDF usando a biblioteca Aspose.PDF. O primeiro exemplo demonstra como adicionar dicas de ferramenta a fragmentos de texto específicos dentro de um PDF criando elementos invisíveis ButtonField sobre o texto e definindo a propriedade `alternate_name` como a dica. O segundo exemplo mostra como criar blocos de texto flutuantes que se tornam visíveis ao passar o mouse sobre um `TextFragment`; um `TextBoxField` oculto é criado em sua posição, e eventos `HideAction` são anexados a um `ButtonField` invisível para mostrar ou ocultar o bloco flutuante.
---

## Adicionar dica de ferramenta ao texto pesquisado em um PDF

Este trecho de código mostra como sobrepor elementos invisíveis [`ButtonField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/buttonfield/) em objetos específicos [`TextFragment`](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textfragment/) em um PDF para exibir dicas de ferramenta quando o usuário passa o mouse sobre eles. Ele suporta mensagens de dica curtas e longas usando a propriedade `alternate_name` do `ButtonField`.

1. Crie um novo [`Document`](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/).
1. Salve o documento inicial.
1. Reabra o documento PDF.
1. Procure o texto-alvo usando [`TextFragmentAbsorber`](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textfragmentabsorber/).
1. Adicione um [`ButtonField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/buttonfield/) invisível com uma dica curta.
1. Procure o segundo texto-alvo.
1. Adicione um [`ButtonField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/buttonfield/) invisível com uma dica longa sobre o fragmento correspondente.
...
Adicione texto flutuante interativo a um documento PDF. Ele sobrepõe um [`ButtonField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/buttonfield/) invisível em uma frase-alvo e revela um [`TextBoxField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/textboxfield/) oculto quando o usuário passa o mouse sobre ele. Esta técnica é ideal para ajuda contextual, anotações ou apresentação de conteúdo dinâmico.

1. Crie um novo documento PDF.
1. Salve o PDF para que ele possa ser reaberto para configurar a interatividade.
1. Reabra o documento PDF.
...
1. Crie um [`TextBoxField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/textboxfield/) oculto.
1. Adicione o campo oculto à coleção [`Form`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/form/) do documento.
1. Crie um [`ButtonField`](https://reference.aspose.com/pdf/python-net/aspose.pdf.forms/buttonfield/) invisível.
1. Atribua ações de mouse (`on_enter`, `on_exit`) usando [`HideAction`](https://reference.aspose.com/pdf/python-net/aspose.pdf.annotations/hideaction/) para mostrar/ocultar o campo oculto.
1. Salve o documento final.
