...
description: Nesta página são apresentadas as funcionalidades novas mais populares no Aspose.PDF para Python via .NET que foram introduzidas nas versões recentes.
sitemap: 
    changefreq: "monthly"
    priority: 0.8
lastmod: "2025-02-24"
...
## Novidades no Aspose.PDF 25.9

A versão 25.9 traz acessibilidade aprimorada, suporte de conformidade reforçado e novas funcionalidades de API para trabalhar com imagens marcadas e padrões de documentos.
...
Na versão 25.9 da biblioteca Aspose.PDF para Python, a conversão para o formato PDF/E-1 está disponível. Você pode encontrar mais informações sobre este formato na [(Documentação de Formatos de Arquivo)[https://docs.fileformat.com/pdf/e/].
...
### Adicionar Imagens Marcadas a partir de um Fluxo

Adicionar Imagens Marcadas a partir de um Fluxo em PDF. A versão 25.9 suporta acessibilidade aprimorada em documentos PDF ao adicionar uma imagem a partir de um fluxo de memória e marcá-la com texto alternativo.
...
Esta atualização acrescenta mais flexibilidade na disposição e na gestão de segurança de documentos.

1. Criar índices de conteúdo marcados (TOC).
1. Redimensionar páginas PDF com dimensionamento de conteúdo.
1. Aplicar bordas tracejadas a tabelas.

### Criar Índice de Conteúdo Marcado (TOC)

Gere automaticamente índices de conteúdo acessíveis (TOC) em PDFs marcados. Criar um índice de conteúdo totalmente acessível em um PDF permite que os leitores naveguem pelo documento de forma eficiente e garante a conformidade PDF/UA-1 para acessibilidade.
...
### Redimensionar Páginas com Dimensionamento de Conteúdo

Redimensione páginas PDF preservando o layout e dimensionando o conteúdo proporcionalmente. Ao trabalhar com PDFs, pode ser necessário redimensionar páginas ou escalar o conteúdo para se adequar a novas dimensões.
...
### Aplicar Bordas Tracejadas a Tabelas

Adicione tabelas com estilos de borda personalizados usando linhas tracejadas. Este exemplo demonstra como aplicar estilos de borda personalizados — como linhas tracejadas ou pontilhadas — a tabelas em um documento PDF usando Aspose.PDF para Python via .NET.
...
## Novidades no Aspose.PDF 25.7

A versão 25.7 foca em melhor suporte a anotações, ajuste de texto e gestão de assinatura digital.

1. Ajustar texto dentro de formas.
1. Criptografar PDFs usando um certificado público.
1. Adicionar anotações de nuvem e polígono.

### Criptografar PDFs com um Certificado Público

Proteja seus PDFs com criptografia baseada em certificados públicos. A criptografia com certificado público permite que PDFs sejam criptografados para destinatários específicos, garantindo que apenas os detentores das chaves privadas correspondentes possam abrir e ler o documento.
...
Dimensione automaticamente o texto para caber dentro de um retângulo definido. Ao atualizar ou expandir texto em um PDF, pode exceder os limites originais do parágrafo.
...
### Adicionar Anotações de Polígono de Nuvem

Melhore os fluxos de trabalho de revisão de PDF com anotações em nuvem ou estilo polígono. As anotações de polígono permitem que você destaque ou enfatize áreas específicas em um PDF usando formas geométricas.
...
## Novidades no Aspose.PDF 25.6

Principais recursos desta versão:

1. Suporte a texto alternativo de imagem.
1. Acesso às informações de licença.
1. Anotações de texto livre estilizadas.
1. Aparência personalizável de assinatura digital.

### Suporte a texto alternativo de imagem

Defina e recupere texto alternativo para imagens, melhorando a acessibilidade para leitores de tela.
...
### Acesso às informações de licença
...
### Aparência personalizável de assinatura digital

Adicione imagens, altere fontes e sobreponha gráficos de assinatura sobre o conteúdo de fundo para melhor identidade visual ou consistência de design.
...
A atualização mais recente do Aspose.PDF introduz várias melhorias poderosas que aprimoram a acessibilidade, compatibilidade e segurança de documentos. Os desenvolvedores agora podem extrair certificados digitais diretamente de arquivos PDF assinados, permitindo verificações avançadas de conformidade e autenticação.

1. Extrair certificados de assinaturas PDF.
1. Criar listas ordenadas estruturadas em PDFs marcados.
1. Verificar assinaturas com certificados de chave pública.
1. Converter formulários XFA dinâmicos para PDFs AcroForm.
1. Substituição de fontes em PDF - conversão XPS.

### Extrair certificados de assinaturas PDF

Recupere certificados incorporados usando 'extract_certificate()'.
...
Valide assinaturas digitais usando certificados de chave pública externos.
...
### Substituição de fontes em PDF - conversão XPS
...
### Autotagging durante conversão PDF/A

Converta PDFs para PDF/A-1b com criação automática de estrutura lógica para melhorar a acessibilidade.
