...
- [Otimizar PDF](/pdf/pt/python-cpp/optimize-pdf/) - otimizar o conteúdo da página, otimizar o tamanho do arquivo, remover objetos não utilizados, comprimir todas as imagens para uma otimização bem-sucedida do documento.
- [Mesclar PDF](/pdf/pt/python-cpp/merge-pdf-documents/) - mesclar vários arquivos PDF em um único documento PDF usando Python.
- [Dividir PDF](/pdf/pt/python-cpp/split-document/) - dividir páginas PDF em arquivos PDF individuais em suas aplicações Python.