...
<script type="application/ld+json">
{
    ...
    "keywords": "pdf, python, operações avançadas em pdf, criar pdf, excluir pdf, manipular pdf",
    "wordcount": "302",
    ...
    "description": "Aspose.PDF pode realizar não apenas tarefas simples e fáceis, mas também lidar com objetivos mais complexos. Confira a próxima seção para usuários e desenvolvedores avançados usando Python via Java."
}
</script>
