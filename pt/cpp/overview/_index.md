...
Vamos verificar as páginas de Documentos para mais detalhes: [Otimizar PDF](/pdf/pt/cpp/optimize-pdf/)
...
Vamos verificar a próxima seção para mais detalhes: [Trabalhando com Tabelas](/pdf/pt/cpp/working-with-tables/)
...
Vamos verificar as páginas de Documentação para mais detalhes: [Trabalhando com Gráficos](/pdf/pt/cpp/graphs/)
...
Vamos verificar a próxima seção para mais detalhes: [Actions](/pdf/pt/cpp/actions/)
...
Vamos verificar as páginas dos Documentos para mais detalhes: [Protegendo e Assinando](/pdf/pt/cpp/securing-and-signing/)
...
Vamos verificar a próxima seção para mais detalhes: [Marcadores](/pdf/pt/cpp/add-and-delete-bookmark/)
...
Vamos verificar as páginas de Documentação para mais detalhes: [Trabalhando com TOC](/pdf/pt/cpp/manipulate-pdf-document/)
...
A biblioteca Aspose.PDF para C++ possui uma variedade de manipulações com [Anotações](/pdf/pt/cpp/annotations/). Você pode adicionar tipos como:
...
Para mais detalhes, consulte as próximas [páginas de Documentação](/pdf/pt/cpp/attachments/).
...
Gerencie fácil e rapidamente [Metadados](/pdf/pt/cpp/pdf-file-metadata/) em um documento PDF com a biblioteca **Aspose.PDF for C++**.
...
Você também pode adicionar, mudar a posição, deletar imagens e realizar mais [ações complexas](/pdf/pt/cpp/working-with-images/) com imagens no seu PDF.

### Dividir, concatenar, extrair ou inserir páginas
O [Trabalhando com Páginas de PDF](/pdf/pt/cpp/working-with-pages/) na seção Docs explica como você pode adicionar, mover, deletar, rotacionar ou dividir páginas em PDF.
...
Biblioteca Aspose.PDF usando DocumentDevice, ou classe ImageDevice para conversão de PDF para Imagem.[Converter PDF para Diferentes Formatos de Imagem](/pdf/pt/cpp/convert-pdf-to-images-format/).
...
Vamos verificar a próxima seção para mais detalhes: [Imprimindo documentos PDF](/pdf/pt/cpp/printing-document/).
...
Por favor, visite a página de [Licenciamento](/pdf/pt/cpp/licensing/) para informações sobre licenças e revise a página de [Informação sobre Preços](https://purchase.aspose.com/pricing/pdf/family/) para detalhes sobre preços.

## Technical Support

Para mais informações sobre o suporte técnico do Aspose.PDF, dê uma olhada na [Página de Suporte](/pdf/pt/cpp/technical-support/).

Saiba mais sobre:

- [Formatos de Arquivo Suportados](/pdf/pt/cpp/supported-file-formats/)
- [Principais Recursos do Aspose.PDF](/pdf/pt/cpp/key-features/)
- [Requisitos do Sistema](/pdf/pt/cpp/system-requirements/)
- [Instalação](/pdf/pt/cpp/installation/)
- [Licenciamento](/pdf/pt/cpp/licensing/)
- [Suporte Técnico](/pdf/pt/cpp/technical-support/)