...
- [Esquema XML Suportado](/pdf/pt/cpp/supported-xml-schema/) - use o seguinte esquema XML para trabalhar com documentos XML.

- [Exemplo simples 'Hello World' baseado em XML e XSLT](/pdf/pt/cpp/create-a-hello-world-pdf-document-through-xml-and-xslt/) - use XSLT para transformar seu documento XML existente em PDF.
- [Gerar PDF a partir de XML](/pdf/pt/cpp/generate-pdf-from-xml/) - Aspose.PDF tem várias maneiras de gerar PDF com base em documento XML.