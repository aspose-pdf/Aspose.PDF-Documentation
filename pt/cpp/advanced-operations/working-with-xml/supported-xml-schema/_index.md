...
type: docs
weight: 10
url: pt/cpp/supported-xml-schema/
description: Este artigo descreve um esquema XML para trabalhar com documentos XML no Aspose.PDF para C++.
lastmod: "2022-01-31"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Aspose.PDF para C++ usa o seguinte esquema XML para trabalhar com documentos XML:
