---
title: Formatos de Arquivo Suportados C++
linktitle: Formatos de Arquivo Suportados
type: docs
weight: 70
url: pt/cpp/supported-file-formats/
description: Esta página mostra quais formatos de arquivo o Aspose.PDF para C++ pode carregar e salvar.
lastmod: "2021-11-08"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF para C++ pode carregar e salvar.
...
|[XLSX](https://docs.fileformat.com/spreadsheet/xlsx/)|Salva o documento no formato Microsoft Excel| |{{< emoticons/tick >}}| |
...
|[GIF](https://docs.fileformat.com/image/gif/)|Formato de Intercâmbio Gráfico| | |A ser lançado em 2022|