...
description: Esta página mostra quais formatos de arquivo o Aspose.PDF para Node.js pode carregar e salvar.
lastmod: "2023-11-16"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF para Node.js via C++ pode carregar e salvar.
...
|[PDF/A](https://docs.fileformat.com/pdf/a/)|Versões do PDF/A|{{< emoticons/tick >}}|{{< emoticons/tick >}} | |
