...
type: docs
weight: 10
url: /pt/nodejs-cpp/supported-file-formats/
description: Esta página mostra quais formatos de arquivo o Aspose.PDF for Node.js pode carregar e salvar.
lastmod: "2026-07-18"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF for Node.js via C++ pode carregar e salvar.
...
|Tons de cinza|Salva o documento como escala de cinza| |{{< emoticons/tick >}}| |
|[Texto](https://docs.fileformat.com/word-processing/txt/)|Salve o documento em formato de texto| |{{< emoticons/tick >}}| |{{< emoticons/tick >}}| |
