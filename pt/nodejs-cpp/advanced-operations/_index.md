...
- [Trabalhando com Documentos](/pdf/pt/nodejs-cpp/working-with-documents/) - comprimir, dividir e mesclar documentos e realizar outras operações com o documento inteiro.
- [Trabalhando com Páginas](/pdf/pt/nodejs-cpp/working-with-pages/) - adicionar, mover ou remover, cortar páginas, carimbos.

- [Metadados em PDFs](/pdf/pt/nodejs-cpp/pdf-file-metadata/) - obter ou definir metadados em documentos.
- [Trabalhando com Imagens](/pdf/pt/nodejs-cpp/working-with-images/) - inserir, remover, extrair imagem no documento.
- [Navegação e Interação](/pdf/pt/nodejs-cpp/navigation-and-interaction/) - lidar com ações, marcadores, navegar pelas páginas.
- [Anotações](/pdf/pt/nodejs-cpp/annotations/) - as anotações permitem que os usuários adicionem conteúdo personalizado nas páginas do PDF. Você pode adicionar, excluir e modificar a anotação dos documentos PDF.
- [Segurança e Assinatura](/pdf/pt/nodejs-cpp/securing-and-signing/) - proteger e assinar seu documento PDF programaticamente.
