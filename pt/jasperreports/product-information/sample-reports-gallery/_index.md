---
title: Galeria de relatórios de amostra
linktitle: Galeria de relatórios de amostra
type: docs
weight: 40
url: /pt/jasperreports/sample-reports-gallery/
description: Veja exemplos de relatórios criados usando Aspose.PDF para JasperReports. Veja como ele aprimora os recursos de exportação de PDF.
lastmod: "2021-06-05"
---

{{% alert color="primary" %}}

Esta galeria demonstra relatórios em PDF exportados por Aspose.PDF para JasperReports.
...
## Relatório de gráficos padrão do Egeu
...
## Relatório padrão de gráficos atraentes
