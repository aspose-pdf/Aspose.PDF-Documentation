...
A integração do Aspose.PDF para JasperReports com JasperServer é descrita abaixo.
...
6. Execute o JasperServer e abra qualquer relatório para visualizar. Se as etapas anteriores foram executadas corretamente, você verá um ícone para exportação via Aspose.PDF para JasperReports na lista de formatos disponíveis.
