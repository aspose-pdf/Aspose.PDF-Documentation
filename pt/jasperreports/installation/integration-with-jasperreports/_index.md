...
Para usar Aspose.PDF for JasperReports em seu aplicativo, copie **aspose.pdf.jasperreports.jar** da pasta \lib em **Aspose.PDF.JasperReports.zip** para o diretório JasperReports\lib ou para uma pasta de biblioteca de seu aplicativo. Depois disso, você poderá acessar os exportadores de forma programática.
