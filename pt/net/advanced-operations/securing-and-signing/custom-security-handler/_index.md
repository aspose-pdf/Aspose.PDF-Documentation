---
title: Adicionar assinatura digital com um manipulador de segurança personalizado em C#
linktitle: Manipulador de segurança personalizado
type: docs
weight: 40
url: /pt/net/custom-security-handler/
description: Adicionar assinatura digital com um manipulador de segurança personalizado em C#
lastmod: "2025-04-08"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Você pode criar seu próprio manipulador de segurança aplicando o algoritmo de criptografia desejado.
O Adobe Acrobat não será capaz de abrir tal arquivo, mas você pode trabalhar com ele usando Aspose.Pdf.
Para criar um manipulador, você deve implementar a interface:
...
Um exemplo de uma implementação simples da interface (apenas para demonstrar):
...
Exemplo de criptografia de documento:
...
Exemplo de abertura de um documento criptografado:
