...
O seguinte trecho de código mostra os passos para adicionar RadioButtonField com três opções e colocá-los dentro de células da Tabela.
...
A classe Document fornece uma coleção chamada Form que gerencia campos de formulário em um documento PDF. Para adicionar um tooltip a um campo de formulário, use o AlternateName da classe Field. O Adobe Acrobat usa o 'nome alternativo' como um tooltip de campo.
