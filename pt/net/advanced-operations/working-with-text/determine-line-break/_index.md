...
description: Saiba mais sobre como determinar uma quebra de linha de TextFragment de múltiplas linhas usando C#
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Descubra o recurso Determinar Quebra de Linha em Aspose.PDF for .NET, que permite controle preciso sobre a quebra de linha de TextFragments de múltiplas linhas em seus documentos PDF. Essa funcionalidade simplifica o rastreamento da formatação de texto e aprimora a apresentação geral de suas saídas PDF, tornando-se uma ferramenta essencial para desenvolvedores que trabalham com layout de texto em C#",
    "author": {
        "@type": "Person",
