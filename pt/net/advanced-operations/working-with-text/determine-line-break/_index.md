...
<script type="application/ld+json">
{
    ...
    "keywords": "pdf, c#, determinar quebra de linha",
    "wordcount": "302",
...
Aspose.PDF para .NET oferece registro (rastreamento) de processamento em segundo plano (quebra de linha) de fragmentos de texto multilinha em cenários de adição de texto. Você pode usar o método [GetNotifications](https://reference.aspose.com/pdf/net/aspose.pdf/page/methods/getnotifications)() da Classe [Page](https://reference.aspose.com/pdf/net/aspose.pdf/page) da seguinte forma, para rastrear a quebra de linha do fragmento de texto:
