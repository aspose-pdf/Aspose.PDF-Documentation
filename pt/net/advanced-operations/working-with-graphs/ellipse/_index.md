...
weight: 60
url: /pt/net/add-ellipse/
description: Este artigo explica como criar um objeto Elipse no seu PDF usando Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Apresentando o novo recurso de Objeto Elipse para Aspose.PDF em .NET, que permite aos desenvolvedores incorporar formas elípticas em seus documentos PDF sem esforço. Essa funcionalidade suporta a adição de elipses preenchidas e até texto dentro das formas, aprimorando a apresentação visual e a personalização dos arquivos PDF. Otimize a geração de documentos com elementos gráficos ricos que elevam o engajamento do usuário.",
    "author": {
        "@type": "Person",
...
Aspose.PDF for .NET suporta a adição de texto dentro do Objeto Gráfico. A propriedade de texto do Objeto Gráfico fornece a opção de definir o texto do Objeto Gráfico. O seguinte trecho de código mostra como adicionar texto dentro de um objeto Retângulo.
