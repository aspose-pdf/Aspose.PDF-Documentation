---
title: Trabalhando com Gráficos em arquivos PDF
...
- [Círculo](/pdf/net/add-circle/) - exibe dados usando um círculo dividido em setores. Usamos um gráfico circular (também chamado de gráfico de pizza) para mostrar como os dados representam porções de um todo ou de um grupo.
...
- [Elipse](/pdf/net/add-ellipse/) - é um conjunto de pontos em um plano, criando uma forma oval, curva.
