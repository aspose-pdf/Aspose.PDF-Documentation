---
title: XML Schema do Aspose.PDF
linktitle: Esquema XML Suportado
type: docs
weight: 10
url: ptnet/supported-xml-schema/
description: Este artigo descreve um esquema XML para trabalhar com documentos XML no Aspose.PDF para .NET
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "XML Schema do Aspose.PDF",
    "alternativeHeadline": "Como trabalhar com Esquema XML em PDF",
    "author": {
        "@type": "Person",
...
Aspose.PDF para .NET usa o seguinte esquema XML para trabalhar com documentos XML:
