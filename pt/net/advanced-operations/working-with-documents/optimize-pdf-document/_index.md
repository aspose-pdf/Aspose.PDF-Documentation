...
O método [OptimizeResources()](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document/methods/optimizeresources) permite que você reduza o tamanho do documento eliminando informações desnecessárias. Por padrão, este método funciona da seguinte forma:
