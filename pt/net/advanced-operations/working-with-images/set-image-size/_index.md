...
description: Esta seção descreve como definir o tamanho da imagem no arquivo PDF usando a biblioteca C#.
lastmod: "2022-02-17"
---
...
// Instancia objeto Document
Document doc = new Document();
// adiciona página à coleção de páginas do arquivo PDF
Aspose.Pdf.Page page = doc.Pages.Add();
// Cria uma instância de imagem
Aspose.Pdf.Image img = new Aspose.Pdf.Image();
// Define a Largura e Altura da Imagem em Pontos
img.FixWidth = 100;
img.FixHeight = 100;
// Define o tipo de imagem como SVG
