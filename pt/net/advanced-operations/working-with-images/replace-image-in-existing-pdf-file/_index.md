...
O método [Substituir](https://reference.aspose.com/pdf/pt/net/aspose.pdf/ximagecollection/methods/replace/index) da coleção Imagens permite que você substitua uma imagem em um arquivo PDF existente.
