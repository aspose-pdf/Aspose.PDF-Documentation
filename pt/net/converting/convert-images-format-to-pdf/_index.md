...
- [Converter BMP para PDF](#csharp-bmp-to-pdf)
- [Converter CGM para PDF](#csharp-cgm-to-pdf)
- [Converter DICOM para PDF](#csharp-dicom-to-pdf)
- [Converter EMF para PDF](#csharp-emf-to-pdf)
- [Converter GIF para PDF](#csharp-gif-to-pdf)
- [Converter JPG para PDF](#csharp-jpg-to-pdf)
- [Converter PNG para PDF](#csharp-png-to-pdf)
- [Converter SVG para PDF](#csharp-svg-to-pdf)
- [Converter TIFF para PDF](#csharp-tiff-to-pdf)
- [Converter CDR para PDF](#csharp-cdr-to-pdf)
- [Converter DJVU para PDF](#csharp-djvu-to-pdf)
- [Converter HEIC para PDF](#csharp-heic-to-pdf)
...
<a name="csharp-bmp-to-pdf" id="csharp-bmp-to-pdf"><strong>Converter BMP para PDF</strong></a>

1. Inicialize um novo objeto da classe [Document](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document).
...
<a name="csharp-dicom-to-pdf" id="csharp-dicom-to-pdf"><strong>Converter DICOM para PDF</strong></a>

1. Crie um objeto da classe Image.
2. Adicione a imagem à coleção de Parágrafos de uma página.
3. Especifique a propriedade [FileType](https://reference.aspose.com/pdf/pt/net/aspose.pdf/image/properties/filetype).
...
<a name="csharp-emf-to-pdf" id="csharp-emf-to-pdf"><strong>Converter EMF para PDF</strong></a>

1. Primeiro, inicialize um objeto da classe [Document](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document).
...
<abbr title="Graphics Interchange Format">GIF</abbr> é capaz de armazenar dados comprimidos sem perda de qualidade em um formato de no máximo 256 cores. O formato GIF independente de hardware foi desenvolvido em 1987 (GIF87a) pela CompuServe para transmitir imagens bitmap por redes.
...
<a name="csharp-gif-to-pdf" id="csharp-gif-to-pdf"><strong>Converter GIF para PDF</strong></a>
...
<a name="csharp-jpg-to-pdf" id="csharp-jpg-to-pdf"><strong>Converter JPG para PDF</strong></a>
...
<a name="csharp-png-to-pdf" id="csharp-png-to-pdf"><strong>Converter PNG para PDF</strong></a>
...
<a name="csharp-svg-to-pdf" id="csharp-svg-to-pdf"><strong>Converter SVG para PDF</strong></a>

1. Crie uma instância da classe [`SvgLoadOptions`](https://reference.aspose.com/pdf/pt/net/aspose.pdf/loadoptions).
2. Crie uma instância da classe [`Document`](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document) mencionando o nome do arquivo de origem e as opções.
3. Salve o documento com o nome de arquivo desejado.
...
**Aspose.PDF** formato de arquivo suportado, seja uma imagem <abbr title="Tag Image File Format">TIFF</abbr> de um único quadro ou multi-quadro. Isso significa que você pode converter a imagem TIFF em PDF em suas aplicações .NET.
...
<a name="csharp-tiff-to-pdf" id="csharp-tiff-to-pdf"><strong>Converter TIFF para PDF</strong></a>

1. Crie um novo objeto da classe [Document](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document) e adicione uma Página.
...
<abbr title="CDR">CDR</abbr> é um formato de arquivo que foi desenvolvido pela Corel Corporation e é usado principalmente para imagens e desenhos gráficos vetoriais. O formato de arquivo CDR é reconhecido pela maioria dos programas de edição de imagem. O formato CDR é o formato padrão para Aplicativos Corel Draw.

Confira o próximo trecho de código para converter arquivos CDR para o formato PDF.

<a name="csharp-cdr-to-pdf" id="csharp-cdr-to-pdf"><strong>Converter CDR para PDF</strong></a>

1. Crie uma instância da classe [CdrLoadOptions](https://reference.aspose.com/pdf/pt/net/aspose.pdf/cdrloadoptions/).
2. Crie uma instância da classe [Document](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document) mencionando o nome do arquivo de origem e as opções.
3. Salve o documento com o nome de arquivo desejado.
...
<a name="csharp-djvu-to-pdf" id="csharp-djvu-to-pdf"><strong>Converter DJVU para PDF</strong></a>

1. Crie uma instância da classe [DjvuLoadOptions](https://reference.aspose.com/pdf/pt/net/aspose.pdf/djvuloadoptions/).
2. Crie uma instância da classe [Document](https://reference.aspose.com/pdf/pt/net/aspose.pdf/document) mencionando o nome do arquivo de origem e as opções.
3. Salve o documento com o nome de arquivo desejado.
...
<a name="csharp-heic-to-pdf" id="csharp-heic-to-pdf"><strong>Converter HEIC para PDF</strong></a>
