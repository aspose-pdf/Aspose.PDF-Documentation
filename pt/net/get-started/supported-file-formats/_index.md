...
description: Esta página mostra quais Aspose.PDF for .NET pode carregar e salvar formatos de arquivo.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que Aspose.PDF for .NET pode carregar e salvar.
...
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|Metarquivo de Gráficos Computacionais para gráficos vetoriais 2D|{{< emoticons/tick >}}| | |
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|Formato de arquivo de composição LaTex|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
