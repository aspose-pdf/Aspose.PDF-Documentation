...
description: Esta página mostra quais formatos de arquivo o Aspose.PDF para .NET pode carregar e salvar.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF C# pode carregar e salvar.
...
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|Meta-arquivo de Gráficos Computacionais para gráficos vetoriais 2D|{{< emoticons/tick >}}| | |
...
| [PPTX](https://docs.fileformat.com/presentation/pptx/) | Salva o documento no formato de Apresentações Microsoft PowerPoint |  | {{< emoticons/tick >}} |  |
...
| [EMF](https://docs.fileformat.com/image/emf/) | Formato de meta-arquivo aprimorado (EMF) | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
...
|[Texto](https://docs.fileformat.com/word-processing/txt/)|Salve o documento no Formato de Texto|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
