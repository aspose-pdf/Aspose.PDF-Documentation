...
Para verificar se um arquivo PDF está assinado usando uma [assinatura específica](/pdf/net/working-with-signature-in-a-pdf-file/), use o método VerifySigned da classe [PdfFileSignature](https://reference.aspose.com/pdf/net/aspose.pdf.facades/pdffilesignature). Este método requer o nome da assinatura e retorna verdadeiro se o PDF estiver assinado usando esse nome de assinatura. Também é possível verificar se um [PDF está assinado](/pdf/net/working-with-signature-in-a-pdf-file/), sem verificar com qual assinatura ele está assinado.
