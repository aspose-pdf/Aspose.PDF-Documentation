...
Com a ajuda de [CompositingParameters](https://reference.aspose.com/pdf/pt/net/aspose.pdf.facades.pdffilemend/addimage/methods/1), podemos sobrepor uma imagem sobre outra:
...
![Adicionar Imagem](/pdf/pt/net/images/add_image2.png)
...
Podemos adicionar texto de várias maneiras. Considere a primeira. Pegamos o [FormattedText](https://reference.aspose.com/pdf/pt/net/aspose.pdf.facades/formattedtext) e o adicionamos à Página. Depois, indicamos as coordenadas do canto inferior esquerdo e, em seguida, adicionamos nosso texto à Página.
...
![Adicionar Texto](/pdf/pt/net/images/add_text.png)

A segunda maneira de adicionar [FormattedText](https://reference.aspose.com/pdf/pt/net/aspose.pdf.facades/formattedtext). Além disso, indicamos um retângulo no qual nosso texto deve caber.
