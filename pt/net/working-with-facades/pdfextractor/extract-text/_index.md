...
Neste artigo, vamos explorar os detalhes da extração de texto de um arquivo PDF. Todos esses recursos de extração estão disponíveis em um só lugar, na classe [PdfExtractor](https://reference.aspose.com/pdf/pt/net/aspose.pdf.facades/pdfextractor). Vamos ver como usar esses recursos em nosso código.
