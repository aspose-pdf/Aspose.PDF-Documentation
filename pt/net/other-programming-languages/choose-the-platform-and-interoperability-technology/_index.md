...
[Aspose.PDF for .NET](/pdf/pt/net/) é uma biblioteca de classes que oferece funcionalidades para gerar documentos PDF do zero, bem como capacidades para editar/manipular documentos PDF existentes. Aspose.PDF está disponível em dois produtos distintos [Aspose.PDF for .NET](/pdf/pt/net/) e [Aspose.PDF for Java](/pdf/pt/java/). Podemos dizer que o Aspose.PDF suporta “nativamente”:
...
Por favor, note que também é possível usar [Aspose.PDF for .NET](/pdf/pt/net/) de várias linguagens de programação, incluindo: ASP, C++, ColdFusion, Delphi, JavaScript, Perl, PHP, PowerBuilder, Python, VBScript etc.
...
- Como determinar “se usar [Aspose.PDF para .NET](/pdf/pt/net/) ou [Aspose.PDF para Java](/pdf/pt/java/)“?
...
- [Aspose.PDF para .NET](/pdf/pt/net/) para usar com qualquer linguagem de programação que tenha como alvo a plataforma .NET.
- [Aspose.PDF para Java](/pdf/pt/java/) para usar com a linguagem de programação Java.
...
Conforme a tabela acima, você pode ver que para algumas linguagens de programação é possível usar o [Aspose.PDF para .NET](/pdf/pt/net/) ou o [Aspose.PDF para Java](/pdf/pt/java/).
