...
Por favor, registre Aspose.PDF for .NET com COM Interop, verifique o artigo intitulado [Use Aspose.pdf para .NET via COM Interop](/pdf/net/use-aspose-pdf-for-net-via-com-interop/).
