...
description: Esta página mostra quais formatos de arquivo o Aspose.PDF para Java pode carregar e salvar.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF para Java pode carregar e salvar.
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Salva o documento como imagem TIFF de página única ou múltipla| |{{< emoticons/tick >}}| |
