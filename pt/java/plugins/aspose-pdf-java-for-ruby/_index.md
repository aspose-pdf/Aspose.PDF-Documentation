...
- [Baixar e Configurar Aspose.Pdf em Ruby](/pdf/java/download-and-configure-aspose-pdf-in-ruby/)
- [Guia do Programador Ruby](/pdf/java/ruby-programmers-guide/)
  - [Trabalhando com Objeto Documento em Ruby](/pdf/java/working-with-document-object-in-ruby/)
    - [Adicionando JavaScript em Ruby](/pdf/java/adding-javascript-in-ruby/)
    - [Adicionar Camadas ao Arquivo PDF em Ruby](/pdf/java/add-layers-to-pdf-file-in-ruby/)

    - [Adicionar TOC ao PDF Existente em Ruby](/pdf/java/add-toc-to-existing-pdf-in-ruby/)
- [Obter Propriedades da Janela do Documento e Exibição de Página em Ruby](/pdf/java/get-document-window-and-page-display-properties-in-ruby/)
- [Obter Informações do Arquivo PDF em Ruby](/pdf/java/get-pdf-file-information-in-ruby/)
- [Obter Metadados XMP de Arquivo PDF em Ruby](/pdf/java/get-xmp-metadata-from-pdf-file-in-ruby/)
- [Otimizar Documento PDF para a Web em Ruby](/pdf/java/optimize-pdf-document-for-the-web-in-ruby/)
- [Otimizar Tamanho do Arquivo PDF em Ruby](/pdf/java/optimize-pdf-file-size-in-ruby/)
- [Remover Metadados do PDF em Ruby](/pdf/java/remove-metadata-from-pdf-in-ruby/)
- [Definir Propriedades da Janela do Documento e Exibição de Página em Ruby](/pdf/java/set-document-window-and-page-display-properties-in-ruby/)
- [Definir Expiração do PDF em Ruby](/pdf/java/set-pdf-expiration-in-ruby/)
- [Definir Informações do Arquivo PDF em Ruby](/pdf/java/set-pdf-file-information-in-ruby/)
...
- [Obter uma Página Específica em um Arquivo PDF em Ruby](/pdf/java/get-a-particular-page-in-a-pdf-file-in-ruby/)
...
- [Inserir uma Página Vazia no Final do Arquivo PDF em Ruby](/pdf/java/insert-an-empty-page-at-end-of-pdf-file-in-ruby/)
- [Inserir uma Página Vazia em um Arquivo PDF em Ruby](/pdf/java/insert-an-empty-page-into-a-pdf-file-in-ruby/)
...
- [Trabalhando com Conversão de Documentos em Ruby](/pdf/java/working-with-document-conversion-in-ruby/)
  - [Converter HTML para Formato PDF em Ruby](/pdf/java/convert-html-to-pdf-format-in-ruby/)
  - [Converter Páginas PDF para Imagens em Ruby](/pdf/java/convert-pdf-pages-to-images-in-ruby/)
  - [Converter PDF para formato DOC ou DOCX em Ruby](/pdf/java/convert-pdf-to-doc-or-docx-format-in-ruby/)
  - [Converter PDF para Planilha Excel em Ruby](/pdf/java/convert-pdf-to-excel-workbook-in-ruby/)
  - [Converter PDF para Formato SVG em Ruby](/pdf/java/convert-pdf-to-svg-format-in-ruby/)
  - [Converter arquivo SVG para formato PDF em Ruby](/pdf/java/convert-svg-file-to-pdf-format-in-ruby/)
- [Suporte, Estenda e Contribua para Aspose.Pdf em Ruby](/pdf/java/support-extend-and-contribute-to-aspose-pdf-in-ruby/)