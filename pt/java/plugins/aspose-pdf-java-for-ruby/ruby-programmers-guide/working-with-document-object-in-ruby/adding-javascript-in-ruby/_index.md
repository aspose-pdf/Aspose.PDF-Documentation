...
linktitle: Adicionando JavaScript em Ruby
type: docs
weight: 10
url: /java/adding-javascript-in-ruby/
description: Habilite a funcionalidade JavaScript em PDFs usando Aspose.PDF em Ruby para interatividade e automação.
lastmod: "2026-06-09"
---
## Aspose.PDF - Adicionando JavaScript

Para adicionar JavaScript em um documento PDF usando **Aspose.PDF Java para Ruby**, basta invocar o módulo **AddJavaScript**.
