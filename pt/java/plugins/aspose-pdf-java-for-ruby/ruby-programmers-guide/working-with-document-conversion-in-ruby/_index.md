...
- [Converter Páginas de PDF para Imagens em Ruby](/pdf/pt/java/convert-pdf-pages-to-images-in-ruby/)
- [Converter PDF para Formato DOC ou DOCX em Ruby](/pdf/pt/java/convert-pdf-to-doc-or-docx-format-in-ruby/)
- [Converter PDF para Planilha do Excel em Ruby](/pdf/pt/java/convert-pdf-to-excel-workbook-in-ruby/)
