---
title: Obtenha propriedades da página em Python
linktitle: Obtenha propriedades da página em Python
type: docs
weight: 50
url: /java/get-page-properties-in-python/
description: Aprenda como acessar as propriedades de páginas específicas em um documento PDF em Python usando Aspose.PDF para controle detalhado.
lastmod: "2026-06-09"
---
Para obter as propriedades da página do documento PDF usando **Aspose.PDF Java para Python**, basta invocar a classe **GetPageProperties**.
