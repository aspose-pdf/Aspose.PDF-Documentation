...
type: docs
weight: 50
url: /pt/java/get-page-properties-in-python/
lastmod: "2021-06-05"
---

Para obter as propriedades da página de um documento Pdf usando **Aspose.PDF Java for Python**, basta invocar a classe **GetPageProperties**.
...
print "BleedBox : Altura = " + pdf_page.getBleedBox().getHeight() + ", Largura = " + pdf_page.getBleedBox().getWidth() + ", LLX = " + pdf_page.getBleedBox().getLLX() + ", LLY = " + pdf_page.getBleedBox().getLLY() + ", URX = " + pdf_page.getBleedBox().getURX() + ", URY = " + pdf_page.getBleedBox().getURY()
...
print "Rect : Altura = " + pdf_page.getRect().getHeight() + ", Largura = " + pdf_page.getRect().getWidth() + ", LLX = " + pdf_page.getRect().getLLX() + ", LLY = " + pdf_page.getRect().getLLY() + ", URX = " + pdf_page.getRect().getURX() + ", URY = " + pdf_page.getRect().getURY()
print "Número da Página :- " + pdf_page.getNumber()
print "Rotação :-" + pdf_page.getRotate()
