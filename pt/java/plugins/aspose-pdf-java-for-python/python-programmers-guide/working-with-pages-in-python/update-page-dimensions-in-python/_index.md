---
title: Atualizar dimensões de página em Python
linktitle: Atualizar dimensões de página em Python
type: docs
weight: 90
...
lastmod: "2026-06-09"
---
Para atualizar as dimensões da página usando **Aspose.PDF Java para Python**, basta invocar a classe **UpdatePageDimensions**.
