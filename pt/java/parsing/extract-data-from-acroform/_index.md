...
Use `com.aspose.pdf.facades.Form` para ler nomes e valores de campos sem trabalhar em todo o modelo de objeto do documento.

1. Abra o formulário PDF de origem com a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) para que os campos do AcroForm possam ser lidos sem percorrer todo o modelo de objeto do documento.
1. Chame `getFieldNames()` para coletar todos os identificadores de campo presentes no formulário.
...
1. Feche a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) no bloco `finally`.
...
1. Abra o formulário PDF de origem com a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/).
1. Chame `getField(fieldName)` com o nome do campo solicitado para ler seu valor atual dos dados do AcroForm.
...
1. Abra o formulário PDF de origem com a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/).
1. Chame `getFieldNames()` para coletar todos os identificadores de campo disponíveis no AcroForm.
...
1. Crie a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) sem vincular um documento ainda.
1. Abra um fluxo de saída para o arquivo XML e vincule o PDF de origem à fachada com `bindPdf(...)`.
1. Chame `exportXml(stream)` para que os dados do campo de formulário atual sejam serializados como XML.
1. Feche a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) após a conclusão da exportação.
...
1. Chame `exportFdf(stream)` para que os dados do campo do formulário sejam serializados no formato FDF.
1. Feche a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) após a conclusão da exportação.
...
1. Chame `exportXfdf(stream)` para que os dados do campo do formulário sejam serializados no formato XFDF.
1. Feche a fachada [Form](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/form/) após a conclusão da exportação.
