...
type: docs
weight: 20
url: /pt/java/extract-paragraph-from-pdf/
description: Este artigo descreve como usar ParagraphAbsorber - uma ferramenta especial no Aspose.PDF para extrair texto de documentos PDF.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
## Extrair Texto de documento PDF em formato de Parágrafos

Podemos obter texto de um documento PDF pesquisando um texto específico (usando "texto simples" ou "expressões regulares") de uma única página ou documento inteiro, ou podemos obter o texto completo de uma única página, intervalo de páginas ou documento completo.
 No entanto, em alguns casos, você precisa extrair parágrafos de um documento PDF ou texto na forma de Parágrafos. Implementamos a funcionalidade para pesquisar seções e parágrafos no texto das páginas de documentos PDF. Introduzimos a Classe ParagraphAbsorber (como TextFragmentAbsorber e TextAbsorber), que pode ser usada para extrair parágrafos de documentos PDF. Existem duas maneiras a seguir nas quais você pode usar ParagraphAbsorber:
