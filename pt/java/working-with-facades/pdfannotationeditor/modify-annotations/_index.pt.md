...
Tente comparar e encontrar uma maneira de trabalhar com anotações que seja adequada para você. Vamos aprender a seção de [Anotações em PDF](/pdf/java/annotations/).