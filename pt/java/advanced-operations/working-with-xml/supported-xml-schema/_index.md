...
type: docs
weight: 10
url: pt/java/supported-xml-schema/
description: Este artigo descreve um esquema XML para trabalhar com documentos XML no Aspose.PDF para Java
lastmod: "2021-06-05"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Aspose.PDF para Java usa o seguinte esquema XML para trabalhar com documentos XML:
