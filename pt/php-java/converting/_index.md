...
- [Converter PDF para Microsoft Word](/pdf/pt/php-java/convert-pdf-to-word/) - você pode converter seu documento PDF para o formato Word com Java
...
- [Converter PDF para Microsoft Excel](/pdf/pt/php-java/convert-pdf-to-excel/) - esta seção descreve como converter documento PDF para XLSX, ODS, CSV e SpreadSheetML
...
- [Converter PDF para Microsoft PowerPoint](/pdf/pt/php-java/convert-pdf-to-powerpoint/) - aqui estamos falando sobre converter PDF para PowerPoint acompanhando o processo de conversão
...
- [Converter formato HTML para arquivo PDF](/pdf/pt/php-java/convert-html-to-pdf/) - artigo sobre diferentes aspectos da conversão de HTML para PDF
- [Converter arquivo PDF para formato HTML](/pdf/pt/php-java/convert-pdf-to-html/) - converta seus documentos PDF em arquivos HTML como páginas separadas ou como uma única página
...
- [Converter formatos de imagens para arquivo PDF](/pdf/pt/php-java/convert-images-format-to-pdf/) - o Aspose.PDF permite que você converta diferentes formatos de imagens em arquivo PDF
- [Converter PDF para vários formatos de imagens](/pdf/pt/php-java/convert-pdf-to-images-format/) - converta páginas PDF como imagens em formatos JPEG, PNG e outros

Esta seção inclui formatos como: EPUB, Markdown, PCL, XPS, LATex/TeX, Texto e PostScript.

- [Converter outros formatos de arquivo para PDF](/pdf/pt/php-java/convert-other-files-to-pdf/) - este tópico descreve a conversão com vários formatos como EPUB, XPS, Postscript, texto e outros
- [Converter arquivo PDF para outros formatos](/pdf/pt/php-java/convert-pdf-to-other-files/) - este tópico descreve a maneira de converter documento PDF para vários formatos
...
- [Converter PDF para formatos PDF/A](/pdf/pt/php-java/convert-pdf-to-pdfa/) - a biblioteca Java da Aspose.PDF tem uma maneira fácil de converter PDF para PDF/A
- [Converter PDF/A para formato PDF](/pdf/pt/php-java/convert-pdfa-to-pdf/) - converter PDF/A para formato PDF com Java de forma fácil, rápida e de alta qualidade