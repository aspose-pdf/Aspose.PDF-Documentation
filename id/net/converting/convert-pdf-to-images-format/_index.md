...
- Kelas [BmpDevice](https://reference.aspose.com/pdf/id/net/aspose.pdf.devices/bmpdevice) memungkinkan Anda mengonversi halaman PDF ke <abbr title="Bitmap Image File">BMP</abbr> gambar.
- Kelas [EmfDevice](https://reference.aspose.com/pdf/id/net/aspose.pdf.devices/emfdevice) memungkinkan Anda mengonversi halaman PDF ke <abbr title="Enhanced Meta File">EMF</abbr> gambar.
...
- Kelas [PngDevice](https://reference.aspose.com/pdf/id/net/aspose.pdf.devices/pngdevice) memungkinkan Anda mengonversi halaman PDF ke <abbr title="Portable Network Graphics">PNG</abbr> gambar.
- Kelas [GifDevice](https://reference.aspose.com/pdf/id/net/aspose.pdf.devices/gifdevice) memungkinkan Anda mengonversi halaman PDF ke <abbr title="Graphics Interchange Format">GIF</abbr> gambar.
...
Langkah-langkah berikut dan potongan kode dalam C# menunjukkan kemungkinan ini
