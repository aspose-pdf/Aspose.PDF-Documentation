...
[Aspose.PDF for .NET](/pdf/id/net/) juga mendukung penambahan grafik ke dokumen PDF. Untuk tujuan ini, kelas Grafik disediakan. Grafik adalah elemen tingkat paragraf dan dapat ditambahkan ke koleksi `paragraphs` dalam instance Halaman. Sebuah instance Grafik berisi koleksi Bentuk.
...
- [Kurva](/pdf/id/net/add-curve/) - adalah persatuan terhubung dari garis proyektif, setiap garis bertemu tiga garis lainnya di titik ganda biasa.
...
- [Rectangle](/pdf/id/net/add-rectangle/) - adalah salah satu dari banyak bentuk dasar yang akan Anda lihat dalam grafik, ini bisa sangat berguna dalam membantu Anda menyelesaikan masalah.
