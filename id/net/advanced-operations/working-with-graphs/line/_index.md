...
weight: 40
url: /id/net/add-line/
description: Artikel ini menjelaskan cara membuat objek garis ke PDF Anda menggunakan Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Tingkatkan dokumen PDF Anda dengan menambahkan objek garis secara mulus menggunakan Aspose.PDF for .NET. Fungsionalitas baru ini memungkinkan kontrol yang tepat atas atribut garis, termasuk pola garis putus-putus dan warna, memungkinkan pengguna untuk membuat representasi grafis yang menarik secara visual dalam file PDF mereka. Temukan cara untuk menerapkan fitur ini dengan mudah dengan contoh kode yang komprehensif dan instruksi langkah demi langkah yang jelas.",
    "author": {
        "@type": "Person",
...
1. Buat instance [Rectangle](https://reference.aspose.com/pdf/net/aspose.pdf.drawing/rectangle).
1. Atur lebar garis.
1. Tambahkan objek [Rectangle](https://reference.aspose.com/pdf/net/aspose.pdf.drawing/rectangle) ke koleksi bentuk dari objek Grafik.
...
Kita juga dapat menggunakan objek garis untuk menggambar salib mulai dari sudut Kiri-Bawah ke Kanan-Atas dan sudut Kiri-Atas ke Kanan-Bawah.
