...
description: Anda dapat mengatur berbagai properti elemen struktur dalam dokumen PDF dengan Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Tingkatkan aksesibilitas dokumen PDF Anda dengan fitur baru di Aspose.PDF for .NET yang memungkinkan pengguna untuk mengatur properti untuk elemen struktur. Fungsionalitas ini memungkinkan kontrol yang tepat atas judul, bahasa, dan tag kustom untuk berbagai elemen dalam PDF Berlabel, memastikan kepatuhan dan navigasi yang lebih baik untuk pembaca layar",
    "author": {
        "@type": "Person",
