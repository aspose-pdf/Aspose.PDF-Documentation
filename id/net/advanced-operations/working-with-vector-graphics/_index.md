...
<script type="application/ld+json">
{
    ...
    "alternativeHeadline": "Cara mendapatkan posisi Gambar dalam Berkas PDF",
    "author": {
        "@type": "Person",
    ...
    "description": "Bagian ini menjelaskan fitur-fitur dari bekerja dengan berkas PDF GraphicsAbsorber menggunakan perpustakaan C#."
}
</script>
...
## 2. Memindahkan Grafis<a name="moving-graphics"></a>
...
- **Penempatan Elemen**: Posisi setiap grafis disesuaikan dengan mengubah koordinat `X` dan `Y`nya.
