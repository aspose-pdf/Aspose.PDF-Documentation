...
Aspose.PDF untuk .NET menawarkan pencatatan (pelacakan) pemrosesan latar belakang (pemecahan baris) dari fragmen teks multi-baris dalam skenario penambahan teks. Anda dapat menggunakan metode [GetNotifications](https://reference.aspose.com/pdf/net/aspose.pdf/page/methods/getnotifications)() dari Kelas [Page](https://reference.aspose.com/pdf/net/aspose.pdf/page) seperti berikut, untuk melacak pemecahan baris dari fragmen teks:
