...
Berikut adalah daftar teknologi interoperabilitas yang disarankan untuk digunakan untuk berbagai bahasa pemrograman:
Berikut adalah daftar teknologi interoperabilitas yang disarankan untuk digunakan pada berbagai bahasa pemrograman:

{{% /alert %}}

|**Bahasa Pemrograman** |**Aspose.PDF yang Digunakan** |**Teknologi Interoperabilitas** |
| :- | :- | :- |
|ASP |.NET |COM Interop |
