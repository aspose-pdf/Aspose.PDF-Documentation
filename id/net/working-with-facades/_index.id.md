...
- [Menggunakan PdfFileEditor](/pdf/net/pdffileeditor-class/) - alat yang memungkinkan melakukan operasi dengan file PDF (memisah, menggabungkan, dll)
- [Menggunakan PdfFileMend](/pdf/net/pdffilemend-class/) - alat untuk menambahkan teks dan gambar pada halaman dokumen PDF yang sudah ada
...
- [Menggunakan PdfBookmarEditor](/pdf/net/working-with-bookmarks-facades/) - alat untuk membuat, mengimpor, mengekspor, dan menghapus penanda buku
...
- [Menggunakan PdfConverter](/pdf/net/pdfconverter-class/) - alat untuk mengkonversi file PDF ke gambar (BMP, JPEG, PNG dan TIFF) dan sebaliknya
- [Menggunakan FormDataConverter](/pdf/net/formdataconverter-class/) - alat untuk mengkonversi data dari satu format ke format lainnya
- [Menggunakan FormEditor](/pdf/net/formeditor-class/) - alat untuk mengedit formulir (menambah/menghapus bidang dll)
...
- [Menggunakan PdfFileSecurity](/pdf/net/pdffilesecurity-class/) - alat untuk manipulasi dengan Enkripsi, Dekripsi dan Mengatur Hak Istimewa pada File PDF
- [Menggunakan PdfFileStamp](/pdf/net/pdffilestamp-class/) - alat untuk manipulasi dengan halaman, stempel gambar
...
- [Menggunakan Stamp](/pdf/net/stamp-class/) - alat untuk stempel di PDF
- [Menggunakan AutoFiller](/pdf/net/autofiller-class/) - alat untuk menerima data dari database atau sumber data lainnya, mengisi mereka ke dalam bidang yang dirancang dari template pdf dan akhirnya menghasilkan file pdf baru atau stream