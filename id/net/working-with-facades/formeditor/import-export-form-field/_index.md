...
description: Isi bidang formulir menggunakan DataTable dengan Kelas FormEditor oleh Aspose.PDF for .NET
lastmod: "2021-06-05"
draft: false
---
...
Aspose.PDF for .NET menyediakan kemampuan hebat untuk membuat/memanipulasi bidang formulir di dalam dokumen PDF. Menggunakan API ini, Anda dapat mengisi bidang formulir di dalam file PDF secara programatis, mengisi bidang formulir dengan [Impor Data dari FDF ke File PDF](/pdf/net/import-and-export-data/), [Impor Data dari XFDF ke File PDF](/pdf/net/import-and-export-data/), [Impor Data dari XML ke File PDF](/pdf/net/import-and-export-data/) atau bahkan Anda dapat mengimpor data dari objek [System.Data.DataTable](https://reference.aspose.com/pdf/net/aspose.pdf.table/importdatatable/methods/1).
...
## Ekspor Data dari FDF ke File PDF
