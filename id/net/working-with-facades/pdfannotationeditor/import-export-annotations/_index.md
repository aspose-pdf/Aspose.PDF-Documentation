...
[Aspose.PDF for .NET](/pdf/id/net/) adalah komponen kaya fitur ketika datang untuk mengedit dokumen PDF. Seperti yang kita ketahui, XFDF adalah aspek penting dari manipulasi formulir PDF, [namespace Aspose.Pdf.Facades](https://reference.aspose.com/pdf/net/aspose.pdf.facades) dalam [Aspose.PDF for .NET](/pdf/id/net/) telah mempertimbangkan ini dengan baik, dan telah menyediakan metode untuk mengimpor dan mengekspor data anotasi ke file XFDF.
