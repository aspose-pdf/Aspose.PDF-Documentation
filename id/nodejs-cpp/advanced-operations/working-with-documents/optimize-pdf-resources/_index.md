...
description: Optimalkan Sumber Daya file PDF untuk tampilan web cepat menggunakan alat Node.js.
lastmod: "2026-07-18"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Jika Anda ingin mengoptimalkan sumber daya PDF, Anda dapat menggunakan [AsposePdfOptimizeResource](https://reference.aspose.com/pdf/nodejs-cpp/organize/asposepdfoptimizeresource/) fungsi. 
Silakan periksa potongan kode berikut untuk mengoptimalkan sumber daya PDF di lingkungan Node.js.
...
1. Optimalkan sumber daya PDF. Jadi, jika 'json.errorCode' adalah 0, hasil operasi disimpan dalam "ResultPdfOptimizeResource.pdf". Jika parameter json.errorCode bukan 0 dan, sesuai, muncul kesalahan dalam file Anda, informasi kesalahan akan berada di 'json.errorText'.
