---
title: Optimalkan PDF menggunakan Aspose.PDF for Node.js via C++
...
Toolkit oleh Aspose.PDF for Node.js via C++ memungkinkan Anda mengoptimalkan konten PDF untuk lingkungan Node.js. 

Optimisasi, atau linearisasi mengacu pada proses membuat file PDF cocok untuk penjelajahan daring menggunakan peramban web.

Jika Anda ingin mengoptimalkan PDF, Anda dapat menggunakan [AsposePdfOptimize](https://reference.aspose.com/pdf/nodejs-cpp/organize/asposepdfoptimize/) fungsi. 
...
1. Optimalkan file PDF. Jadi, jika ‘json.errorCode’ adalah 0, hasil operasi disimpan dalam “ResultOptimize.pdf”. Jika parameter json.errorCode bukan 0 dan, sesuai, terjadi kesalahan dalam file Anda, informasi kesalahan akan terdapat dalam ‘json.errorText’.
