...
description: Pada halaman ini memperkenalkan fitur baru paling populer di Aspose.PDF untuk Python via .NET yang telah diperkenalkan dalam rilis terbaru.
sitemap: 
    changefreq: "monthly"
    priority: 0.8
lastmod: "2025-02-24"
...
Rilis 25.9 memperkenalkan aksesibilitas yang ditingkatkan, dukungan kepatuhan yang lebih baik, dan kemampuan API baru untuk bekerja dengan gambar bertag dan standar dokumen.

1. Mengonversi PDF ke format PDF/E-1.
1. Menambahkan gambar bertag dari aliran memori.

### Mengonversi PDF ke Format PDF/E-1

Dalam versi 25.9 dari pustaka Aspose.PDF untuk Python, konversi format PDF/E-1 tersedia. Anda dapat menemukan informasi lebih lanjut tentang format ini di [(Dokumen Format File)[https://docs.fileformat.com/pdf/e/].
...
### Menambahkan Gambar Bertag dari Aliran

Menambahkan Gambar Bertag dari Aliran dalam PDF. Versi 25.9 mendukung aksesibilitas yang ditingkatkan dalam dokumen PDF dengan menambahkan gambar dari aliran memori dan menandainya dengan teks alternatif.
...
Pembaruan ini menambahkan lebih banyak fleksibilitas dalam tata letak dan pengelolaan keamanan dokumen.

1. Membuat daftar isi bertag (TOC).
1. Mengubah ukuran halaman PDF dengan penskalaan konten.
1. Menerapkan batas bergaris putus-putus pada tabel.

### Membuat Daftar Isi Bertag (TOC)

Secara otomatis menghasilkan daftar isi (TOC) yang dapat diakses dalam PDF bertag. Membuat Daftar Isi (TOC) yang sepenuhnya dapat diakses dalam PDF memungkinkan pembaca menavigasi dokumen dengan efisien dan memastikan kepatuhan PDF/UA-1 untuk aksesibilitas.
...
### Mengubah Ukuran Halaman dengan Penskalaan Konten

Mengubah ukuran halaman PDF sambil mempertahankan tata letak dan menskalakan konten secara proporsional. Saat bekerja dengan PDF, Anda mungkin perlu mengubah ukuran halaman atau menskalakan konten agar sesuai dengan dimensi baru.
...
### Menerapkan Batas Bergaris Putus-putus pada Tabel

Tambahkan tabel dengan gaya batas khusus menggunakan garis putus-putus. Contoh ini menunjukkan cara menerapkan gaya batas khusus—seperti garis putus-putus atau titik-titik—ke tabel dalam dokumen PDF menggunakan Aspose.PDF untuk Python via .NET.
...
1. Menyesuaikan teks di dalam bentuk.
1. Mengenkripsi PDF menggunakan sertifikat publik.
1. Menambahkan anotasi awan dan poligon.

### Mengenkripsi PDF dengan Sertifikat Publik

Amankan PDF Anda dengan enkripsi berbasis sertifikat publik. Enkripsi sertifikat publik memungkinkan PDF dienkripsi untuk penerima tertentu, memastikan hanya pemegang kunci pribadi yang sesuai yang dapat membuka dan membaca dokumen.
...
### Menyesuaikan Teks dalam Persegi Panjang

Secara otomatis menskalakan teks agar sesuai dalam persegi panjang yang ditentukan. Saat memperbarui atau memperluas teks dalam PDF, teks dapat melampaui batas paragraf asli.
...
### Menambahkan Anotasi Poligon Awan

Tingkatkan alur kerja peninjauan PDF dengan anotasi cloud atau bergaya poligon. Anotasi poligon memungkinkan Anda menyorot atau menekankan area tertentu dalam PDF menggunakan bentuk geometris.
...
Gunakan SetTextStyle untuk menerapkan gaya seperti tebal, miring, garis bawah, atau menghapus format yang ada pada teks anotasi.
...
Tambahkan gambar, ubah font, dan lapisi grafik tanda tangan di atas konten latar belakang untuk branding yang lebih baik atau konsistensi desain.
...
## Apa baru di Aspose.PDF 25.5

Pembaruan Aspose.PDF terbaru memperkenalkan beberapa peningkatan kuat yang meningkatkan aksesibilitas dokumen, kompatibilitas, dan keamanan. Pengembang kini dapat mengekstrak sertifikat digital langsung dari file PDF yang ditandatangani, memungkinkan verifikasi lanjutan dan pemeriksaan kepatuhan.

1. Ekstrak Sertifikat dari Tanda Tangan PDF.
1. Buat Daftar Terurut Terstruktur dalam PDF yang Ditandai.
...
### Buat Daftar Terurut Terstruktur dalam PDF yang Ditandai

Hasilkan daftar bernomor yang dapat diakses (dengan item bersarang) di dalam dokumen yang ditandai.
...
Standarisasi formulir XFA dengan 'ignore_needs_rendering'.
...
### Penggantian Font dalam PDF - Konversi XPS
