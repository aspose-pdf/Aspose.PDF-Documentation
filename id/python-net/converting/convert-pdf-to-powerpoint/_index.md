...
description: Pelajari cara mengkonversi PDF ke PowerPoint dengan Python, termasuk PDF ke PPTX, slide sebagai gambar, dan resolusi gambar khusus dengan Aspose.PDF.
lastmod: "2026-06-12"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Abstract: Artikel ini menunjukkan cara mengonversi file PDF ke presentasi PowerPoint dengan Aspose.PDF for Python via .NET. Ini mencakup konversi PDF ke PPTX, mengonversi slide sebagai gambar, dan mengatur resolusi gambar untuk output presentasi.
---
...
Selama konversi PDF ke PPTX, teks dapat ditampilkan sebagai teks yang dapat dipilih yang dapat Anda perbarui di PowerPoint. Untuk mengonversi file PDF ke format PPTX, Aspose.PDF menyediakan the [PptxSaveOptions](https://reference.aspose.com/pdf/python-net/aspose.pdf/pptxsaveoptions/) kelas. Lewati a `PptxSaveOptions` objek sebagai argumen kedua ke [save()](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/#methods) metode.
...
1. Buat sebuah instance dari [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) kelas.
...
{{% alert color="success" %}}
**Coba mengonversi PDF ke PowerPoint secara daring**
...
1. Setel properti 'image_resolution' ke 300 DPI untuk rendering berkualitas tinggi.
1. Simpan PDF sebagai file PPTX menggunakan opsi penyimpanan yang telah didefinisikan.
...
- [Konversi PDF ke Word](/pdf/id/python-net/convert-pdf-to-word/) untuk keluaran dokumen yang dapat diedit alih-alih slide.
- [Konversi PDF ke Excel](/pdf/id/python-net/convert-pdf-to-excel/) ketika PDF sumber berisi data bisnis yang penuh tabel.
- [Konversi PDF ke HTML](/pdf/id/python-net/convert-pdf-to-html/) untuk alur kerja penerbitan yang siap peramban.
