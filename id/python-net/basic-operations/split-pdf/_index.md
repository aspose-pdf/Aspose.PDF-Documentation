...
1. Untuk setiap iterasi, buat objek Document baru dan tambahkan masing-masing [Halaman](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/) objek ke dalam dokumen kosong
