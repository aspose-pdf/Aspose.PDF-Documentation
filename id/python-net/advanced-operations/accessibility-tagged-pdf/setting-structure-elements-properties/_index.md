---
title: Atur Properti Elemen Struktur Tagged PDF di Python
linktitle: Mengatur Properti Elemen Struktur
type: docs
weight: 30
url: /id/python-net/setting-structure-elements-properties/
description: Pelajari cara mengatur properti elemen struktur tagged PDF di Python dengan Aspose.PDF for Python via .NET, termasuk judul, bahasa, teks aktual, teks alternatif, dan teks ekspansi.
lastmod: "2026-06-12"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Elemen struktur mendefinisikan hierarki semantik dari sebuah dokumen PDF, seperti bagian, judul, paragraf, atau tabel. Dengan mengatur properti seperti title, language, alternative_text, actual_text, dan expansion_text, Anda meningkatkan aksesibilitas dan makna semantik PDF untuk teknologi bantu seperti pembaca layar.

Potongan kode berikut menunjukkan cara mengatur properti elemen struktur dari Dokumen Tagged PDF:

1. Buat dokumen tagged PDF baru.
1. Atur metadata dokumen.
1. Buat elemen struktur.
1. Atur properti aksesibilitas.
...
Untuk mengatur elemen struktur teks dari Tagged PDF Document, Aspose.PDF menawarkan [Elemen Paragraf](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/) kelas. Cuplikan kode berikut menunjukkan cara mengatur elemen struktur teks dari Tagged PDF Document:
...
Contoh Python ini menggunakan Aspose.PDF untuk membuat Tagged PDF yang mencakup hierarki terstruktur dari header dan paragraf, meningkatkan fitur semantik dan aksesibilitas dokumen.

1. Buat dokumen tagged PDF baru.
1. Atur metadata dokumen.
1. Akses elemen struktur root.
1. Buat header multi-tingkat.
1. Tambahkan header ke struktur root.
1. Buat elemen paragraf.
1. Tambahkan paragraf ke struktur akar.
1. Simpan PDF ber-tag.

Potongan kode berikut menunjukkan cara mengatur elemen struktur blok teks dari Dokumen Tagged PDF:
...
## Pengaturan Elemen Struktur Inline

Buat elemen teks inline (/Span) dalam header dan paragraf pada PDF ber‑tag menggunakan Aspose.PDF for Python via .NET.

Potongan kode berikut menunjukkan cara mengatur elemen struktur inline dari Dokumen Tagged PDF:
...
Tetapkan Nama Tag Kustom untuk Struktur dan Elemen Inline dalam Tagged PDF Menggunakan Aspose.PDF untuk Python.

Potongan kode berikut menunjukkan cara mengatur nama tag khusus:

1. Buat dokumen tagged PDF baru.
1. Atur metadata dokumen.
1. Buat elemen section.
1. Buat elemen paragraf dengan tag khusus.
1. Buat elemen span inline dengan tag khusus.
1. Simpan PDF ber-tag.
...
Buat tautan dan elemen gambar dalam PDF bertag menggunakan Aspose.PDF for Python via .NET.

Potongan kode berikut menunjukkan cara mengatur elemen struktur dalam paragraf dengan teks Dokumen Tagged PDF:
...
## Pengaturan Elemen Struktur Tautan

Aspose.PDF for Python via .NET API juga memungkinkan Anda menambahkan elemen struktur tautan.

Cuplikan kode berikut menunjukkan cara menambahkan elemen struktur tautan ke Dokumen Tagged PDF:
...
## Pengaturan Elemen Struktur Catatan

API Aspose.PDF for Python via .NET juga memungkinkan Anda untuk menambahkan [ElemenCatatan](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/noteelement/) pada dokumen Tagged PDF. Potongan kode berikut menunjukkan cara menambahkan elemen catatan dalam Tagged PDF Document:
...
## Cara mengatur Bahasa dan Judul

Aspose.PDF for Python via .NET API juga memungkinkan Anda mengatur bahasa dan judul untuk sebuah dokumen sesuai spesifikasi PDF/UA. Bahasa dapat diatur untuk seluruh dokumen maupun untuk elemen struktural terpisahnya. Potongan kode berikut menunjukkan cara mengatur bahasa dan judul dalam Dokumen Tagged PDF:

1. Buat dokumen tagged PDF baru.
1. Atur judul dokumen dan bahasa.
1. Buat elemen header.
1. Tambahkan paragraf dengan bahasa tertentu.
1. Simpan PDF ber-tag.
...
- [Buat Tagged PDF](/pdf/id/python-net/create-tagged-pdf/) untuk menghasilkan elemen struktur sebelum memperbarui propertinya.
- [Ekstrak Tagged Content dari Tagged PDFs](/pdf/id/python-net/extract-tagged-content-from-tagged-pdfs/) untuk memeriksa node struktur yang ada dan metadata.
- [Bekerja dengan Tabel dalam Tagged PDF](/pdf/id/python-net/working-with-table-in-tagged-pdfs/) jika Anda perlu menerapkan properti aksesibel ke struktur tabel.
