---
title: Aspose.PDF Format File yang Didukung
...
Tabel berikut menunjukkan format file yang dapat dimuat dan disimpan oleh Aspose.PDF untuk Android via Java.
...
|[EPUB](https://docs.fileformat.com/ebook/epub/)|Format file Buku Elektronik| |{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Menyimpan dokumen sebagai Gambar TIFF Tunggal atau Multi-Halaman| |{{< emoticons/tick >}}| |
|[DICOM ](https://docs.fileformat.com/image/dicom/)|Menambahkan Gambar DICOM dalam dokumen PDF| |{{< emoticons/tick >}}| |
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|Menyimpan dokumen dalam Format CSV| |{{< emoticons/tick >}}| |
