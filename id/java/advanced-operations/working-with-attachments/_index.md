...
- [Menambahkan lampiran ke dokumen PDF](/pdf/id/java/add-attachment-to-pdf-document/)
- [Ekstrak dan simpan lampiran](/pdf/id/java/extract-and-save-an-attachment/)

- [Menghapus lampiran dari PDF yang ada](/pdf/id/java/removing-attachment-from-an-existing-pdf/)
- [Nonaktifkan Kompresi File saat Menambahkan sebagai Sumber Daya Tertanam](/pdf/id/java/disable-files-compression-when-adding-as-embedded-resources/)
- [Portofolio](/pdf/id/java/portfolio/)