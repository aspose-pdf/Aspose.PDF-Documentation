...
1. Конвертировать PDF-файл в DOC с помощью [save_doc](https://reference.aspose.com/pdf/rust-cpp/convert/save_doc/) функция.
...
1. Откройте PDF-документ.
1. Конвертировать PDF‑файл в DOCX с помощью [save_docx](https://reference.aspose.com/pdf/rust-cpp/convert/save_docx/) функция.
...
## Конвертировать PDF в DOCX с улучшенным режимом распознавания
