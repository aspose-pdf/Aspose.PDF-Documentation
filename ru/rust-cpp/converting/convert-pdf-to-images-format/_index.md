...
1. Конвертировать страницу в JPEG с помощью [страница_в_jpg](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_jpg/) функция.
...
1. Откройте PDF‑документ.
1. Конвертировать страницу в TIFF с помощью [страница_в_tiff](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_tiff/) функция.
...
1. Откройте PDF‑документ.
1. Конвертировать Page в PNG с помощью [page_to_png](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_png/) функция.
...
1. Откройте PDF‑документ.
1. Преобразовать страницу в SVG, используя [page_to_svg](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_svg/) функция.
...
### Конвертировать PDF в ZIP‑архив SVG
...
1. Откройте PDF‑документ.
1. Конвертировать Page в DICOM с использованием [page_to_dicom](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_dicom/) функция.
...
1. Откройте PDF‑документ.
1. Конвертировать страницу в BMP с помощью [страница_в_BMP](https://reference.aspose.com/pdf/rust-cpp/convert/page_to_bmp/) функция.
