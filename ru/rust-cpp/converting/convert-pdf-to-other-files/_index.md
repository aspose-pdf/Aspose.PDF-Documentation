...
1. Конвертируйте PDF-файл в EPUB с помощью функции [save_epub](https://reference.aspose.com/pdf/rust-cpp/convert/save_epub/).
...
1. Откройте PDF-документ.
1. Преобразуйте PDF‑файл в TeX с помощью функции [save_tex](https://reference.aspose.com/pdf/rust-cpp/convert/save_tex/).
...
1. Откройте PDF-документ.
1. Конвертируйте PDF-файл в TXT с помощью функции [save_txt](https://reference.aspose.com/pdf/rust-cpp/convert/save_txt/).
...
1. Откройте PDF-документ.
1. Конвертируйте PDF-файл в XPS с помощью функции [save_xps](https://reference.aspose.com/pdf/rust-cpp/convert/save_xps/).
...
1. Откройте PDF-документ.
1. Преобразуйте страницу PDF в оттенки серого с помощью функции [page_grayscale](https://reference.aspose.com/pdf/rust-cpp/organize/page_grayscale/).
