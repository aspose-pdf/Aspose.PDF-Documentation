---
title: Компоновка PDF с использованием Aspose.PDF for Rust через C++
linktitle: Компоновка PDF
type: docs
weight: 30
url: /ru/rust-cpp/pdf-imposition/
description: В этой статье объясняется, как переставлять страницы PDF для печатных оптимизированных макетов с использованием Aspose.PDF for Rust через C++.
lastmod: "2026-07-20"
sitemap:
    changefreq: "monthly"
    priority: 0.7
