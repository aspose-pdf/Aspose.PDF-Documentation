...
1. Этот [save](https://reference.aspose.com/pdf/rust-cpp/core/save/) Метод гарантирует, что изменения PDF записываются обратно в файл. Этот шаг важен для сохранения изменений, например, добавления новых страниц.
