...
1. Этот [open](https://reference.aspose.com/pdf/rust-cpp/core/open/) Метод загружает указанный PDF‑файл в память, позволяя выполнять дальнейшие манипуляции, такие как изменение его внешнего вида или содержимого.
