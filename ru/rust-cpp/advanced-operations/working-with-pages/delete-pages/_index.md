...
1. Удаление определённой страницы с [page_delete](https://reference.aspose.com/pdf/rust-cpp/core/page_delete/) функция.
1. Сохранение документа с помощью [save](https://reference.aspose.com/pdf/rust-cpp/core/save/) метод.
