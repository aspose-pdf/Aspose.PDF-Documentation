...
### Добавьте текст в нижний колонтитул PDF‑документа
...
### Добавьте текст в заголовок PDF-документа
...
1. Откройте существующий PDF.
1. Добавьте текст в заголовок с помощью [add_text_header](https://reference.aspose.com/pdf/rust-cpp/organize/add_text_header/).
1. Сохраните изменённый PDF.
