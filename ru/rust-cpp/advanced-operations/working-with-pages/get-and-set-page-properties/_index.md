...
1. Откройте PDF‑документ с помощью [открыть](https://reference.aspose.com/pdf/rust-cpp/core/open/) метод.
1. Установите размер страницы с помощью [page_set_size](https://reference.aspose.com/pdf/rust-cpp/organize/page_set_size/) функции.
1. Сохраните документ с использованием [save_as](https://reference.aspose.com/pdf/rust-cpp/core/save_as/) метод.
