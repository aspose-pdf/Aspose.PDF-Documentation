...
1. Поверните PDF Pages. The [повернуть](https://reference.aspose.com/pdf/rust-cpp/organize/rotate/) функция применяет конкретный поворот (в данном случае 180 градусов) к заданной странице.
1. Сохраните изменения в новый файл. The [save_as](https://reference.aspose.com/pdf/rust-cpp/core/save_as/) Функция создаёт новый PDF‑файл, чтобы сохранить оригинал и одновременно хранить обновлённую версию.
