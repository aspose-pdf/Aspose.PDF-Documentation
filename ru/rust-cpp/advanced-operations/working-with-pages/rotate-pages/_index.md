...
1. Поверните страницы PDF с помощью функции [rotate](https://reference.aspose.com/pdf/rust-cpp/organize/rotate/), которая применяет заданный поворот к нужной странице.
1. Сохраните изменения в новый файл с помощью [save_as](https://reference.aspose.com/pdf/rust-cpp/core/save_as/), чтобы сохранить оригинал и обновлённую версию отдельно.
