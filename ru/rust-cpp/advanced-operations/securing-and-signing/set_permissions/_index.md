...
## Установить права доступа для PDF‑документа
...
1. Вызов [set_permissions](https://reference.aspose.com/pdf/rust-cpp/security/set_permissions/) для защиты документа.
