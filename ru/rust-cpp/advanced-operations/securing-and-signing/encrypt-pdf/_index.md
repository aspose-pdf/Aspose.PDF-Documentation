...
description: Зашифровать файл PDF с помощью Aspose.PDF for Rust via C++.
lastmod: "2026-07-20"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Для простого и безопасного шифрования документов вы можете использовать Aspose.PDF for Rust via C++.
...
1. Зашифруйте PDF‑документ с помощью [encrypt](https://reference.aspose.com/pdf/rust-cpp/security/encrypt/) метод.
