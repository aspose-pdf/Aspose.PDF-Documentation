...
## Получите разрешения защищенного паролем PDF-документа
...
1. Вызовите [get_permissions](https://reference.aspose.com/pdf/rust-cpp/security/get_permissions/), чтобы получить флаги разрешений, определяющие, какие операции разрешены.
