...
Abstract: Руководство «Начало работы» для Aspose.PDF for Rust via C++ предоставляет вводную информацию по работе с библиотекой, охватывая базовые шаги по созданию и манипулированию PDF‑документами. Оно включает пример «Hello World», демонстрирующий, как сгенерировать простой PDF‑файл с текстовым содержимым, помогая разработчикам быстро понять основную функциональность API.
