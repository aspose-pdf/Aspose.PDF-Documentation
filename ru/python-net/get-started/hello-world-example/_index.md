...
description: Этот пример демонстрирует, как создать простой PDF-документ с текстом Hello World, используя Aspose.PDF for Python via .NET.
lastmod: "2022-12-22"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
В этой статье мы создаем PDF-документ, содержащий текст "Hello World!". После установки **Aspose.PDF for Python via .NET** в вашей среде, вы можете выполнить следующий пример кода, чтобы увидеть, как работает API Aspose.PDF.
...
Следующий фрагмент кода представляет собой программу "Hello World", демонстрирующую работу Aspose.PDF for Python via .NET API.
