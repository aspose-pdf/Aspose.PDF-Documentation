...
Чтобы создать PDF‑файл usingPython, можно использовать следующие шаги.

1. Создать объект [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) class
1. Добавить [Page](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/) объект к [Страницы](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/#properties) коллекция объекта Document
1. Добавить [TextFragment](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textfragment/) к [абзацы](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/#properties) коллекция страницы
