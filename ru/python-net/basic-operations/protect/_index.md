...
1. Создать объект разрешений.
1. Разрешить конкретные разрешения.
1. Установить пароли пользователя и владельца.
1. Выбрать алгоритм шифрования.
1. Применить шифрование к документу.
...
1. Загрузите PDF‑документ.
1. Определить пароли пользователя и владельца.
1. Установить полные права доступа.
1. Выбрать алгоритм шифрования.
...
1. Открыть PDF с каждым паролем, используя ap.Document().
