...
1. Сохраните в [HtmlSaveOptions](https://reference.aspose.com/pdf/python-net/aspose.pdf/htmlsaveoptions/) вызывая [save()](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/#methods) метод.
...
1. Создайте 'HtmlSaveOptions' и 'set split_into_pages'.
