...
1. Инициализируйте a [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) объект с исходным HTML‑файлом.
...
1. Создайте экземпляр [HtmlLoadOptions()](https://reference.aspose.com/pdf/python-net/aspose.pdf/htmlloadoptions/) класс.
1. Установите `html_media_type` для применения CSS-правил, предназначенных для экранных или печатных макетов, таких как `HtmlMediaType.SCREEN` или `HtmlMediaType.PRINT`.
...
1. Создайте экземпляр [HtmlLoadOptions](https://reference.aspose.com/pdf/python-net/aspose.pdf/htmlloadoptions/) класс.
1. Установите `is_priority_css_page_rule = False` чтобы другие стили имели приоритет над `@page` правила.
...
1. Установите `is_embed_fonts = True` встроить шрифты, используемые в HTML, непосредственно в PDF.
...
1. Включите `is_render_to_single_page` отобразить весь HTML‑контент на одной странице.
...
1. Активируйте семантическую разметку, чтобы PDF содержал структурированные элементы.
1. Откройте HTML‑файл, используя настроенные параметры.
1. Сохраните структурированный PDF.
