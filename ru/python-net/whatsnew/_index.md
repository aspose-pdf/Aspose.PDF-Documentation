...
### Преобразование PDF в формат PDF/E-1
...
### Добавление Tagged Images из потока
...
### Создание помеченного оглавления (TOC)
...
### Добавление облачные полигональные аннотации
...
### Извлечение сертификаты из подписей PDF
...
### Создание структурированные упорядоченные списки в Tagged PDF
...
### Преобразование динамические формы XFA в PDF‑файлы AcroForm
