...
Используя [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) class, разработчики могут изменять эти флаги, чтобы скрывать, показывать или настраивать поведение полей формы в интерактивном PDF.
