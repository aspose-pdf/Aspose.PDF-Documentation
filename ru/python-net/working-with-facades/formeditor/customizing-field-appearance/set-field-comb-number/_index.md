...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) Класс предоставляет метод ‘set_field_comb_number’, позволяющий задать количество ячеек (символов) в поле формы.

1. Откройте существующую PDF-форму.
1. Создает объект FormEditor.
