...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) Класс предоставляет метод 'set_field_limit' для определения максимальной длины ввода для поля.
