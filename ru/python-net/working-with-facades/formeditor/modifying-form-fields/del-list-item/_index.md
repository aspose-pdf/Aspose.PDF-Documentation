...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) Класс предоставляет метод ’del_list_item’ для удаления конкретного элемента из поля списка.
