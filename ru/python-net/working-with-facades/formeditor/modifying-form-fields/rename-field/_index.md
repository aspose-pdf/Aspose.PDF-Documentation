...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) класс предоставляет метод 'rename_field', который позволяет разработчикам изменить имя существующего поля, сохраняя его позицию, значение и внешний вид.
