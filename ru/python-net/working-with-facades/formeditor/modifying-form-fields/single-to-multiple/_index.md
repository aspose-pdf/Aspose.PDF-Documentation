...
Используя [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) класс, разработчики могут изменять существующие текстовые поля, не влияя на их положение или другие свойства.
