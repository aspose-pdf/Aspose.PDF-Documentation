...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) Класс позволяет добавлять текстовые поля, флажки, переключатели, списковые поля, комбинированные поля и кнопки, упрощая создание интерактивных PDF.
