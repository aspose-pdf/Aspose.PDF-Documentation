...
description: Проверьте, как программно добавить поле ComboBox (выпадающий список) в документ PDF с помощью Aspose.PDF for Python. Этот пример демонстрирует, как вставить формовое поле ComboBox, добавить выбираемые элементы и сохранить обновлённый файл PDF.
lastmod: "2026-03-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) класс позволяет создавать и управлять различными типами полей, включая текстовые поля, флажки, переключатели и раскрывающиеся списки.
