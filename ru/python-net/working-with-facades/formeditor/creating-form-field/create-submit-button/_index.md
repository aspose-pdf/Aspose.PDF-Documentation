...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) class позволяет добавлять кнопки, флажки, переключатели, текстовые поля и другие элементы управления формой.

1. Загрузить существующий PDF‑документ.
1. Добавить поле кнопки Submit на конкретную страницу.
1. Установить метку кнопки и целевой URL-адрес отправки.
1. Сохранить обновлённый PDF с новой кнопкой.
