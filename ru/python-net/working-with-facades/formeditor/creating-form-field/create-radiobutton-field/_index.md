...
The [FormEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/formeditor/) Класс предоставляет методы для создания различных типов полей, включая текстовые поля, флажки, раскрывающиеся списки, списки и радиокнопки.

1. Загрузить существующий PDF‑документ.
1. Определить список вариантов переключателей.
1. Добавить поле переключателя на определённую страницу.
