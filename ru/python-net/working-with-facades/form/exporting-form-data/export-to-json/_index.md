...
JSON — широко используемый формат данных, который обеспечивает бесшовный обмен между приложениями и сервисами. В этом примере [Form](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/form/) объект из [aspose.pdf.facades](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/) модуль используется для привязки файла PDF и экспорта его значений полей формы в читаемую структуру JSON.
