...
XFDF представляет собой XML-представление данных формы PDF, которое позволяет разработчикам переносить значения полей формы независимо от оригинального документа. В этом примере [Form](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/form/) объект из [aspose.pdf.facades](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/) используется для привязки исходного PDF и экспорта его данных в структурированный файл XFDF.
...
1. Экспорт данных формы. Вызовите 'export_xfdf()', чтобы извлечь и сохранить значения полей формы в формате XFDF.
