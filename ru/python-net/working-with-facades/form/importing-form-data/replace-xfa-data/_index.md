...
Формы XFA (XML Forms Architecture) хранят свои данные в формате XML внутри структуры PDF. В этом примере, [Form](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/form/) фасад из [aspose.pdf.facades](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/) модуль используется для привязки PDF и замены его существующего набора данных XFA с использованием внешнего XML‑потока. После применения новых данных обновлённый PDF сохраняется как отдельный файл.
