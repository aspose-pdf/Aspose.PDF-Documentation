...
Поля штрихкода в PDF‑формах позволяют сохранять закодированную информацию и визуально отображать её в виде штрихкодов. В этом примере, the [Form](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/form/) фасад из [aspose.pdf.facades](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/) модуль используется для доступа к полям формы и назначения значения штрихкода. После заполнения данных PDF сохраняется с обновлённым содержимым штрихкода.
