...
lastmod: "2026-02-19"
TechArticle: true
AlternativeHeadline: Добавление изображения к полям кнопок & чтение флагов отправки
...
## Добавить изображение к полям кнопок
...
1. Привязать PDF‑файл к объекту Form.
1. Добавить изображение в поле Button Field.

    - Определить путь к файлу изображения, связанному с PDF
    - Открыть изображение в бинарном режиме как image_stream.
    - Вызвать fill_image_field() с полностью квалифицированным именем поля кнопки.
