...
В этом фрагменте кода метод 'make_n_up' класса [PdfFileEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/pdffileeditor/) класс располагает страницы входного PDF в сетке 2 × 2, что означает, что четыре оригинальные страницы появляются на одной странице в выходном документе.
