...
Узнайте, как использовать метод extract [PdfFileEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/pdffileeditor/) class. Указывая список страниц для извлечения, вы можете создать новый PDF, содержащий только выбранные страницы, при этом сохраняется оригинальное содержание и форматирование.
