...
Этот фрагмент кода показывает, как использовать метод append [PdfFileEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/pdffileeditor/) класс для добавления выбранных страниц из другого PDF‑файла в конец исходного PDF. Указывая диапазон страниц, разработчики могут точно контролировать, какие страницы включаются в окончательный документ.

1. Создать объект PdfFileEditor.
1. Добавить страницы из другого PDF.
