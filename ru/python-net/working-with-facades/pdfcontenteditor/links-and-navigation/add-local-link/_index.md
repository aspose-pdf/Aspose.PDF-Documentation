...
description: В этом примере привязывается входной PDF, добавляется локальная ссылка красного цвета на странице 1, указывающая на страницу 1, и сохраняется изменённый документ.
lastmod: "2026-03-20"
sitemap:
    changefreq: "weekly"
    priority: 0.7
