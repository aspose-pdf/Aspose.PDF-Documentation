---
title: Заменить текст на странице с помощью состояния
type: docs
weight: 20
url: /python-net/replace-text-on-page-with-state/
description: В этом примере все вхождения слова "software" на странице 1 заменяются на "SOFTWARE PAGE 1", используя красный текст размером шрифта 12.
lastmod: "2026-03-20"
sitemap:
    changefreq: "weekly"
    priority: 0.7
