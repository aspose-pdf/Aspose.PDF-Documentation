...
1. Инициализируйте [PdfContentEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/pdfcontenteditor/) и привяжите PDF.
1. Получите текущие Viewer Preferences.
1. Проверьте конкретные флаги.
1. Отобразите текущие настройки.
