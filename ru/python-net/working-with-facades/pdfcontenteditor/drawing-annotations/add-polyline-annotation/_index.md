...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Добавить полилинейную аннотацию в PDF с помощью PdfContentEditor на Python
Abstract: Этот пример демонстрирует, как добавить полилинейную аннотацию в документ PDF, используя Aspose.PDF for Python через API Facades. Он показывает, как определить последовательность вершин, стиль границы, прямоугольник аннотации, текст и сохранить обновлённый документ.
---

Полилинейные аннотации позволяют выделять серию соединённых отрезков линий в PDF. Используя [PdfContentEditor](https://reference.aspose.com/pdf/python-net/aspose.pdf.facades/pdfcontenteditor/)", вы можете нарисовать полилинию, указав координаты вершин, стиль границы, номер страницы и границы аннотации. Это полезно для визуального представления путей, тенденций или соединений в диаграммах и документах.
