...
## Добавление страницу PDF в качестве штампа
...
## Добавление TextStamp с текстовым состоянием
...
## Добавление штамп на определённые страницы
...
## Добавление фонового ImageStamp
