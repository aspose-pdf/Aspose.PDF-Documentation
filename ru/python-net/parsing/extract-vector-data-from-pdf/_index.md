---
title: Извлеките векторные данные из PDF-файла с помощью Python
...
## Получите доступ к векторным данным PDF-документа
...
## Сохраните векторную графику со страницы в SVG-файл
...
### Извлеките каждый подпуть в отдельный SVG
...
### Извлеките список элементов в одно изображение
