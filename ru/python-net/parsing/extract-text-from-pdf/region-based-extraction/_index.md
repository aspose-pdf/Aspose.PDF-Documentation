---
title: Извлеките текст по области с помощью Python
linktitle: Извлеките текст по области
type: docs
weight: 20
...
## Извлеките текст из определённой области страницы
...
## Извлеките абзацы с визуализацией ограничивающего многоугольника
