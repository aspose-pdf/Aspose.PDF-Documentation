...
1. Объедините две ячейки по горизонтали в одну.
...
1. Добавьте текст и управление обтеканием.
1. Добавьте строки и ячейки.
1. Сохраните PDF.
...
1. Установите начальные ширины столбцов.
...
1. Примените стиль со скруглёнными углами.
1. Добавьте строки и ячейки.
...
1. Определите границы таблицы и ячеек.
1. Добавьте LaTeX контент.
1. Добавьте строки. Цикл добавляет несколько строк с контентом, отформатированным в LaTeX, в каждой ячейке.
1. Вставьте таблицу на страницу PDF с помощью 'page.paragraphs.add(table)'.
1. Сохраните документ PDF.
...
### Вставка автоматических разрывов страниц в таблице PDF
...
1. Инициализируйте таблицу.
1. Повторяйте строки заголовка, включая шрифт, размер и цвет.
1. Установите ширину столбцов и примените границы к таблице.
1. Добавьте строки заголовка.
...
1. Установите стиль границы таблицы.
1. Инициализируйте таблицу.
1. Добавьте таблицу на страницу PDF.
1. Добавьте строку заголовка.
1. Добавьте строки данных.
...
### Создание таблицы PDF с ячейками, содержащими повернутый текст
