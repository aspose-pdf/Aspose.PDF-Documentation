...
1. Загрузить существующий PDF с `ap.Document(infile)`.
...
1. Создать новый `Document` и добавить страницу.
1. Добавьте изображение в ресурсы страницы (`page.resources.images`).
1. Создать операторы преобразования (`GSave`, `ConcatenateMatrix`, `Do`, `GRestore`).
...
1. Получить ресурсы изображений из `page.resources.images`.
1. Установить альтернативный текст с помощью `try_set_alternative_text()`.
1. Сохраните полученный PDF.
