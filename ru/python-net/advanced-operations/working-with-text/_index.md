...
- [PDF Подсказка](/pdf/python-net/pdf-tooltip/) - вы можете добавить подсказку к искомому тексту, добавив невидимую кнопку с использованием Python.
- [Форматирование текста внутри PDF](/pdf/python-net/text-formatting-inside-pdf/) - многие функции вы можете добавить в ваш документ при форматировании текста внутри него.
...
- [Повернуть текст внутри PDF](/pdf/python-net/rotate-text-inside-pdf/) - повернуть текст внутри PDF, используя свойство поворота класса TextFragment.
...
- [Определить разрыв строки](/pdf/python-net/determine-line-break/) - эта тема объясняет, как отслеживать разрывы строк в многострочных текстовых фрагментах.
