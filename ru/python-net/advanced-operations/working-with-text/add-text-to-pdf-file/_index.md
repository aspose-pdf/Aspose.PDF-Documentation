...
### Добавление текста: простой пример
...
1. Создайте новый [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) объект.
1. Используйте `document.pages.add()` создать новый пустой [Page](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/).
...
1. Создайте новый [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) и пустой [Page](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/) используя `document.pages.add()`.
1. Прочитайте текст из файла или используйте текст по умолчанию.
1. Создайте [`TextBuilder`](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textbuilder/) добавить контент уровня абзаца с управлением разметкой и переносом.
1. Создайте [`TextParagraph`](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textparagraph/) и установите режим переноса (пример использует `DISCRETIONARY_HYPHENATION`).
1. Создайте [`TextFragment`](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textfragment/), примените стили и добавьте фрагмент к абзацу.
...
### Добавление абзацы с отступами в PDF
...
### Добавление новую строку текста в PDF
...
1. Определите текстовое содержимое.
...
### Добавление невидимого текста в PDF
...
### Добавление текста с оформлением границы в PDF
...
1. Примените стили текста. Установить шрифт Times New Roman, размер 12. Применить светло-серый фон и красный цвет переднего плана (текст).
1. Настройте стили границы.
1. Добавьте текст на страницу. Используйте TextBuilder, чтобы добавить стилизованный текст на страницу.
1. Сохраните Document.
...
### Добавление перечёркнутого текста в PDF
...
1. Примените форматирование цвета и зачеркивания. Установить фон светло-серым, цвет текста красным и включите зачеркивание.
1. Расположите текст.
...
1. Добавьте стиль подчеркивания.
...
### Добавление HTML-текст в PDF-документ
...
1. Вставьте HTML в Page. Добавляет фрагмент HTML в коллекцию абзацев страницы, отображая HTML как нативный PDF‑контент.
1. Сохраните Document.
...
### Добавление HTML‑фрагмент с переопределённым состоянием текста
...
### Добавление LaTeX-текста в PDF-документ
...
### Использование пользовательского Font из файла
...
### Использование пользовательского Font из потока
