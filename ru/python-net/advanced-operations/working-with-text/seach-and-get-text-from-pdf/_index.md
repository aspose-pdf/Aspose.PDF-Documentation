...
1. Определите область поиска с ограничениями прямоугольника.
1. Создайте и настройте TextAbsorber.
1. Обработайте все страницы в документе.
1. Получите и отобразить извлечённый текст.
...
1. Обработайте все страницы в документе.
1. Итерируйте извлечённые фрагменты текста.
...
1. Итерируйте найденные фрагменты.
...
1. Загрузите PDF Document.
1. Инициализируйте TextFragmentAbsorber и установите поисковую фразу.
...
1. Обработайте следующую страницу последовательно. Перейти к странице 2 и при желании продолжить через остальной документ. Метод 'absorber.visit()' обеспечивает накопление результатов со всех посещённых страниц. Выводит совокупные результаты поиска, показывая как текст, так и расположение.
...
1. Загрузите PDF Document.
1. Инициализируйте TextFragmentAbsorber с Phrase и прямоугольными ограничениями
1. Примените Absorber к странице 2. Ограничивает обработку только страницей 2, снижая ненужные вычисления. Обеспечивает поиск, специфичный для страницы.
1. Итерируйте найденные фрагменты и печатать
...
1. Итерируйте найденные фрагменты. Печатает соответствующие текстовые фрагменты и их координаты. Предоставляет точную информацию о местоположении извлечённых шаблонов.
...
1. Оформите и добавьте гиперссылки к совпадениям.
...
1. Обработайте каждую страницу. Применить абсорбер к каждой странице. Собрать все обнаруженные фрагменты текста и их геометрические позиции.
1. Преобразуйте Page в поток PNG.
1. Подготовьте графический объект для рисования.
1. Примените преобразование координат. Преобразовать координаты PDF в пиксели изображения.
