...
#### Загрузить PDF и собрать линейные аннотации
...
#### Найти линейные аннотации для удаления
...
#### Открыть PDF и создать квадратную аннотацию
...
#### Загрузить документ и собрать квадратные аннотации
