---
title: Фигурные аннотации через Python
...
### Добавить линейную аннотацию 

Этот пример добавляет линейную аннотацию на первую страницу и настраивает стили стрелок, толщину линии и всплывающее окно.
...
#### Создать и настроить линейную аннотацию
...
#### Прикрепите всплывающее окно и сохраните PDF
...
#### Загрузите PDF и соберите линейные аннотации
...
### Добавить квадратную аннотацию 

Квадратные аннотации полезны для обозначения прямоугольных областей в документе. В этом примере создаётся квадратная аннотация с настройками границы, заливки и прозрачности.

#### Откройте PDF и создайте квадратную аннотацию
...
Чтобы просмотреть квадратные аннотации, отфильтруйте аннотации первой страницы по `SQUARE` введите и распечатайте каждый прямоугольник.

#### Загрузите документ и соберите квадратные аннотации
...
#### Откройте PDF и создайте круговую аннотацию
...
#### Загрузите документ и соберите круговые аннотации
...
#### Откройте PDF и создайте полигональную аннотацию
...
#### Загрузите документ и соберите полигональные аннотации
...
#### Найдите и удалите аннотации полигонов
...
#### Откройте PDF и создайте аннотацию полилинии
...
#### Загрузите документ и соберите аннотации полилиний
