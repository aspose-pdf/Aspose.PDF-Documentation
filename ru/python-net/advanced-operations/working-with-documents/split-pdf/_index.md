...
1. Перебрать страницы PDF‑документа [Document](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) объекта [PageCollection](https://reference.aspose.com/pdf/python-net/aspose.pdf/pagecollection/) коллекция
...
1. Сохранить новый PDF, используя [save()](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/#methods) метод
...
1. Удалить страницы второй половины из первого документа.
1. Сохраните первую часть.
1. Создайте второй документ вывода.
1. Удалить страницы первой половины из второго документа.
...
1. Загрузите PDF-документ.
1. Определить общее количество страниц.
1. Определить количество страниц на часть.
1. Итерировать документ по частям.
...
1. Сохранить разделенный документ.
1. Повторять, пока все страницы не будут обработаны.
...
1. Сохранить документ последней страницы.
