...
1. Создать новый [`Document`](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) чтобы удержать извлечённую страницу.
...
1. Загрузите исходный PDF с помощью [`Document`](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) API (`ap.Document()`).
1. Создать новый [`Document`](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) для хранения извлечённых страниц.
