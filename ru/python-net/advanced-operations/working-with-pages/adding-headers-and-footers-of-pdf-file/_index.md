...
1. Перебрать все страницы в документе.
...
1. Перебрать все страницы и назначить заголовок и нижний колонтитул каждой из них.
...
1. Итерировать все страницы документа.
...
1. Определить стили текста с помощью [`TextState`](https://reference.aspose.com/pdf/python-net/aspose.pdf/textstate/) для верхнего и нижнего колонтитулов (шрифт, размер, выравнивание).
1. Создать [`HeaderFooter`](https://reference.aspose.com/pdf/python-net/aspose.pdf/headerfooter/) объекты для заголовка и нижнего колонтитула.
1. Создать заголовок [`Table`](https://reference.aspose.com/pdf/python-net/aspose.pdf/table/) с одной строкой и ячейкой, содержащей заголовочный текст.
1. Создать нижний колонтитул [`Table`](https://reference.aspose.com/pdf/python-net/aspose.pdf/table/) с единственной строкой и ячейкой, содержащей текст нижнего колонтитула.
...
1. Сохранить изменённое [`Document`](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/) в файл вывода.
...
1. Итерировать все страницы документа.
1. Создать [`HeaderFooter`](https://reference.aspose.com/pdf/python-net/aspose.pdf/headerfooter/) объект для заголовка.
1. Создать [`TeXFragment`](https://reference.aspose.com/pdf/python-net/aspose.pdf/texfragment/) для текста заголовка, содержащего команды LaTeX (например, `\\today\\`).
1. Создать [`HeaderFooter`](https://reference.aspose.com/pdf/python-net/aspose.pdf/headerfooter/) объект для нижнего колонтитула.
1. Создать [`TeXFragment`](https://reference.aspose.com/pdf/python-net/aspose.pdf/texfragment/) для текста нижнего колонтитула, включая символы LaTeX и нумерацию страниц.
1. Добавить [`TeXFragment`](https://reference.aspose.com/pdf/python-net/aspose.pdf/texfragment/) к соответствующему объекту заголовка/нижнего колонтитула.
