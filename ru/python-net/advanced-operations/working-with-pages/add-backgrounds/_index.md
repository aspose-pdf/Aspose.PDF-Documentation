---
title: Добавить фон в PDF с помощью Python
...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Добавить фон в PDF с помощью Python",
