...
1. Импортировать данные XML в форму.
...
1. Создать `Form` объект.
1. Привяжите входной PDF.
1. Импортировать данные формы с `import_fdf()`.
1. Сохраните обновлённый PDF.
...
1. Экспортировать данные формы с `export_fdf()`.
...
1. Создать `Form` объект.
1. Привяжите входной PDF.
1. Импортировать данные формы из файла XFDF.
1. Сохраните обновлённый PDF.
...
1. Создать `Form` объект.
1. Привяжите входной PDF.
1. Экспортировать данные формы в XFDF.
...
1. Создать источник и назначение `Form` объекты.
1. Объединить исходный и целевой PDF.
1. Экспортировать данные формы из исходного PDF.
1. Импортировать данные формы в целевой PDF.
...
1. Экспортировать поля формы с помощью `export_json()`.
...
1. Инициализировать пустой словарь для хранения данных полей формы.
