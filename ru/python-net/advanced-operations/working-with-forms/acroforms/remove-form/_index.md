...
1. Получите доступ к ресурсам страницы.
1. Очистите объекты формы.
...
## Удаление конкретного типа формы
...
1. Загрузите PDF-документ.
1. Получите доступ к формам страницы.
1. Итерируйте формы.
1. Проверьте наличие форм‑пишущих машинок.
1. Удалите соответствующую форму.
1. Сохраните обновлённый документ.
