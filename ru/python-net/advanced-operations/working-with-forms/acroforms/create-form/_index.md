...
1. Определить позиции текстовых полей.
1. Создайте разные внешние виды по умолчанию.
1. Создать текстовое поле.
1. Применить внешний вид к каждому виджету.
1. Настроить стиль границы.
1. Добавить поле в форму.
1. Сохранить PDF‑файл.
...
1. Добавить поле переключателя
1. Добавить поле комбобокса
1. Добавить поле флажка
1. Добавить поле списка
1. Добавить поле подписи
1. Добавить поле штрих‑кода
