...
1. Определить координаты размещения изображения
1. Получить доступ к целевой странице
1. Загрузить изображение в поток
1. Сохранить текущее графическое состояние
1. Создать прямоугольник и матрицу преобразования
1. Применить матрицу преобразования
1. Нарисовать изображение
1. Восстановить предыдущее графическое состояние
1. Сохранить изменённый PDF документ
