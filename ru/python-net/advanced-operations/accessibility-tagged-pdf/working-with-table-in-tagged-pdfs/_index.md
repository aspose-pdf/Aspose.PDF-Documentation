...
1. Создайте строку заголовка таблицы.
1. Создайте строки тела таблицы с ячейками.
1. Создайте строку нижнего колонтитула таблицы.
1. Установите атрибут summary таблицы.
1. Сохраните Tagged PDF.
...
1. Создайте элемент структуры таблицы.
