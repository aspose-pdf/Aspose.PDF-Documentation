...
1. Создайте Tagged PDF с изображением.
1. Настройте документ.
1. Создайте и настройте рисунок.
1. Установите позиционирование.
...
1. Создайте параметры конвертации PDF/UA.
1. Включите автоматическое тегирование.
