...
Элементы структуры определяют семантическую иерархию PDF‑документа, такую как разделы, заголовки, абзацы или таблицы. Устанавливая свойства, такие как title, language, alternative_text, actual_text и expansion_text, вы улучшаете доступность и семантическое значение PDF для вспомогательных технологий, таких как экранные читалки.

Следующий фрагмент кода показывает, как установить свойства элементов структуры Tagged PDF Document:

1. Создайте новый документ Tagged PDF.
1. Установите метаданные документа.
1. Создайте Structure Elements.
1. Установите свойства доступности.
...
## Настройка Text Structure Elements

Для установки текстовых структурных элементов Tagged PDF Document Aspose.PDF предлагает [ParagraphElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/) класс. Ниже показан фрагмент кода, демонстрирующий, как задать текстовые структурные элементы Tagged PDF Document:
...
## Настройка текстового блока Structure Elements

Этот пример на Python использует Aspose.PDF для создания Tagged PDF, который включает структурированную иерархию заголовков и абзац, улучшая семантические и доступные характеристики документа.

1. Создайте новый документ Tagged PDF.
1. Установите метаданные документа.
1. Получите доступ к корневому структурному элементу.
1. Создайте заголовки нескольких уровней.
1. Добавьте заголовки к корневой структуре.
1. Создайте элемент абзаца.
1. Добавьте абзац к корневой структуре.
1. Сохраните тегированный PDF.

Следующий фрагмент кода показывает, как задать элементы структуры текстового блока Tagged PDF Document:
...
Создайте встроенные текстовые элементы (/Span) в заголовках и абзацах тегированного PDF, используя Aspose.PDF for Python via .NET.

Следующий фрагмент кода показывает, как задать встроенные структурные элементы Tagged PDF Document:
...
Установить пользовательские имена тегов для структурных и встроенных элементов в Tagged PDF с помощью Aspose.PDF for Python.

Следующий фрагмент кода показывает, как установить пользовательское имя тега:

1. Создайте новый документ Tagged PDF.
1. Установите метаданные документа.
1. Создайте элемент section.
1. Создайте элементы абзаца с пользовательскими тегами.
1. Создавайте встроенные элементы span с пользовательскими тегами.
1. Сохраните тегированный PDF.
...
Создавайте ссылки и элементы изображений в тегированном PDF с помощью Aspose.PDF for Python via .NET.

Следующий фрагмент кода показывает, как установить элементы структуры в абзаце с текстом Tagged PDF Document:
...
## Настройка элемента структуры ссылки

API Aspose.PDF for Python via .NET также позволяет добавлять элементы структуры ссылок.

Следующий фрагмент кода показывает, как добавить элемент структуры ссылки в Tagged PDF Document:
...
## Настройка структурного элемента Note

Aspose.PDF for Python via .NET API также позволяет добавить [NoteElement](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/noteelement/) в документе Tagged PDF. Ниже приведён фрагмент кода, показывающий, как добавить элемент note в Tagged PDF Document:
...
## Как установить язык и заголовок

Aspose.PDF for Python via .NET API также позволяет задать язык и заголовок для документа в соответствии со спецификацией PDF/UA. Язык может быть установлен как для всего документа, так и для его отдельных структурных элементов. Следующий фрагмент кода показывает, как et язык и заголовок в Tagged PDF Document:

1. Создайте новый документ Tagged PDF.
1. Установите заголовок документа и язык.
1. Создайте элемент заголовка.
1. Добавьте абзацы с определёнными языками.
1. Сохраните тегированный PDF.
...
- [Создать Tagged PDF](/pdf/ru/python-net/create-tagged-pdf/) сгенерировать элементы структуры перед обновлением их свойств.
- [Извлечь помеченный контент из Tagged PDFs](/pdf/ru/python-net/extract-tagged-content-from-tagged-pdfs/) для просмотра существующих узлов структуры и метаданных.
- [Работа с таблицами в Tagged PDF](/pdf/ru/python-net/working-with-table-in-tagged-pdfs/) если вам нужно применить свойства доступности к структурам таблиц.
