...
1. Создать Structure Elements.
1. Установить свойства доступности.
...
1. Создайте новый документ Tagged PDF.
1. Установить метаданные документа.
1. Получить доступ к корневому структурному элементу.
1. Создайте заголовки нескольких уровней.
1. Добавить заголовки к корневой структуре.
