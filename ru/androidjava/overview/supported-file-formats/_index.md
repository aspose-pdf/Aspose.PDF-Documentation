---
title: Поддерживаемые форматы файлов Aspose.PDF
linktitle: Поддерживаемые форматы файлов
type: docs
weight: 10
url: /ru/androidjava/supported-file-formats/
description: Эта страница показывает, какие форматы файлов Aspose.PDF для Android через Java может загружать и сохранять.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Следующая таблица указывает форматы файлов, которые Aspose.PDF для Android через Java может загружать и сохранять.
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|Формат файла вёрстки LaTex| |{{< emoticons/tick >}}| |
...
|[DICOM ](https://docs.fileformat.com/image/dicom/)|Добавляет изображения DICOM в PDF документ| |{{< emoticons/tick >}}| |
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|Сохраняет документ в формате CSV| |{{< emoticons/tick >}}| |
