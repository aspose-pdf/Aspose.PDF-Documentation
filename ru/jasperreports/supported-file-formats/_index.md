...
description: Узнайте о поддерживаемых форматах файлов в Aspose.PDF for JasperReports. Экспортируйте отчеты в PDF, XPS, DOC и другие форматы.
lastmod: "2026-08-31"
---

## Поддерживаемые форматы загрузки

В следующей таблице указаны форматы файлов, которые может загружать Aspose.PDF for JasperReports.
...
В следующей таблице указаны форматы файлов, в которых документ можно сохранить с помощью Aspose.PDF for JasperReports.
