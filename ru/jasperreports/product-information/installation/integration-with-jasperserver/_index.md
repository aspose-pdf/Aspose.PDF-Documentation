...
6. Запустите JasperServer и откройте любой отчет для просмотра. Если предыдущие шаги были выполнены правильно, в списке доступных форматов вы увидите значок экспорта через Aspose.PDF для JasperReports.
