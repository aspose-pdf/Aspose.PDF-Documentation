...
11. Запустите демо-версию:
   ...
   - Перейдите в каталог <InstallDir>\demo\hsqldb и выполните следующую команду:
      `ant runServer`
12. Откройте новый экземпляр командной строки, измените текущий каталог на <InstallDir>\demo\samples\fonts.ap и выполните следующие команды:
13. Выполните команду `ant javac`, чтобы скомпилировать исходные файлы Java тестового приложения.
14. Выполните команду `ant compile`, чтобы скомпилировать XML-дизайн отчета и создать файл `.jasper`.
15. Выполните команду `ant fill`, чтобы заполнить скомпилированный отчет данными и создать файл `.jrprint`.
16. Выполните команду `ant aspose_pdf`, чтобы создать PDF-файл с использованием Aspose.PDF для JasperReports.
