...
## Запуск Aspose.PDF для демонстраций JasperReports
...
7. Перейдите в каталог ```<InstallDir>```\demo\hsqldb и запустите следующую командную строку:
