...
Ранее отсканированные документы часто сохраняются в формате PDF. Однако вам нужно отредактировать их в графическом редакторе или отправить дальше в формате изображения?
