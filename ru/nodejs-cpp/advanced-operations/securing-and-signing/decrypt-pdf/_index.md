...
## Расшифруйте PDF-файл, используя пароль владельца
...
1. Вызовите `AsposePdf` как Promise и выполните операцию расшифровки файла. Получите объект при успешном выполнении.
