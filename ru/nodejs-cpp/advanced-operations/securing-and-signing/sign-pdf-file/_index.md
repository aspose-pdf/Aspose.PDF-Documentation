...
Если вы хотите подписать PDF‑файл, вы можете использовать [AsposePdfSignPKS7](https://reference.aspose.com/pdf/nodejs-cpp/security/asposepdfsignpkcs7/) функция.
