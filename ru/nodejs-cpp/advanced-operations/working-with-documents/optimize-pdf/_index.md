...
1. Оптимизировать PDF-файл. Таким образом, если \u0027json.errorCode\u0027 равно 0, результат операции сохраняется в \u0022ResultOptimize.pdf\u0022. Если параметр json.errorCode не равен 0 и, соответственно, в вашем файле появляется ошибка, информация об ошибке будет содержаться в \u0027json.errorText\u0027.
