...
- array: в этом случае мы можем указать только страницы. Массив [3, 7] означает, что мы хотим удалить страницы 3 и 7.
...
1. Вызовите `AsposePdf` как Promise и выполните операцию по удалению страниц. Получите объект, если успешно.
