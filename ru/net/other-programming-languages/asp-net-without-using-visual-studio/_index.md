...
[Aspose.PDF for .NET](/pdf/ru/net/) можно использовать для разработки страниц или приложений ASP.NET без использования Visual Studio. В этом примере мы будем писать HTML и код C# или VB.NET в одном файле .aspx; это широко известно как Instant ASP.NET.
...
Этот пример показывает, как использовать [Aspose.PDF for .NET](/pdf/ru/net/) со встроенным кодом на странице ASP.NET для создания простого PDF-документа с некоторым образцом текста внутри.
{{% /alert %}}
