...
Пожалуйста, зарегистрируйте Aspose.PDF for .NET с COM Interop, внимательно ознакомьтесь со статьей под названием [Используйте Aspose.pdf для .NET через COM Interop](/pdf/ru/net/use-aspose-pdf-for-net-via-com-interop/).
