---
title: Конвертация PDF в EPUB, LaTeX, текст, XPS на C#
...
lastmod: "2021-11-01"
description: Эта тема показывает, как конвертировать PDF файл в другие форматы файлов, такие как EPUB, LaTeX, текст, XPS и т.д. с использованием C# или .NET.
sitemap:
    changefreq: "monthly"
    priority: 0.8
---
...
- [Конвертация PDF в EPUB](#csharp-convert-pdf-to-epub)
- [Конвертация PDF в LaTeX/TeX](#csharp-convert-pdf-to-latex)
- [Конвертация PDF в простой текст](#csharp-convert-pdf-to-plain-text)
- [Конвертация PDF в XPS](#csharp-convert-pdf-to-xps)
- [Конвертация PDF в Markdown](#csharp-convert-pdf-to-markdown)
...
<a name="csharp-convert-pdf-to-epub" id="csharp-convert-pdf-to-epub"><strong>Конвертация PDF в EPUB</strong></a>

Aspose.PDF for .NET предлагает вам онлайн бесплатное приложение ["PDF в EPUB"](https://products.aspose.app/pdf/conversion/pdf-to-epub), где вы можете попробовать исследовать функциональность и качество его работы.
...
<a name="csharp-convert-pdf-to-latex" id="csharp-convert-pdf-to-latex"><strong>Конвертация PDF в LaTeX/TeX</strong></a>
...
Aspose.PDF for .NET предлагает вам онлайн бесплатное приложение ["PDF в LaTeX"](https://products.aspose.app/pdf/conversion/pdf-to-tex), где вы можете попробовать исследовать функциональность и качество его работы.
...
Чтобы конвертировать PDF файлы в TeX, Aspose.PDF имеет класс [LaTeXSaveOptions](https://reference.aspose.com/pdf/ru/net/aspose.pdf/latexsaveoptions), который предоставляет свойство OutDirectoryPath для сохранения временных изображений во время процесса конвертации.
...
<a name="csharp-convert-pdf-to-plain-text" id="csharp-convert-pdf-to-plain-text"><strong>Конвертация PDF в простой текст</strong></a>
...
Aspose.PDF for .NET предлагает вам онлайн бесплатное приложение ["PDF в текст"](https://products.aspose.app/pdf/conversion/pdf-to-txt), где вы можете попробовать исследовать функциональность и качество его работы.
...
<a name="csharp-convert-pdf-to-xps" id="csharp-convert-pdf-to-xps"><strong>Конвертация PDF в XPS</strong></a>
...
Aspose.PDF for .NET предлагает вам онлайн бесплатное приложение ["PDF в XPS"](https://products.aspose.app/pdf/conversion/pdf-to-xps), где вы можете попробовать исследовать функциональность и качество его работы.
...
<a name="csharp-convert-pdf-to-markdown" id="csharp-convert-pdf-to-markdown"><strong>Конвертация PDF в Markdown</strong></a>
