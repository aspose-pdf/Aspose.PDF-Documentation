...
- [Конвертация HTML в PDF](#csharp-html-to-pdf)
- [Конвертация веб-страницы в PDF](#csharp-webpage-to-pdf)
- [Конвертация MHTML в PDF](#csharp-mhtml-to-pdf)
...
<a name="csharp-html-to-pdf"><strong>Конвертация HTML в PDF</strong></a>

1. Создайте экземпляр класса [HtmlLoadOptions](https://reference.aspose.com/pdf/ru/net/aspose.pdf/htmlloadoptions/).
2. Инициализируйте объект [Document](https://reference.aspose.com/pdf/ru/net/aspose.pdf/document/).
...
Aspose предлагает вам онлайн бесплатное приложение ["HTML в PDF"](https://products.aspose.app/html/en/conversion/html-to-pdf), где вы можете попробовать исследовать функциональность и качество его работы.
...
Медиа-запросы — это популярная техника для предоставления адаптированной таблицы стилей для различных устройств. Мы можем установить тип устройства, используя свойство [`HtmlMediaType`](https://reference.aspose.com/pdf/ru/net/aspose.pdf/htmlloadoptions/properties/htmlmediatype).
...
HTML-страницы часто используют шрифты (например, шрифты из локальной папки, Google Fonts и т. д.). Мы также можем контролировать встраивание шрифтов в документ, используя свойство [`IsEmbedFonts`](https://reference.aspose.com/pdf/ru/net/aspose.pdf/htmlloadoptions/properties/isembedfonts).
...
<a name="csharp-webpage-to-pdf"><strong>Конвертация веб-страницы в PDF</strong></a>

1. Прочитайте содержимое страницы, используя объект HttpClient.
1. Создайте объект [HtmlLoadOptions](https://reference.aspose.com/pdf/ru/net/aspose.pdf/htmlloadoptions) и установите базовый URL.
...
Aspose.PDF for .NET предлагает вам онлайн бесплатное приложение ["MHTML в PDF"](https://products.aspose.app/pdf/conversion/mhtml-to-pdf), где вы можете попробовать исследовать функциональность и качество его работы.
...
<a name="csharp-mhtml-to-pdf"><strong>Конвертация MHTML в PDF</strong></a>

1. Создайте экземпляр класса [MhtLoadOptions](https://reference.aspose.com/pdf/ru/net/aspose.pdf/mhtloadoptions/).
2. Инициализируйте объект [Document](https://reference.aspose.com/pdf/ru/net/aspose.pdf/document/).
3. Сохраните выходной PDF-документ, вызвав метод **Document.Save()**.
