...
* Создайте объект [FileSpecification](https://reference.aspose.com/pdf/ru/net/aspose.pdf/filespecification/) указав путь и описание другого файла с именем «factur-x.xml», который содержит метаданные счёта, соответствующие стандарту ZUGFeRD.
