...
- [Создание AcroForm](/pdf/ru/net/create-form) — создайте форму с нуля с помощью C#.
- [Заполнение AcroForm](/pdf/ru/net/fill-form) — заполните поля формы в вашем PDF-документе.
- [Извлечение AcroForm](/pdf/ru/net/extract-form) — получите значение из всех полей или отдельного поля PDF-документа.
- [Изменение AcroForm](/pdf/ru/net/modifing-form) — получение или установка FieldLimit, установка шрифта поля формы и т.д.
- [Размещение данных AcroForm](/pdf/ru/net/posting-acroform-data/) — импорт и экспорт данных формы в файл XML.
- [Импорт и экспорт данных](/pdf/ru/net/import-and-export-data/) —  импорт и экспорт данных с использованием класса Form.
- [Удаление форм из PDF](/pdf/ru/net/remove-form/) — удаление текста на основе подтипа/формы, удаление всех форм.
- [Импорт и экспорт данных в JSON](/pdf/ru/net/import-export-json/) — импорт и экспорт данных с помощью JSON.
