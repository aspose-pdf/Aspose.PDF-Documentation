...
- [Создать ссылки](/pdf/net/create-links/) - узнайте простой способ создания ссылок в вашем PDF файле с использованием C#.
- [Обновить ссылки](/pdf/net/update-links/) - попробуйте установить цель для PDF, попробуйте установить назначение ссылки на веб-адрес, попробуйте установить цель ссылки на другой PDF файл, обновить цвет текста ссылки.
- [Извлечь ссылки](/pdf/net/extract-links) - извлеките ссылки из PDF файла с помощью класса AnnotationSelector.
