Aspose.PDF for .NET позволяет вам добавлять заголовки и колонтитулы в существующий PDF-файл. Вы можете вставлять как изображения, так и текст в документ.

Следующий фрагмент кода также работает с библиотекой [Aspose.PDF.Drawing](/pdf/ru/net/drawing/).

## Добавление заголовков и колонтитулов в виде текстовых фрагментов

Следующий фрагмент кода демонстрирует, как добавить заголовки и колонтитулы в виде текстовых фрагментов в PDF с использованием C#.
...
## Добавление заголовков и колонтитулов в виде HTML-фрагментов

Следующий фрагмент кода демонстрирует, как добавить заголовки и колонтитулы в виде HTML-фрагментов в PDF с использованием C#.
...
## Добавление заголовков и колонтитулов в виде изображений

Следующий фрагмент кода демонстрирует, как добавить заголовки и колонтитулы в виде изображений в PDF с использованием C#.
