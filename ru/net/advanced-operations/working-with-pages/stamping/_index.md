...
- [Добавить штампы изображений на странице PDF](/pdf/net/image-stamps-in-pdf-page/) — добавить штамп изображения, контролировать качество изображения, сделать изображение штампом в качестве фона вашего PDF-файла.
- [Добавление текстовых штампов в файл PDF](/pdf/net/text-stamps-in-the-pdf-file/) — добавление текстового штампа, определение выравнивания для объекта TextStamp, заполнение обводки текста в качестве штампа в файле PDF.
- [Штампы страниц в файле PDF](/pdf/net/page-stamps-in-the-pdf-file/) — добавьте штамп страницы в документ PDF с помощью класса PdfPageStamp.
