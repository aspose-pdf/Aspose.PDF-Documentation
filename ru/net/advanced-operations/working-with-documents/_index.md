...
- [Управление PDF-документом](/pdf/ru/net/manipulate-pdf-document/) — проверка PDF-документа на соответствие стандарту PDF A, работа с оглавлением, установка срока действия PDF и т. д.
- [Оптимизация PDF](/pdf/ru/net/optimize-pdf/) — оптимизация содержимого страниц, размера файла, удаление неиспользуемых объектов, сжатие всех изображений для успешной оптимизации документа.
- [Объединение PDF-файлов](/pdf/ru/net/merge-pdf-documents/) — объединение нескольких PDF-файлов в один PDF-документ с помощью C#.
- [Разделение PDF-файла](/pdf/ru/net/split-document/) — разделение страниц PDF-файла на отдельные PDF-файлы в ваших приложениях .NET.
- [Объединение всех PDF-файлов в папке](/pdf/ru/net/concatenate-pdf-documents/#concatenating-all-pdf-files-in-particular-folder) — объединение всех PDF-файлов в определённой папке с использованием класса PdfFileEditor.
- [Объединение нескольких PDF-файлов с использованием MemoryStreams](/pdf/ru/net/concatenate-pdf-documents/) — вы узнаете, как объединить несколько PDF-файлов с помощью MemoryStreams с помощью C#.
- [Создание отчётов о сбоях](/pdf/ru/net/generate-crash-reports/) — генерация отчётов о сбоях с помощью C#.
- [Работа с заголовками](/pdf/ru/net/working-with-headings/) — вы можете создавать нумерацию заголовков в вашем PDF-документе с помощью C#.
