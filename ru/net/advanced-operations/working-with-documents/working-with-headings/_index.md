...
[Aspose.PDF for .NET](/pdf/ru/net/) предлагает множество предустановленных стилей нумерации. Эти предустановленные стили хранятся в перечислении NumberingStyle. Предустановленные значения перечисления NumberingStyle и их описания приведены ниже:
