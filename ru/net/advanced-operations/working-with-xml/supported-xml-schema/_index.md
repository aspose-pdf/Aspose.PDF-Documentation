---
title: XML-схема Aspose.PDF
linktitle: Поддерживаемая XML-схема
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 10
url: /runet/supported-xml-schema/
description: В этой статье описывается XML-схема для работы с XML-документами в Aspose.PDF for .NET
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Представляем XML-схему для Aspose.PDF для .NET — новую мощную функцию, которая расширяет ваши возможности работы с XML-документами в приложениях .NET. Эта схема предоставляет структурированный способ определения и управления объектами PDF, позволяя выполнять расширенную настройку и контролировать дизайн и макет документа, что делает её важным инструментом для разработчиков, стремящихся оптимизировать процессы создания PDF-файлов. Узнайте, как эта функция может упростить ваш рабочий процесс разработки и улучшить возможности обработки PDF-документов в ваших приложениях",
    "author": {
        "@type": "Person",
    ...
    "description": "Эта статья описывает XML-схему для работы с XML-документами в Aspose.PDF для .NET"
}
</script>

Следующий фрагмент кода также работает с библиотекой [Aspose.PDF.Drawing](/pdf/net/drawing/).

Aspose.PDF for .NET использует следующую XML-схему для работы с XML-документами:
