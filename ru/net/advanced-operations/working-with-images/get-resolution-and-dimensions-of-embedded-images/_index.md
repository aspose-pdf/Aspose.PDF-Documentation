...
Существуют разные способы достижения этой цели. В этой статье объясняется, как использовать `ArrayList` и [классы размещения изображений](https://reference.aspose.com/pdf/ru/net/aspose.pdf/imageplacement).
