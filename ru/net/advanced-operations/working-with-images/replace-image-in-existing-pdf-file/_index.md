...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Замена изображения в существующем PDF файле",
    "alternativeHeadline": "Как заменить изображение в PDF",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, dotnet, замена изображения в pdf",
    "wordcount": "302",
...
Коллекцию Images можно найти в коллекции Resources страницы. Чтобы заменить изображение:

1. Откройте PDF-файл с помощью объекта Document.
2. Замените определенное изображение, сохраните обновленный PDF-файл с помощью метода Save объекта Document.
