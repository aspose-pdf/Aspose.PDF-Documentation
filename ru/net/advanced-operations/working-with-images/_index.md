...
- [Добавить изображение в существующий PDF-файл](/pdf/ru/net/add-image-to-existing-pdf-file/) — добавляйте изображения и ссылки на одно изображение в документ PDF, а затем контролируйте качество.
- [Удалить изображения из файла PDF](/pdf/ru/net/delete-images-from-pdf-file/) — проверьте фрагмент кода для удаления изображений из файла PDF.
- [Извлечь изображения из файла PDF](/pdf/ru/net/extract-images-from-pdf-file/) — используйте коллекцию Images для извлечения изображений из файла PDF.
- [Получить разрешение и размеры встроенных изображений](/pdf/ru/net/get-resolution-and-dimensions-of-embedded-images/) — используйте классы операторов в пространстве имён Aspose.PDF, которые позволяют получить информацию о разрешении и размерах.
- [Работа с размещением изображений](/pdf/ru/net/working-with-image-placement/) — можно получить разрешение и положение изображения в документе PDF.
- [Поиск и получение изображений из документа PDF](/pdf/ru/net/search-and-get-images-from-pdf-document/) — вы можете получить изображение с отдельной страницы и выполнить поиск среди изображений на всех страницах с помощью C#.
- [Замена изображения в существующем файле PDF](/pdf/ru/net/replace-image-in-existing-pdf-file/) — ознакомьтесь с нашим фрагментом кода, он покажет вам, как заменить изображение в файле PDF.
- [Установка размера изображения](/pdf/ru/net/set-image-size/) — библиотека C# позволяет установить размер изображения.
- [Установка имени шрифта по умолчанию](/pdf/ru/net/set-default-font-name/) — установка имени шрифта по умолчанию для процесса преобразования.
- [Создание уменьшенных изображений из документов PDF](/pdf/ru/net/generate-thumbnail-images-from-pdf-documents/) — в следующей статье показано, как создавать уменьшенные изображения из документов PDF сначала с использованием Acrobat SDK, а затем Aspose.PDF.
- Поддержка изображений DICOM — Aspose.PDF for .NET поддерживает специальный медицинский графический стандарт изображений. Aspose.PDF for .NET позволяет конвертировать изображения DICOM и SVG. Пожалуйста, ознакомьтесь с разделом [Преобразование DICOM в PDF](/pdf/ru/net/convert-images-format-to-pdf/#convert-dicom-to-pdf).
- [Работа с векторной графикой](/pdf/ru/net/working-with-vector-graphics) — в этом разделе описаны возможности работы с инструментом GraphicsAbsorber с использованием C#.
