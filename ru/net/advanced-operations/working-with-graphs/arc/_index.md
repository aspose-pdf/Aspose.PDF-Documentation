---
title: Добавление дугового объекта в PDF-файл
...
weight: 10
url: /ru/net/add-arc/
description: В этой статье объясняется, как создать дуговой объект в вашем PDF-файле с помощью Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Новая функция в Aspose.PDF для .NET позволяет пользователям легко интегрировать дуговые объекты в PDF-документы, расширяя графические возможности за счёт рисования дуг разных цветов и размеров. Эта функциональность даёт разработчикам возможность создавать более привлекательные и персонализированные PDF-файлы, добавляя заполненные дуги и детализированные фигуры с точным контролем над такими атрибутами, как границы и цвета заливки",
    "author": {
        "@type": "Person",
    ...
    "description": "Этот статья объясняет, как создать дуговой объект в вашем PDF-файле с помощью Aspose.PDF для .NET."
}
</script>

Следующий фрагмент кода также работает с библиотекой [Aspose.PDF.Drawing](/pdf/ru/net/drawing/).

## Добавление дугового объекта

Aspose.PDF for .NET поддерживает функцию добавления графических объектов (например, графика, линия, прямоугольник и т. д.) в PDF-документы. Он также предлагает функцию заполнения дугового объекта определённым цветом.
...
## Создание заполненного дугового объекта

В следующем примере показано, как добавить дуговой объект, который заполнен цветом и имеет определённые размеры.
...
<script type="application/ld+json">
{
    ...
    "категория приложения": "Библиотека управления PDF-документами для .NET",
