...
- [Curve](/pdf/ru/net/add-curve/) - это связное объединение проективных линий, каждая из которых пересекается с тремя другими в обычных двойных точках.
...
- [Rectangle](/pdf/ru/net/add-rectangle/) - это одна из многих основных фигур, которые вы увидите в графиках, она может быть очень полезной для решения проблемы.
...
- [Check bounds](/pdf/ru/net/aspose-pdf-drawing-graph-shapes-bounds-check/) - проверка границ фигуры в коллекции Shapes.
