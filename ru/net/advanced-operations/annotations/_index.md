...
- [Обзор аннотаций](/pdf/net/обзор-аннотаций/) — узнайте, какие типы аннотаций определены спецификацией PDF и что поддерживает Aspose.PDF.
- [Добавление, удаление и получение аннотации](/pdf/net/добавление-удаление-и-получение-аннотации/) — в этом разделе объясняется, как работать со всеми типами разрешённых аннотаций.
- [Импорт и экспорт аннотаций в формате XFDF](/pdf/net/импорт-и-экспорт-xfdf/) — библиотека Aspose.PDF предоставляет методы для импорта и экспорта данных аннотаций в файлы XFDF.
- [Импорт аннотаций формата FDF в PDF](/pdf/net/import-fdf/) — библиотека Aspose.PDF предоставила метод импорта аннотаций формата FDF в файлы PDF.
