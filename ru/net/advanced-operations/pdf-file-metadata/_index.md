...
Обратите внимание, что вы не можете устанавливать значения для полей *Application* и *Producer*, так как Aspose Ltd. и Aspose.PDF for .NET x.x.x будут отображаться в этих полях.
