...
В этой статье мы рассмотрим детали извлечения текста из PDF файла. Все эти функции извлечения предоставлены в одном месте, в классе [PdfExtractor](https://reference.aspose.com/pdf/ru/net/aspose.pdf.facades/pdfextractor). Мы увидим, как использовать эти функции в нашем коде.
