...
Aspose.PDF для .NET предоставляет отличные возможности для создания/манипулирования полями формы внутри PDF документа. Используя этот API, вы можете программно заполнять поля формы внутри PDF файла, заполнять поля формы с помощью [Импорт данных из FDF в PDF файл](/pdf/net/import-and-export-data/), [Импорт данных из XFDF в PDF файл](/pdf/net/import-and-export-data/), [Импорт данных из XML в PDF файл](/pdf/net/import-and-export-data/) или даже импортировать данные из объекта [System.Data.DataTable](https://reference.aspose.com/pdf/net/aspose.pdf.table/importdatatable/methods/1).
