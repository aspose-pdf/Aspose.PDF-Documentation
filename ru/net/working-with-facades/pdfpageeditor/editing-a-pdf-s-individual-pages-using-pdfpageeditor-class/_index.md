...
Пространство имен Aspose.Pdf.Facades в [Aspose.PDF для .NET](/pdf/ru/net/) позволяет управлять отдельными страницами в PDF файле. Эта функция помогает работать с отображением страниц, выравниванием и переходами и т.д. Класс PdfPageEditor помогает достичь этой функциональности. В этой статье мы рассмотрим свойства и методы, предоставляемые этим классом, а также работу этих методов.
