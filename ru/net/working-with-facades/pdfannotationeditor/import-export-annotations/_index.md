...
[Aspose.PDF for .NET](/pdf/ru/net/) — это многофункциональный компонент, когда речь заходит о редактировании PDF-документов. Как известно, XFDF является важным аспектом управления PDF-формами, и пространство имён Aspose.Pdf.Facades в [Aspose.PDF for .NET](/pdf/ru/net/) хорошо это учло и предоставило методы для импорта и экспорта данных аннотаций в файлы XFDF.
