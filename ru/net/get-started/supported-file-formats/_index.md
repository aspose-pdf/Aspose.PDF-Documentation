...
Следующая таблица указывает форматы файлов, которые Aspose.PDF for .NET может загружать и сохранять.
...
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|Компьютерный графический метафайл для 2D векторной графики|{{< emoticons/tick >}}| | |
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|Формат файла для вёрстки LaTex|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[DJVU](https://docs.fileformat.com/image/djvu/)|DjVu — это графический формат файла, предназначенный для сканированных документов и книг, разработанный AT&T Labs|{{< emoticons/tick >}}| | |
|[CDR](https://docs.fileformat.com/image/cdr/)|Файл CDR — это файл векторного рисования, который создается в CorelDRAW|{{< emoticons/tick >}}| | |
|[MobiXML](https://docs.fileformat.com/ebook/mobi/)|Сохраняет документ в формате стандарта eBook MobiXML| |{{< emoticons/tick >}}| |
...
|[PCL](https://docs.fileformat.com/page-description-language/pcl/)|Язык команд принтера, который является языком описания страниц, введенным Hewlett Packard (HP)|{{< emoticons/tick >}}| | |
...
|[GIF](https://docs.fileformat.com/image/gif/)|Формат графической интерменции| |{{< emoticons/tick >}}| |
|[TIFF](https://docs.fileformat.com/image/tiff/)|Сохраняет документ как одно- или многопстраничное изображение TIFF|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
