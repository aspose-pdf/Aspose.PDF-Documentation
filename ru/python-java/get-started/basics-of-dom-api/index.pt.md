---
title: Noções básicas da API Aspose.PDF DOM
linktitle: Noções básicas da API DOM
type: docs
weight: 110
url: ru/python-java/basics-of-dom-api/
description: Aspose.PDF para Java também utiliza a ideia de DOM para representar a estrutura de um documento PDF em termos de objetos. Aqui você pode ler a descrição dessa estrutura.
lastmod: "2024-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Document Object Model (DOM) é uma forma de representação de documentos estruturados como um modelo orientado a objetos. DOM é o padrão oficial do World Wide Web Consortium (W3C) para representar documentos estruturados de maneira neutra em relação à plataforma e à linguagem.

Em palavras simples, DOM é uma árvore de objetos que representam a estrutura de algum documento.
 Aspose.PDF for Java também usa a ideia de DOM para representar a estrutura de um documento PDF em termos de objetos. No entanto, os aspectos do DOM (como seus Elementos) são manipulados dentro da sintaxe da linguagem de programação em uso. A interface pública de um DOM é especificada em sua interface de programação de aplicativos (API).
...
Como a estrutura de um arquivo PDF é hierárquica, o Aspose.PDF para Java também acessa os elementos da mesma forma. A seguinte hierarquia mostra como o documento PDF é estruturado logicamente e como o Aspose.PDF para Java DOM API o constrói.

![Estrutura do Documento PDF](../images/structure.png)

### Acessando Elementos do Documento PDF

O objeto Document está no nível raiz do modelo de objeto. O Aspose.PDF para Java DOM API permite criar um objeto Document e, em seguida, acessar todos os outros objetos na hierarquia. Você pode acessar qualquer uma das coleções, como Pages, ou um elemento individual, como Page, etc. A API DOM fornece pontos de entrada e saída únicos para manipular o documento PDF, conforme mostrado abaixo:
...
Este tópico explicará a nova API Aspose.PDF para Java e guiará você para começar rápida e facilmente. Por favor, note que os detalhes sobre o uso dos recursos específicos não fazem parte deste artigo.

O Aspose.PDF para Java é composto de duas partes:
...
A nova API Aspose.PDF para Java DOM corresponde à estrutura do documento PDF, o que ajuda a trabalhar com documentos PDF não apenas no nível de arquivo e documento, mas também no nível de objeto. Fornecemos mais flexibilidade aos desenvolvedores para acessar todos os elementos e objetos do documento PDF. Usando as classes da API Aspose.PDF DOM, você pode obter acesso programático aos elementos e formatação do documento. Esta nova API DOM é composta por vários namespaces, conforme listado abaixo:

### com.aspose.pdf

Este namespace fornece a classe Document que permite abrir e salvar um documento PDF. A classe License também faz parte deste namespace. Ela também fornece classes relacionadas a páginas de PDF, anexos e favoritos como com.aspose.pdf.Page, com.aspose.pdf.PageCollection, com.aspose.pdf.FileSpecification, com.aspose.pdf.EmbeddedFileCollection, com.aspose.pdf.OutlineItemCollection e com.aspose.pdf.OutlineCollection etc.
...
Anteriormente ao Aspose.PDF para Java também, você precisava do Aspose.PDF.Kit para Java para manipular arquivos PDF existentes. Para executar o código antigo do Aspose.PDF.Kit, pode usar o namespace com.aspose.pdf.facades.