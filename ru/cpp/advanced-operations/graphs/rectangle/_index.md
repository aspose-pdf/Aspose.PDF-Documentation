...
Следующий фрагмент кода показывает шаги для отображения объектов [Rectangle](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.drawing.rectangle/) друг на друге.
