...
График [Curve](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.drawing.curve/) представляет собой соединение проективных линий, каждая из которых встречается с тремя другими в обычных двойных точках.
