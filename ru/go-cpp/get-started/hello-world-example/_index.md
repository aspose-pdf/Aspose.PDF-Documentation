...
Abstract: Руководство «Get Started» для Aspose.PDF for Go через C++ предоставляет введение в работу с библиотекой, охватывая базовые шаги по созданию и манипулированию PDF‑документами. Оно включает пример 'Hello World', демонстрирующий, как сгенерировать простой PDF‑файл с текстовым содержимым, помогая разработчикам быстро понять основную функциональность API.
