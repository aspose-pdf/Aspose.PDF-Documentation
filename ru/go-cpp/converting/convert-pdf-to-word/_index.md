...
Редактируйте содержимое PDF‑файла в Microsoft Word или других текстовых процессорах, поддерживающих форматы DOC и DOCX. PDF‑файлы можно редактировать, но файлы DOC и DOCX более гибкие и настраиваемые.
