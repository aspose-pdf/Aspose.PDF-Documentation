...
description: Расшифровать PDF-файл с помощью Aspose.PDF for Go через C++.
lastmod: "2026-07-04"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Вы можете открыть, расшифровать и сохранить защищённый паролем PDF‑документ с помощью Aspose.PDF for Go через C++. PDF‑файл открывается с паролем владельца, расшифровывается для снятия всех ограничений безопасности и затем сохраняется как новый, незащищённый документ.
