...
description: Зашифровать PDF‑файл с помощью Aspose.PDF for Go через C++.
lastmod: "2026-07-04"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Чтобы легко и надёжно зашифровать документы, вы можете использовать Aspose.PDF for Go через C++.
...
- Пароль **ownerPassword**, если установлен, контролирует разрешения, такие как печать, редактирование, извлечение, комментирование и т.д. Acrobat/Reader будет запрещать эти действия в зависимости от настроек разрешений. Acrobat потребует этот пароль, если вы хотите установить/изменить разрешения.
