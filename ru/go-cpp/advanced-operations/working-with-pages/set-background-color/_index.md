...
1. [Open](https://reference.aspose.com/pdf/go-cpp/core/open/) метод загружает указанный PDF‑файл в память, позволяя выполнять дальнейшие манипуляции, такие как изменение его внешнего вида или содержимого.
1. [SetBackground](https://reference.aspose.com/pdf/go-cpp/organize/setbackground/) метод применяет новый цвет фона к PDF‑документу. Значения RGB позволяют пользователям настраивать визуальный стиль документа.
1. [SaveAs](https://reference.aspose.com/pdf/go-cpp/core/saveas/) метод сохраняет обновлённый PDF под новым именем.
