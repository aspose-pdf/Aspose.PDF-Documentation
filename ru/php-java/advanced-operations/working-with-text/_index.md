...
- [Добавить текст в PDF файл](/pdf/ru/php-java/add-text-to-pdf-file/) - добавьте текст в ваш PDF, используйте шрифты из потока и файлов, добавьте HTML строку, добавьте гиперссылку и т.д.