...
- [AcroForms](/pdf/ru/php-java/acroforms/) - создание формы, заполнение полей формы, извлечение данных из формы, изменение полей в вашем PDF с помощью библиотеки PHP.
- [XFA Forms](/pdf/ru/php-java/xfa-forms/) - заполнение полей XFA, преобразование XFA, получение свойств полей XFA.