...
- [Форматирование PDF Документа](/pdf/ru/php-java/formatting-pdf-document/) - получение и установка свойств документа, встраивание шрифтов и другие операции с PDF файлами.
- [Манипуляции с PDF Документом](/pdf/ru/php-java/manipulate-pdf-document/) - проверка PDF документа на соответствие стандарту PDF A, работа с оглавлением, установка срока действия PDF и т.д.
- [Оптимизация PDF](/pdf/ru/php-java/optimize-pdf/) - оптимизация содержимого страниц, уменьшение размера файла, удаление неиспользуемых объектов, сжатие всех изображений для успешной оптимизации документа.
- [Объединение PDF](/pdf/ru/php-java/merge-pdf-documents/) - объединение нескольких PDF файлов в один PDF документ с использованием PHP.
- [Разделение PDF](/pdf/ru/php-java/split-document/) - разделение страниц PDF на отдельные PDF файлы в ваших Java приложениях.
- [Работа с Заголовками](/pdf/ru/php-java/working-with-headings/) - вы можете создать нумерацию в заголовках вашего PDF документа с помощью Java.