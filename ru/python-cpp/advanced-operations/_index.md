...
**Расширенные операции** — это раздел о том, как программно работать с существующими PDF-файлами, будь то документы, созданные с помощью Aspose.PDF, как обсуждалось в разделе [Основные операции](/pdf/ru/python-cpp/basic-operations/), или PDF, созданные с помощью Adobe Acrobat, Google Docs, Microsoft Office, Open Office или любого другого производителя PDF.
...
- [Работа с документами](/pdf/ru/python-cpp/working-with-documents/) - сжимать, разделять и объединять документы и выполнять другие операции с документом целиком.
- [Работа со страницами](/pdf/ru/python-cpp/working-with-pages/) - добавлять, перемещать или удалять, обрезать страницы, добавлять водяные знаки, штампы и т.д.

- [Шифрование и расшифровка PDF](/pdf/ru/python-cpp/encrypt-decrypt-pdf/) - шифровать и расшифровывать PDF с использованием Python.