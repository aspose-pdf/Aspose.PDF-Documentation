...
1. Загрузите PDF-файл - новый [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document).

1. Создайте новую [Circle Annotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/circleannotation) и установите параметры круга (new Rectangle, title, color, InteriorColor, Opacity).
1. Создайте новую [PopupAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/class-use/PopupAnnotation).
1. Далее нам нужно создать [Square Annotation](https://reference.aspose.com/pdf/java/com.aspose.pdf.class-use/SquareAnnotation).
1. Установите те же параметры квадрата (new Rectangle, title, color, InteriorColor, Opacity).
...
1. Загрузите PDF файл - новый [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document).
1. Создайте новую [Polygon Annotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/PolygonAnnotation) и установите параметры многоугольника (новый Rectangle, новые Points, заголовок, цвет, InteriorColor и Opacity).
1. Создайте новую [PopupAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf.class-use/PopupAnnotation).
1. Далее создайте [PolyLine Annotation](https://reference.aspose.com/pdf/java/com.aspose.pdf.class-use/PolylineAnnotation) и повторите все действия.
1. После этого можно добавить аннотации на страницу.
...
1. Загрузите PDF файл - новый [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document).
2. Создайте новую [аннотацию линии](https://reference.aspose.com/pdf/java/com.aspose.pdf/lineannotation) и установите параметры линии (новый Rectangle, новый Point, заголовок, цвет, ширина, StartingStyle и EndingStyle).

1. Создайте новый [PopupAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/class-use/PopupAnnotation).
1. Затем мы можем добавить аннотацию на страницу
...
Аннотация чернила представляет собой произвольную "закорючку", состоящую из одного или нескольких несвязанных путей.
 При открытии должно отображаться всплывающее окно с текстом связанной заметки.

[InkAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/class-use/InkAnnotation) представляет собой произвольную каракулю, состоящую из одной или нескольких несвязанных точек. Пожалуйста, попробуйте использовать следующий фрагмент кода, чтобы добавить InkAnnotation в PDF-документ.
...
Вы можете получить [InkAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/class-use/InkAnnotation) с помощью следующего фрагмента кода:
...
Aspose.PDF для Java позволяет удалять [InkAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/class-use/InkAnnotation) из вашего PDF файла.
