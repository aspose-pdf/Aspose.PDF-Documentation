---
title: Обновление ссылок PDF в Java
...
## Обновление цвета связанного текста
...
## Обновление цвета границы ссылки

Используйте этот пример, когда необходимо изменить видимый цвет существующих аннотаций ссылок.

1. Откройте исходный PDF в объекте [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
1. Переберите аннотации страницы и отфильтруйте объекты [LinkAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/linkannotation/).
...
## Обновление назначения веб‑ссылки
