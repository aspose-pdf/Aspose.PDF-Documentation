...
## Добавление именованного действия печати
...
1. Создайте [ButtonField](https://reference.aspose.com/pdf/java/com.aspose.pdf/buttonfield/) и присвойте [NamedAction](https://reference.aspose.com/pdf/java/com.aspose.pdf/namedaction/) для печати.
...
## Добавление действия скрытия

Используйте этот пример, когда кнопка должна показывать или скрывать набор полей формы, например флажки.

1. Откройте исходный PDF в объекте [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и соберите целевые виджеты формы.
1. Создайте кнопку и назначьте ей действие [HideAction](https://reference.aspose.com/pdf/java/com.aspose.pdf/hideaction/).
...
## Добавление действий запуска на уровне документа
...
## Добавление действий открытия и закрытия страницы

Используйте этот пример, когда определённая страница должна вызывать действия при открытии и закрытии.

1. Откройте исходный PDF в объекте [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и убедитесь, что целевая страница существует.
