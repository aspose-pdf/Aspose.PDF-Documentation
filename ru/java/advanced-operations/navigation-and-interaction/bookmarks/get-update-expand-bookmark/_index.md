---
title: Получение, обновление и развертывание PDF‑закладок в Java
linktitle: Получение, обновление и развертывание закладки
type: docs
weight: 20
...
## Развертывание закладок по умолчанию
