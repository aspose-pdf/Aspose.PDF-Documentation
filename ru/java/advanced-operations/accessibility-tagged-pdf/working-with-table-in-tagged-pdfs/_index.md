...
## Примените стиль к помеченным строкам таблицы
...
## Отрегулируйте позицию тегированной таблицы
...
## Заполните помеченную таблицу структурированным содержимым
