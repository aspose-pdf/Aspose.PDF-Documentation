...
## Применение стиля к помеченным строкам таблицы
...
## Регулировка позиции тегированной таблицы
...
## Заполнение помеченной таблицы структурированным содержимым
