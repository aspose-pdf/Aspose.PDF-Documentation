...
linktitle: Извлечение помеченного контента
type: docs
weight: 20
...
sitemap:
    ...
    priority: 0.7
---
Используйте эти API, когда необходимо просмотреть логическое дерево структуры помеченного PDF и изучить или обновить метаданные элементов структуры.

## Получение метаданных помеченного контента
...
## Получение корневой структуры помеченного PDF

Этот пример показывает, как исследовать корневые объекты, представляющие дерево структуры Tagged PDF.

1. Создайте новый PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и получите его тегированное содержимое.
...
## Получение доступа к дочерним элементам структуры и их обновление
