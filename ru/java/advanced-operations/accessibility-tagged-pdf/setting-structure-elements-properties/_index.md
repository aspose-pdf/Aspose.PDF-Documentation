---
title: Установка свойств элементов структуры Tagged PDF в Java
...
## Установка общих свойств элементов структуры
...
## Установка элементов текстового блока
...
## Установка встроенных элементов
...
## Установка пользовательских имён тегов
...
## Установка элементов link и figure
...
## Добавление абзацев со встроенным содержимым ссылок
...
## Установка языка и заголовка для многоязычного контента
