...
Граф [Curve](https://reference.aspose.com/pdf/java/com.aspose.pdf.drawing/Curve) представляет собой соединенное объединение проективных линий, каждая из которых встречает три другие в обычных двойных точках.
