---
title: Добавление изображения в PDF с помощью Java
linktitle: Добавление изображения
type: docs
weight: 10
...
## Добавление изображения с координатами страницы
...
## Добавление изображения с помощью операторов страницы
...
## Добавление изображения и задание альтернативного текста
