...
1. Добавьте блок на страницу и сохраните документ.
...
1. Вычислите ширины столбцов и настройте параметры колонок `FloatingBox`.
1. Добавьте повторяющиеся фрагменты текста в блок и сохраните документ.
...
1. Поместите блок на страницу и сохраните документ.
...
1. Создайте `FloatingBox`, установите абсолютное позиционирование и задайте смещения сверху и слева.
...
1. Создайте новый PDF‑документ и добавьте страницу.
1. Создайте несколько объектов `FloatingBox` с различными настройками выравнивания.
