---
title: Использование FloatingBox для разметки PDF в Java
...
## Создание и добавление плавающего блока
...
## Создание повторяющегося многоколоночного макета
...
## Добавление плавающего блока с цветом фона
...
## Размещение плавающего блока с абсолютными смещениями
