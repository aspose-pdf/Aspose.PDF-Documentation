---
title: Используйте FloatingBox для разметки PDF в Java
linktitle: Использование FloatingBox
type: docs
weight: 30
url: /ru/java/floating-box/
description: Узнайте, как использовать FloatingBox для макетирования текста, многоколоночного контента и точного позиционирования в PDF‑документах с Java.
lastmod: "2026-08-19"
sitemap:
    changefreq: "monthly"
    priority: 0.5
...
Abstract: В этой статье объясняется, как использовать FloatingBox в Aspose.PDF for Java. Описывается размещение текста в ограниченных плавающих контейнерах, создание повторяющихся много‑колоночных макетов, использование фоновых цветов, абсолютных смещений, а также варианты горизонтального или вертикального выравнивания.
---
Aspose.PDF for Java использует `FloatingBox` для создания многоразовых текстовых контейнеров и макетов на основе колонок.

## Создайте и добавить плавающий блок

Используйте этот пример, когда текст следует разместить внутри обрамлённого плавающего контейнера.
...
1. Добавьте рамку на страницу и сохраните документ.
...
## Создайте повторяющийся многоколоночный макет

Используйте этот пример, когда длинный текст должен протекать через несколько колонок внутри одного плавающего блока.

1. Создайте страницу и настройте поля.
1. Вычислите ширины столбцов и настройте `FloatingBox` настройки столбца.
1. Добавьте повторяющиеся фрагменты текста в поле и сохраните документ.
...
## Начните каждый фрагмент как первый элемент в столбце

Используйте этот пример, когда каждый вставленный фрагмент должен начинать новый сегмент потока колонок.

1. Создайте страницу и настройте несколько колонок `FloatingBox`.
1. Создайте фрагменты текста и пометьте их `setFirstParagraphInColumn(true)`.
1. Добавьте коробку на страницу и сохраните PDF.
...
## Добавьте плавающий блок с цветом фона

Используйте этот пример, когда плавающий контейнер должен иметь видимую заливку фона.

1. Создайте новый PDF‑документ и добавьте страницу.
1. Создайте `FloatingBox`, задайте его цвет фона и добавьте текст.
1. Поместите коробку на страницу и сохраните документ.
...
## Разместите плавающий блок с абсолютными смещениями

Используйте этот пример, когда плавающий блок должен появиться с точным смещением на странице.

1. Создайте страницу и подготовьте окружающий текстовый контент.
1. Создайте `FloatingBox`, установить абсолютное позиционирование и задать смещения сверху и слева.
...
## Выровняйте текст внутри плавающих блоков

Используйте этот пример, когда плавающие блоки должны демонстрировать разные вертикальные выравнивания при одинаковом горизонтальном выравнивании.

1. Создайте новый PDF‑документ и добавьте страницу.
1. Создайте несколько `FloatingBox` объекты с различными настройками выравнивания.
