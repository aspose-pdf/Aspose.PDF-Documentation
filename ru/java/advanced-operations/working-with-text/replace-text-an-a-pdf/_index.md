...
## Замените текст на всех страницах
...
## Замените текст в определённой области страницы
...
## Замените текст и отрегулировать интервал внутри смещённого прямоугольника
...
## Замените текст внутри более крупного прямоугольника абзаца
...
## Замените текст и масштабировать шрифт, чтобы заполнить прямоугольник
...
1. Определите заменяющий прямоугольник и включить `ScaleToFill` регулировка шрифта.
...
## Замените текст и уменьшить его, чтобы он поместился
...
## Замените шрифты и удалить неиспользуемые ресурсы шрифтов
