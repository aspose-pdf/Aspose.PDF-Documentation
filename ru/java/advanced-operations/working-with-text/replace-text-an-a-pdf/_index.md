---
title: Замените текст в PDF с помощью Java
linktitle: Замените текст в PDF
type: docs
weight: 40
...
## Замените текст и отрегулируйте интервал внутри смещённого прямоугольника
...
## Замените текст и уменьшите его, чтобы он поместился
