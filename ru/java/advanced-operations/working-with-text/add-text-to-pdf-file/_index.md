...
## Вставьте текст с ручным разрывом строки
...
## Измеряйте ширину текста динамически
...
## Примените осевой градиент к тексту
...
## Примените радиальное градиентное затенение к тексту
