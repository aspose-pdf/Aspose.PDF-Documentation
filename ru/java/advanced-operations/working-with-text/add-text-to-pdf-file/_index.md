---
title: Добавление текста в PDF на Java
...
## Добавление простого текстового фрагмента
...
1. Создайте `TextFragment` и установите его позицию.
...
## Добавление абзаца внутри прямоугольника

Используйте этот пример, когда более крупный блок текста должен быть размещён внутри ограниченной области.

1. Создайте новый документ PDF и добавьте страницу.
1. Загрузите исходный текст и настройте прямоугольник и режим обтекания для `TextParagraph`.
...
## Добавление абзацев с различными настройками отступов
...
## Вставка текста с ручным разрывом строки
...
## Добавление текста с сегментом гиперссылки
...
## Добавление текста справа налево

Используйте этот пример, когда документ должен отображать текст с направлением письма справа налево с правильным выравниванием.
...
## Добавление стилизованного текста и сегментов, похожих на формулы
...
## Добавление подчёркнутого текста
...
1. Добавьте фрагмент с помощью `TextBuilder` и сохраните результат.
...
## Добавление прозрачного текста поверх цветной формы
...
## Добавление текста с прямоугольной рамкой

Используйте этот пример, когда текст должен быть отрисован вместе с его ограничивающим прямоугольником.

1. Создайте новый документ PDF и добавьте страницу.
1. Создайте стилизованный `TextFragment` и включите отрисовку границы текстового прямоугольника.
1. Добавьте фрагмент с помощью `TextBuilder` и сохраните PDF.
...
## Добавление зачёркнутого текста
...
## Применение осевого градиента к тексту
...
## Применение радиального градиентного затенения к тексту
...
## Добавление встроенного текста, отформатированного в стиле HTML
...
## Добавление фрагмента текста LaTeX
...
## Добавление HTML-фрагмента со структурированным содержимым
...
## Добавление HtmlFragment с переопределённым состоянием текста
...
## Использование пользовательского шрифта, загруженного из файла
...
## Использование пользовательского шрифта, загруженного из потока
