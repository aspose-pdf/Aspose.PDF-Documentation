...
## Измерение ширины текста динамически
...
## Добавление стилизованного текста и сегментов, похожие на формулы
...
## Добавление встроенного текста, отформатированный в стиле HTML
...
## Добавление богатого HTML-фрагмента
...
## Использование пользовательского шрифта, загруженный из файла
...
## Использование пользовательского шрифта, загруженный из потока
