---
title: Форматирование текста PDF в Java
...
## Установка простого межстрочного интервала
...
1. Загрузите или подготовьте исходный текст и создайте объект `TextFragment`.
...
## Сравнение режимов межстрочного интервала с пользовательским шрифтом
...
## Установка межсимвольного интервала с помощью фрагментов текста
...
## Задание межсимвольного интервала внутри текстового абзаца
...
## Создание маркированного списка с помощью HTML
...
## Создание нумерованного списка с помощью HTML
...
## Создание маркированного списка с LaTeX

Используйте этот пример, когда форматирование ненумерованного списка должно быть преобразовано из разметки TeX.

1. Создайте новый документ PDF и добавьте страницу.
1. Подготовьте строку списка TeX с окружением `itemize`.
1. Добавьте это как `TeXFragment` и сохраните PDF.
...
## Создание нумерованного списка с помощью LaTeX

Используйте этот пример, когда нумерованный список должен быть отформатирован из разметки TeX.

1. Создайте новый документ PDF и добавьте страницу.
1. Подготовьте строку списка TeX с окружением `enumerate`.
1. Добавьте это как `TeXFragment` и сохраните PDF.
...
## Создание маркированного списка с текстовыми абзацами

Используйте этот пример, когда необходимо создать ручной маркированный список из фрагментов обычного текста.

1. Создайте новый документ PDF и добавьте страницу.
1. Создайте `TextParagraph` и добавьте фрагменты с префиксом‑маркером.
...
## Создание нумерованного списка с абзацами текста
...
1. Добавьте последующий встроенный текст и сохраните документ.
...
## Добавление сноски с пользовательским стилем текста
...
## Добавление сноски с пользовательским текстом маркера
...
## Настройка разделительной линии сноски
...
## Добавление сноски с изображением и содержимым таблицы
...
## Добавление концевой сноски

Используйте этот пример, когда фрагмент текста должен ссылаться на содержание сноски в конце, а не на сноску на странице.

1. Создайте новый документ PDF и добавьте страницу.
1. Назначьте концевую сноску основному фрагменту текста и добавьте сопутствующий основной текст.
...
## Добавление концевой сноски с пользовательским текстом маркера
...
## Принудительное размещение содержимого таблиц на новой странице
...
## Смешивание встроенного контента внутри одного абзаца
...
## Создание макета текста с несколькими колонками
...
## Создание выровненного текста с пользовательскими табуляциями

Используйте этот пример, когда текст должен выравниваться как простая таблица, используя позиции табуляции.

1. Создайте новый документ PDF и добавьте страницу.
1. Настройте позиции табуляции с параметрами выравнивания и заполнителя.
