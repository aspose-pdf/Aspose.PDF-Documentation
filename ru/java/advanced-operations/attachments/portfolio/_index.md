...
1. Создайте новый PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и включите его [Collection](https://reference.aspose.com/pdf/java/com.aspose.pdf/collection/).
...
Используйте этот пример, когда необходимо очистить существующую коллекцию PDF-портфолио.
