---
title: Добавление штампов страниц в PDF на Java
...
## Добавление штампа страницы из другого PDF
...
## Добавление стандартного штампа номера страницы
...
## Добавление штампа номера страницы римскими цифрами
