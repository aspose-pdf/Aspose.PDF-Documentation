---
title: Добавление штампов изображений в PDF на Java
...
## Добавление штампа изображения с контролем качества
...
## Использование изображения в качестве фона плавающего блока
