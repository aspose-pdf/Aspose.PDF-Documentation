...
1. Определить необходимые индексы столбцов из строки заголовка CSV.
...
## Разбить одну строку CSV на значения
