...
---
Пример на Java создаёт таблицы PDF из CSV-данных без внешних библиотек для работы с табличными данными.

## Создание таблицы из строк CSV

Используйте этот пример, когда выбранные столбцы CSV необходимо преобразовать в стилизованную таблицу PDF.

1. Создайте [Table](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте её границы.
...
## Создание PDF из данных CSV

Используйте этот пример, когда данные CSV нужно отобразить в виде таблицы в PDF-документе.

1. Прочитайте строки CSV из входного файла.
1. Выведите часть разобранных строк в консоль для предварительного просмотра.
...
## Поиск индексов столбцов CSV по имени
...
## Разбиение одной строки CSV на значения
