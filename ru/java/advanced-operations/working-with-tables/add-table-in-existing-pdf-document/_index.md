---
title: Добавить таблицы в PDF в Java
...
Abstract: В этой статье объясняется, как добавлять и настраивать таблицы в PDF-документах с помощью Aspose.PDF для Java. Он охватывает создание таблиц, границы, поля, заполнение, диапазоны строк и столбцов, поведение автоподбора, вставку изображений в ячейки, повторяющиеся строки и столбцы, фрагменты HTML и LaTeX, а также управление многостраничным рендерингом.
---
Aspose.PDF для Java предоставляет богатый API `Table` для создания таблиц с настройкой макета и содержимого.

## Создайте базовую таблицу

Используйте этот пример, если вам нужно добавить простую таблицу с однородными границами и текстовыми ячейками.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте ее границы.
...
## Добавьте ячейки с диапазоном строк и столбцов.

Используйте этот пример, если таблице необходимо объединить ячейки в строках или столбцах.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и добавьте строки.
1. Настройте `ColSpan` и `RowSpan` в целевых ячейках, затем сохраните PDF-файл.
...
## Добавление границ таблицы и заполнения ячеек

Используйте этот пример, когда вам нужно настроить границы, отступы и перенос ячеек.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте ширину, границы и отступы.
...
## Включить автоматическую настройку макета таблицы

Используйте этот пример, когда таблица должна автоматически подстраиваться под доступную ширину страницы.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и установите `ColumnAdjustment.AutoFitToWindow`.
1. Добавьте образцы строк и сохраните PDF-файл.
...
Используйте этот пример, когда таблице необходимо отображать содержимое растрового изображения внутри одной из ячеек.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и добавьте строку с ячейками текста и изображения.
1. Настройте размер [Изображение](https://reference.aspose.com/pdf/java/com.aspose.pdf/image/) и сохраните документ.
...
## Добавьте изображения SVG внутри ячеек таблицы.

Используйте этот пример, когда таблица должна отображать файлы SVG построчно.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Table](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и просмотрите файлы SVG.
1. Добавьте по одной строке на изображение, настройте SVG [Image](https://reference.aspose.com/pdf/java/com.aspose.pdf/image/) и сохраните PDF-файл.
...
## Добавьте фрагменты HTML в ячейки таблицы

Используйте этот пример, когда содержимое таблицы должно включать встроенное форматирование HTML.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте границы.
1. Добавьте в ячейки объекты [HtmlFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlfragment/) и сохраните документ.
...
## Добавление фрагментов LaTeX в ячейки таблицы

Используйте этот пример, когда содержимое таблицы должно отображать выражения TeX или LaTeX.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) с границами.
1. Добавьте в ячейки объекты [TeXFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/texfragment/) и сохраните выходной файл.
...
## Перенести таблицу на новую страницу
...
1. Создайте первую большую [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и добавьте ее на страницу.
1. Создайте вторую таблицу, установите `InNewPage` и сохраните документ.
...
## Постройте вертикально разбитую таблицу с повторяющимися столбцами.

Используйте этот пример, когда широкая таблица должна продолжаться вертикально и повторять ключевые столбцы.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте вертикальное разбиение с повторяющимися столбцами.
...
## Пример повторного использования границ и отступов

Используйте этот помощник, когда сценарий полей и заполнения должен делегироваться примеру общей границы.

1. Вызовите существующий метод границы и заполнения таблицы.
1. Повторно используйте одну и ту же логику макета таблицы без дублирования кода.
...
## Создайте стол с закругленными углами

Используйте этот пример, когда таблица должна использовать стиль закругленных углов вместо стандартных прямоугольных границ.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте параметры закругленных границ.
...
## Добавьте повторяющиеся строки заголовков

Используйте этот пример, когда многостраничные таблицы должны повторять строки заголовков на каждой странице продолжения.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте вертикально разбитую [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и настройте количество и стиль повторяющихся строк.
...
## Добавление повторяющихся столбцов в широкую таблицу

Используйте этот пример, когда первые столбцы должны повторяться, а таблица разбивается по вертикали на той же странице.

1. Создайте новый PDF [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и настройте размер страницы.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и установите повторяющиеся столбцы, а также функцию автоподбора.
1. Добавьте строки заголовка и данных, затем сохраните PDF-файл.
...
## Вставка разрывов страниц между строками таблицы

Используйте этот пример, когда определенные строки таблицы должны начинаться на новой странице.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и заполните множество строк.
1. Отметьте выбранные строки значком `InNewPage` и сохраните документ.
...
## Поворот текста внутри ячеек таблицы

Используйте этот пример, когда текст ячейки должен отображаться под разными углами поворота.

1. Создайте новый PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и добавьте страницу.
1. Создайте [Таблицу](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/) и добавьте строку с несколькими ячейками.
1. Создайте повернутые объекты [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/), добавьте их в ячейки и сохраните PDF-файл.
