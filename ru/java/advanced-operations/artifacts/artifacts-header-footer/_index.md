---
title: Управление заголовками и нижними колонтитулами PDF с помощью Java
linktitle: Управление заголовками и нижними колонтитулами PDF
type: docs
weight: 70
...
## Добавление артефакта заголовка
...
## Удаление артефактов заголовка и нижнего колонтитула
