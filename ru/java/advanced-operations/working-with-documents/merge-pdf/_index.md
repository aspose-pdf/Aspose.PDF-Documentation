...
1. Добавьте [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) коллекция из второго документа в первый документ.
...
## Скопируйте выбранный диапазон страниц между документами
...
1. Откройте или получите исходный и целевой PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) объекты.
1. Нормализуйте запрашиваемый диапазон страниц, чтобы он оставался в пределах доступного [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) коллекция.
...
1. Откройте каждый входной файл по одному и скопируйте его полностью [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) диапазон в выходной документ.
...
## Объедините выбранные диапазоны страниц из двух документов
...
1. Откройте оба исходных PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) объекты и создать новый выходной документ.
1. Добавьте только необходимое [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) диапазоны из каждого исходного документа.
...
## Вставьте один PDF‑документ в другой в определённую позицию

Используйте этот подход, когда один документ должен отображаться внутри другого, а не только до или после него.

1. Откройте базовый и вставленный PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) объекты и создать новый выходной документ.
1. Скопируйте первую часть базового документа, затем добавьте полностью вставляемый документ, а в конце добавьте оставшуюся часть базового. [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) диапазон.
...
## Объедините документы с разделительными страницами и закладками
...
1. Добавьте разделитель [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) с заголовком, затем создать [OutlineItemCollection](https://reference.aspose.com/pdf/java/com.aspose.pdf/outlineitemcollection/) закладка для этого раздела.
