...
1. Добавьте коллекцию страниц [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) из второго документа в первый документ.
...
1. Откройте или получите исходный и целевой PDF объекты [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
1. Ограничьте запрашиваемый диапазон страниц границами доступной коллекции [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/).
...
1. Создайте пустой выходной PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
1. Откройте каждый входной файл по очереди и скопируйте весь диапазон его страниц [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) в выходной документ.
...
## Объединение выбранных диапазонов страниц из двух документов
...
1. Откройте оба исходных PDF объекты [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и создайте новый выходной документ.
1. Добавьте только необходимые диапазоны страниц [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) из каждого исходного документа.
...
## Вставка одного PDF‑документа в другой в определённую позицию

Используйте этот подход, когда один документ должен отображаться внутри другого, а не только до или после него.

1. Откройте базовый и вставленный PDF объекты [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и создайте новый выходной документ.
1. Скопируйте первый диапазон страниц [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) базового документа, затем добавьте весь вставляемый документ и оставшийся диапазон страниц базового документа.
...
## Объединение двух PDF-документов с чередованием страниц
...
1. Откройте оба исходных PDF объекты [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и создайте новый выходной документ.
1. Переберите максимальное доступное количество страниц и добавьте каждую доступную [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) поочередно из первого и второго документов.
...
## Объединение документов с разделительными страницами и закладками
...
1. Создайте пустой выходной PDF [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) и откройте каждый исходный файл поочередно.
1. Добавьте страницу-разделитель [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) с заголовком, затем создайте закладку [OutlineItemCollection](https://reference.aspose.com/pdf/java/com.aspose.pdf/outlineitemcollection/) для этого раздела.
