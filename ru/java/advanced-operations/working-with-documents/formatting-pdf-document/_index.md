---
title: Форматирование PDF-документов на Java
...
## Получение настроек окна документа
...
## Установка предпочтений окна документа
...
## Встраивание шрифтов в существующий PDF
...
## Установка коэффициента масштабирования при открытии документа
...
## Получение коэффициента масштабирования при открытии документа
