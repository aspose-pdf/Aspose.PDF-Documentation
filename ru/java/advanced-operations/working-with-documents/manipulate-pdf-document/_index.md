...
public static void validatePdfaStandardA1a(Path inputFile, Path outputFile) {
    try (Document document = new Document(inputFile.toString())) {
        document.validate(outputFile.toString(), .PDF_A_1A);
    }
}
```
...
## Настройка уровней TOC и форматирования
...
## Настройка префиксов номеров страниц в TOC
...
## Добавление скрипта истечения срока действия PDF
