---
title: Создание PDF-файлов в Java
linktitle: Создать PDF-документ
type: docs
weight: 10
url: /java/create-pdf-document/
description: Узнайте, как создавать PDF-файлы и PDF-файлы с возможностью поиска на Java с помощью Aspose.PDF.
lastmod: "2026-06-09"
sitemap:
    changefreq: "monthly"
    priority: 0.7
TechArticle: true
AlternativeHeadline: Создавайте PDF-файлы и PDF-документы с возможностью поиска с помощью Java.
Abstract: В этой статье показано, как создавать PDF-документы с помощью Aspose.PDF для Java. В нем рассматривается создание нового PDF-файла с нуля и преобразование документа на основе изображения в PDF-файл с возможностью поиска путем предоставления выходных данных HOCR из внешнего механизма оптического распознавания символов.
---
Aspose.PDF для Java поддерживает как простое создание документов, так и рабочие процессы PDF с возможностью оптического распознавания символов.
...
## Создайте PDF-файл с возможностью поиска

В примере `createSearchablePdf` используется `Document.convert(...)` с реализацией `CallBackGetHocr`. Обратный вызов записывает исходное изображение во временный файл, вызывает Tesseract с опцией `hocr`, считывает сгенерированную разметку HOCR и возвращает ее в Aspose.PDF.

1. Откройте исходный PDF-файл [Документ](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
1. Создайте обратный вызов `CallBackGetHocr` и преобразуйте исходный документ в PDF-содержимое с возможностью поиска.
