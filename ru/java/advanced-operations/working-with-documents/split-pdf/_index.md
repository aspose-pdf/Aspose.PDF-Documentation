...
## Разбейте PDF на одностраничные файлы
...
## Разделите PDF на группы страниц фиксированного размера
...
## Разделите PDF по пользовательским диапазонам страниц
...
## Разделите первую страницу и остальные страницы
...
## Разделите последнюю страницу и предыдущие страницы
...
## Разделите PDF на пользовательские группы страниц
...
## Разделите PDF на отдельные страницы со стабильными именами файлов
...
## Разделите PDF на нечётные и чётные страницы
