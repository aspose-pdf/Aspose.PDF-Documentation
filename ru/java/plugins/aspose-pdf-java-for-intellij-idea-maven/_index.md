---
title: Aspose.PDF Java для IntelliJ IDEA - Maven
linktitle: Aspose.PDF Java для IntelliJ IDEA - Maven
type: docs
weight: 30
...
IntelliJ IDEA — это интегрированная среда разработки (IDE) Java для разработчиков программного обеспечения. Она разрабатывается компанией JetBrains. Изначально создана для Java, в настоящее время поддерживает широкий спектр языков, включая JavaScript, Groovy, HTML, CSS, RSS, R, Haskell, PHP, Ruby, Python, Scala, Clojure и Kotlin.

В отчете Infoworld 2010 года IntelliJ получила самый высокий балл в тестовом центре среди четырех ведущих инструментов программирования на Java: Eclipse, IntelliJ IDEA, NetBeans и Oracle JDeveloper.
...
Пожалуйста, проверьте [это видео](https://www.youtube.com/watch?v=KoGdZhoWzcI&feature=youtu.be) ниже, чтобы увидеть Aspose.PDF Maven Project Wizard и Aspose.PDF Example Wizard в действии.

## Поддержка, расширение и участие

### Поддержка

- Если вы хотите увидеть известные/сообщённые проблемы (со стороны пользователей или команды QA) в плагине.
- Или вы хотите сообщить о любой найденной в плагине проблеме
- Есть предложения по улучшению или хотите запросить новую функцию
