...
description: Узнайте, как получить свойства страницы в PDF-файле с помощью Ruby с Aspose.PDF для эффективного управления и манипулирования вашими документами.
lastmod: "2026-06-09"
---
## Aspose.PDF — получение свойств страницы

Чтобы получить свойства страницы PDF-документа с помощью **Aspose.PDF Java для Ruby**, просто вызовите модуль **GetPageProperties**.
