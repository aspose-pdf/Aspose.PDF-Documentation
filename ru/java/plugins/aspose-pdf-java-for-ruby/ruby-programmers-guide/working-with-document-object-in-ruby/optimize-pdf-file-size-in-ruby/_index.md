...
description: Научитесь уменьшать размер PDF-файлов без ущерба для качества с помощью Aspose.PDF для Ruby.
lastmod: "2026-06-09"
---
## Aspose.PDF — оптимизация размера PDF-файла

Чтобы оптимизировать размер файла PDF-документа с помощью **Aspose.PDF Java for Ruby**, вызовите метод **optimize_filesize** модуля **Optimize**.
...
Загрузите **Оптимизировать размер PDF-файла (Aspose.PDF)** с любого из перечисленных ниже сайтов социального кодирования:
