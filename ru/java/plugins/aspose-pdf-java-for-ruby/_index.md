...
- [Скачать и настроить Aspose.Pdf в Ruby](/pdf/java/download-and-configure-aspose-pdf-in-ruby/)
- [Руководство для программистов Ruby](/pdf/java/ruby-programmers-guide/)
  - [Работа с объектом документа в Ruby](/pdf/java/working-with-document-object-in-ruby/)
    - [Добавление JavaScript в Ruby](/pdf/java/adding-javascript-in-ruby/)
    - [Добавить слои в PDF файл в Ruby](/pdf/java/add-layers-to-pdf-file-in-ruby/)

    - [Добавить Оглавление в существующий PDF в Ruby](/pdf/java/add-toc-to-existing-pdf-in-ruby/)
- [Получить свойства окна документа и отображения страницы в Ruby](/pdf/java/get-document-window-and-page-display-properties-in-ruby/)
- [Получить информацию о PDF файле в Ruby](/pdf/java/get-pdf-file-information-in-ruby/)
- [Получить XMP метаданные из PDF файла в Ruby](/pdf/java/get-xmp-metadata-from-pdf-file-in-ruby/)
- [Оптимизировать PDF документ для веба в Ruby](/pdf/java/optimize-pdf-document-for-the-web-in-ruby/)
- [Оптимизировать размер PDF файла в Ruby](/pdf/java/optimize-pdf-file-size-in-ruby/)
- [Удалить метаданные из PDF в Ruby](/pdf/java/remove-metadata-from-pdf-in-ruby/)
- [Установить свойства окна документа и отображения страницы в Ruby](/pdf/java/set-document-window-and-page-display-properties-in-ruby/)
- [Установить срок действия PDF в Ruby](/pdf/java/set-pdf-expiration-in-ruby/)
- [Установить информацию о PDF файле в Ruby](/pdf/java/set-pdf-file-information-in-ruby/)
- [Работа с страницами в Ruby](/pdf/java/working-with-pages-in-ruby/)

- [Объединить PDF файлы в Ruby](/pdf/java/concatenate-pdf-files-in-ruby/)
- [Удалить определенную страницу из PDF файла на Ruby](/pdf/java/delete-a-particular-page-from-the-pdf-file-in-ruby/)
- [Получить определенную страницу в PDF файле на Ruby](/pdf/java/get-a-particular-page-in-a-pdf-file-in-ruby/)
- [Получить количество страниц PDF на Ruby](/pdf/java/get-page-count-of-pdf-in-ruby/)
- [Получить свойства страницы на Ruby](/pdf/java/get-page-properties-in-ruby/)
- [Вставить пустую страницу в конец PDF файла на Ruby](/pdf/java/insert-an-empty-page-at-end-of-pdf-file-in-ruby/)
- [Вставить пустую страницу в PDF файл на Ruby](/pdf/java/insert-an-empty-page-into-a-pdf-file-in-ruby/)
- [Разделить PDF файл на отдельные страницы на Ruby](/pdf/java/split-pdf-file-into-individual-pages-in-ruby/)
- [Обновить размеры страницы на Ruby](/pdf/java/update-page-dimensions-in-ruby/)
- [Работа с текстом на Ruby](/pdf/java/working-with-text-in-ruby/)
  - [Добавить HTML строку с использованием DOM на Ruby](/pdf/java/add-html-string-using-dom-in-ruby/)
  - [Добавить текст в существующий PDF файл на Ruby](/pdf/java/add-text-to-an-existing-pdf-file-in-ruby/)
- [Извлечение текста со всех страниц PDF-документа на Ruby](/pdf/java/extract-text-from-all-the-pages-of-a-pdf-document-in-ruby/)
  - [Работа с преобразованием документов на Ruby](/pdf/java/working-with-document-conversion-in-ruby/)
    - [Преобразование HTML в формат PDF на Ruby](/pdf/java/convert-html-to-pdf-format-in-ruby/)
    - [Преобразование страниц PDF в изображения на Ruby](/pdf/java/convert-pdf-pages-to-images-in-ruby/)
    - [Преобразование PDF в формат DOC или DOCX на Ruby](/pdf/java/convert-pdf-to-doc-or-docx-format-in-ruby/)
    - [Преобразование PDF в Excel Workbook на Ruby](/pdf/java/convert-pdf-to-excel-workbook-in-ruby/)
    - [Преобразование PDF в формат SVG на Ruby](/pdf/java/convert-pdf-to-svg-format-in-ruby/)
    - [Преобразование файла SVG в формат PDF на Ruby](/pdf/java/convert-svg-file-to-pdf-format-in-ruby/)
- [Поддержка, расширение и вклад в Aspose.Pdf на Ruby](/pdf/java/support-extend-and-contribute-to-aspose-pdf-in-ruby/)