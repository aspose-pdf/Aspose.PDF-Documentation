---
title: Получение XMP‑метаданных из PDF‑файла в Python
linktitle: Получение XMP‑метаданных из PDF‑файла в Python
type: docs
weight: 50
...
Скачайте **Get XMP Metadata (Aspose.PDF)** с любого из перечисленных ниже сайтов для совместной разработки:
