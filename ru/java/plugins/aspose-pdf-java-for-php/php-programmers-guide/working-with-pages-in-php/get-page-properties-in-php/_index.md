---
title: Получить свойства страницы в PHP
linktitle: Получить свойства страницы в PHP
type: docs
weight: 50
url: /java/get-page-properties-in-php/
description: Узнайте, как получить свойства определенных страниц PDF-документа на PHP с помощью Aspose.PDF для детального контроля.
lastmod: "2026-06-09"
---
## Aspose.PDF — получение свойств страницы

Чтобы получить свойства страницы PDF-документа с помощью **Aspose.PDF Java для PHP**, просто вызовите класс **GetPageProperties**.
