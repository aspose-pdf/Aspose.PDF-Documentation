...
---
Класс `FormExamples` на Java заполняет отдельные поля напрямую:
...
Если ваше приложение уже имеет динамический набор имён полей и значений, используйте тот же вызов `fillField(...)` внутри собственного цикла:
