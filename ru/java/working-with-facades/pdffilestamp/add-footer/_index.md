---
title: Добавление нижнего колонтитула в PDF
linktitle: Добавление нижнего колонтитула в PDF
type: docs
weight: 10
...
---
## Добавление нижнего колонтитула в PDF

Используйте `PdfFileStamp`, когда вам нужно повторяющееся содержимое нижнего колонтитула на каждой странице документа.
