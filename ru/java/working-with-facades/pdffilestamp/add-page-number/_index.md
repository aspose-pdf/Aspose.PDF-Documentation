...
linktitle: Добавление номера страницы в PDF
type: docs
weight: 30
...
3. Задайте при необходимости стиль нумерации и начальный номер перед нанесением штампа.
4. Вызовите `addPageNumber` с требуемой перегрузкой.
