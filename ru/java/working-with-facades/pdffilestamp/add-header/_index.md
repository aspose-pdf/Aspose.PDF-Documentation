---
title: Добавление заголовка в PDF
linktitle: Добавление заголовка в PDF
type: docs
weight: 20
...
Используйте `PdfFileStamp`, когда вам нужно повторяющееся содержимое заголовка на каждой странице.

### Шаги

1. Создайте экземпляр `PdfFileStamp` и привяжите исходный PDF.
2. Создайте содержимое заголовка как `FormattedText` или загрузите его из потока изображения.
