---
title: Установка флага отправки
linktitle: Установка флага отправки
type: docs
weight: 40
...
---
Метод `FormEditorExamples.setSubmitUrl(...)` на Java включает следующие действия:

## Настройка флага отправки
