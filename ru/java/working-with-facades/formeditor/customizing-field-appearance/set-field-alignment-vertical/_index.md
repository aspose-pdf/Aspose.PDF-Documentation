---
title: Установка вертикального выравнивания поля
linktitle: Установка вертикального выравнивания поля
type: docs
weight: 30
...
---
## Установка вертикального выравнивания поля

1. Привяжите исходный PDF к фасаду `FormEditor`.
2. Вызовите `setFieldAlignmentV(...)` для целевого поля и требуемой константы вертикального выравнивания.
