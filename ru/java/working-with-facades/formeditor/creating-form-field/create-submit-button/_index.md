---
title: Создание кнопки отправки
linktitle: Создание кнопки отправки
type: docs
weight: 60
...
2. Вызовите `addSubmitBtn(...)` с именем кнопки, страницей, ярлыком, целевым URL и прямоугольником.
