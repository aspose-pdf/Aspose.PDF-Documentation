...
linktitle: Смена пароля PDF‑файла
type: docs
weight: 10
...
Используйте `PdfFileSecurity`, когда вам необходимо сменить учетные данные в уже защищённом PDF.

### Шаги

1. Создайте экземпляр `PdfFileSecurity`.
2. Привяжите защищённый PDF с помощью `bindPdf`.
