...
## Добавление свободной текстовой аннотации

1. Загрузите исходный PDF и выберите целевую страницу и прямоугольник для свободной текстовой заметки.
2. Создайте `FreeTextAnnotation`, инициализируйте её стандартный внешний вид и установите заголовок и цвет.
