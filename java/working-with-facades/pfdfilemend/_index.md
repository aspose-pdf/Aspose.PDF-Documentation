...
We can add text in several ways. Consider the first. We take the [FormattedText](https://apireference.aspose.com/pdf/java/com.aspose.pdf.facades/FormattedText) and add it to the Page. After, we indicate the coordinates of the lower left corner, and then we add our text to the Page.
