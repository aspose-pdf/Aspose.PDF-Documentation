...
When adding Image as stamp object, you can also control the quality of image. In order to accomplish this requirement, Quality property is added for [Stamp](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/Stamp) class. It indicates the quality of image in percents (valid values are 0..100).
