...
type: docs
weight: 10
url: /jasperreports/aspose-barcode-for-jasperreports-19-12-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for Aspose.BarCode for JasperReports 19.12 based on features from [Aspose.BarCode for Java 19.12](https://downloads.aspose.com/barcode/java/new-releases/aspose.barcode-for-java-19.12/).
