...
linktitle: Was gibt es Neues
type: docs
weight: 10
url: /de/python-net/whatsnew/
description: Auf dieser Seite werden die populärsten neuen Funktionen in Aspose.PDF for Python via .NET vorgestellt, die in den letzten Versionen eingeführt wurden.
sitemap:
    changefreq: "monthly"
    priority: 0.8
lastmod: "2026-05-18"
...
## Was ist neu in Aspose.PDF 26.3

In **Aspose.PDF for Python via .NET** 26.3 haben wir hinzugefügt:

Verlustfreie Bildstrom-Neukompression während der PDF-Optimierung. Die Eigenschaft OptimizationOptions.CompressAllContentStreams komprimiert nun auch berechtigte Bild‑XObject‑Streams mit FlateDecode, was hilft, die Dateigröße zu reduzieren, während die Bildqualität erhalten bleibt.
...
Die Bild-Neukompression stimmt jetzt während der Optimierung mit der ausgewählten Einstellung ImageCompressionOptions.Encoding überein und sorgt für konsistentere Ergebnisse bei der Verwendung von Jpeg2000 oder Flate, zusammen mit Bildgrößenänderung, Auflösungsgrenzen und Qualitätssteuerelementen.
...
Unterstützung für das Rendern von Kommentaren beim Speichern von PDF-Dokumenten als Bilder oder HTML, wodurch sichtbare Review-Markup erhalten bleibt, wenn annotierte Dokumente zum Teilen außerhalb von PDF-Viewern exportiert werden.
...
Verbesserte PDF-zu-TIFF-Renderleistung für hochvolumige Rasterisierungsszenarien, insbesondere beim Exportieren von Seiten in bitonale TIFF-Bilder.
...
## Was ist neu in Aspose.PDF 26.2

Aspose.PDF 26.2 führt die Unterstützung für die Konvertierung von RTF nach PDF ein. Diese Funktion ermöglicht Entwicklern, Rich Text Format (RTF)-Dokumente direkt in PDF-Dateien zu konvertieren.

RTF ist ein weit verbreitetes, plattformübergreifendes Dokumentformat, das ursprünglich von Microsoft entwickelt wurde. Es ist darauf ausgelegt, den Dokumentenaustausch zwischen verschiedenen Textverarbeitungsanwendungen zu ermöglichen, während grundlegende Formatierungen wie Schriftarten, Farben, fett und kursiv formatierter Text sowie eingebettete Bilder erhalten bleiben.
...
Dieses Code‑Snippet zeigt, wie man eine Tabelle nach dem vorhandenen Inhalt auf einer PDF‑Seite mit Aspose.PDF für Python einfügt.

Das Skript öffnet ein vorhandenes PDF-Dokument und berechnet die Begrenzungsbox des aktuellen Inhalts auf der ersten Seite. Mit diesen Informationen findet es heraus, wo der vorhandene Inhalt endet, und positioniert eine neue Tabelle unter dem letzten Element, wobei ein festgelegter Abstand vor dem Beginn der Tabelle gelassen wird.

Eine Tabelle wird dann erstellt und mit mehreren Zeilen und Spalten in einer Schleife gefüllt. Nachdem die Tabellenstruktur und der Inhalt festgelegt wurden, wird die Tabelle zur Absatzsammlung der Seite hinzugefügt. Schließlich wird das aktualisierte Dokument als neue PDF-Datei gespeichert.
...
Erkennen und Entfernen von unsichtbarem Text aus einem PDF-Dokument mit Aspose.PDF für Python:
...
## Was ist neu in Aspose.PDF 26.1

In **Aspose.PDF for Python via .NET** 26.1 haben wir hinzugefügt:

1. Leistungsverbesserungen – schlechte Leistung beim Hinzufügen von Text zu Dokumenten und allgemeine Leistungsprobleme behoben.
1. Verbesserte Rendergenauigkeit – fehlenden vertikalen Text auf der linken Seite von PDFs behoben und die Darstellung chinesischer Zeichen bei der PDF-zu-PNG-Konvertierung korrigiert.
1. Verbesserte HTML-Konvertierung – die API berücksichtigt jetzt die Linienfarbe bei der HTML-zu-PDF-Konvertierung und hat Textüberlappungsprobleme bei der XFA-zu-Standard-Konvertierung behoben.
1. Fehlerbehebungen für die Dokumentenstruktur – NumberingStyle funktioniert jetzt korrekt für Überschriftenobjekte, und PDF-zu-HTML bewahrt nun die hervorgehobene Textfarbe.

## Was ist neu in Aspose.PDF 25.12

Konvertieren Sie ein HTML-Dokument in ein PDF, wobei die logischen Strukturinformationen erhalten bleiben. Das resultierende PDF ist besser für Barrierefreiheit, Tagging und nachgelagerte Verarbeitung geeignet, die auf strukturierten Dokumenteninhalten beruht.
...
Analysieren Sie ein digital signiertes PDF, um Inhalte zu identifizieren und zu melden, die nicht von Signaturen abgedeckt sind. Verwenden Sie es, um die Dokumentenintegrität zu überprüfen, signierte PDFs zu prüfen und Änderungen nach der Signatur zu erkennen.
...
## Was ist neu in Aspose.PDF 25.11

Diese Funktion vergleicht eine bestimmte Seite aus zwei PDF-Dokumenten und erzeugt einen nebeneinander angezeigten visuellen Unterschied. Durch Anpassen der Vergleichsoptionen und Farben hebt sie bedeutende Änderungen hervor, während sie unbedeutende Unterschiede wie Leerzeichen ignoriert.
...
Versteckte Daten entfernen und Seiten rasterisieren in Version 25.11.
...
Optimierung von Ressourcen durch Font-Subsetting und Komprimierung von Inhalts-Streams Version 25.11.
...
## Was ist neu in Aspose.PDF 25.10

Erweiterte PDF‑Ebenen‑Sichtbarkeitssteuerung – dieses Release führt die Möglichkeit ein, den anfänglichen Sichtbarkeitsstatus von PDF‑Ebenen programmgesteuert zu definieren und sie zu sperren, um Sichtbarkeitsänderungen in PDF‑Viewern zu verhindern.

Eine neue 'layer.default_state'-Eigenschaft ermöglicht das Festlegen der Standardanzeige einer Ebene auf sichtbar oder verborgen über die DefaultState-Eigenschaft. Dies bietet eine feinkörnige Steuerung für die Verwaltung komplexer, geschichteter PDF-Dokumente mit vorhersehbarem Sichtbarkeitsverhalten für den Benutzer.
...
## Was ist neu in Aspose.PDF 25.9

Die Version 25.9 führt verbesserte Barrierefreiheit, erweiterte Unterstützung für die Einhaltung von Vorschriften und neue API‑Funktionen für die Arbeit mit getaggten Bildern und Dokumentenstandards ein.

1. Konvertieren Sie PDFs in das PDF/E-1-Format.
1. Markierte Bilder aus Speicherströmen hinzufügen.

### PDF in PDF/E-1-Format konvertieren

In der Version 25.9 der Aspose.PDF für Python-Bibliothek ist die PDF/E-1-Formatkonvertierung verfügbar. Weitere Informationen zu diesem Format finden Sie auf der [Dateiformat-Dokumentationen](https://docs.fileformat.com/pdf/e/).
...
### Getaggte Bilder aus einem Stream hinzufügen

Fügen Sie getaggte Bilder aus einem Stream in PDF hinzu. Die Version 25.9 unterstützt verbesserte Barrierefreiheit in PDF-Dokumenten, indem ein Bild aus einem Memory-Stream hinzugefügt und mit Alternativtext getaggt wird.
...
## Was gibt es Neues in Aspose.PDF 25.8

Dieses Update fügt mehr Flexibilität bei der Layout- und Dokumentensicherheitsverwaltung hinzu.

1. Erstelle getaggte Inhaltsverzeichnisse (TOC).
1. PDF-Seiten mit Inhalts‑Skalierung skalieren.
1. Gestrichelte Rahmen auf Tabellen anwenden.

### Erstelle Tagged Inhaltsverzeichnis (TOC)

Automatisch barrierefreie Inhaltsverzeichnisse (TOC) in getaggten PDFs erstellen. Das Erstellen eines vollständig barrierefreien Inhaltsverzeichnisses (TOC) in einem PDF ermöglicht es den Lesern, das Dokument effizient zu navigieren, und stellt die PDF/UA-1‑Konformität für Barrierefreiheit sicher.
...
### Seitengröße ändern mit Inhalts‑Skalierung

PDF-Seiten skalieren, während das Layout beibehalten und der Inhalt proportional skaliert wird. Beim Arbeiten mit PDFs kann es nötig sein, Seiten zu skalieren oder Inhalte an neue Abmessungen anzupassen.
...
### Gestrichelte Rahmen auf Tabellen anwenden

Fügen Sie Tabellen mit benutzerdefinierten Rahmenstilen unter Verwendung von Strichlinien hinzu. Dieses Beispiel zeigt, wie benutzerdefinierte Rahmenstile — wie gestrichelte oder gepunktete Linien — auf Tabellen in einem PDF-Dokument mithilfe von Aspose.PDF for Python via .NET angewendet werden.
...
## Was ist neu in Aspose.PDF 25.7

Das 25.7-Release konzentriert sich auf bessere Annotation-Unterstützung, Textanpassung und Verwaltung digitaler Signaturen.

1. Text in Formen einpassen.
1. Verschlüsseln Sie PDFs mit einem öffentlichen Zertifikat.
1. Füge Wolken- und Polygon-Anmerkungen hinzu.

### PDFs mit einem öffentlichen Zertifikat verschlüsseln

Schützen Sie Ihre PDFs mit Verschlüsselung basierend auf öffentlichen Zertifikaten. Die Verschlüsselung mit öffentlichen Zertifikaten ermöglicht es, PDFs für bestimmte Empfänger zu verschlüsseln, sodass nur Inhaber der entsprechenden privaten Schlüssel das Dokument öffnen und lesen können.
...
### Text in ein Rechteck einpassen

Automatisch Text skalieren, damit er in ein definiertes Rechteck passt. Beim Aktualisieren oder Erweitern von Text in einem PDF kann er die ursprünglichen Absatzgrenzen überschreiten.
...
### Cloud-Polygon-Anmerkungen hinzufügen

Verbessern Sie die PDF-Überprüfungsabläufe mit Wolken- oder Polygon-Annotationen. Polygon-Annotationen ermöglichen es Ihnen, bestimmte Bereiche in einem PDF mithilfe geometrischer Formen hervorzuheben oder zu betonen.
...
## Was ist neu in Aspose.PDF 25.6

Die Hauptfunktionen dieser Version:

1. Unterstützung für Bild-Alt-Text.
1. Lizenzinfo-Zugriff.
1. Gestylte Freitext-Annotationen.
1. Anpassbares Erscheinungsbild der digitalen Signatur.

### Unterstützung für Alt-Text von Bildern

Legen Sie alternativen Text für Bilder fest und rufen Sie ihn ab, um die Barrierefreiheit für Bildschirmleser zu verbessern.
...
Rufen Sie detaillierte Lizenzmetadaten (lizenzierter Benutzer, Ablaufdatum) über LicenseInfo ab.
...
### Gestylte Freitext-Annotationen

Verwenden Sie SetTextStyle, um Stile wie Fettdruck, Kursivschrift, Unterstreichung anzuwenden oder die vorhandene Formatierung des Anmerkungstextes zu löschen.
...
### Anpassbares Erscheinungsbild der digitalen Signatur

Fügen Sie Bilder hinzu, ändern Sie Schriftarten und legen Sie Signaturgrafiken über Hintergrundinhalte, um ein besseres Branding oder eine konsistente Gestaltung zu erreichen.
...
## Was ist neu in Aspose.PDF 25.5

Das neueste Aspose.PDF-Update führt mehrere leistungsstarke Verbesserungen ein, die die Barrierefreiheit, Kompatibilität und Sicherheit von Dokumenten verbessern. Entwickler können jetzt digitale Zertifikate direkt aus signierten PDF-Dateien extrahieren, was erweiterte Verifizierungen und Compliance‑Prüfungen ermöglicht.

1. Zertifikate aus PDF-Signaturen extrahieren.
1. Erstelle strukturierte geordnete Listen in Tagged PDFs.
1. Signaturen mit öffentlichen Schlüsselzertifikaten überprüfen.
1. Konvertieren Sie dynamische XFA-Formulare in AcroForm-PDFs.
1. Schriftarten-Ersetzung in PDF - XPS-Konvertierung.

### Zertifikate aus PDF-Signaturen extrahieren

Rufen Sie eingebettete Zertifikate mit 'extract_certificate()' ab.
...
### Strukturierte geordnete Listen in Tagged PDFs erstellen

Erzeugen Sie zugängliche nummerierte Listen (mit verschachtelten Elementen) in getaggten Dokumenten.
...
### Signaturen mit öffentlichen Schlüsselzertifikaten überprüfen

Validieren Sie digitale Signaturen mithilfe externer öffentlicher Schlüsselzertifikate.
...
### Dynamische XFA-Formulare in AcroForm-PDFs konvertieren

Standardisieren Sie XFA-Formulare mit 'ignore_needs_rendering'.
...
### Schriftart ersetzen in PDF - XPS-Konvertierung

Ersetzen Sie fehlende Schriftarten durch eine standardmäßige Ersatzschrift (z. B. „Courier New“).
...
## Was ist neu in Aspose.PDF 25.4

### Automatisches Tagging während der PDF/A-Konvertierung

Konvertieren Sie PDFs zu PDF/A-1b mit automatischer Erstellung einer logischen Struktur für verbesserte Barrierefreiheit.
