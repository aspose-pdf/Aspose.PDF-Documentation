...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Travailler avec des tableaux dans un PDF en utilisant Python",
    "alternativeHeadline": "Travailler avec des tableaux",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, python, tableaux dans pdf",
    "wordcount": "302",
    ...
    "description": "Cet article décrit comment ajouter et extraire un tableau, comment manipuler et intégrer un tableau en utilisant la bibliothèque Python."
}
</script>
