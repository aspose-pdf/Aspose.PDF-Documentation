...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Faire pivoter les pages PDF à l'aide de Python",
    "alternativeHeadline": "Comment faire pivoter les pages PDF avec Python",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, python, faire pivoter la page pdf",
    "wordcount": "302",
