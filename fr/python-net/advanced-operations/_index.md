...
<script type="application/ld+json">
{
    ...
    "alternativeHeadline": "Utilisation de fonctionnalités avancées pour travailler avec PDF via Python",
    "author": {
        "@type": "Person",
    ...
    "description": "Aspose.PDF peut non seulement effectuer des tâches simples et faciles, mais aussi gérer des objectifs plus complexes. Consultez la section suivante pour les utilisateurs avancés et les développeurs utilisant Python via .NET."
}
</script>
