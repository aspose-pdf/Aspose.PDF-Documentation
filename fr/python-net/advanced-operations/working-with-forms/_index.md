...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Travailler avec des formulaires en utilisant Python",
    "alternativeHeadline": "Comment travailler avec les AcroForms dans PDF",
    "author": {
        "@type": "Person",
    ...
    "description": "Cette section explique comment travailler avec les AcroForms dans vos documents PDF avec Aspose.PDF pour Python."
}
</script>
...
- [AcroForms](/pdf/python-net/acroforms/) - créer un formulaire, remplir un champ de formulaire, extraire des données du formulaire, ajouter et supprimer des champs dans votre PDF avec la bibliothèque Python.
