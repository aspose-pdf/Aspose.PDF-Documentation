...
Consultez les pages Docs pour plus de détails : [Optimiser le PDF](/pdf/fr/cpp/optimize-pdf/)
...
Vérifions la section suivante pour plus de détails : [Travailler avec des tableaux](/pdf/fr/cpp/working-with-tables/)
...
Vérifions les pages Docs pour plus de détails : [Travailler avec des graphiques](/pdf/fr/cpp/graphs/)
...
Vérifions la section suivante pour plus de détails : [Actions](/pdf/fr/cpp/actions/)
...
Vérifions les pages Docs pour plus de détails : [Sécurisation et Signature](/pdf/fr/cpp/securing-and-signing/)
...
Vérifions la section suivante pour plus de détails : [Signets](/pdf/fr/cpp/add-and-delete-bookmark/)
...
Vérifions les pages Docs pour plus de détails : [Travailler avec TOC](/pdf/fr/cpp/manipulate-pdf-document/)
...
La bibliothèque Aspose.PDF pour C++ propose différentes manipulations avec [Annotations](/pdf/fr/cpp/annotations/). Vous pouvez ajouter des types tels que :
...
Également, notre bibliothèque vous permet d'ajouter, d'extraire et de supprimer des pièces jointes du PDF. Pour plus de détails, consultez les prochaines [pages de documentation](/pdf/fr/cpp/attachments/).
...
Gérez facilement et rapidement les [métadonnées](/pdf/fr/cpp/pdf-file-metadata/) dans un document PDF avec une bibliothèque **Aspose.PDF for C++**.
...
Vous pouvez également ajouter, changer la position, supprimer des images, et réaliser des [actions plus complexes](/pdf/fr/cpp/working-with-images/) avec les images dans votre PDF.

### Diviser, concaténer, extraire ou insérer des pages
Le [Travail avec les Pages PDF](/pdf/fr/cpp/working-with-pages/) dans la section Docs explique comment vous pouvez ajouter, déplacer, supprimer, faire pivoter ou diviser des pages dans un PDF.
...
Aspose.PDF Library utilise la classe DocumentDevice, ou ImageDevice pour la conversion de PDF en Image. [Convertir PDF en Différents Formats d'Image](/pdf/fr/cpp/convert-pdf-to-images-format/).
...
Vérifions la section suivante pour plus de détails : [Impression de documents PDF](/pdf/fr/cpp/printing-document/).
...
Veuillez visiter la page [Licences](/pdf/fr/cpp/licensing/) pour des informations sur les licences et consulter la page [Informations sur la tarification](https://purchase.aspose.com/pricing/pdf/family/) pour des détails sur les prix.

## Support Technique

Pour plus d'informations sur le support technique d'Aspose.PDF, consultez la [page de Support](/pdf/fr/cpp/technical-support/).

En savoir plus sur :

- [Formats de fichiers pris en charge](/pdf/fr/cpp/supported-file-formats/)
- [Caractéristiques clés d'Aspose.PDF](/pdf/fr/cpp/key-features/)
- [Configuration système requise](/pdf/fr/cpp/system-requirements/)
- [Installation](/pdf/fr/cpp/installation/)
- [Licence](/pdf/fr/cpp/licensing/)
- [Support technique](/pdf/fr/cpp/technical-support/)