...
linktitle: Formats de Fichiers Supportés
type: docs
weight: 10
url: fr/javascript-cpp/supported-file-formats/
description: Cette page montre quels formats de fichiers Aspose.PDF for JavaScript peut charger et enregistrer.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Le tableau suivant indique les formats de fichiers qu'Aspose.PDF for JavaScript via C++ peut charger et enregistrer.
...
|[PPTX](https://docs.fileformat.com/presentation/pptx/)|Enregistre le document au format Présentations Microsoft PowerPoint| |{{< emoticons/tick >}}| |
