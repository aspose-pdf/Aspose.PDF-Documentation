---
title: Copier un champ depuis un autre PDF
...
Abstract: Cet article montre comment créer un PDF de destination, le lier à la façade FormEditor, copier un champ d'un autre document et enregistrer le résultat à l'aide d'Aspose.PDF for Java.
---
