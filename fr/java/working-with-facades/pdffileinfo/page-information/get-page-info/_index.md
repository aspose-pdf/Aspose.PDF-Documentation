...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Obtenir des informations sur une page PDF à l'aide d'Aspose.PDF for Java
Abstract: Découvrez comment récupérer des informations de page avec Aspose.PDF for Java. L'exemple Java utilise PdfFileInfo pour lire la largeur, la hauteur et la rotation de la page 1 afin que vous puissiez inspecter sa mise en page avant de poursuivre le traitement.
---
