...
Abstract: Découvrez comment récupérer les décalages de page avec Aspose.PDF for Java. L'exemple Java utilise PdfFileInfo pour lire les décalages X et Y de la page 1 et convertit les valeurs de points en pouces pour faciliter l'analyse de la mise en page.
---
