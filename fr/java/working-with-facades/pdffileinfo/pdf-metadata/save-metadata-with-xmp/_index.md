...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Enregistrement des métadonnées PDF avec XMP à l'aide d'Aspose.PDF for Java
Abstract: Découvrez comment enregistrer des métadonnées PDF avec XMP à l'aide d'Aspose.PDF for Java. L'exemple Java met à jour les champs de métadonnées principaux avec PdfFileInfo et les réécrit en utilisant `saveNewInfoWithXmp()` afin que le document de sortie stocke les informations sous forme XMP.
---
