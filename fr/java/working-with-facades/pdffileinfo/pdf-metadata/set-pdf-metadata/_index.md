...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Mise à jour des métadonnées PDF à l'aide d'Aspose.PDF for Java
Abstract: Découvrez comment mettre à jour les métadonnées PDF avec Aspose.PDF for Java. L'exemple Java utilise PdfFileInfo pour définir des champs de métadonnées standard tels que le sujet, le titre, les mots-clés et le créateur, ajoute une entrée de métadonnées personnalisée et enregistre le résultat dans un nouveau PDF.
---
