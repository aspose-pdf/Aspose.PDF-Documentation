...
Abstract: Découvrez comment ajouter du contenu de tampon aux documents PDF avec Aspose.PDF for Java à l'aide de la façade PdfFileStamp. L'ensemble d'exemples Java actuel montre comment créer un `Stamp`, le lier à un fichier image, l'ajouter au document et enregistrer le PDF tamponné.
---
