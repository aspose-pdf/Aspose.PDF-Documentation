...
Abstract: Découvrez comment ajouter du contenu d'en-tête aux documents PDF avec Aspose.PDF for Java à l'aide de la façade PdfFileStamp. Les exemples Java couvrent les en-têtes de texte brut, les en-têtes d'image chargés à partir d'un flux et les en-têtes stylisés avec des valeurs de marge explicites.
---
