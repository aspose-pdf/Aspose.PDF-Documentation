...
Abstract: Découvrez comment inspecter les métadonnées de signature avec Aspose.PDF for Java. L'exemple Java lit le premier nom de signature disponible, puis récupère le signataire, la date, le motif et l'emplacement du PDF signé.
---
