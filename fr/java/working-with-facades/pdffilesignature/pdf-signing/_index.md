...
Abstract: Découvrez comment signer des documents PDF avec Aspose.PDF for Java. L'ensemble d'exemples Java couvre la signature avec un chemin de certificat et un mot de passe configurés, ainsi que la signature avec un objet de signature PKCS7 explicite qui inclut des métadonnées de signature telles que le motif, les informations de contact, l'emplacement et l'autorité.
---
