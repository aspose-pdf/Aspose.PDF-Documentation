...
Abstract: Apprenez à diviser un PDF depuis le début avec Aspose.PDF for Java. L'exemple Java utilise PdfFileEditor pour prendre les trois premières pages d'un document et les enregistrer dans un PDF distinct.
---
