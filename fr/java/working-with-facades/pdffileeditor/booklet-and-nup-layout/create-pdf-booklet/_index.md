...
Abstract: Découvrez comment créer un livret PDF avec Aspose.PDF for Java. L'exemple Java utilise PdfFileEditor pour réorganiser les pages pour l'impression de livrets et inclut également une variante de retour booléen pour une vérification simple du succès.
---
## Créer un livret PDF
