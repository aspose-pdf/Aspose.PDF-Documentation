...
Abstract: Découvrez comment supprimer des pages d'un PDF avec Aspose.PDF for Java. L'exemple Java utilise PdfFileEditor pour supprimer un ensemble défini de numéros de page et enregistrer les pages restantes en tant que nouveau document.
---
