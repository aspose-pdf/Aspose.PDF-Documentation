...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Fusionner des documents PDF en Java avec PdfFileEditor
Abstract: Cette section explique les flux de travail de fusion liés à PdfFileEditor dans Aspose.PDF for Java. L'ensemble d'exemples Java actuel comprend un exemple de concaténation directe pour combiner les fichiers d'entrée, tandis que plusieurs pages de fusion supplémentaires dans cette section sont conservées comme notes sur les limites des exemples car aucune méthode Java dédiée n'est présente dans l'exemple de classe du référentiel.
---
La classe Java `PdfFileEditorExamples` inclut un exemple direct `concatenate` pour la fusion de fichiers PDF.
