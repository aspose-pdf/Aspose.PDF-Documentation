...
lastmod: "2026-09-22"
TechArticle: true
AlternativeHeadline: Remplir plusieurs champs de formulaire PDF à partir de paires nom-valeur en Java
...
Il s'agit d'un modèle au niveau de l'application dérivé de la même API Java utilisée dans `FormExamples.fillTextFields(...)` ; le référentiel actuel n'inclut pas de méthode auxiliaire dédiée distincte pour le remplissage à partir d’une table associative.
