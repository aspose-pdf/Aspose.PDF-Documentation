---
title: Importation de données de formulaire
...
lastmod: "2026-09-23"
TechArticle: true
AlternativeHeadline: Importer des données de formulaire PDF à partir de XML, FDF et XFDF en Java
Abstract: Cette section couvre les exemples d'importation de formulaires Java implémentés avec la façade Form dans Aspose.PDF for Java. L'ensemble d'exemples actuel inclut l'importation de données AcroForm à partir de XML, FDF et XFDF, tandis que les sujets de remplacement JSON et XFA non pris en charge sont explicitement notés pour que la documentation reste alignée sur les sources du référentiel.
---
