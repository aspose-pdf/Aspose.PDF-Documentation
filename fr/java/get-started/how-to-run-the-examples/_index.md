...
type: docs
weight: 50
url: fr/java/how-to-run-other-examples/    
description: Cette page présente des lignes directrices qui seront utiles pour les exigences suivantes avant de télécharger et d'exécuter les exemples.
lastmod: "2021-06-05"
---

## Télécharger depuis GitHub

Tous les exemples de Aspose.PDF pour Java sont hébergés sur [Github](https://github.com/aspose-pdf/Aspose.PDF-for-Java). Vous pouvez soit cloner le dépôt en utilisant votre client Github préféré, soit télécharger le fichier ZIP depuis [ici](https://github.com/aspose-pdf/Aspose.PDF-for-Java/archive/master.zip).
...
Cliquez sur le menu **File** et choisissez **Open**.
 Parcourez jusqu'au dossier du projet et sélectionnez le fichier **pom.xml**.
...
Cela ouvrira le projet et téléchargera automatiquement les dépendances. Depuis l'onglet Projets, parcourez les exemples dans **source packages**. Pour exécuter un exemple, faites simplement un clic droit sur le fichier et choisissez **Run File**, l'exemple sera exécuté et le résultat s'affichera dans la fenêtre de sortie de la console intégrée.
...
Pour contribuer, vous pouvez fork le dépôt, modifier le code source et créer une pull request. Nous examinerons les modifications et les inclurons dans le dépôt si elles sont jugées utiles.