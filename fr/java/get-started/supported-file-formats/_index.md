...
Le tableau suivant indique les formats de fichiers que Aspose.PDF pour Java peut charger et enregistrer.
...
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|Métafile de Graphiques Informatiques pour graphiques vectoriels 2D|{{< emoticons/tick >}}| | |
...
|[EMF](https://docs.fileformat.com/image/emf/)|Format de métafile amélioré (EMF)| |{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Enregistre le document en image TIFF à page unique ou multiple| |{{< emoticons/tick >}}| |
