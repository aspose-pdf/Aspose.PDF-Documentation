...
1. Ouvrez les deux documents sources avec le constructeur [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
...
1. Enregistrez le [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) fusionné dans le fichier de sortie.
