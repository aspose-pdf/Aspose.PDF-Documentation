...
type: docs
weight: 70
url: /fr/java/artifacts-header-footer/
description: Découvrez comment ajouter et supprimer des artefacts d'en-tête et de pied de page dans des documents PDF à l'aide d'Aspose.PDF for Java.
lastmod: "2026-09-22"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Abstract: Cet article explique comment gérer les artefacts d'en-tête et de pied de page dans les documents PDF à l'aide d'Aspose.PDF for Java. Il couvre la création d'objets `HeaderArtifact` et `FooterArtifact` réutilisables avec un état et un alignement de texte personnalisés, leur ajout à une page et la suppression des artefacts d'en-tête et de pied de page existants.
---
...
Utilisez cette méthode auxiliaire lorsque vous avez besoin d’un artefact d’en-tête réutilisable avec un style et un alignement de texte cohérents.

1. Créez un objet [HeaderArtifact](https://reference.aspose.com/pdf/java/com.aspose.pdf/headerartifact/).
1. Définissez son texte, ses paramètres de police et sa couleur de premier plan.
...
Cette méthode auxiliaire crée un artefact de pied de page réutilisable avec le même modèle de style que l'artefact d'en-tête.

1. Créez un [FooterArtifact](https://reference.aspose.com/pdf/java/com.aspose.pdf/footerartifact/).
1. Définissez son texte, son état et sa couleur de premier plan.
...
1. Créez l'artefact d'en-tête via la méthode auxiliaire.
...
1. Ouvrez le PDF source [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/).
1. Créez l'artefact de pied de page via la méthode auxiliaire.
1. Ajoutez l'artefact à la page et enregistrez le fichier de sortie.
