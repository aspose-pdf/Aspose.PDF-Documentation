---
title: Création d'un PDF conforme PDF/A-3 et pièce jointe d'une facture ZUGFeRD en Java
...
Abstract: Cet article explique comment créer un document de facture conforme PDF/A-3A à l'aide d'Aspose.PDF for Java. Il couvre la pièce jointe de la facture XML en tant que fichier intégré, la définition du type MIME et de la relation entre les fichiers associés, la conversion du PDF en PDF/A-3A et l'enregistrement du document final prêt pour ZUGFeRD.
---
...
1. Créez le [FileSpecification](https://reference.aspose.com/pdf/java/com.aspose.pdf/filespecification/) pour le fichier de facture XML.
