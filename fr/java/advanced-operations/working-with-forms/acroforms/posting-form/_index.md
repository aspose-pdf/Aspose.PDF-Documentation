...
description: Ajoutez des boutons de soumission et des actions de soumission aux PDF AcroForms à l'aide d'Aspose.PDF for Java.
lastmod: "2026-09-22"
sitemap:
    changefreq: "monthly"
    priority: 0.7
TechArticle: true
AlternativeHeadline: Ajouter des boutons de soumission et des actions de publication de formulaire aux fichiers PDF avec Java
Abstract: Cet article montre comment ajouter une fonctionnalité de soumission aux formulaires PDF à l'aide d'Aspose.PDF for Java. Il couvre la création d'un bouton de soumission avec FormEditor et la création d'un champ de bouton personnalisé qui utilise SubmitFormAction pour plus de contrôle sur l'URL et les indicateurs de soumission.
---
Aspose.PDF for Java prend en charge la création de boutons de soumission basés sur la façade et sur le DOM.
...
1. Créez le [ButtonField](https://reference.aspose.com/pdf/java/com.aspose.pdf/buttonfield/) sur la [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) cible et attribuez l'action de soumission.
