...
1. Ouvrez le PDF source [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) et créez un document de destination.
1. Ajoutez la page cible à la destination et supprimez-la de la source.
...
1. Ouvrez le PDF source [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) et créez le document de destination.
1. Copiez les pages sélectionnées dans le document de destination.
...
1. Dupliquez la page cible dans la nouvelle position et supprimez l'entrée de page d'origine.
