---
title: Travailler avec des pièces jointes PDF en Java
...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Ajouter, extraire, supprimer et organiser des pièces jointes et des portefeuilles PDF en Java
Abstract: Cet article explique comment travailler avec des pièces jointes PDF à l'aide d'Aspose.PDF pour Java. Découvrez comment intégrer des fichiers dans des documents PDF, extraire un ou tous les fichiers incorporés, gérer les annotations des pièces jointes, créer des portefeuilles PDF et supprimer des pièces jointes par programme.
---
