---
title: Travailler avec du texte au format PDF à l'aide de Java
...
- [Ajouter du texte aux fichiers PDF](/pdf/fr/java/add-text-to-pdf-file/)
- [Ajouter des info-bulles au texte](/pdf/fr/java/pdf-tooltip/)
- [Utilisez FloatingBox pour la mise en page](/pdf/fr/java/floating-box/)
- [Remplacer le texte dans le PDF](/pdf/fr/java/replace-text-in-pdf/)
- [Faire pivoter le texte dans le PDF](/pdf/fr/java/rotate-text-inside-pdf/)
- [Rechercher et extraire du texte](/pdf/fr/java/search-and-get-text-from-pdf/)
- [Formater le texte dans le PDF](/pdf/fr/java/text-formatting-inside-pdf/)
