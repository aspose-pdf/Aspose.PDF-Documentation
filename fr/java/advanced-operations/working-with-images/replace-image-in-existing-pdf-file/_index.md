...
Abstract: Cet article montre comment remplacer des images dans des documents PDF à l'aide d'Aspose.PDF for Java. Il couvre le remplacement d'une image par son index de ressources et le remplacement du premier emplacement d'image correspondant trouvé avec ImagePlacementAbsorber.
---
...
## Remplacer une image en utilisant `ImagePlacementAbsorber`
