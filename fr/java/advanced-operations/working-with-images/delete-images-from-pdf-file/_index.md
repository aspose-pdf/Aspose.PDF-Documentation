...
Abstract: Cet article montre comment supprimer des images de documents PDF à l'aide d'Aspose.PDF for Java. L'exemple supprime une ressource image de la première page par son index dans la collection d'images de page, puis enregistre le document modifié.
---
