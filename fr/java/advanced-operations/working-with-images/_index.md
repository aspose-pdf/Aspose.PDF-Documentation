---
title: Travailler avec des images au format PDF à l'aide de Java
...
- [Ajouter des images à un PDF existant](/pdf/java/add-image-to-existing-pdf-file/)

- [Supprimer des images d'un PDF](/pdf/java/delete-images-from-pdf-file/)

- [Extraire des images d'un PDF](/pdf/java/extract-images-from-pdf-file/)

- [Remplacer les images dans un PDF](/pdf/java/replace-image-in-existing-pdf-file/)
- [Rechercher et inspecter des images dans un PDF](/pdf/java/search-and-get-images-from-pdf-document/)
