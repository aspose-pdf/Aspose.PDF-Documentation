...
description: Découvrez comment copier des annotations d'un document PDF vers un autre document PDF à l'aide d'Aspose.PDF for Java.
lastmod: "2026-09-22"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
1. Ajoutez chaque [Annotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/annotation/) à la [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) cible.
