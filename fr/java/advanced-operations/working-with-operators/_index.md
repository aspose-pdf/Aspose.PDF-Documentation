...
1. Restaurez l’état graphique et enregistrez le PDF de sortie.
...
- [Gérer les pages PDF en Java](/pdf/fr/java/working-with-pages/)
- [Travailler avec des graphiques vectoriels en Java](/pdf/fr/java/working-with-vector-graphics/)
