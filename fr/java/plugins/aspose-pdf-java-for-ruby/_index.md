...
- [Télécharger et configurer Aspose.Pdf en Ruby](/pdf/fr/java/download-and-configure-aspose-pdf-in-ruby/)
- [Guide du programmeur Ruby](/pdf/fr/java/ruby-programmers-guide/)
  - [Travailler avec l'objet Document en Ruby](/pdf/fr/java/working-with-document-object-in-ruby/)
    - [Ajouter du JavaScript en Ruby](/pdf/fr/java/adding-javascript-in-ruby/)
    - [Ajouter des calques au fichier PDF en Ruby](/pdf/fr/java/add-layers-to-pdf-file-in-ruby/)

    - [Ajouter une table des matières à un PDF existant en Ruby](/pdf/fr/java/add-toc-to-existing-pdf-in-ruby/)
- [Obtenir les propriétés de la fenêtre du document et de l'affichage des pages en Ruby](/pdf/fr/java/get-document-window-and-page-display-properties-in-ruby/)
- [Obtenir des informations sur le fichier PDF en Ruby](/pdf/fr/java/get-pdf-file-information-in-ruby/)
- [Obtenir les métadonnées XMP d'un fichier PDF en Ruby](/pdf/fr/java/get-xmp-metadata-from-pdf-file-in-ruby/)
- [Optimiser le document PDF pour le Web en Ruby](/pdf/fr/java/optimize-pdf-document-for-the-web-in-ruby/)
- [Optimiser la taille du fichier PDF en Ruby](/pdf/fr/java/optimize-pdf-file-size-in-ruby/)
- [Supprimer les métadonnées du PDF en Ruby](/pdf/fr/java/remove-metadata-from-pdf-in-ruby/)
- [Définir les propriétés de la fenêtre du document et de l'affichage des pages en Ruby](/pdf/fr/java/set-document-window-and-page-display-properties-in-ruby/)
- [Définir l'expiration du PDF en Ruby](/pdf/fr/java/set-pdf-expiration-in-ruby/)
- [Définir des informations sur le fichier PDF en Ruby](/pdf/fr/java/set-pdf-file-information-in-ruby/)
- [Travailler avec les pages en Ruby](/pdf/fr/java/working-with-pages-in-ruby/)

- [Concaténer des fichiers PDF en Ruby](/pdf/fr/java/concatenate-pdf-files-in-ruby/)
- [Supprimer une page particulière d'un fichier PDF en Ruby](/pdf/fr/java/delete-a-particular-page-from-the-pdf-file-in-ruby/)
- [Obtenir une page particulière dans un fichier PDF en Ruby](/pdf/fr/java/get-a-particular-page-in-a-pdf-file-in-ruby/)
- [Obtenir le nombre de pages d'un PDF en Ruby](/pdf/fr/java/get-page-count-of-pdf-in-ruby/)
- [Obtenir les propriétés de la page en Ruby](/pdf/fr/java/get-page-properties-in-ruby/)
- [Insérer une page vide à la fin d'un fichier PDF en Ruby](/pdf/fr/java/insert-an-empty-page-at-end-of-pdf-file-in-ruby/)
- [Insérer une page vide dans un fichier PDF en Ruby](/pdf/fr/java/insert-an-empty-page-into-a-pdf-file-in-ruby/)
- [Diviser un fichier PDF en pages individuelles en Ruby](/pdf/fr/java/split-pdf-file-into-individual-pages-in-ruby/)
- [Mettre à jour les dimensions de la page en Ruby](/pdf/fr/java/update-page-dimensions-in-ruby/)
- [Travailler avec du texte en Ruby](/pdf/fr/java/working-with-text-in-ruby/)
- [Ajouter une chaîne HTML en utilisant DOM en Ruby](/pdf/fr/java/add-html-string-using-dom-in-ruby/)
- [Ajouter du texte à un fichier PDF existant en Ruby](/pdf/fr/java/add-text-to-an-existing-pdf-file-in-ruby/)
- [Extraire le texte de toutes les pages d'un document PDF en Ruby](/pdf/fr/java/extract-text-from-all-the-pages-of-a-pdf-document-in-ruby/)
  - [Travailler avec la conversion de documents en Ruby](/pdf/fr/java/working-with-document-conversion-in-ruby/)
    - [Convertir HTML en format PDF en Ruby](/pdf/fr/java/convert-html-to-pdf-format-in-ruby/)
    - [Convertir des pages PDF en images en Ruby](/pdf/fr/java/convert-pdf-pages-to-images-in-ruby/)
    - [Convertir PDF en format DOC ou DOCX en Ruby](/pdf/fr/java/convert-pdf-to-doc-or-docx-format-in-ruby/)
    - [Convertir PDF en classeur Excel en Ruby](/pdf/fr/java/convert-pdf-to-excel-workbook-in-ruby/)
    - [Convertir PDF en format SVG en Ruby](/pdf/fr/java/convert-pdf-to-svg-format-in-ruby/)
    - [Convertir un fichier SVG en format PDF en Ruby](/pdf/fr/java/convert-svg-file-to-pdf-format-in-ruby/)
- [Supporter, étendre et contribuer à Aspose.Pdf en Ruby](/pdf/fr/java/support-extend-and-contribute-to-aspose-pdf-in-ruby/)