---
title: Optimiser un document PDF pour le Web en Ruby
...
Pour optimiser un document PDF pour le Web à l'aide de **Aspose.PDF Java pour Ruby**, utilisez la méthode **optimize_web** du module **Optimize**.
