...
Abstract: Cet article explique comment inspecter les polices utilisées dans un document PDF avec Aspose.PDF for Java. Il montre comment ouvrir un PDF, appeler `getFontUtilities().getAllFonts()` et parcourir les objets de police résultants pour lire leurs noms.
---
