...
Abstract: Cet article explique comment extraire des images incorporées à partir d'un document PDF avec Aspose.PDF for Java. Il montre comment ouvrir le PDF source, accéder à une image de la collection de ressources de la page et enregistrer l’objet XImage extrait dans un fichier externe.
---
