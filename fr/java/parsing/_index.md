...
sitemap:
    ...
    priority: 0.7
TechArticle: true
AlternativeHeadline: Analyser des fichiers PDF avec Aspose.PDF for Java
Abstract: Cet article présente les fonctionnalités d'analyse PDF dans Aspose.PDF for Java. Il couvre l'extraction de texte, d'images, de polices, de données AcroForm, de données de tableaux et de graphiques vectoriels à partir de documents PDF, avec des liens vers des guides ciblés pour chaque tâche.
---
L’analyse de documents PDF consiste à extraire le contenu structuré ou brut des fichiers PDF existants afin qu'il puisse être inspecté, exporté, indexé ou réutilisé dans d'autres flux de travail.
