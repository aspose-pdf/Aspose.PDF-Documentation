...
Abstract: Cet article explique comment extraire et exporter des données AcroForm à partir de fichiers PDF avec Aspose.PDF for Java. Il couvre la lecture de tous les champs de formulaire, la récupération d'une valeur de champ par nom, l'exportation des données de champ au format JSON et l'écriture des données de formulaire aux formats XML, FDF et XFDF.
---
