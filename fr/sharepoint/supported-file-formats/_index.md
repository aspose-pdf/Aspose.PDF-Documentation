...
Le tableau suivant indique les formats de fichiers qu'Aspose.PDF for SharePoint peut charger.
...
Le tableau suivant indique les formats de fichiers dans lesquels le document peut être enregistré à l'aide d'Aspose.PDF for SharePoint.
