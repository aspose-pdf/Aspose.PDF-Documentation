...
type: docs
weight: 70
url: /fr/go-cpp/supported-file-formats/
description: Cette page montre quels formats de fichiers Aspose.PDF for Go peut charger et enregistrer.
lastmod: "2026-07-04"
sitemap:
    changefreq: "monthly"
    priority: 0.7
TechArticle: true
AlternativeHeadline: Page des Formats de fichiers pris en charge pour Aspose.PDF for Go
Abstract: La page Formats de fichiers pris en charge pour Aspose.PDF for Go fournit des informations détaillées sur les formats de fichiers que la bibliothèque peut charger et enregistrer. Elle inclut le PDF (Portable Document Format) ainsi que divers autres formats de documents, avec des instructions claires sur les formats pris en charge pour la lecture (chargement) et l'écriture (enregistrement). Cela aide les développeurs à déterminer quels formats de fichiers ils peuvent manipuler en utilisant la bibliothèque Aspose.PDF for Go lors de la création de solutions de manipulation de PDF. La page constitue une référence importante pour les utilisateurs afin de comprendre la compatibilité des fichiers de l'API.
SoftwareApplication: go-cpp
---

Le tableau suivant indique les formats de fichier que Aspose.PDF for Go peut charger et enregistrer.
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Enregistre le document en tant qu'image TIFF simple ou multi-pages||{{< emoticons/tick >}} | |
|[Texte](https://docs.fileformat.com/word-processing/txt/)|Enregistrez le document au format texte||{{< emoticons/tick >}} | |
|DICOM|Enregistrez le document au format texte DICOM||{{< emoticons/tick >}} | |