...
type: docs  
weight: 50  
url: /fr/python-java/get-page-properties-in-python/  
---

Pour obtenir les propriétés de la page d'un document Pdf en utilisant **Aspose.PDF Java pour Python**, il suffit d'invoquer la classe **GetPageProperties**.
...
print "BleedBox : Hauteur = " + pdf_page.getBleedBox().getHeight() + ", Largeur = " + pdf_page.getBleedBox().getWidth() + ", LLX = " + pdf_page.getBleedBox().getLLX() + ", LLY = " + pdf_page.getBleedBox().getLLY() + ", URX = " + pdf_page.getBleedBox().getURX() + ", URY = " 
...
print "Rect : Height = " + pdf_page.getRect().getHeight() + ", Width = " + pdf_page.getRect().getWidth() + ", LLX = " + pdf_page.getRect().getLLX() + ", LLY = " + pdf_page.getRect().getLLY() + ", URX = " + pdf_page.getRect().getURX() + ", URY = " + pdf_page.getRect().getURY()print "Numéro de page :- " + pdf_page.getNumber()  
