...
- [Ajouter des tampons d'image dans la page PDF](/pdf/fr/php-java/image-stamps-in-pdf-page/) - ajouter un tampon d'image, contrôler la qualité de l'image, tampon d'image comme arrière-plan de votre fichier PDF.
- [Ajouter des tampons de texte dans le fichier PDF](/pdf/fr/php-java/text-stamps-in-the-pdf-file/) - ajouter un tampon de texte, définir l'alignement pour l'objet TextStamp, remplir le texte de contour comme tampon dans le PDF.

- [Ajouter des tampons de page dans les PDF](/pdf/fr/php-java/page-stamps-in-the-pdf-file/) - ajouter un tampon complexe basé sur une page d'un autre fichier PDF.