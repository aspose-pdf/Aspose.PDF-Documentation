...
Le tableau suivant indique les formats de fichiers qu'Aspose.PDF pour PHP via Java peut charger et enregistrer.
...
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|Graphiques Vectoriels Adaptatifs (Un format d'image vectorielle basé sur XML)|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[XSLFO](https://docs.fileformat.com/page-description-language/xslfo/)|XSL-FO fait partie du fichier XSL utilisé pour la transformation et le formatage des données XML|{{< emoticons/tick >}}| | |
...
|[EMF](https://docs.fileformat.com/image/emf/)|Format de métafichier amélioré (EMF)| |{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Enregistre le document en image TIFF simple ou multi-pages| |{{< emoticons/tick >}}| |
|[Text](https://docs.fileformat.com/word-processing/txt/)|Enregistre le document au format texte| |{{< emoticons/tick >}}| |