...
linktitle: Licence simple et abordable
type: docs
weight: 20
url: /fr/jasperreports/simple-and-affordable-licensing/
description: Découvrez des options de licence simples et abordables pour Aspose.PDF pour JasperReports. Débloquez de puissantes fonctionnalités d’exportation PDF à un excellent rapport qualité-prix.
lastmod: "2021-06-05"
---

{{% alert color="primary" %}}

Chaque licence Aspose est accompagnée d'un an de mises à jour logicielles gratuites et d'une assistance technique gratuite et illimitée.
...
Profitez de la version d'évaluation d'Aspose.PDF pour JasperReports : elle n'a pas de limite de temps et est accompagnée d'un support technique gratuit.
