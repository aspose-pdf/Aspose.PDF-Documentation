...
6. Exécutez JasperServer et ouvrez n'importe quel rapport à afficher. Si les étapes précédentes ont été correctement réalisées, vous verrez une icône d'exportation via Aspose.PDF for JasperReports dans la liste des formats disponibles.

   **Aspose.PDF for JasperReports est intégré**
