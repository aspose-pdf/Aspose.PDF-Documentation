...
Ceci est une application ASP simple qui vous montre comment ajouter une chaîne de texte simple à un fichier PDF en utilisant [Aspose.PDF for .NET](/pdf/fr/net/) et JScript via COM Interop.
