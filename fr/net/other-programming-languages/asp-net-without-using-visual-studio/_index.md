...
[Aspose.PDF pour .NET](/pdf/fr/net/) peut être utilisé pour développer des pages ou des applications ASP.NET sans utiliser Visual Studio. Dans cet exemple, nous allons écrire du HTML et le code C# ou VB.NET dans un seul fichier .aspx ; cela est communément appelé ASP.NET instantané.
...
Cet exemple montre comment utiliser [Aspose.PDF pour .NET](/pdf/fr/net/) avec du code intégré dans une page ASP.NET afin de créer un document PDF simple avec du texte d'exemple à l'intérieur.
{{% /alert %}}
