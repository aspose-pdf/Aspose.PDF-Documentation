...
Il s'agit d'une application ASP simple qui vous montre comment créer un fichier PDF avec du texte d'exemple en utilisant [Aspose.PDF pour .NET](/pdf/fr/net/) et VBScript via COM Interop.
