...
<script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "TechArticle",
    "headline": "Travailler avec des documents PDF en utilisant la fonction Microsoft Azure",
    "alternativeHeadline": "Utiliser la fonction Microsoft Azure pour traiter des documents PDF",
    "author": {
        "@type": "Person",
        "name":"Anastasiia Holub",
        "givenName": "Anastasiia",
    ...
    "keywords": "pdf, c#, opérations avancées dans pdf, microsoft azure, fonction",
    "wordcount": "302",
    ...
    "description": "Aspose.PDF for .NET peut traiter des documents en utilisant la fonction Microsoft Azure."
}
</script>
