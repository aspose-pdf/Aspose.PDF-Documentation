...
- [Ouvrir un document PDF](/pdf/fr/net/open-pdf-document/) - cet article décrit les différentes manières d'ouvrir un document PDF dans une application .NET.
- [Enregistrer un document PDF](/pdf/fr/net/save-pdf-document/) - cet article décrit les différentes manières d'enregistrer un document PDF dans un fichier, un flux, l'envoyer sur le Web ou l'enregistrer en tant que document PDF/A (ou PDF/X).
