...
Avec l'aide de [CompositingParameters](https://reference.aspose.com/pdf/fr/net/aspose.pdf.facades.pdffilemend/addimage/methods/1), nous pouvons superposer une image sur une autre :
...
La deuxième façon d'ajouter [FormattedText](https://reference.aspose.com/pdf/fr/net/aspose.pdf.facades/formattedtext). De plus, nous indiquons un rectangle dans lequel notre texte doit s'adapter.
