...
[Aspose.PDF for .NET](/pdf/fr/net/) est un composant riche en fonctionnalités lorsqu'il s'agit d'éditer des documents PDF. Comme nous le savons, XFDF est un aspect important de la manipulation des formulaires PDF, le [namespace Aspose.Pdf.Facades](https://reference.aspose.com/pdf/net/aspose.pdf.facades) dans [Aspose.PDF for .NET](/pdf/fr/net/) a très bien pris cela en compte et a fourni des méthodes pour importer et exporter des données d'annotations vers des fichiers XFDF.
