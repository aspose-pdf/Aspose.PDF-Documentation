...
Le tableau suivant indique les formats de fichiers que Aspose.PDF C# peut charger et sauvegarder.
...
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|Métafichier de graphiques informatiques pour graphiques vectoriels 2D|{{< emoticons/tick >}}| | |
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|Format de fichier de composition typographique LaTex|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
| [TeX](https://docs.fileformat.com/page-description-language/tex/) | Format de fichier de composition de LaTex | {{< emoticons/tick >}} | {{< emoticons/tick >}} |  |
| [MHT](https://docs.fileformat.com/web/mhtml/) | Document MHTML | {{< emoticons/tick >}} |  |  |
| [PCL](https://docs.fileformat.com/page-description-language/pcl/) | Fichiers du langage de contrôle d'imprimante | {{< emoticons/tick >}} |  |  |
...
| [XSLFO](https://docs.fileformat.com/page-description-language/xslfo/) | XSL-FO fait partie du fichier XSL qui est utilisé pour la transformation et la mise en forme des données XML | {{< emoticons/tick >}} |  |  |
| [XSLFO](https://docs.fileformat.com/page-description-language/xslfo/) | XSL-FO fait partie du fichier XSL qui est utilisé pour la transformation et le formatage des données XML | {{< emoticons/tick >}} |  |  |
...
| [PPTX](https://docs.fileformat.com/presentation/pptx/) | Enregistre le document au format de présentations Microsoft PowerPoint |  | {{< emoticons/tick >}} |  |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Enregistre le document en image TIFF à page unique ou multipage|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[Text](https://docs.fileformat.com/word-processing/txt/)|Enregistre le document au format Texte|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
```
|[Texte](https://docs.fileformat.com/word-processing/txt/)|Enregistrer le document au format Texte|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
```
