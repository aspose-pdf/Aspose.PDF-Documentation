---
title: Ajouter une signature numérique avec un gestionnaire de sécurité personnalisé en C#
linktitle: Gestionnaire de sécurité personnalisé
type: docs
weight: 40
url: /fr/net/custom-security-handler/
description: Ajouter une signature numérique avec un gestionnaire de sécurité personnalisé en C#
lastmod: "2025-04-08"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Vous pouvez créer votre propre gestionnaire de sécurité en appliquant l'algorithme de cryptage souhaité.
Adobe Acrobat ne pourra pas ouvrir un tel fichier, mais vous pouvez travailler avec en utilisant Aspose.Pdf.
Pour créer un gestionnaire, vous devez implémenter l'interface :
...
Un exemple d'implémentation simple de l'interface (uniquement pour démontrer) :
...
Exemple de cryptage de document :
...
Exemple d'ouverture d'un document crypté :
