...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Remplacer une image dans un fichier PDF existant",
    "alternativeHeadline": "Comment remplacer une image dans un PDF",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, dotnet, remplacer une image dans un pdf",
    "wordcount": "302",
...
La collection d'Images se trouve dans la collection de Ressources d'une page. Pour remplacer une image :

1. Ouvrir le fichier PDF en utilisant l'objet Document.
2. Remplacer une image particulière, enregistrer le fichier PDF mis à jour en utilisant la méthode Save de l'objet Document.

Le code suivant montre comment remplacer une image dans un fichier PDF.
