...
La méthode [Replace](https://reference.aspose.com/pdf/fr/net/aspose.pdf/ximagecollection/methods/replace/index) de la collection Images vous permet de remplacer une image dans un fichier PDF existant.
