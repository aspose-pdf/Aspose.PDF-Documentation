...
Cette préférence peut être activée et désactivée en utilisant la façade [PdfContentEditor](https://reference.aspose.com/pdf/fr/net/aspose.pdf.facades/pdfcontenteditor/).
