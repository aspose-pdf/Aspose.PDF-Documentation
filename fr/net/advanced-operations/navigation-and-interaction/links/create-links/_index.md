...
1. [Créer un Document](https://reference.aspose.com/pdf/net/aspose.pdf/document) objet.
1. Obtenez la [Page](https://reference.aspose.com/pdf/net/aspose.pdf/page) à laquelle vous souhaitez ajouter le lien.
...
1. De plus, définissez la propriété Action de l'objet [LaunchAction](https://reference.aspose.com/pdf/net/aspose.pdf.annotations/launchaction).
...
1. Ensuite, obtenez la [Page](https://reference.aspose.com/pdf/net/aspose.pdf/page) particulière à laquelle vous souhaitez ajouter le lien.
1. Créez un objet [LinkAnnotation](https://reference.aspose.com/pdf/net/aspose.pdf.annotations/linkannotation) en utilisant les objets Page et [Rectangle](https://reference.aspose.com/pdf/net/aspose.pdf/rectangle).
1. Définissez les attributs du lien en utilisant l'objet [LinkAnnotation](https://reference.aspose.com/pdf/net/aspose.pdf.annotations/linkannotation).
1. Définissez la propriété Action sur l'objet [GoToRemoteAction](https://reference.aspose.com/pdf/net/aspose.pdf.annotations/gotoremoteaction).
