...
description: Aspose.PDF peut supprimer des pièces jointes de vos documents PDF. Utilisez l'API PDF C# pour supprimer des pièces jointes dans des fichiers PDF en utilisant la bibliothèque Aspose.PDF.
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF inclut désormais une fonctionnalité puissante qui permet aux utilisateurs de supprimer facilement des pièces jointes de leurs documents PDF en utilisant l'API PDF C#. Cette fonctionnalité simplifie la gestion des PDF en permettant aux utilisateurs de supprimer tous les fichiers intégrés de leurs documents, garantissant une expérience PDF plus propre et plus fluide.",
    "author": {
        "@type": "Person",
