...
- **Linux と macOS** 用に、実行時に実行可能ファイルがライブラリを見つけられるよう、[ランタイム構成](/pdf/ja/rust-cpp/runtime-configuration/) の手順も実行してください。
...
**重要:** **Linux と macOS** の場合、実行時に実行可能ファイルがライブラリを見つけられるよう、[ランタイム構成](/pdf/ja/rust-cpp/runtime-configuration/) の手順にも従ってください。
