...
1. PDFドキュメントを開く。
1. ページをJPEGに変換するには [PageToJpg](https://reference.aspose.com/pdf/go-cpp/convert/pagetojpg/) 関数。
...
1. PDFドキュメントを開く。
1. ページを TIFF に変換するには [PageToTiff](https://reference.aspose.com/pdf/go-cpp/convert/pagetotiff/) 関数。
1. PDF ドキュメントを閉じ、割り当てられたリソースを解放してください。
...
1. PDFドキュメントを開く。
1. ページを PNG に変換するには [PageToPng](https://reference.aspose.com/pdf/go-cpp/convert/pagetopng/) 関数。
1. PDF ドキュメントを閉じ、割り当てられたリソースを解放してください。
