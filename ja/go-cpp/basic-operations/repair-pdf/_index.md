...
1. PDF ドキュメントを開くには [Open](https://reference.aspose.com/pdf/go-cpp/core/open/) 関数。
1. PDF ドキュメントを修復するには [Repair](https://reference.aspose.com/pdf/go-cpp/organize/repair/) 関数。
