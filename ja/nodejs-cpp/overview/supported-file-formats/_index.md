...
description: このページでは、Aspose.PDF for Node.js が読み込みおよび保存できるファイル形式を示します。
lastmod: "2026-07-18"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
以下の表は、Aspose.PDF for Node.js via C++ が読み込みおよび保存できるファイル形式を示しています。
...
|[SVGZ](https://docs.fileformat.com/image/svgz/)|SVGZ ファイル形式| |{{< emoticons/tick >}}| |
