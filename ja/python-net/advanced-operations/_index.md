...
<script type="application/ld+json">
{
    ...
    "alternativeHeadline": "Pythonを使用したPDF作業における高度な機能",
    "author": {
        "@type": "Person",
    ...
    "genre": "pdfドキュメント生成",
    "keywords": "pdf, python, pdfの高度な操作, pdf作成, pdf削除, pdf操作",
    "wordcount": "302",
    ...
    "description": "Aspose.PDFは、単純で簡単なタスクを実行するだけでなく、より複雑な目標にも対応できます。次のセクションでPythonを介して.NETを使用する上級ユーザーと開発者向けの情報を確認してください。"
}
</script>
