...
[リンク注釈](https://reference.aspose.com/pdf/ja/net/aspose.pdf.annotations/linkannotation)は、ハイパーリンク、他の場所への宛先、およびドキュメントを表します。PDF標準によれば、リンク注釈は次の3つのケースで使用できます：ページビューを開く、ファイルを開く、Webページを開く。
