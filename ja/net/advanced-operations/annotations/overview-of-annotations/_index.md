...
description: Aspose.PDF for .NETを使用して作業できる可能な注釈のリストを確認してください。
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NETで利用可能なサポートされている注釈の包括的リストを発見し、開発者がさまざまな機能でPDFドキュメントを強化できるようにします。この機能には、テキスト、リンク、ハイライト、マルチメディアなどの多様な注釈タイプが含まれ、PDFの操作とカスタマイズのための強力なオプションを提供します。これらの注釈がどのようにあなたの.NETアプリケーションを向上させ、PDFコンテンツとのユーザーエンゲージメントを改善できるかを探ってください。",
    "author": {
        "@type": "Person",
...
以下の表は、Aspose.PDF for .NETがサポートしている注釈タイプを示しています。
