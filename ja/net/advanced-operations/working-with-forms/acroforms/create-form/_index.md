...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NETでは、記入可能なPDFフォームを一から作成する機能が導入され、開発者はテキストボックス、ラジオボタン、コンボボックスなどのカスタマイズ可能なフォームフィールドをPDFにシームレスに統合できます。この機能により、アプリケーション内でドキュメントのインタラクティブ性を向上させ、データ収集を改善することが可能になります",
    "author": {
        "@type": "Person",
...
[Document](https://reference.aspose.com/pdf/ja/net/aspose.pdf/document)クラスは、PDFドキュメント内のフォームフィールドを管理する[Form](https://reference.aspose.com/pdf/ja/net/aspose.pdf/document/properties/form)コレクションを提供します。
...
[TextBoxField](https://reference.aspose.com/pdf/ja/net/aspose.pdf.forms/textboxfield)はウィジェット注釈と共に追加できます。
{{< tabs tabID="1" tabTotal="2" tabName1=".NET Core 3.1" tabName2=".NET 8" >}}
{{< tab tabNum="1" >}}
```csharp
...
Documentクラスは、PDFドキュメント内のフォームフィールドを管理するFormコレクションを提供します。フォームフィールドにツールチップを追加するには、FieldクラスのAlternateNameプロパティを使用します。Adobe Acrobatは「alternate name」をフィールドのツールチップとして使用します。
