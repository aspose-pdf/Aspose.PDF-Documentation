...
- [円](/pdf/net/add-circle/) - データをセクターに分割された円を使用して表示します。データが全体またはグループの一部を表す方法を示すために円グラフ（パイチャートとも呼ばれます）を使用します。
- [曲線](/pdf/net/add-curve/) - 各線が他の三つの線と通常の二重点で交わる投影線の接続された集合です。
