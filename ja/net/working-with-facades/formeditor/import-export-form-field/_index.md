...
Aspose.PDF for .NETは、PDFドキュメント内のフォームフィールドを作成/操作するための優れた機能を提供します。このAPIを使用すると、プログラム的にPDFファイル内のフォームフィールドを埋めたり、[FDFからPDFファイルにデータをインポートする](/pdf/net/import-and-export-data/)、[XFDFからPDFファイルにデータをインポートする](/pdf/net/import-and-export-data/)、[XMLからPDFファイルにデータをインポートする](/pdf/net/import-and-export-data/)ことができます。また、[System.Data.DataTable](https://reference.aspose.com/pdf/net/aspose.pdf.table/importdatatable/methods/1)オブジェクトからデータをインポートすることもできます。
