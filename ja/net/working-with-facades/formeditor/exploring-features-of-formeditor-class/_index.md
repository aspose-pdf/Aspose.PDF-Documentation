...
開発者は、[Aspose.Pdf.Facades namespace](https://reference.aspose.com/pdf/net/aspose.pdf.facades)を使用して、新しいフォームやフォームフィールドをPDFドキュメントに追加するだけでなく、既存のフィールドを編集することもできます。 この記事の範囲は、フォーム編集を扱う[Aspose.PDF for .NET](/pdf/ja/net/)の機能に限定されています。
