...
<script type="application/ld+json">
{
    ...
    "abstract": "PdfFileSignatureクラスを使用してデジタル署名を追加する新しい機能で、PDFドキュメントを強化します。この機能により、ユーザーはPKCS#1、PKCS#7、PKCS#7Detachedなどのさまざまな署名タイプを適用し、画像や特定の属性を使用して署名の外観をカスタマイズできます。複数の署名を異なるページに簡単に組み込むことで、ドキュメントの検証プロセスを効率化します。",
    "author": {
        "@type": "Person",
...
以下のコード例は、2つの署名でドキュメントに署名する能力を示しています。私たちの例では、最初のページに最初の署名を、2番目のページに2番目の署名を置きます。必要なページを指定できます。
