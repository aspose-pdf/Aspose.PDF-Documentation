...
以下は、さまざまなプログラミング言語で使用するための推奨される相互運用技術のリストです：
以下は、さまざまなプログラミング言語に対して使用することを推奨する相互運用技術のリストです：

{{% /alert %}}

|**プログラミング言語** |**使用するAspose.PDF** |**相互運用技術** |
| :- | :- | :- |
|ASP |.NET |COM Interop |
|デルファイ |.NET |COM Interop |
