...
type: docs
weight: 10
url: ja/java/supported-xml-schema/
description: この記事では、Aspose.PDF for Java で XML ドキュメントを操作するための XML スキーマについて説明します
lastmod: "2021-06-05"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Aspose.PDF for Java は、XML ドキュメントを操作するために次の XML スキーマを使用します:
