...
1. ECB 메뉴에서 **Convert to PDF**를 클릭합니다.
1. 결과 PDF 파일을 다운로드하고 저장합니다.

ECB 메뉴의 Convert to PDF 옵션
...
- 다음 사항에 유의하십시오. **Application** 및 **Producer** 필드에 값을 설정할 수 없습니다. Aspose Ltd.와 Aspose.PDF for SharePoint x.x.x가 이 필드에 표시됩니다. 
