...
이 문서에서는 Aspose.PDF for SharePoint를 사용하여 여러 선택된 파일을 단일 변환 작업으로 PDF 파일로 변환하는 방법을 보여줍니다.
