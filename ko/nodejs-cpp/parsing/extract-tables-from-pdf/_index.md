---
title: Node.js에서 PDF의 테이블 추출
linktitle: PDF에서 테이블 추출
type: docs
weight: 10
...
## PDF를 CSV 파일로 변환하면서 테이블 추출

### PDF를 CSV로 변환

PDF에 테이블이 있으면 별도의 CSV 파일로 저장됩니다. PDF 문서를 변환하려는 경우, 다음을 사용할 수 있습니다. [AsposePdfTablesToCSV](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftablestocsv/) 함수. 
Node.js 환경에서 PDF 파일을 변환하기 위해 다음 코드 스니펫을 확인하십시오.
...
1. 함수를 호출합니다. [AsposePdfTablesToCSV](https://reference.aspose.com/pdf/nodejs-cpp/convert/asposepdftablestocsv/).
