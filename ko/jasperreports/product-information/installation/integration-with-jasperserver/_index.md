...
JasperServer와 JasperReports용 Aspose.PDF를 통합하는 방법은 아래에 설명되어 있습니다.
...
6. JasperServer를 실행하고 보고서를 열어 확인하세요. 이전 단계가 올바르게 수행된 경우 사용 가능한 형식 목록에서 JasperReports용 Aspose.PDF를 통해 내보낼 수 있는 아이콘이 표시됩니다.

   **JasperReports용 Aspose.PDF가 통합되었습니다**
