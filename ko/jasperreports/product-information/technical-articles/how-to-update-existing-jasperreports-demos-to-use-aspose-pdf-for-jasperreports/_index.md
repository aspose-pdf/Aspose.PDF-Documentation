---
title: 방법 - JasperReports용 Aspose.PDF를 사용하도록 기존 JasperReports 데모를 업데이트합니다.
linktitle: 방법 - JasperReports용 Aspose.PDF를 사용하도록 기존 JasperReports 데모를 업데이트합니다.
type: docs
weight: 20
url: /ko/jasperreports/how-to-update-existing-jasperreports-demos-to-use-aspose-pdf-for-jasperreports/
description: JasperReports용 Aspose.PDF의 기능을 활용하기 위해 기존 JasperReports 데모를 업데이트하는 방법을 알아보세요.
lastmod: "2021-06-05"
---

{{% alert color="primary" %}}

JasperReports용 Aspose.PDF에는 보고서를 PDF로 내보내기 시작하는 데 도움이 되는 다양한 데모 프로젝트가 포함되어 있습니다. 이 데모는 새로운 내보내기 도구를 사용하는 방법을 보여주기 위해 수정된 표준 JasperReports 데모를 기반으로 합니다. 이 튜토리얼에서는 JasperReports용 Aspose.PDF를 사용하기 위해 기존 JasperReports 데모를 업데이트하는 데 필요한 단계를 안내합니다.
...
4. 기존 데모를 업데이트하려면 ```<InstallDir>```\jasperreports\demo\samples, (where ```<InstallDir>```(JasperReports의 압축을 푼 위치)를 엽니다. 예를 들어 JasperReports용 Aspose.PDF와 함께 사용하기 위해 글꼴 데모를 선택한 경우 원본 데모가 동일하게 유지되도록 복사본을 만드세요. 이 예에서는 새 폴더 이름을 **fonts.ap**으로 지정했습니다.
