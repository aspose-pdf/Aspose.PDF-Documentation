...
description: Aspose.PDF for JasperReports를 찾아보세요. 고급 맞춤 설정으로 JasperReports에서 직접 PDF 보고서를 생성합니다.
is_root: true
lastmod: "2026-09-09"
---
...
![Aspose.PDF for JasperReports 로고](../../aspose_pdf-for-jasperreports.png)

## Aspose.PDF for JasperReports 문서에 오신 것을 환영합니다

Aspose.PDF for JasperReports는 JasperReports와 JasperServer에서 보고서를 Portable Document Format (PDF)으로 내보내도록 설계된 유연한 구성 요소입니다. 표, 차트 및 이미지와 같은 중요한 보고서 기능은 가장 높은 정밀도로 PDF로 변환됩니다.
