...
- [PDF 페이지에 이미지 스탬프 추가](/pdf/ko/php-java/image-stamps-in-pdf-page/) - 이미지 스탬프 추가, 이미지 품질 제어, PDF 파일의 배경으로 이미지 스탬프 추가.
- [PDF 파일에 텍스트 스탬프 추가](/pdf/ko/php-java/text-stamps-in-the-pdf-file/) - 텍스트 스탬프 추가, TextStamp 객체의 정렬 정의, PDF에서 스탬프로 채우기 텍스트 

- [PDF에 페이지 스탬프 추가](/pdf/ko/php-java/page-stamps-in-the-pdf-file/) - 다른 PDF 파일의 페이지를 기반으로 복잡한 스탬프 추가.