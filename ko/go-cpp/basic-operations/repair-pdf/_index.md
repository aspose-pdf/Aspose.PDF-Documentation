...
1. PDF 문서를 열 때 사용 [열기](https://reference.aspose.com/pdf/go-cpp/core/open/) 함수.
1. PDF 문서를 다음으로 복구합니다 [복구](https://reference.aspose.com/pdf/go-cpp/organize/repair/) 함수.
