...
1. 
선택한 페이지 영역에서 텍스트를 수집하려면 [TextAbsorber](https://reference.aspose.com/pdf/java/com.aspose.pdf/textabsorber/)를 생성하세요.
...
추출된 텍스트와 함께 섹션 직사각형 및 단락 다각형을 검사하려면 `ParagraphAbsorber`을 사용하십시오.
...
1. [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/) 라인에서 재구성된 각 섹션 직사각형, 단락 다각형 및 단락 텍스트를 수집합니다.
