...
1. 모양 [XForm](https://reference.aspose.com/pdf/java/com.aspose.pdf/xform/)을 방문하여 추출된 텍스트를 인쇄합니다.
...
1. 대상 [페이지](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/)를 방문하여 해당 [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/) 개체를 수집합니다.
