...
1. 해당 메모리 버퍼에서 두 번째 [문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/)를 다시 엽니다.
...
1. 
[문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) 인스턴스에서 소스 PDF를 엽니다.
1. 전체 문서 추출을 위해 [TextAbsorber](https://reference.aspose.com/pdf/java/com.aspose.pdf/textabsorber/)를 만듭니다.
