...
`TextAbsorber`을 사용하면 전체 문서에서 일반 텍스트 스트림을 수집하여 파일에 쓸 수 있습니다. 읽을 수 있는 텍스트 콘텐츠만 필요하고 단락 경계나 좌표는 필요하지 않은 경우 가장 간단한 옵션입니다.
...
1. 
[TextAbsorber](https://reference.aspose.com/pdf/java/com.aspose.pdf/textabsorber/)를 만들어 문서 전체에 걸쳐 텍스트를 축적하세요.
