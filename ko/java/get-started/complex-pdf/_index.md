...
1. 
설명 단락에 대한 두 번째 [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/)를 만듭니다.

1. 
테두리, 패딩, 헤더 스타일을 적용하여 [표](https://reference.aspose.com/pdf/java/com.aspose.pdf/table/)를 만들어 보세요.
...
동일한 예에서는 도우미 메서드를 사용하여 헤더 형식과 생성된 출발 시간이 포함된 일정 테이블을 준비합니다.
