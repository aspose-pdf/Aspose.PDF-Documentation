...
"Hello World" 예제는 기본 PDF 생성 작업 과정을 이해하는 가장 짧은 경로입니다. 이 문서의 예제에서는 새 PDF를 만들고, 스타일이 지정된 텍스트 조각을 페이지에 배치하고, 출력 파일을 저장합니다.
...
1. 
[TextState](https://reference.aspose.com/pdf/java/com.aspose.pdf/textstate/) 프래그먼트를 통해 [위치](https://reference.aspose.com/pdf/java/com.aspose.pdf/position/), 글꼴, 글꼴 크기, 배경색, 전경색을 설정합니다.

1. 
페이지에 대한 [TextBuilder](https://reference.aspose.com/pdf/java/com.aspose.pdf/textbuilder/)를 만듭니다.

1. 
[페이지](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/)에 [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/)를 추가합니다.
