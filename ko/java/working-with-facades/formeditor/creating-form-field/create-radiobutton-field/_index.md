...
Abstract: 이 기사에서는 Java용 Aspose.PDF에서 FormEditor 파사드를 사용하여 기존 PDF를 바인딩하고, 라디오 버튼 레이아웃 설정을 구성하고, 라디오 버튼 필드를 만들고, 수정된 문서를 저장하는 방법을 보여줍니다.
---
...
3. 
라디오 버튼 항목을 정의합니다.
4. 기본 선택 및 직사각형을 사용하여 라디오 버튼 필드를 추가합니다.
