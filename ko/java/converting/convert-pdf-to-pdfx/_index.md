...
1. 
변환 중에 규정 준수 문제가 기록되도록 유효성 검사 로그를 사이드카 XML 파일에 기록합니다.
...
1. 
[`PdfFormat`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pdfformat/) `PDF_X_4`에 대한 [`PdfFormatConversionOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pdfformatconversionoptions/)과 원하는 로그 파일 경로를 만듭니다.
