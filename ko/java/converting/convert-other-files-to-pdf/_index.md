...
1. 
Open the OFD source by passing the file path and [`OfdLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/ofdloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. 
Open the TeX source by passing the file path and [`TeXLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/texloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.

1. 
Let Aspose.PDF interpret the TeX markup and build the PDF layout during loading.
...
1. 
Open the PostScript source with [`PsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/psloadoptions/) in the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.

1. 
Let Aspose.PDF translate the PostScript page-description stream into a PDF document model.
...
1. 
Open the EPS source with [`PsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/psloadoptions/) because EPS follows the same PostScript-based load path.

1. 
Load the file into a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) so the page-description content is converted during import.
...
1. 
Open the EPUB source by passing the file path and [`EpubLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/epubloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.

1. 
Let Aspose.PDF load the ebook structure and transform it into PDF pages.
...
1. 
Open the Markdown source by passing the file path and [`MdLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/mdloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.

1. 
Let Aspose.PDF interpret the Markdown content and render it into PDF page content.
...
1. 
Create an empty [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) and add a [`Page`](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/).

1. 
Wrap the text in a [`TextFragment`](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/) and add it to the page paragraphs collection.
...
1. 
Create an empty [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) and configure each [`Page`](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) with margins and default text state.

1. 
Resolve the monospaced font through [`FontRepository`](https://reference.aspose.com/pdf/java/com.aspose.pdf/fontrepository/) and add each line as a [`TextFragment`](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/).

1. 
Save the output file after the page-building loop completes.
...
1. 
Create [`PclLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pclloadoptions/) and enable suppressed parsing errors when lenient import behavior is required.

1. 
Open the PCL source by passing the file path and load options into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. 
Pass the generated HTML file into the existing HTML-to-PDF conversion function so the final PDF uses the standard [`HtmlLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlloadoptions/) workflow.

1. 
Delete the temporary HTML file in the `finally` block after conversion completes.
...
1. 
Open the XPS source by passing the file path and [`XpsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/xpsloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.

1. 
Let Aspose.PDF interpret the XPS page description during document loading.
...
1. 
Create [`XslFoLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/xslfoloadoptions/) with the XSLT path so the XML source can be transformed during loading.

1. 
Configure the parsing error handling mode to throw immediately when invalid XSL-FO is encountered.

1. 
Open the XML source in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) with those load options.
...
1. 
Create a `Transformer` from the XSLT stylesheet and run it against the XML source.

1. 
Write the transformed HTML file to disk so the downstream PDF conversion function can load it.
