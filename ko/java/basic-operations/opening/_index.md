...
description: 파일 경로, 스트림 또는 비밀번호를 통해 Aspose.PDF를 사용하여 Java에서 PDF 파일을 여는 방법을 알아보세요.
lastmod: "2026-06-09"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
1. 비밀번호를 입력하여 암호화된 [문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/)를 엽니다.
