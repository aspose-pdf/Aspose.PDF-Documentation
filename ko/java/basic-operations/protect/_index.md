...
1. 
보호된 [문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/)에 대해 [암호알고리즘](https://reference.aspose.com/pdf/java/com.aspose.pdf/cryptoalgorithm/)을 선택하세요.
