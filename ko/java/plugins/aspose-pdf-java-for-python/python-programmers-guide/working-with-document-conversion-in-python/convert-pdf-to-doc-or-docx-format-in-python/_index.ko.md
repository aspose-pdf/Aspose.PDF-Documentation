...
**Aspose.PDF Java for Python**을 사용하여 PDF 문서를 DOC 또는 DOCX 형식으로 변환하려면, **PdfToDoc** 모듈을 호출하십시오.
...
아래 언급된 소셜 코딩 사이트 중 하나에서 **Convert PDF to DOC or DOCX (Aspose.PDF)**를 다운로드하십시오:
