---
title: Jython에서 PDF를 Excel 통합 문서로 변환
linktitle: Jython에서 PDF를 Excel 통합 문서로 변환
type: docs
weight: 20
url: /java/convert-pdf-to-excel-workbook-in-jython/
description: Aspose.PDF를 사용하여 Jython에서 PDF 문서를 Excel 통합 문서로 변환하고 분석을 위한 데이터 추출을 활성화하는 방법을 알아보세요.
lastmod: "2026-06-09"
---
## 
Aspose.PDF - PDF를 Excel로
