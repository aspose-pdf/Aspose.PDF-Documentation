...
1. 각 이미지의 [ColorType](https://reference.aspose.com/pdf/java/com.aspose.pdf/colortype/)을 읽어서 총합을 출력합니다.
...
낮은 수준의 페이지 콘텐츠 연산자에서 효과적인 이미지 크기와 해상도를 파생해야 하는 경우 이 예를 사용하세요.
...
1. 각 이미지 그리기 작업을 해결하고 유효 크기와 해상도를 계산합니다.
