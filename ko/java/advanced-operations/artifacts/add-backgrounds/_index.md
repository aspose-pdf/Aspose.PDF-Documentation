...
1. 
대상 페이지에 아티팩트를 추가하고 출력 PDF를 저장합니다.
...
1. 
유형이 페이지 매김이고 하위 유형이 배경인 이슈를 삭제한 후 문서를 저장합니다.
