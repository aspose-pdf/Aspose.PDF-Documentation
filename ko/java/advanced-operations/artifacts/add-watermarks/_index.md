...
1. 워터마크 페이지 매김 아티팩트를 필터링하고 해당 텍스트와 직사각형을 인쇄합니다.
...
1. 페이지에 워터마크를 추가하고 출력 파일을 저장합니다.
...
기존 워터마크 아티팩트를 페이지에서 제거해야 하는 경우 이 접근 방식을 사용하십시오.
...
1. 하위 유형이 워터마크인 페이지 매김 아티팩트를 삭제한 다음 문서를 저장합니다.
