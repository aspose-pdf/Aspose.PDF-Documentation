...
1. 
[HeaderArtifact](https://reference.aspose.com/pdf/java/com.aspose.pdf/headerartifact/)를 만듭니다.

1. 
텍스트, 글꼴 설정 및 전경색을 설정합니다.

1. 
수평 정렬을 구성하고 아티팩트를 반환합니다.
...
1. 
하위 유형이 머리글 또는 바닥글인 페이지 매김 아티팩트를 삭제한 다음 문서를 저장하십시오.
