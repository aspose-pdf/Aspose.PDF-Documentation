...
Abstract: 이 문서에서는 Aspose.PDF for Java를 사용하여 PDF 문서에서 Bates 번호 지정 아티팩트를 생성하고 제거하는 방법을 설명합니다. `BatesNArtifact` 구성, Bates 번호 매기기 도우미 또는 일반 페이지 매김 도우미를 통해 적용, 문서에서 Bates 번호 매기기 제거에 대해 다룹니다.
---
Bates 번호 지정 아티팩트는 각 페이지에 지속적인 페이지 수준 식별자가 필요한 법적, 보관 및 문서 제어 작업 흐름에 유용합니다.
...
1. 페이지 컬렉션에 Bates 번호 매기기를 적용하고 출력 파일을 저장합니다.
...
1. 페이지 컬렉션에 페이지 매김 아티팩트를 적용하고 문서를 저장합니다.
