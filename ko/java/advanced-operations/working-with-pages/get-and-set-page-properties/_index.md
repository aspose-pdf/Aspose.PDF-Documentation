...
1. 
모든 페이지를 반복하고 각 페이지를 읽습니다. [ColorType](https://reference.aspose.com/pdf/java/com.aspose.pdf/colortype/).

1. 
열거형 값을 읽을 수 있는 텍스트로 변환하고 결과를 출력합니다.
