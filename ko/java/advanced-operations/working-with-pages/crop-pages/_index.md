...
1. 새 자르기 [직사각형](https://reference.aspose.com/pdf/java/com.aspose.pdf/rectangle/)을 만듭니다.
1. 자르기 관련 페이지 상자에 사각형을 적용하고 문서를 저장합니다.
...
1. 자르기 상자를 이미지 직사각형으로 설정한 다음 문서를 저장합니다.
