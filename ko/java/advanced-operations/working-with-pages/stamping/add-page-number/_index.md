...
1. 
구성된 [PageNumberStamp](https://reference.aspose.com/pdf/java/com.aspose.pdf/pagenumberstamp/)를 대상 [페이지](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/)에 추가합니다.
