...
Abstract: 이 문서에서는 Aspose.PDF for Java를 사용하여 AcroForm 데이터를 외부 형식과 교환하는 방법을 설명합니다. Form Facade를 통해 XML, FDF 및 XFDF 데이터 가져오기 및 내보내기, 양식 필드 값을 JSON으로 추출하는 방법을 다룹니다.
---
