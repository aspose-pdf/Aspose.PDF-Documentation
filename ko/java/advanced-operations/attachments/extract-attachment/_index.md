...
1. 
첨부 스트림을 출력 파일에 복사하고 추출 후 중지합니다.
...
PDF에 포함된 모든 파일을 출력 디렉터리에 기록해야 하는 경우 이 예를 사용합니다.
...
1. 
메타데이터를 인쇄하고 각 첨부 파일 스트림을 저장한 다음 모든 파일을 내보낼 때까지 계속합니다.
...
1. 
페이지에서 첫 번째 [FileAttachmentAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/fileattachmentannotation/)을 찾습니다.

1. 
파일 사양을 읽고, 내용을 내보내고, 대상 경로를 인쇄합니다.
