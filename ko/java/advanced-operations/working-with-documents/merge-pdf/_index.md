...
1. 
원본 및 대상 PDF [문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) 개체를 열거나 받습니다.

1. 
사용 가능한 [페이지](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) 컬렉션 내에 유지되도록 요청된 페이지 범위를 정규화합니다.

1. 
검증된 범위의 각 페이지를 대상 문서에 추가합니다.
...
1. 
소스 페이지를 추가하고 선택적으로 첫 번째 콘텐츠 페이지를 가리키는 책갈피를 추가한 다음 병합된 최종 문서를 저장합니다.
