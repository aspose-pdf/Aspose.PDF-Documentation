...
---
Aspose.PDF for Java의 형식에는 뷰어 동작, 글꼴 포함 및 디스플레이 설정이 포함됩니다.
...
1. 포함되지 않은 [글꼴](https://reference.aspose.com/pdf/java/com.aspose.pdf/font/) 개체를 포함용으로 표시합니다.
...
1. 필요한 [TextFragment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/), [TextSegment](https://reference.aspose.com/pdf/java/com.aspose.pdf/textsegment/) 및 [TextState](https://reference.aspose.com/pdf/java/com.aspose.pdf/textstate/)를 만듭니다.
