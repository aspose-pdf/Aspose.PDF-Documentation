...
1. 
[그래프](https://reference.aspose.com/pdf/java/com.aspose.pdf.drawing/graph/) 컨테이너에 [사각형](https://reference.aspose.com/pdf/java/com.aspose.pdf.drawing/rectangle/)을 추가합니다.
