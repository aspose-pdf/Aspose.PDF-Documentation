...
1. 
페이지 수준 'ImagesDifference'를 얻으려면 'GraphicalPdfComparer'를 사용하십시오.
...
1. 
필요한 비교 모드에 대해 [SideBySideComparisonOptions](https://reference.aspose.com/pdf/java/com.aspose.pdf/comparison/sidebysidecomparisonoptions/)를 구성합니다.
...
1. 
[GraphicalPdfComparer](https://reference.aspose.com/pdf/java/com.aspose.pdf/comparison/graphicalpdfcomparer/) 임계값, 색상 및 해상도를 구성합니다.
...
1. 
원하는 비교 동작에 맞게 [SideBySideComparisonOptions](https://reference.aspose.com/pdf/java/com.aspose.pdf/comparison/sidebysidecomparisonoptions/)를 구성합니다.
