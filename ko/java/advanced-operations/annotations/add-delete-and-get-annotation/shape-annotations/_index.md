...
사용자 정의 색상, 불투명도, 팝업 데이터 또는 점 배열을 사용하여 기하학적 주석을 배치해야 하는 경우 다음 예를 사용하십시오.
...
1. 
필수 [AnnotationType](https://reference.aspose.com/pdf/java/com.aspose.pdf/annotationtype/) 값으로 필터링하고 직사각형을 인쇄합니다.
...
1. 
각 일치 항목을 [LineAnnotation](https://reference.aspose.com/pdf/java/com.aspose.pdf/lineannotation/)으로 전송하고 해당 좌표를 인쇄합니다.
