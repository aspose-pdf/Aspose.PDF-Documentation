...
1. 
헤더 행과 요청된 데이터 행 수를 추가한 다음 테이블을 반환합니다.
...
1. 
PDF [문서](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/)를 생성하고 생성된 테이블을 추가한 후 출력 파일을 저장합니다.
