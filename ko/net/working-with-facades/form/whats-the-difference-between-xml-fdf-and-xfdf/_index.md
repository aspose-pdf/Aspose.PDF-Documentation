...
Aspose.Pdf.Facades 네임스페이스에는 PDF 양식을 조작할 수 있는 [FormEditor](https://reference.aspose.com/pdf/ko/net/aspose.pdf.facades/formeditor)라는 클래스가 있으며, 기존의 모든 양식 필드 아래에 텍스트 필드를 추가하고 새 이름으로 PDF 양식을 저장할 수 있습니다.
