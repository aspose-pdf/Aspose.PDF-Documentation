...
[Aspose.PDF for .NET](/pdf/net/)는 PDF 문서를 편집할 때 기능이 풍부한 구성 요소입니다. XFDF는 PDF 양식 조작의 중요한 측면인 만큼, [Aspose.PDF for .NET](/pdf/net/)의 [Aspose.Pdf.Facades 네임스페이스](https://reference.aspose.com/pdf/net/aspose.pdf.facades)는 이를 잘 고려하여 XFDF 파일로 주석 데이터를 가져오고 내보내는 메서드를 제공했습니다.
