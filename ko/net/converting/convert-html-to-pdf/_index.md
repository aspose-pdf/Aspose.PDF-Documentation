...
lastmod: "2021-11-01"
description: 이 주제는 Aspose.PDF를 사용하여 HTML을 PDF 및 MHTML을 PDF로 변환하는 방법을 보여줍니다.
sitemap:
    changefreq: "monthly"
    priority: 0.8
---
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET의 변환 기능은 HTML 및 MHTML 문서를 고품질 PDF 파일로 원활하게 변환할 수 있습니다. 고급 사용자 정의 옵션을 통해 사용자는 글꼴 포함, 미디어 쿼리 및 외부 리소스 관리를 제어할 수 있으며, 웹 페이지 또는 로컬 HTML 파일이 PDF 형식으로 정확하게 렌더링되도록 하여 특정 요구 사항에 맞게 유연성을 보장합니다.",
    "author": {
        "@type": "Person",
...
- [C# HTML을 PDF로 변환하는 방법](#csharp-html-to-pdf)

_형식_: **MHTML**
- [C# MHTML을 PDF로 변환](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 변환하기](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 변환하는 방법](#csharp-mhtml-to-pdf)

_형식_: **웹 페이지**
- [C# 웹 페이지를 PDF로 변환](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 변환하기](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 변환하는 방법](#csharp-webpage-to-pdf)
...
Aspose는 ["HTML to PDF"](https://products.aspose.app/html/en/conversion/html-to-pdf)라는 온라인 무료 애플리케이션을 제공하여 기능과 품질을 조사해 볼 수 있습니다.

[![Aspose.PDF HTML을 PDF로 변환하는 무료 앱](html.png)](https://products.aspose.app/html/en/conversion/html-to-pdf)
{{% /alert %}}
...
Aspose.PDF for .NET은 ["MHTML to PDF"](https://products.aspose.app/pdf/conversion/mhtml-to-pdf)라는 온라인 무료 애플리케이션을 제공하여 기능과 품질을 조사해 볼 수 있습니다.

[![Aspose.PDF MHTML을 PDF로 변환하는 무료 앱](mhtml.png)](https://products.aspose.app/pdf/conversion/mhtml-to-pdf)
{{% /alert %}}

<abbr title="집합 HTML 문서의 MIME 캡슐화">MHTML</abbr>, MIME HTML의 약자는 일반적으로 외부 링크(예: 이미지, Flash 애니메이션, Java 애플릿 및 오디오 파일)로 표시되는 리소스를 HTML 코드와 결합하여 단일 파일로 만드는 웹 페이지 아카이브 형식입니다. MHTML 파일의 내용은 MIME 유형 multipart/related를 사용하여 HTML 이메일 메시지인 것처럼 인코딩됩니다. Aspose.PDF for .NET은 HTML 파일을 PDF 형식으로 변환할 수 있으며, Aspose.PDF for .NET 9.0.0의 출시와 함께 MHTML 파일을 PDF 형식으로 변환할 수 있는 새로운 기능을 도입했습니다. 다음 코드 스니펫은 C#을 사용하여 MHTML 파일을 PDF 형식으로 변환하는 방법을 보여줍니다.
...
_형식_: **HTML**
- [C# HTML을 PDF로 변환 코드](#csharp-html-to-pdf)
- [C# HTML을 PDF로 변환 API](#csharp-html-to-pdf)
- [C# HTML을 PDF로 프로그래밍 방식으로 변환](#csharp-html-to-pdf)
- [C# HTML을 PDF로 변환 라이브러리](#csharp-html-to-pdf)
- [C# HTML을 PDF로 저장](#csharp-html-to-pdf)
- [C# HTML에서 PDF 생성](#csharp-html-to-pdf)
- [C# HTML에서 PDF 만들기](#csharp-html-to-pdf)
- [C# HTML을 PDF로 변환기](#csharp-html-to-pdf)

_형식_: **MHTML**
- [C# MHTML을 PDF로 변환 코드](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 변환 API](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 프로그래밍 방식으로 변환](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 변환 라이브러리](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 저장](#csharp-mhtml-to-pdf)
- [C# MHTML에서 PDF 생성](#csharp-mhtml-to-pdf)
- [C# MHTML에서 PDF 만들기](#csharp-mhtml-to-pdf)
- [C# MHTML을 PDF로 변환기](#csharp-mhtml-to-pdf)

_형식_: **웹 페이지**
- [C# 웹 페이지를 PDF로 변환 코드](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 변환 API](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 프로그래밍 방식으로 변환](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 변환 라이브러리](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 저장](#csharp-webpage-to-pdf)
- [C# 웹 페이지에서 PDF 생성](#csharp-webpage-to-pdf)
- [C# 웹 페이지에서 PDF 만들기](#csharp-webpage-to-pdf)
- [C# 웹 페이지를 PDF로 변환기](#csharp-webpage-to-pdf)