---
title: Docker에서 Aspose.PDF for .NET 8 실행 방법
linktitle: Docker에서 Aspose.PDF for .NET 8 사용하기
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 20
url: /ko/net/docker/dotnet8/
description: Docker Linux 또는 Windows 컨테이너를 사용하여 .NET 8 애플리케이션에 Aspose.PDF 기능 통합
lastmod: "2024-01-21"
sitemap:
    changefreq: "monthly"
    priority: 0.5
...
<script type="application/ld+json">
{
    ...
    "abstract": "Linux 또는 Windows 컨테이너를 사용하여 애플리케이션에 Aspose.PDF for .NET 8을 원활하게 통합하는 방법을 알아보세요. 이 기능은 ASP.NET Core 애플리케이션 내에서 효율적인 PDF 문서 생성 및 조작을 가능하게 하여 개발자가 컨테이너화된 환경에서 강력한 PDF 기능을 활용할 수 있도록 합니다. 이 간단한 설정 가이드를 활용하여 .NET 프로젝트를 최적화하고 Aspose.PDF for .NET의 강력한 기능으로 개발 워크플로를 향상시키세요.",
    "author": {
        "@type": "Person",
...
* 아래 제공된 예제에서 .NET 8 SDK가 사용됩니다.
* Aspose.PDF.Drawing v.24.01.

## Docker Linux 컨테이너용 샘플 애플리케이션 만들기

1. Visual Studio 2022를 실행하고 **ASP.NET Core Web App (Model-View-Controller)** 템플릿을 선택한 후 **Next**를 누릅니다.
1. **새 프로젝트 구성** 창에서 원하는 프로젝트 이름과 위치를 설정한 후 **Next**를 누릅니다.
1. **추가 정보** 창에서 **.NET 6.0 (Long-term support)**를 선택하고 Docker 지원을 활성화합니다. 필요에 따라 **Docker OS**를 Linux로 설정할 수도 있습니다.
1. **Create**를 누릅니다.
1. **Tools->Nuget Package Manager->Package Manager Console**을 선택하고 **Aspose.PDF for .NET**을 설치합니다 (명령어 `Install-Package Aspose.PDF` 사용).
