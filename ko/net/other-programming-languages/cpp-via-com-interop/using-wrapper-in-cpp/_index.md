...
COM Interop을 통해 Aspose.PDF for .NET를 등록해 주십시오. [COM Interop을 통해 Aspose.pdf for .NET 사용하기](/pdf/ko/net/use-aspose-pdf-for-net-via-com-interop/)라는 기사를 확인해 주십시오.
