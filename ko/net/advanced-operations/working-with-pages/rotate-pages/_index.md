...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "C#을 사용하여 PDF 페이지 회전",
    "alternativeHeadline": ".NET을 사용하여 PDF 페이지 회전 방법",
    "author": {
        "@type": "Person",
...
Aspose.PDF for .NET 9.6.0 릴리스에서, 우리는 풍경에서 초상화로, 그 반대로 페이지 방향을 변경하는 것과 같은 훌륭한 새 기능을 추가했습니다. 페이지 방향을 변경하려면 다음 코드 스니펫을 사용하여 페이지의 MediaBox를 설정하세요. Rotate() 메소드를 사용하여 회전 각도를 설정함으로써 페이지 방향을 변경할 수도 있습니다.

{{< gist "aspose-pdf" "7e1330795d76012fcb04248bb81d45b3" "Examples-CSharp-AsposePDF-Pages-ChangeOrientation-ChangeOrientation.cs" >}}

## 새 페이지 방향에 페이지 내용 맞추기

위의 코드 스니펫을 사용할 때, 문서의 내용 일부가 잘릴 수 있으므로 페이지 높이가 감소한다는 점에 유의하세요. 이를 방지하기 위해 폭을 비례적으로 증가시키고 높이는 그대로 둡니다. 계산 예:

{{< gist "aspose-pdf" "7e1330795d76012fcb04248bb81d45b3" "Examples-CSharp-AsposePDF-Pages-FitPageContents-FitPageContents.cs" >}}
{{< gist "aspose-pdf" "7e1330795d76012fcb04248bb81d45b3" "Examples-CSharp-AsposePDF-Pages-FitPageContents-FitPageContents.cs" >}}

위의 접근 방식 외에도, 페이지 내용에 줌을 적용할 수 있는 PdfPageEditor 파사드를 사용하는 것을 고려해 보세요.
