---
title: PDF에서 C#을 사용하여 북마크 작업하기
linktitle: 북마크
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 30
url: /ko/net/bookmarks/
description: Aspose.PDF를 사용하여 .NET에서 PDF 북마크로 문서를 쉽게 탐색하고 구성하는 방법을 알아보세요.
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "PDF 문서에서 북마크를 효율적으로 관리할 수 있는 Aspose.PDF for .NET의 새로운 기능을 알아보세요. 이 기능은 북마크의 추가, 삭제 및 검색을 원활하게 수행할 수 있게 하여 PDF 파일 내에서 탐색 및 접근성을 향상시킵니다.",
    "author": {
        "@type": "Person",
    ...
    "description": "이 섹션에서는 Aspose.PDF for .NET을 사용하여 북마크를 추가, 삭제 및 가져오는 방법을 설명합니다."
}
</script>
