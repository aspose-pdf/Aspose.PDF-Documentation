...
description: Aspose.PDF for .NET을 사용하면 PDF 파일에 처음부터 양식을 생성할 수 있습니다.
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Document 클래스는 PDF 문서의 양식 필드를 관리하는 Form 컬렉션을 제공합니다. 양식 필드에 툴팁을 추가하려면 Field 클래스의 AlternateName을 사용하십시오. Adobe Acrobat은 'alternate name'을 필드 툴팁으로 사용합니다.

다음 코드 스니펫은 먼저 C#을 사용한 다음 Visual Basic을 사용하여 양식 필드에 툴팁을 추가하는 방법을 보여줍니다.
