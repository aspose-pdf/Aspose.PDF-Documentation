...
* ZUGFeRD 표준에 준하는 인보이스 메타데이터를 포함하는 "factur-x.xml"이라는 다른 파일의 경로와 설명을 제공하여 [FileSpecification](https://reference.aspose.com/pdf/ko/net/aspose.pdf/filespecification/) 객체를 생성합니다.
