---
title: Establecer propiedades de elementos de estructura Tagged PDF en Python
linktitle: Configuración de propiedades de Structure Elements
type: docs
weight: 30
...
Para establecer los elementos de estructura de texto de un Tagged PDF Document, Aspose.PDF ofrece [Elemento de párrafo](https://reference.aspose.com/pdf/python-net/aspose.pdf.logicalstructure/paragraphelement/) clase. El siguiente fragmento de código muestra cómo establecer los elementos de estructura de texto de un Documento PDF con etiquetas:
...
## Configuración de los Elementos de Estructura del Bloque de Texto

Este ejemplo de Python usa Aspose.PDF para crear un Tagged PDF que incluye una jerarquía estructurada de encabezados y un párrafo, mejorando las características semánticas y de accesibilidad del documento.
...
1. Añadir párrafo a la estructura raíz.
1. Guarda el PDF etiquetado.

El siguiente fragmento de código muestra cómo establecer los elementos de estructura de bloque de texto de un Documento PDF con etiquetas:
...
Crear elementos de texto en línea (/Span) dentro de encabezados y párrafos en un PDF etiquetado usando Aspose.PDF for Python via .NET.
...
1. Cree elementos span en línea con etiquetas personalizadas.
1. Guarda el PDF etiquetado.
...
**Esta función es compatible con la versión 19.4 o posterior.**
...
La API Aspose.PDF for Python via .NET también permite agregar elementos de estructura de enlaces.
...
Aspose.PDF for Python via .NET API también permite establecer el idioma y el título de un documento de acuerdo con la especificación PDF/UA. El idioma puede configurarse tanto para todo el documento como para sus elementos estructurales separados. El siguiente fragmento de código muestra cómo establecer el idioma y el título en un documento Tagged PDF:

1. Crea un nuevo documento PDF etiquetado.
1. Establecer título y idioma del documento.
1. Crear un elemento de encabezado.
1. Añadir párrafos con idiomas específicos.
1. Guarda el PDF etiquetado.
...
- [Trabajando con tablas en PDF etiquetados](/pdf/es/python-net/working-with-table-in-tagged-pdfs/) si necesita aplicar propiedades accesibles a las estructuras de tabla.
