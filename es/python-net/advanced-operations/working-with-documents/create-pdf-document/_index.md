...
1. Añadir un [Página](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/) objeto al [páginas](https://reference.aspose.com/pdf/python-net/aspose.pdf/document/#properties) colección del objeto Document
1. Agregar [TextFragment](https://reference.aspose.com/pdf/python-net/aspose.pdf.text/textfragment/) a [párrafos](https://reference.aspose.com/pdf/python-net/aspose.pdf/page/#properties) colección de la página
