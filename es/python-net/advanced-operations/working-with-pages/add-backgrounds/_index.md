---
title: Añadir fondo a PDF con Python
...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Añadir fondo a PDF con Python",
    "alternativeHeadline": "Trabajando con Fondo en PDF",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, python, fondo en pdf",
    "wordcount": "302",
    ...
    "description": "Añadir imagen de fondo a su archivo PDF con Python. Use el objeto BackgroundArtifact."
}
</script>
...
```python
    ...
    # Crear objeto Artefacto de Fondo
    ...
    # Añadir artefacto de fondo a la colección de artefactos de la página
