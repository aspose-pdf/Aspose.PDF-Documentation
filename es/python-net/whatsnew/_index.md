...
description: En esta página se presentan las características nuevas más populares de Aspose.PDF para Python a través de .NET que se han introducido en versiones recientes.
sitemap: 
    changefreq: "monthly"
    priority: 0.8
lastmod: "2025-02-24"
...
1. Añadir imágenes etiquetadas desde flujos de memoria.

### Convertir PDF al formato PDF/E-1

En la versión 25.9 de la biblioteca Aspose.PDF para Python, la conversión al formato PDF/E-1 está disponible. Puede encontrar más información sobre este formato en los [(Documentos de formatos de archivo)[https://docs.fileformat.com/pdf/e/].
...
### Añadir imágenes etiquetadas desde un flujo

Añadir imágenes etiquetadas desde un flujo en PDF. La versión 25.9 soporta una accesibilidad mejorada en documentos PDF al agregar una imagen desde un flujo de memoria y etiquetarla con texto alternativo.
...
## Novedades en Aspose.PDF 25.8

Esta actualización añade mayor flexibilidad en el diseño y la gestión de la seguridad de los documentos.

1. Crear tablas de contenido etiquetadas (TOC).
1. Redimensionar páginas PDF con escalado de contenido.
1. Aplicar bordes discontinuos a tablas.

### Crear tabla de contenido etiquetada (TOC)

Genere automáticamente tablas de contenido accesibles (TOC) en PDFs etiquetados. Crear una tabla de contenido totalmente accesible en un PDF permite a los lectores navegar el documento de manera eficiente y garantiza el cumplimiento PDF/UA-1 para la accesibilidad.
...
Redimensione páginas PDF mientras preserva el diseño y escala el contenido proporcionalmente. Al trabajar con PDFs, puede necesitar redimensionar páginas o escalar el contenido para ajustarse a nuevas dimensiones.
...
Añada tablas con estilos de borde personalizados usando líneas discontinuas. Este ejemplo muestra cómo aplicar estilos de borde personalizados —como líneas discontinuas o punteadas— a tablas en un documento PDF usando Aspose.PDF para Python a través de .NET.
...
1. Encriptar PDFs usando un certificado público.
1. Añadir anotaciones de nube y polígono.

### Encriptar PDFs con un certificado público

Proteja sus PDFs con cifrado basado en certificados públicos. El cifrado con certificado público permite que los PDFs se encripten para destinatarios específicos, asegurando que solo los poseedores de las claves privadas correspondientes puedan abrir y leer el documento.
...
Escalar automáticamente el texto para que encaje dentro de un rectángulo definido. Al actualizar o ampliar texto en un PDF, este puede exceder los límites originales del párrafo.
...
### Añadir anotaciones de nube y polígonos

Mejore los flujos de trabajo de revisión de PDF con anotaciones en la nube o de estilo polígono. Las anotaciones de polígono le permiten resaltar o enfatizar áreas específicas en un PDF utilizando formas geométricas.
...
1. Soporte de texto alternativo para imágenes.
1. Acceso a la información de la licencia.
...
Establezca y recupere texto alternativo para imágenes para mejorar la accesibilidad de los lectores de pantalla.
...
Recupere metadatos detallados de la licencia (usuario con licencia, fecha de vencimiento) a través de LicenseInfo.
...
Use SetTextStyle para aplicar estilos como negrita, cursiva, subrayado, o borrar el formato existente del texto de la anotación.
...
### Apariencia personalizable de la firma digital

Agregue imágenes, cambie fuentes y superponga gráficos de la firma sobre el contenido de fondo para una mejor marca o consistencia de diseño.
...
Recupere los certificados incrustados usando 'extract_certificate()'.
...
Genere listas numeradas accesibles (con elementos anidados) dentro de documentos etiquetados.
...
Valide firmas digitales utilizando certificados de clave pública externos.
...
Estandarice los formularios XFA con 'ignore_needs_rendering'.
...
### Reemplazo de fuentes en PDF - Conversión a XPS

Sustituya fuentes faltantes con una alternativa predeterminada (p. ej., “Courier New”).
...
Convierta PDFs a PDF/A-1b con creación automática de estructura lógica para mejorar la accesibilidad.
