...
- [AcroForms](/pdf/php-java/acroforms/) - crear formulario, llenar campo de formulario, extraer datos del formulario, modificar campos en tu PDF con la biblioteca PHP.
- [XFA Forms](/pdf/php-java/xfa-forms/) - llenar campos XFA, convertir XFA, obtener propiedades de campos XFA.