...
type: docs
weight: 70
url: es/php-java/supported-file-formats/
description: Esta página muestra qué formatos de archivo puede cargar y guardar Aspose.PDF para PHP a través de Java.
lastmod: "2024-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
La siguiente tabla indica los formatos de archivo que Aspose.PDF para PHP a través de Java puede cargar y guardar.
...
|[PCL](https://docs.fileformat.com/page-description-language/pcl/)|Archivos de Lenguaje de Control de Impresoras|{{< emoticons/tick >}}| | |
...
|[XSLFO](https://docs.fileformat.com/page-description-language/xslfo/)|XSL-FO es parte de un archivo XSL que se utiliza para la transformación y formateo de datos XML|{{< emoticons/tick >}}| | |
