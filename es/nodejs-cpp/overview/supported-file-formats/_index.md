...
type: docs
weight: 10
url: /es/nodejs-cpp/supported-file-formats/
description: Esta página muestra cuáles formatos de archivo Aspose.PDF para Node.js puede cargar y guardar.
lastmod: "2023-11-16"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
La siguiente tabla indica los formatos de archivo que Aspose.PDF para Node.js via C++ puede cargar y guardar.
...
|[PDF/A](https://docs.fileformat.com/pdf/a/)|Versiones de PDF/A|{{< emoticons/tick >}}|{{< emoticons/tick >}} | |
...
|[SVGZ](https://docs.fileformat.com/image/svgz/)|Formato de archivo SVGZ| |{{< emoticons/tick >}}| |
...
|[PPTX](https://docs.fileformat.com/presentation/pptx/)|Guarda el documento en el formato de Microsoft PowerPoint Presentations| |{{< emoticons/tick >}}| |
...
|Grayscale|Guarda el documento en escala de grises| |{{< emoticons/tick >}}| |
|[Text](https://docs.fileformat.com/word-processing/txt/)|Guarda el documento en formato de texto| |{{< emoticons/tick >}}| |{{< emoticons/tick >}}| |
|[DICOM](https://docs.fileformat.com/image/dicom/)|Guarda el documento como imagen DICOM| |{{< emoticons/tick >}}| |
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|Guarda el documento como CSV| |{{< emoticons/tick >}}| |