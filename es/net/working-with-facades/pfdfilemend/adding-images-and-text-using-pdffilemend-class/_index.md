...
Podemos agregar texto de varias maneras. Consideremos la primera. Tomamos el [FormattedText](https://reference.aspose.com/pdf/net/aspose.pdf.facades/formattedtext) y lo agregamos a la Página. Después, indicamos las coordenadas de la esquina inferior izquierda, y luego agregamos nuestro texto a la Página.
