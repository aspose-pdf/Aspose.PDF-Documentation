...
Para obtener información, utilizamos la propiedad [Header](https://reference.aspose.com/pdf/es/net/aspose.pdf.facades/pdffileinfo/properties/header). Con 'Hashtable' obtenemos todos los valores posibles.
