---
title: Descripción general de Aspose.PDF.Drawing para .NET
linktitle: Versión de PDF.Dibujo
type: docs
...
url: /es/net/drawing/
lastmod: "2023-12-21"
description: Descripción general de las características clave y ventajas de la biblioteca Aspose.PDF.Drawing para .NET.
sitemap:
    changefreq: "monthly"
    priority: 0.7
---
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF.Drawing para .NET es una poderosa biblioteca que mejora la manipulación de documentos PDF al utilizar la biblioteca Aspose.Drawing en lugar de System.Drawing. Esta característica garantiza un soporte sin problemas en múltiples plataformas, renderizado de texto de alta calidad y una amplia gama de funcionalidades, como compresión de documentos, amplias capacidades de hipervínculo y gestión de fuentes personalizadas, todo mientras mantiene un rendimiento superior y compatibilidad con la API",
    "author": {
        "@type": "Person",
...
Además, es necesario mencionar que la biblioteca Aspose.PDF.Drawing funciona con éxito en la plataforma Docker, que permite empaquetar su aplicación en un contenedor. Para más información, consulte la página [Cómo ejecutar Aspose.PDF en Docker](https://docs.aspose.com/pdf/net/docker/). Los paquetes 'ttf-mscorefonts-installer' y 'fontconfig' son necesarios para el correcto funcionamiento de la biblioteca Aspose.PDF.Drawing para .NET en Docker.
...
1. La calidad de renderizado. Con Aspose.PDF.Drawing, puede lograr un renderizado de texto de alta calidad con suavizado y sugerencias. Esto asegura bordes de fuente suaves sin artefactos dentados, haciendo que el texto sea legible en diversas pantallas y resoluciones. La diferencia en un documento de formato A4 es como máximo de 10 píxeles por página.

1. Conjunto de características completo. Aspose.PDF.Drawing cuenta con una amplia gama de características para gráficos 2D, abarcando formas, líneas, texto, imágenes y gráficos.

1. Compatibilidad con la API. Utilizando el espacio de nombres System.Drawing, Aspose.PDF.Drawing reemplaza sin problemas a System.Drawing.Common, permitiendo la sustitución sin necesidad de alterar el código fuente existente.
...
1. Capacidades de renderizado de texto. Aspose.PDF.Drawing sobresale en el renderizado de texto con alta calidad. Esto asegura bordes de fuente suaves, eliminando artefactos dentados y asegurando legibilidad en diversas pantallas y resoluciones.

1. Asistencia para el formateo de formas. Aspose.PDF.Drawing ofrece una variedad de opciones para formatear formas, abarcando características como color de relleno, color de trazo, grosor de línea y estilo de línea.

1. Características de procesamiento de imágenes. Aspose.PDF.Drawing para .NET proporciona diversas capacidades de procesamiento de imágenes, incluyendo agregar, reemplazar o eliminar.
...
No hay licencia adicional para Aspose.PDF.Drawing, use la misma que para Aspose.PDF. Consulte la sección [Licencia de Aspose PDF](/pdf/es/net/licensing/).

## Instalación

Para probar **Aspose.PDF.Drawing para .NET**, simplemente ejecute `Install-Package Aspose.PDF.Drawing` desde la Consola del Administrador de Paquetes en Visual Studio para obtener el paquete NuGet. Si ya tiene Aspose.PDF for .NET y desea actualizar la versión, ejecute `Update-Package Aspose.PDF.Drawing` para obtener la última versión. Más información se puede encontrar en el enlace al [paquete NuGet](https://www.nuget.org/packages/Aspose.PDF.Drawing/).

![Aspose.PDF.Drawing para .NET](nuget.png)

Conozca las clases disponibles en Aspose.PDF.Drawing en el sitio de [Referencia de API](https://reference.aspose.com/pdf/net/aspose.pdf.drawing/).

Conozca más sobre:

- [Formatos de archivo compatibles](/pdf/es/net/supported-file-formats/)
