---
title: Convertir PDF al formato de intercambio PDF/X
linktitle: Convertir PDF al formato de intercambio PDF/X
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 120
url: /es/net/convert-pdf-to-pdfx/
lastmod: "2025-01-16"
description: Aprenda a convertir un archivo PDF al formato PDF/X para intercambio gráfico e impresión utilizando Aspose.PDF for .NET.
sitemap:
    changefreq: "monthly"
    priority: 0.8
---
<script type="application/ld+json">
{
    ...
    "abstract": "El soporte PDF/X en Aspose.PDF for .NET permite la conversión fácil de archivos PDF estándar a varios formatos compatibles con PDF/X. Esta función no solo garantiza el cumplimiento de los estándares PDF/X a través de una validación exhaustiva, sino que también permite emplear un perfil ICC personalizado para asegurar un intercambio gráfico adecuado en cada entorno. Explore las robustas capacidades de Aspose.PDF para una conversión PDF/X eficiente y confiable.",
    "author": {
        "@type": "Person",
...
- [Convertir PDF a PDF/X-4](#csharp-convert-pdf-to-x4)
...
## Convertir archivo PDF a PDF/X-4 con perfil ICC externo

<a name="csharp-convert-pdf-to-x4" id="csharp-convert-pdf-to-x4"><strong>Convertir PDF a PDF/X4</strong></a>

El siguiente fragmento de código muestra cómo convertir archivos PDF a PDF compatibles con PDF/X-4 y proporcionar un perfil ICC externo para asegurar la correcta representación del color.
