...
Por favor, registra Aspose.PDF for .NET con COM Interop, consulta el artículo titulado [Usar Aspose.pdf para .NET a través de COM Interop](/pdf/net/use-aspose-pdf-for-net-via-com-interop/).
