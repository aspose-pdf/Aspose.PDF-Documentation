---
title: Agregar firma digital con un controlador de seguridad personalizado en C#
linktitle: Controlador de seguridad personalizado
type: docs
weight: 40
url: /es/net/custom-security-handler/
description: Agregar firma digital con un controlador de seguridad personalizado en C#
lastmod: "2025-04-08"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET introduce capacidades poderosas para firmar digitalmente documentos PDF usando C# o VB.NET, mejorando la integridad y seguridad del documento. Los usuarios pueden implementar varios tipos de firma, incluyendo firmas no separadas y separadas con soporte para PKCS7 y ECDSA, permitiendo procesos de firma personalizables adaptados a estándares criptográficos específicos. Esta función no solo verifica la autenticidad de los documentos, sino que también permite la estampillado de tiempo y certificación, asegurando un manejo de documentos confiable.",
    "author": {
        "@type": "Person",
    ...
    "description": "Firmar digitalmente documentos PDF usando C# o VB.NET. Verificar o validar los PDFs firmados digitalmente usando C# o VB.NET."
}
</script>

Puedes crear tu propio controlador de seguridad aplicando el algoritmo de cifrado deseado.
Adobe Acrobat no podrá abrir tal archivo, pero puedes trabajar con él usando Aspose.Pdf.
Para crear un controlador, debes implementar la interfaz:
...
Un ejemplo de una implementación simple de la interfaz (solo para demostrar):
...
Ejemplo de cifrado de documento:
...
Ejemplo de apertura de un documento cifrado:
