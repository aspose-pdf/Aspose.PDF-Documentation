---
title: Verificar los límites de forma en la colección de Shapes
type: docs
weight: 70
url: /es/net/aspose-pdf-drawing-graph-shapes-bounds-check/
description: Aprenda a verificar los límites de una forma cuando se inserta en la colección de Shapes para asegurarse de que se ajuste dentro de su contenedor padre.
lastmod: "2025-02-28"
draft: false
---
...
Primero, cree un nuevo documento PDF y agréguelo una página.
...
* Verifique que las dimensiones del elemento y el contenedor sean precisas.
