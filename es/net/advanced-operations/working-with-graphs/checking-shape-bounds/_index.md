...
<script type="application/ld+json">
{
    ...
    "abstract": "La nueva función de verificación de límites de Aspose.PDF para .NET en la colección `Drawing.Graph.Shapes` valida automáticamente las dimensiones de los elementos en relación con los contenedores padres, evitando el desbordamiento del diseño. Genera excepciones cuando los elementos superan los límites del contenedor, aplicando restricciones de tamaño estrictas durante la inserción para garantizar un formato PDF preciso y optimizar la precisión del diseño.",
    "author": {
        "@type": "Person",
...
```
Los límites no se ajustan. Dimensiones del contenedor: 100x100
```
