---
title: Agregar objeto Elipse a archivo PDF
...
description: Este artículo explica cómo crear un objeto Elipse en su PDF utilizando Aspose.PDF for .NET.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Presentamos la nueva función de objeto Elipse para Aspose.PDF en .NET, que permite a los desarrolladores incorporar formas de elipse en sus documentos PDF sin esfuerzo. Esta funcionalidad admite la adición de elipses rellenas e incluso texto dentro de las formas, mejorando la presentación visual y la personalización de los archivos PDF. Optimice la generación de su documento con elementos gráficos ricos que elevan el compromiso del usuario.",
    "author": {
        "@type": "Person",
...
Aspose.PDF for .NET admite la adición de objetos [Elipse](https://reference.aspose.com/pdf/es/net/aspose.pdf.drawing/ellipse) a documentos PDF. También ofrece la función de rellenar el objeto elipse con un cierto color.
...
El siguiente fragmento de código muestra cómo agregar un objeto [Elipse](https://reference.aspose.com/pdf/es/net/aspose.pdf.drawing/ellipse) que está relleno de color.
