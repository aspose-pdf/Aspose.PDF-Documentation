...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET presenta una poderosa función que permite a los usuarios enriquecer sus documentos PDF al agregar encabezados y pies de página personalizables. Usando las clases TextStamp e ImageStamp, los desarrolladores pueden integrar fácilmente tanto texto como imágenes, adaptando su colocación y apariencia para ajustarse a varios formatos y estilos de documentos. Esto mejora la profesionalidad y legibilidad del documento, haciéndolo ideal para informes, facturas y otras comunicaciones formales.",
    "author": {
        "@type": "Person",
...
**Aspose.PDF for .NET** te permite agregar encabezados y pies de página a un archivo PDF existente. Puedes insertar tanto imágenes como texto en el documento.

El siguiente fragmento de código también funciona con la biblioteca [Aspose.PDF.Drawing](/pdf/es/net/drawing/).

## Agregar Encabezados y Pies de Página como Fragmentos de Texto

El siguiente fragmento de código demuestra cómo agregar encabezados y pies de página como fragmentos de texto en un PDF usando C#.
...
## Agregar Encabezados y Pies de Página como Fragmentos de HTML

El siguiente fragmento de código demuestra cómo agregar encabezados y pies de página como fragmentos de HTML a un PDF usando C#.
...
El siguiente fragmento de código demuestra cómo agregar encabezados y pies de página como imágenes a un PDF usando C#.
