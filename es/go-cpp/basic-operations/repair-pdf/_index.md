...
1. Abrir un documento PDF usando [Abrir](https://reference.aspose.com/pdf/go-cpp/core/open/) función.
1. Reparar el documento PDF con [Reparar](https://reference.aspose.com/pdf/go-cpp/organize/repair/) función.
