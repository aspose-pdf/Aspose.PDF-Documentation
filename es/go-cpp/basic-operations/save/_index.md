...
El ejemplo demuestra el [Nuevo](https://reference.aspose.com/pdf/go-cpp/core/new/) método para crear un nuevo documento PDF, que es una característica fundamental para generar documentos de forma dinámica, como informes o facturas.
