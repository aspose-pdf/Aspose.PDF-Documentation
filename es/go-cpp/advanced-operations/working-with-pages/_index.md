---
title: Trabajando con páginas PDF en Go
...
- [Agregar páginas](/pdf/es/go-cpp/add-pages/) - agrega páginas a tu archivo PDF mediante Go.
- [Eliminar páginas](/pdf/es/go-cpp/delete-pages/) - elimina una página de tu archivo PDF mediante Go.
- [Rotar páginas](/pdf/es/go-cpp/rotate-pages/) - puedes cambiar la orientación de página de las páginas en un archivo PDF existente.
- [Obtener y establecer propiedades de página](/pdf/es/go-cpp/get-and-set-page-properties/) - aprender cómo obtener y establecer propiedades de página para documentos PDF.
- [Establecer el color de fondo para PDF](/pdf/es/go-cpp/set-background-color/) - establecer el color de fondo para su archivo PDF.
