---
title: Obtener propiedades de página en Python
linktitle: Obtener propiedades de página en Python
type: docs
weight: 50
url: /es/java/get-page-properties-in-python/
description: Aprenda cómo acceder a las propiedades de páginas específicas dentro de un documento PDF en Python usando Aspose.PDF para un control detallado.
lastmod: "2026-09-03"
---
Para obtener las propiedades de página de un documento Pdf usando **Aspose.PDF Java for Python**, simplemente invoque la clase **GetPageProperties**.
...
Download\u0412\u00A0**Obtener propiedades de página (Aspose.PDF)**\u0412\u00A0de\u0412\u00A0cualquiera de los sitios de codificación social mencionados a continuación:
