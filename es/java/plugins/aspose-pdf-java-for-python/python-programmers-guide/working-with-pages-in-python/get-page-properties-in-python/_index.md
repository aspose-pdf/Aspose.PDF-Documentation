...
description: Aprenda a acceder a las propiedades de páginas específicas dentro de un documento PDF en Python usando Aspose.PDF para un control detallado.
lastmod: "2026-06-09"
---

Para obtener las propiedades de la página de un documento PDF utilizando **Aspose.PDF Java para Python**, simplemente invoque la clase **GetPageProperties**.
