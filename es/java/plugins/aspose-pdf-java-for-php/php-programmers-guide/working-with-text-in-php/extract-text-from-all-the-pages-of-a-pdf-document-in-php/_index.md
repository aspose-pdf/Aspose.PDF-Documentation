---
title: Extraiga texto de todas las páginas de un documento PDF en PHP
linktitle: Extraiga texto de todas las páginas de un documento PDF en PHP
type: docs
weight: 30
...
Para extraer el documento PDF TextrFrom All the Pages usando **Aspose.PDF Java para PHP**, simplemente invoque el módulo **ExtractTextFromAllPages**.
Código PHP
