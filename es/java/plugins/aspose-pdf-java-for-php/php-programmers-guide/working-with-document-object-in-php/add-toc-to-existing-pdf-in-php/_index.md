---
title: Agregar TOC a un PDF existente en PHP
linktitle: Agregar TOC a un PDF existente en PHP
type: docs
weight: 20
url: /java/add-toc-to-existing-pdf-in-php/
description: Explore cómo agregar una tabla de contenido (TOC) a un documento PDF existente en PHP con Aspose.PDF para mejorar la navegación.
lastmod: "2026-06-09"
---
## 
