---
title: Obtener propiedades de página en PHP
linktitle: Obtener propiedades de página en PHP
type: docs
weight: 50
...
Para obtener las propiedades de la página de un documento PDF utilizando **Aspose.PDF Java para PHP**, simplemente invoque la clase **GetPageProperties**.
