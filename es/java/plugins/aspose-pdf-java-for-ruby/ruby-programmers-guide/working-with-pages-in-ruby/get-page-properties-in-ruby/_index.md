...
description: Aprenda a recuperar propiedades de página en un archivo PDF usando Ruby con Aspose.PDF para administrar y manipular sus documentos de manera eficiente.
lastmod: "2026-06-09"
---
## 
...
Para obtener las propiedades de la página de un documento PDF utilizando **Aspose.PDF Java para Ruby**, simplemente invoque el módulo **GetPageProperties**.
