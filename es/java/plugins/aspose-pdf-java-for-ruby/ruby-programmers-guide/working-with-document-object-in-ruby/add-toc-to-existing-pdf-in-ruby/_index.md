---
title: Agregar TOC a un PDF existente en Ruby
linktitle: Agregar TOC a un PDF existente en Ruby
type: docs
weight: 30
url: /java/add-toc-to-existing-pdf-in-ruby/
description: Aprenda cómo agregar una tabla de contenido a un PDF existente en Ruby usando Aspose.PDF para mejorar la navegación del documento.
lastmod: "2026-06-09"
---
## 
...
<ins>Para agregar TOC en un documento PDF usando **Aspose.PDF Java para Ruby**, simplemente invoque el módulo **AddToc**.
...
## 
<ins> **Descargar código de ejecución
