---
title: Agregar capas a un archivo PDF en Ruby
linktitle: Agregar capas a un archivo PDF en Ruby
type: docs
weight: 20
url: /java/add-layers-to-pdf-file-in-ruby/
description: Aprenda a agregar capas a un archivo PDF en Ruby usando Aspose.PDF para una mejor estructura del documento y control de visibilidad.
lastmod: "2026-06-09"
---
## 
...
<ins> Para agregar capas en un documento PDF usando **Aspose.PDF Java para Ruby**, simplemente invoque el módulo **AddLayers**.
...
Descargue **Agregar capas (Aspose.PDF)**В desde cualquiera de los sitios de codificación social mencionados a continuación:
