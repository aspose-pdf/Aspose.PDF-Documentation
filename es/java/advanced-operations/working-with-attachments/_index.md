...
- [Agregar adjunto a un documento PDF](/pdf/es/java/add-attachment-to-pdf-document/)
- [Extraer y guardar un adjunto](/pdf/es/java/extract-and-save-an-attachment/)

- [Eliminar adjunto de un PDF existente](/pdf/es/java/removing-attachment-from-an-existing-pdf/)
- [Deshabilitar la Compresión de Archivos al Agregar como Recursos Incrustados](/pdf/es/java/disable-files-compression-when-adding-as-embedded-resources/)
- [Portafolio](/pdf/es/java/portfolio/)