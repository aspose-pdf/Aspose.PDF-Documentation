...
description: Aprenda a agregar y eliminar artefactos de encabezado y pie de página en documentos PDF usando Aspose.PDF para Java.
lastmod: "2026-06-09"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Abstract: Este artículo explica cómo administrar artefactos de encabezado y pie de página en documentos PDF usando Aspose.PDF para Java. Cubre la creación de objetos `HeaderArtifact` y `FooterArtifact` reutilizables con alineación y estado de texto personalizados, su adición a una página y la eliminación de artefactos de encabezado y pie de página existentes.
---
Los artefactos de encabezado y pie de página son elementos de paginación sin contenido que se usan comúnmente para etiquetas repetidas, identificadores de página y marcos de diseño.
...
## 
Crear un artefacto de pie de página
