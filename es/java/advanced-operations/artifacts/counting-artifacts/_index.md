...
1. Read the [Artifact](https://reference.aspose.com/pdf/java/com.aspose.pdf/artifact/) collection from the target [Page](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/).
1. Iterate through the page [Artifact](https://reference.aspose.com/pdf/java/com.aspose.pdf/artifact/) collection and count each pagination subtype you need to report.
