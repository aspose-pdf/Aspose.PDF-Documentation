---
title: Rotar texto PDF en Java
linktitle: Rotar texto dentro de PDF
type: docs
weight: 50
url: /es/java/rotate-text-inside-pdf/
description: Aprenda cómo rotar fragmentos de texto y párrafos dentro de documentos PDF en Java.
lastmod: "2026-09-03"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Abstract: Este artículo explica cómo rotar texto en documentos PDF usando Aspose.PDF for Java. Muestra cómo rotar fragmentos de texto individuales, crear párrafos que contienen líneas rotadas y rotar párrafos de texto completos para diferentes escenarios de diseño.
---
Aspose.PDF for Java le permite rotar fragmentos de texto individuales, así como párrafos de texto completos.
...
1. Crea fragmentos de texto con los valores de rotación requeridos.
1. Añádelos con `TextBuilder` y guardar el resultado.
...
Utilice este ejemplo cuando un párrafo debe contener líneas normales y rotadas.

1. Crea un nuevo documento PDF y agrega una página.
1. Crear un `TextParagraph` y añadir fragmentos de texto con diferentes configuraciones de rotación.
...
## Rotar fragmentos de párrafo sin posiciones explícitas

Utilice este ejemplo cuando se debe agregar texto rotado a través del flujo normal de párrafos de la página.

1. Crea un nuevo documento PDF y agrega una página.
1. Crea varios fragmentos de texto con diferentes valores de rotación.
1. Añádelos a la colección de párrafos de la página y guarda el PDF.
...
Utilice este ejemplo cuando todo el bloque de párrafos deba rotarse mientras cada línea mantiene el estilo compartido.

1. Crea un nuevo documento PDF y agrega una página.
1. Construir varios `TextParagraph` objetos con rotación a nivel de párrafo.
1. Crea las líneas con un método auxiliar compartido, añádelas y guarda el documento.
