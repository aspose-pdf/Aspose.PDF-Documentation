...
type: docs
weight: 10
url: es/java/supported-xml-schema/
description: Este artículo describe un esquema XML para trabajar con documentos XML en Aspose.PDF para Java
lastmod: "2021-06-05"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
Aspose.PDF para Java utiliza el siguiente esquema XML para trabajar con documentos XML:
