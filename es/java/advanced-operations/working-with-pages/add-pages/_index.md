...
1. Inserte una nueva página en la posición de destino en la colección de páginas.
...
1. Agregue una nueva página al final de la colección de páginas.
...
1. Cree el [Documento](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) de destino y abra el documento de origen.

1. Agregue cualquier contenido de destino requerido e importe la página de destino desde el PDF de origen.
