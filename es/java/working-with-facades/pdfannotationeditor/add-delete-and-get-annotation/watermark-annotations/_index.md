...
description: Aprenda a agregar, inspeccionar y eliminar anotaciones de marcas de agua en documentos PDF usando Java.
lastmod: "2026-06-09"
TechArticle: true
AlternativeHeadline: Trabajar con anotaciones de marcas de agua en archivos PDF usando Java
Abstract: Este artículo explica cómo crear, inspeccionar y eliminar anotaciones de marcas de agua en documentos PDF utilizando Java. Cubre agregar una anotación de marca de agua de texto con opacidad y estado de texto personalizados, leer áreas de anotación de marca de agua existentes y eliminar anotaciones de marca de agua.
---
