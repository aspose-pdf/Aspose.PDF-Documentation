...
weight: 10
url: /java/whatsnew/
description: En esta página se presentan las nuevas funciones más populares de Aspose.PDF para Java que se han introducido en versiones recientes.
sitemap:
    changefreq: "monthly"
    priority: 0.8
lastmod: "2026-06-09"
TechArticle: true
AlternativeHeadline: Nuevas funciones populares en Aspose.PDF para Java
Abstract: La sección Novedades de la documentación de Aspose.PDF para Java proporciona una descripción general de las últimas actualizaciones, mejoras y correcciones de errores introducidas en versiones recientes. Destaca nuevas funciones, mejoras de rendimiento y actualizaciones de compatibilidad para ayudar a los desarrolladores a mantenerse informados sobre los últimos avances en el procesamiento de PDF. La documentación también incluye detalles sobre funcionalidades obsoletas y alternativas recomendadas. Al revisar periódicamente esta sección, los desarrolladores pueden asegurarse de que están utilizando las funciones más eficientes y actualizadas en sus aplicaciones Java para una gestión de PDF perfecta.
SoftwareApplication: java
---
## Novedades de Aspose.PDF 25.12
...
Se agregó soporte para ángulos de rotación arbitrarios para anotaciones de texto libre en XFDF, lo que hace que los diseños de anotaciones importadas y exportadas sean más flexibles.
...
## 
Novedades de Aspose.PDF 25.11


### 
Mejoras en la desinfección de datos ocultos

La desinfección mejorada de PDF ahora está disponible a través de HiddenDataSanitizer para mejorar la eliminación del contenido oculto de los documentos.
...
### 
Reducción mejorada del tamaño del archivo durante la optimización de PDF



La optimización de PDF ahora mejora la reducción del tamaño del archivo al refinar cómo se maneja el subconjunto de fuentes.
...
## 
Novedades de Aspose.PDF 25.10


### 
Soporte de conversión de PDF a PDF/E

Aspose.PDF para Java ahora admite la conversión de documentos PDF al formato PDF/E.
...
Se ha agregado soporte para agregar texto HTML dentro de las anotaciones.
...
## 
Novedades de Aspose.PDF 25.9


### 
Complementos de HTML a PDF

Aspose.PDF para Java ahora incluye complementos de HTML a PDF para simplificar los flujos de trabajo de procesamiento de HTML a PDF.
...
### 
Soporte de conformidad con PDF 1.6



Se agregó compatibilidad con PDF 1.6 para escenarios que requieren esta versión del documento.


## 
Novedades de Aspose.PDF 25.8


### 
Soporte de estilo de borde de tabla

Se agregó compatibilidad con estilos de borde de tabla para brindar más control sobre la apariencia de la tabla.
...
Ahora puede obtener descripciones de texto ALT para imágenes en documentos PDF, lo que ayuda con el procesamiento orientado a la accesibilidad.
...
## 
Novedades de Aspose.PDF 25.7


### 
Complemento PDF ChatGPT

Aspose.PDF para Java ahora incluye un complemento PDF ChatGPT para escenarios de interacción de IA centrados en PDF.



El ejemplo demuestra cómo utilizar el complemento PdfChatGpt agregando archivo(s) como fuente del mensaje:
...
El ejemplo demuestra cómo utilizar el complemento PdfChatGpt agregando mensajes a la solicitud:
...
El ejemplo demuestra cómo utilizar el complemento PdfChatGpt agregando un mensaje a la solicitud:
...
## 
Novedades de Aspose.PDF 25.6

### Formato de salida de PDF a DOCX mejorado



Se ha mejorado la conversión de PDF a DOCX para documentos cuyo formato de salida anteriormente era incorrecto.
...
## 
Novedades de Aspose.PDF 25.5


### 
Conservar imágenes en conversión de PDF a ODS
...
La conversión de PDF a PDF/A ahora admite la creación automática de etiquetas para mejorar los resultados del etiquetado en el documento de salida.
...
## 
Novedades de Aspose.PDF 25.4


### 
Preservar hipervínculos en la conversión de PDF a XLSX



Los hipervínculos ahora se conservan al convertir documentos PDF a XLSX, lo que mejora la navegación en las hojas de cálculo exportadas.
...
## Novedades de Aspose.PDF 25.3



Desde 25.2 se agregó la capacidad de detectar compromisos de firmas digitales PDF. Puede utilizar la clase 'SignaturesCompromiseDetector' para verificar si las firmas digitales están comprometidas. Llame al método check() para verificar las firmas del documento. Si no se detecta ninguna firma comprometida, el método devolverá verdadero. Para verificar si las firmas existentes cubren todo el documento, utilice la 'propiedad SignaturesCoverage'.
...
## 
Novedades de Aspose.PDF 25.2



Desde 25.2 se agregó la capacidad de convertir PDF al formato de archivo PDF/X-4:
...
Desde la versión 25.2, es posible centrar el HTML de salida:
...
Además, desde la versión 25.2, es posible obtener el ascenso y descenso de un texto dada la fuente y el tamaño con Aspose.PDF. La nueva característica se ha implementado en la clase 'com.aspose.pdf.Font'.
...
**Mide el punto de ascenso máximo**



-public double getAscentPoint(cadena de cadena, tamaño de fuente flotante)



**Mide el punto de descenso máximo**

- getDescentPoint doble público (cadena de cadena, tamaño de fuente flotante)
...
## 
Novedades de Aspose.PDF 25.1



La capacidad de pasar la ruta al perfil ICC externo para la conversión de PDF/X y PDF/A ya existe en la biblioteca desde hace algunos años, habilitada por la propiedad PdfFormatConversionOptions.IccProfileFileName. Ahora también es posible pasar datos para completar las propiedades OutputIntent usando un objeto de la clase OutputIntent.
...
Desde 25.1 se agregó la capacidad de obtener información sobre privilegios al usar documentos:
...
## Novedades de Aspose.PDF 24.12



Desde la versión 24.12, es posible admitir caracteres de pares sustitutos.



El término "par sustituto" se refiere a la codificación de caracteres Unicode con puntos de código elevados en el esquema de codificación UTF-16.
...
Desde la versión 24.12, es posible convertir documentos PDF a PDF/A-4. La parte 4 del estándar, basada en PDF 2.0, se publicó a finales de 2020.



El siguiente fragmento de código demuestra cómo convertir un documento al formato PDF/A-4 cuando el documento de entrada es una versión PDF anterior a la 2.0.
...
## Novedades de Aspose.PDF 24.9



En esta versión es posible crear un PDF accesible utilizando funciones de bajo nivel:
...
La clase `GraphicalPdfComparer` se agrega para la comparación gráfica de documentos y páginas PDF. La comparación gráfica se ocupa de las imágenes de las páginas del documento. Devuelve el resultado como un objeto `ImagesDifference` o como un documento PDF que contiene imágenes fusionadas del original y las diferencias. La comparación gráfica es más útil para documentos que tienen diferencias menores en el texto o el contenido gráfico.
...
La propiedad AlternativeText se ha agregado a ImageStamp: si se le asigna un valor, al agregar un ImageStamp a un documento, tendrá texto alternativo.
...
## 
Novedades de Aspose.PDF 24.6



Desde 24.6 Aspose.PDF para Java permite firmar PDF con java.security.cert.X509Certificate, java.security.PrivateKey:



Este código recupera un certificado y una clave privada del almacén de certificados y luego los utiliza para aplicar una firma digital a la primera página de un documento PDF.
...
Desde la versión 24.5, puede abrir un PDF, bloquear una capa específica en la primera página y guardar el documento con los cambios. Hay dos métodos nuevos y se agregó una propiedad:



Capa.Lock(); - Bloquea la capa.


Capa.Desbloquear(); - Desbloquea la capa.


Capa.Bloqueada; - Propiedad, que indica el estado de bloqueo de la capa.
...
La biblioteca Aspose.PDF para Java permite extraer cada capa desde la primera página y guarda cada capa en un archivo separado.
...
La biblioteca Aspose.PDF para Java abre un PDF, recorre cada capa en la primera página y aplana cada capa, haciéndola permanente en la página.
...
El método Layer.flatten(boolean cleanupContentStream) acepta el parámetro booleano que especifica si se eliminan los marcadores de grupo de contenido opcionales del flujo de contenido.
Establecer el parámetro cleanupContentStream en falso acelera el proceso de aplanamiento.



**Combina todas las capas dentro del PDF en una**



La biblioteca Aspose.PDF para Java permite fusionar todas las capas de PDF o una capa específica en la primera página en una nueva capa y guarda el documento actualizado.
...
El segundo parámetro permite cambiar el nombre del marcador de grupo de contenido opcional. El valor predeterminado es "oc1" (/OC /oc1 BDC).
...
## 
Novedades de Aspose.PDF 24.3



Desde 24.3 implementar una búsqueda a través de una lista de frases en un TextFragmentAbsorber.
...
## 
Novedades de Aspose.PDF 24.2

Desde 24.2 es posible agregar la marca de agua en PDF con AcroForms. TextStamp es adecuado para usar con archivos AcroForm. Si utiliza TextStamp para archivos XFA, el texto se dibuja en la página como en un archivo PDF normal (se puede ver en aquellos visores de PDF que no pueden leer archivos XFA, por ejemplo, en un navegador Chrome). Para agregar texto al archivo XFA, se debe cambiar en el XML interno del archivo XFA.
...
Establecer StateModel para anotación


Podemos usar setReviewState y setMarkedState de la clase MarkupAnnotation para establecer el estado necesario.


Todas las anotaciones de marcado tienen una opción Establecer estado disponible.
...
Desde 24.2 implemente la conversión de OFD a PDF:
...
## Novedades de Aspose.PDF 24.1



Desde la versión 24.1, implemente la conversión de PDF a Markdown:
...
Además, en 24.1 se ha implementado la interrupción de subprocesos mediante InterruptMonitor.
...
## 
Novedades de Aspose.PDF 23.12



Se puede encontrar el formulario y el texto se puede reemplazar usando el siguiente fragmento de código:
...
O bien, el formulario se puede eliminar por completo:
...
## 
Novedades de Aspose.PDF 23.11



A partir de esta versión es posible eliminar el texto oculto del archivo PDF:
...
Hemos implementado una nueva función para medir la altura de los personajes. Utilice el siguiente código para medir la altura de un personaje:
...
Tenga en cuenta que la medida se basa en la fuente incrustada en el documento. Si falta alguna información para una dimensión, este método devuelve 0.


## 
Novedades de Aspose.PDF 23.9



Desde 23.9 se admite eliminar una anotación secundaria de un campo que se puede completar.
...
Agregar una imagen con ImageFilterType.Flate no conserva la transparencia.
...
## 
Novedades de Aspose.PDF 23.8



La función para detectar actualizaciones incrementales en un documento PDF se agregó en 23.8. Esta función devuelve "verdadero" cuando el documento se guardó con actualizaciones incrementales; de lo contrario, devuelve "falso".
...
Agregamos una nueva propiedad pública Document.getOutputIntents() para permitir el acceso a las intenciones de salida en un documento.
...
Desde el soporte de Aspose.PDF 23.8 para agregar la extracción de forma:
...
## 
Novedades de Aspose.PDF 23.7

A partir de la versión 23.7, se admite la escala de página de ajustes preestablecidos del cuadro de diálogo de impresión:
...
## 
Novedades de Aspose.PDF 23.6



A partir de la versión 23.6 se admite agregar la capacidad de establecer el título de la página HTML o Epub.
...
Desde 23.6 se admite proporcionar una API para posicionar gráficos vectoriales:
...
## 
Novedades de Aspose.PDF 23.1



A partir de la versión 23.1 se admite la creación de anotaciones PrinterMark. Se agregó una de las variantes de anotación: ColorBarAnnotation.
...
## Novedades de Aspose.PDF 22.9



Desde el 22.09 se admite la adición de propiedades para modificar el orden de las rúbricas de materias (E=, CN=, O=, OU=,) en la firma.
...
## 
Novedades de Aspose.PDF 22.8



Desde el soporte de Aspose.PDF 23.8 para agregar un método para reconstruir la tabla de referencia externa:
...
## 
Novedades de Aspose.PDF 22.6

PDF a PDF_A_1A: implemente la opción para eliminar el color de transparencia para evitar un tamaño de archivo de salida grande.



A partir de la versión 22.5, el cliente puede controlar la calidad de la transparencia convertida y, como resultado, el tamaño del archivo de salida:
...
## 
Novedades de Aspose.PDF 22.5



Durante la conversión de PDF/A, el contenido transparente se elimina y se reemplaza con una imagen.
...
## 
Novedades de Aspose.PDF 22.3



PDF a ODS: la compatibilidad con RTL está disponible en la versión 22.3
...
## 
Novedades de Aspose.PDF 22.2



Esta versión incluye PDF a XSLX: compatibilidad con RTL (hebreo, árabe).

## Novedades de Aspose.PDF 22.1
...
## Novedades de Aspose.PDF 21.8


### 
¿Cómo cambiar el color del texto en Firma Digital?



En la versión 21.8 setForegroundColor, permite cambiar el color del texto en Firma Digital:
...
## 
Novedades de Aspose.PDF 21.6


### 
Ocultar imagen usando ImagePlacementAbsorber del documento
...
Aspose.PDF 21.4 le permite combinar imágenes. Combina la lista de secuencias de imágenes como una sola secuencia de imágenes. Se admiten los formatos de salida png/jpg/tiff, en caso de utilizar un flujo de salida de formato no compatible codificado como Jpeg de forma predeterminada.
