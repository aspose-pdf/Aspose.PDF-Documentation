...
1. Open the TeX source by passing the file path and [`TeXLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/texloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Open the PostScript source with [`PsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/psloadoptions/) in the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Open the EPS source with [`PsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/psloadoptions/) because EPS follows the same PostScript-based load path.
1. Load the file into a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) so the page-description content is converted during import.
...
1. Open the EPUB source by passing the file path and [`EpubLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/epubloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Open the Markdown source by passing the file path and [`MdLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/mdloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Wrap the text in a [`TextFragment`](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/) and add it to the page paragraphs collection.
1. Save the generated PDF.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) and configure each [`Page`](https://reference.aspose.com/pdf/java/com.aspose.pdf/page/) with margins and default text state.
1. Resolve the monospaced font through [`FontRepository`](https://reference.aspose.com/pdf/java/com.aspose.pdf/fontrepository/) and add each line as a [`TextFragment`](https://reference.aspose.com/pdf/java/com.aspose.pdf/textfragment/).
...
Utilice este ejemplo cuando una secuencia de impresión PCL deba convertirse a PDF.

1. Create [`PclLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pclloadoptions/) and enable suppressed parsing errors when lenient import behavior is required.
1. Open the PCL source by passing the file path and load options into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Pass the generated HTML file into the existing HTML-to-PDF conversion function so the final PDF uses the standard [`HtmlLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlloadoptions/) workflow.
...
1. Open the XPS source by passing the file path and [`XpsLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/xpsloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) constructor.
...
1. Create [`XslFoLoadOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/xslfoloadoptions/) with the XSLT path so the XML source can be transformed during loading.
1. Configure the parsing error handling mode to throw immediately when invalid XSL-FO is encountered.
1. Open the XML source in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) with those load options.
