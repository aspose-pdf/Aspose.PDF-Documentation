...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and set `setSpecialFolderForAllImages(...)` to a dedicated image output directory.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and enable `setSplitIntoPages(true)`.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and set `setSpecialFolderForSvgImages(...)` to an external SVG resource directory.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and configure a dedicated folder for SVG resources.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and set the raster image saving mode to PNG page backgrounds.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and set the markup generation mode to `WriteOnlyBodyContent`.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and enable transparent and shadowed text preservation.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`HtmlSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/htmlsaveoptions/) and enable `setConvertMarkedContentToLayers(true)`.
