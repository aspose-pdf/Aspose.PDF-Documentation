...
type: docs
weight: 10
url: /es/javascript-cpp/supported-file-formats/
description: Esta página muestra cuáles formatos de archivo Aspose.PDF para JavaScript puede cargar y guardar.
lastmod: "2021-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
La siguiente tabla indica los formatos de archivo que Aspose.PDF para JavaScript a través de C++ puede cargar y guardar.
