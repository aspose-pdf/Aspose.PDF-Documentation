...
Aspose.PDF for SharePoint le permite agregar una marca de agua a un documento PDF. La función agrega una marca de agua de texto en la esquina inferior izquierda de cada página de un documento PDF agregado a la biblioteca.
