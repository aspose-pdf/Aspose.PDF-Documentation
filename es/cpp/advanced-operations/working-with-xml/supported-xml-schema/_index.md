...
type: docs
weight: 10
url: es/cpp/supported-xml-schema/
description: Este artículo describe un esquema XML para trabajar con documentos XML en Aspose.PDF para C++.
lastmod: "2022-01-31"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
Aspose.PDF para C++ utiliza el siguiente esquema XML para trabajar con documentos XML:
