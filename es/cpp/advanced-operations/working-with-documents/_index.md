...
- [Create PDF Document](/pdf/es/cpp/create-pdf-document/) - crear PDF, crear documento PDF con capacidad de búsqueda.
- [Formatting PDF Document](/pdf/es/cpp/formatting-pdf-document/) - obtener y establecer propiedades del documento, incrustar fuentes y otras operaciones con archivos PDF.
- [Manipulate PDF Document](/pdf/es/cpp/manipulate-pdf-document/) - validar un documento PDF para el estándar PDF A, trabajar con TOC, establecer fecha de caducidad del PDF, etc.
- [Optimize PDF Documents](/pdf/es/cpp/optimize-pdf/) - optimizar el contenido de la página, optimizar el tamaño del archivo, eliminar objetos no utilizados, comprimir todas las imágenes para una optimización exitosa del documento.
- [Merge PDF](/pdf/es/cpp/merge-pdf-documents/) - fusionar varios archivos PDF en un solo documento PDF usando C++.
- [Split PDF](/pdf/es/cpp/split-pdf-document/) - dividir páginas PDF en archivos PDF individuales en tus aplicaciones C++.
- [Working with Headings](/pdf/es/cpp/working-with-headings/) - puedes crear numeración en el encabezado de tu documento PDF con C++.