...
Un sello en un documento PDF es análogo a aplicar un sello de goma en un documento de papel. El sello en el archivo PDF proporciona información adicional para el archivo PDF, como proteger el archivo PDF para que no sea utilizado por otros y confirmar la seguridad del contenido del archivo PDF. **Aspose.PDF para C++** permite agregar sellos de imagen o texto en su documento PDF.
