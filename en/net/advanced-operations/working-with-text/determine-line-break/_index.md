...
private static void DetermineLineBreak(string outputPathPdf, string outputPathTxt)
{
	// Open document
	using (var document = new Aspose.Pdf.Document())
	{
		...
		// Save document
		document.Save(outputPathPdf);

		string notifications = document.Pages[1].GetNotifications();
		File.WriteAllText(outputPathTxt, notifications);
	}
}
```
