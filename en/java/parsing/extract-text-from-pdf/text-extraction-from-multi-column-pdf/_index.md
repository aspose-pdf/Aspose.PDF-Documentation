...
1. Create a [TextFragmentAbsorber](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/textfragmentabsorber/) and visit all document pages.
1. Iterate through the [TextFragment](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/textfragment/) objects and reduce each font size.
1. Save the adjusted [Document](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) to an in-memory stream.
1. Reopen the transformed [Document](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) from memory.
1. Create a [TextAbsorber](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/textabsorber/), visit all pages, and write the extracted text to the output file.
...
1. Create [TextExtractionOptions](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/textextractionoptions/) in pure formatting mode.
