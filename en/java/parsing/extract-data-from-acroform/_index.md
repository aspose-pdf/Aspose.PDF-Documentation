...
1. Close the [Form](https://reference.aspose.com/pdf/en/java/com.aspose.pdf.facades/form/) facade.
...
1. Create the [Form](https://reference.aspose.com/pdf/en/java/com.aspose.pdf.facades/form/) facade.
