...
The second way to add [FormattedText](https://reference.aspose.com/pdf//java/com.aspose.pdf.facades/formattedtext). Additionally, we indicate a rectangle in which our text should fit.
...
Adding images and text in an existing PDF file is a common requirement and com.aspose.pdf.facades namespace fulfills this requirement very well. It provides a class [PdfFileMend](https://reference.aspose.com/pdf/java/com.aspose.pdf.facades/PdfFileMend) which allows you to add images in the PDF file.
...
Let's consider the second code snippet. By using variations of the [CompositingParameters](https://reference.aspose.com/pdf/java/com.aspose.pdf/CompositingParameters) class parameters, we can get different design effects.
...
In the following code snippet we use [ImageFilterType](https://reference.aspose.com/pdf/java/com.aspose.pdf/ImageFilterType). ImageFilterType indicates the type of stream codec that will be used for encoding, by default Jpeg. if you load an image from PNG format, then it will be saved in the document as JPEG (or in another format I have specified).
...
In the next code snippet you can note the use of the [IsMasked](https://reference.aspose.com/pdf/java/com.aspose.pdf/CompositingParameters#isMasked--) method.

[IsMasked](https://reference.aspose.com/pdf/java/com.aspose.pdf/CompositingParameters#isMasked--) is a flag, which indicates whether to apply a mask to the image in order to achieve transparency of the original image
