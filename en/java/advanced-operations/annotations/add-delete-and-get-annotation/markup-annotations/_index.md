...
1. Create the required markup annotation, such as [HighlightAnnotation](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/highlightannotation/) or [UnderlineAnnotation](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/underlineannotation/), on the target [Page](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/).
1. Set the annotation properties required by the example.
1. Add the annotation to the target page.
1. Save the updated PDF [Document](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/).
1. Add the annotation to the page collection and save the [Document](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/).
