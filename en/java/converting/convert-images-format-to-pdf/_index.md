...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) to hold the output PDF.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and place the BMP with `page.addImage(...)`.
1. Define the target image rectangle with [`Rectangle`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/rectangle/) so the raster content fills the PDF page area.
...
1. Open the CGM source by passing the file path and [`CgmLoadOptions`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/cgmloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) constructor.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) for the PDF output.
1. Create an [`Image`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/image/) object, set its [`ImageFileType`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/imagefiletype/) to `Dicom`, and assign the source file path.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and append the DICOM image to the page paragraphs collection.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) and open the EMF source as a binary stream.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and clear its margins so the EMF artwork can occupy the full page area.
1. Create an [`Image`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/image/), bind the EMF stream to it, and add it to the page paragraphs collection.
1. Save the output PDF file.
...
1. Create an [`Image`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/image/) from the intermediate byte stream and add it to the page.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) for the PDF output.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and place the GIF with `page.addImage(...)`.
1. Define the placement bounds with [`Rectangle`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/rectangle/) so the image fills the page area.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) for the output PDF.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and insert the JPEG image with `page.addImage(...)`.
1. Use [`Rectangle`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/rectangle/) to control how the raster image is mapped to page coordinates.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) for the conversion output.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and place the PNG image on it with `page.addImage(...)`.
1. Use [`Rectangle`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/rectangle/) to size the image against the page canvas.
...
1. Open the SVG source by passing the file path and [`SvgLoadOptions`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/svgloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) constructor.
...
1. Create an empty [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) for the PDF output.
1. Add a [`Page`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/page/) and place the TIFF image with `page.addImage(...)`.
1. Define the placement area with [`Rectangle`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/rectangle/) so the TIFF content is mapped to page coordinates.
1. Save the result as PDF.
...
1. Open the CDR source by passing the file path and [`CdrLoadOptions`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/cdrloadoptions/) into the [`Document`](https://reference.aspose.com/pdf/en/java/com.aspose.pdf/document/) constructor.
