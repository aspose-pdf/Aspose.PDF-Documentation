...
---
Aspose.PDF for Java supports exporting PDF pages into editable PowerPoint presentations with slide rendering options. Use [`PptxSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pptxsaveoptions/) to control how PDF pages are mapped into PowerPoint slides.
...
1. Create default [`PptxSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pptxsaveoptions/) for editable PowerPoint export.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`PptxSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pptxsaveoptions/) and enable `setSlidesAsImages(true)`.
...
1. Open the source PDF in a [`Document`](https://reference.aspose.com/pdf/java/com.aspose.pdf/document/) instance.
1. Create [`PptxSaveOptions`](https://reference.aspose.com/pdf/java/com.aspose.pdf/pptxsaveoptions/) and set `setImageResolution(300)` for higher slide image fidelity.
