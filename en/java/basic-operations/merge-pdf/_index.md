...
1. Append the pages from the second document to the first document with `document1.getPages().add(document2.getPages())`.
1. Save the merged document to the output path.
