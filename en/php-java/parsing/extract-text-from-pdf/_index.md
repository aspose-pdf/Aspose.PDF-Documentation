...
description: Aspose.PDF allows for extracting different kinds of information. This section contains articles on text extraction from PDF documents using Aspose.PDF for PHP.
lastmod: "2024-05-20"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
- [Extract Text from PDF](/pdf/php-java/extract-text-from-all-pdf/)
- [Extract Paragraph from PDF](/pdf/php-java/extract-paragraph-from-pdf/)
