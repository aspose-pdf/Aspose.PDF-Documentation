...
description: This section shows how to use all kinds of annotations to your PDF file with the Aspose.PDF library. Learn how to draw, open, or add an annotation with PHP.
lastmod: "2024-06-26"    
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
- [Add Annotation](/pdf/php-java/add-delete-and-get-annotation/) - this section explains how to work with Watermark annotations.
