...
1. Open the protected PDF document with [open_with_password](https://reference.aspose.com/pdf/go-cpp/security/open_with_password/) and provide the file path along with the owner password to unlock the document.
