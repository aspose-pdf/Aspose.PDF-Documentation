...
1. Call [set_permissions](https://reference.aspose.com/pdf/go-cpp/security/set_permissions/) to protect the document.
...
1. Save the PDF with permissions applied using [save_as](https://reference.aspose.com/pdf/go-cpp/core/save_as/).
