...
description: This article explains how to access, modify, and save metadata in PDF documents using Aspose.PDF for Python.
lastmod: "2026-03-05"
draft: false
sitemap:
    changefreq: "weekly"
...
- [Set PDF Metadata](/pdf/python-net/set-pdf-metadata/)
- [Clear PDF Metadata](/pdf/python-net/clear-pdf-metadata/)
- [Save Metadata with XMP](/pdf/python-net/save-metadata-with-xmp/)
