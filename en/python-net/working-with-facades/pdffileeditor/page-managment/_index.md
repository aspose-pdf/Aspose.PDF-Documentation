...
## Common page management operations

Use the following tutorials to handle the most common page-level editing tasks with `PdfFileEditor`:

- [Extract Pages from PDF](/pdf/python-net/extract-pages-from-pdf/)
- [Delete Pages from PDF](/pdf/python-net/delete-pages-from-pdf/)
- [Insert Pages into PDF](/pdf/python-net/insert-pages-into-pdf/)
- [Append Pages to PDF](/pdf/python-net/append-pages-to-pdf/)
