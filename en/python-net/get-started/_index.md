...
- [Set and save XMP metadata](/pdf/python-net/save-metadata-with-xmp/)
- [Validate PDF documents for PDF/A-1a and PDF/A-1b compliance](/pdf/python-net/manipulate-pdf-document/)
- Work with [bookmarks](/pdf/python-net/bookmarks/), [annotations](/pdf/python-net/annotations/), [PDF forms](/pdf/python-net/working-with-forms/), [stamps](/pdf/python-net/stamping/), and [watermarks](/pdf/python-net/add-watermarks/)
...
- [Create a complex PDF document](/pdf/python-net/complex-pdf-example/)
