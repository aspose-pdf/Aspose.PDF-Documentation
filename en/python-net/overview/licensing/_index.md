...
- **PDF created with an evaluation watermark.** The evaluation version of Aspose.PDF for Python provides full product functionality, but all the pages in the generated PDF documents are watermarked with "Evaluation Only. Created with Aspose.PDF for Python. Copyright 2002-2020 Aspose Pty Ltd" at the top.
...
If you use any other Aspose for Python component along with Aspose.PDF for Python, please specify the namespace for License like [aspose.pdf.License](https://docs.aspose.com/pdf/).
