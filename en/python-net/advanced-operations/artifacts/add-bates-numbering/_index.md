...
Abstract: "This article demonstrates how to add and remove Bates numbering in PDF documents using Aspose.PDF for Python via .NET. It explains the purpose of Bates numbering in legal, medical, and business contexts and introduces the BatesNArtifact class for configuring numbering parameters such as start page, digit count, prefixes, suffixes, alignment, and margins. The guide provides multiple code examples: a direct method using add_bates_numbering, adding the artifact via a pagination collection, and configuring the artifact through a delegate function. It also shows how to delete existing Bates numbering with delete_bates_numbering. By following these examples, developers can automate the creation and management of sequential page identifiers across PDF files."
---
