...
<script type="application/ld+json">
{
    ...
    "keywords": "pdf, python, delete attachments",
    "wordcount": "302",
    ...
    "description": "Aspose.PDF for Python can remove attachments from your PDF documents. Use Python PDF API to remove attachments in PDF files using Aspose.PDF library."
}
</script>
