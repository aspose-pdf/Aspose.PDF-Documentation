...
weight: 60
url: /zh/net/working-with-forms/
description: 本节解释如何在您的 PDF 文档中使用 AcroForms 和 XFA 表单，使用 Aspose.PDF for .NET。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现 Aspose.PDF for .NET 的新功能，使您能够直接在 PDF 文档中与 AcroForms 和 XFA 表单无缝交互。这个强大的功能简化了以编程方式映射和填写表单的过程，增强了 C# 开发人员的文档操作能力。今天就解锁高级 PDF 表单处理功能！",
    "author": {
        "@type": "Person",
