...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET引入了从头创建可填写PDF表单的功能，使开发者能够无缝集成可定制的表单字段，如文本框、单选按钮和组合框到PDF中。此功能增强了文档的交互性并优化了应用程序内的数据收集流程",
    "author": {
        "@type": "Person",
...
[TextBoxField](https://reference.aspose.com/pdf/zh/net/aspose.pdf.forms/textboxfield)可以附带一些小部件注解添加。
{{< tabs tabID="1" tabTotal="2" tabName1=".NET Core 3.1" tabName2=".NET 8" >}}
{{< tab tabNum="1" >}}
```csharp
...
以下代码片段展示了添加带有三个选项的单选按钮字段并将其放置在表格单元格中的步骤。
...
Document类提供了一个名为Form的集合，用于管理PDF文档中的表单字段。要为表单字段添加工具提示，可使用Field类的AlternateName属性。Adobe Acrobat将"alternate name"作为字段的工具提示使用。
