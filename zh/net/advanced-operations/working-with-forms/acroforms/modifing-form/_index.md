...
weight: 40
url: /zh/net/modifing-form/
description: 使用 Aspose.PDF for .NET 库修改 PDF 文件中的表单。您可以在现有表单中添加或删除字段，获取和设置字段限制等。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET 库中的新修改 AcroForm 功能允许用户无缝地从现有 PDF 表单中添加或删除字段。此功能还包括设置字段限制和自定义字体外观，以提升用户体验，增强 PDF 表单管理和交互。",
    "author": {
        "@type": "Person",
