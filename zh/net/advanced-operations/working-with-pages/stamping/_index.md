...
weight: 120
url: /zh/net/stamping/
description: 本节描述如何向 PDF 页面添加图像印章和文本印章。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现 **Aspose.PDF for .NET** 在管理 PDF 页面方面的高级功能，包括精确添加、移动和删除页面。此功能使用户能够通过直观的 C# 代码在 PDF 文档中添加页眉、页脚、水印和自定义页面大小，从而增强其 PDF 文档。通过无缝的 PDF 操作和自定义功能优化您的文档工作流程。",
    "author": {
        "@type": "Person",
...
在 PDF 文档中，印章类似于在纸质文档上使用橡皮图章。
PDF 文件中的印章提供了额外的信息，例如保护 PDF 文件不被他人使用，并确认 PDF 文件内容的安全性。**Aspose.PDF for .NET** 允许在您的 PDF 文档中添加图像或文本印章。
