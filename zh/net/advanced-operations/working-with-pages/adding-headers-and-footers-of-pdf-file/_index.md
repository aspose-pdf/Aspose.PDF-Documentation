---
title: 添加PDF的页眉和页脚
linktitle: 添加PDF的页眉和页脚
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 70
url: /zh/net/add-headers-and-footers-of-pdf-file/
description: Aspose.PDF for .NET 允许您使用 TextStamp 类向 PDF 文件添加页眉和页脚。
lastmod: "2022-02-17"
sitemap:
changefreq: "monthly"
priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET 引入了一项强大的功能，允许用户通过添加可自定义的页眉和页脚来丰富他们的PDF文档。使用 TextStamp 和 ImageStamp 类，开发人员可以轻松集成文本和图像，调整其位置和外观以适应各种文档格式和样式。这增强了文档的专业性和可读性，使其非常适合报告、发票和其他正式通信。",
    "author": {
        "@type": "Person",
...
**Aspose.PDF for .NET** 使您能够向现有的 PDF 文件添加页眉和页脚。您可以将图像和文本插入文档中。
