...
背景图像可用于向文档添加水印或其他细腻的设计。在Aspose.PDF for .NET中，每个PDF文档都是页面的集合，每个页面包含一组工件。可以使用[BackgroundArtifact](https://reference.aspose.com/pdf/zh/net/aspose.pdf/backgroundartifact)类将背景图像添加到页面对象。
