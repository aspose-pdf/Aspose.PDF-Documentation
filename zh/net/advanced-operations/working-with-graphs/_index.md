...
在处理 Adobe Acrobat Writer 或其他 PDF 处理应用程序时，向 PDF 文档添加图形是开发人员非常常见的任务。PDF 应用程序中可以使用多种类型的图形。[Aspose.PDF for .NET](/pdf/net/) 也支持向 PDF 文档添加图形。为此，提供了 Graph 类。Graph 是一个段落级元素，可以添加到 Page 实例中的 Paragraphs 集合中。Graph 实例包含一个形状的集合。
...
- [线](/pdf/net/add-line) - 线图用于显示连续数据，并且在显示随时间变化的趋势时可以对预测未来事件非常有用。
