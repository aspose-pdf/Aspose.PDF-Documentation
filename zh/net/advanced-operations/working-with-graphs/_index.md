...
<script type="application/ld+json">
{
    ...
    "abstract": "发现使用 Aspose.PDF for .NET 在 PDF 文档中生成和操作图形的强大新功能。此功能允许开发人员创建多种图形形状，包括弧、圆、线和矩形，从而增强其应用程序中数据的视觉呈现。优化您的 PDF 生成过程，轻松提供动态数据可视化",
    "author": {
        "@type": "Person",
...
在处理 Adobe Acrobat Writer 或其他 PDF 处理应用程序时，向 PDF 文档添加图形是开发人员非常常见的任务。PDF 应用程序中可以使用多种类型的图形。
[Aspose.PDF for .NET](/pdf/net/) 也支持向 PDF 文档添加图形。为此，提供了 Graph 类。Graph 是一个段落级元素，可以添加到 Page 实例中的段落集合中。Graph 实例包含一个形状集合。
