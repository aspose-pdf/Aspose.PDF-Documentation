...
weight: 10
url: /zh/net/overview-of-annotations/
description: 查看您可以使用 Aspose.PDF for .NET 处理的可能注释列表。
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现 Aspose.PDF for .NET 中可用的支持注释的综合列表，使开发人员能够通过各种功能增强 PDF 文档。此功能包括多种注释类型，如文本、链接、高亮和多媒体，为 PDF 操作和自定义提供强大的选项。探索这些注释如何提升您的 .NET 应用程序并改善用户与 PDF 内容的互动",
    "author": {
        "@type": "Person",
...
以下表格指示了 Aspose.PDF for .NET 支持的注释类型。
