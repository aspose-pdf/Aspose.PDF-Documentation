---
title: 可访问性和标记PDF
linktitle: 可访问性. 标记PDF
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 180
url: /zh/net/accessibility-tagged-pdf/
description: 了解如何使用Aspose.PDF for .NET生成可访问的标记PDF。遵循可访问性标准以实现包容性文档设计。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "创建具有增强标记功能的可访问PDF。此新功能使辅助技术更容易导航和阅读文档，提高了残疾用户的可访问性。开发符合要求的包容性PDF文档",
    "author": {
        "@type": "Person",
...
标记PDF文档可以被残疾人士访问。向PDF文件添加可访问性标签使屏幕阅读器和其他辅助技术更容易读取和导航文档，包括目录、超链接、书签、替代文本等。
