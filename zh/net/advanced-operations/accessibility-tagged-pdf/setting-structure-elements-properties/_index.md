...
weight: 30
url: /zh/net/setting-structure-elements-properties/
description: 您可以使用 Aspose.PDF for .NET 在 PDF 文档中设置不同的结构元素属性。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "通过 Aspose.PDF for .NET 中的新功能增强您的 PDF 文档的可访问性，该功能允许用户为结构元素设置属性。此功能使您能够精确控制标记 PDF 中各种元素的标题、语言和自定义标签，确保符合标准并改善屏幕阅读器的导航。",
    "author": {
        "@type": "Person",
...
Aspose.PDF for .NET API 还允许您添加链接结构元素。以下代码片段展示了如何将链接结构元素添加到标记 PDF 文档中：
...
Aspose.PDF for .NET API 还允许您根据 PDF/UA 规范为文档设置语言和标题。语言可以为整个文档或其单独的结构元素设置。以下代码片段展示了如何在标记 PDF 文档中设置语言和标题：
