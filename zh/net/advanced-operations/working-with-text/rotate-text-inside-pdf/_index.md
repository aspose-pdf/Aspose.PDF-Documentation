---
title: 使用 C# 在 PDF 中旋转文本
linktitle: 在 PDF 中旋转文本
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 50
url: /zh/net/rotate-text-inside-pdf/
description: 学习如何使用 Aspose.PDF 在 .NET 中旋转 PDF 文件中的文本，以调整文本对齐和改善展示效果。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET 允许用户在 PDF 文档中以各种角度旋转文本片段和整个段落。此功能通过启用精确的文本方向调整，增强了文档的灵活性，满足专业和创意应用中的多样化格式需求。用户可以轻松使用提供的 API 实现这些旋转，提升文档生成体验。",
    "author": {
        "@type": "Person",
    ...
    "description": "学习将文本旋转到 PDF 的不同方法。Aspose.PDF 允许您将文本旋转到任意角度，旋转文本片段或整个段落。"
}
</script>
