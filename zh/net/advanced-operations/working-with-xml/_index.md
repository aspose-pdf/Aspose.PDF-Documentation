...
weight: 80
url: /zh/net/working-with-xml/
description: 学习如何从 XML 生成 PDF 文档
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现直接从 XML 生成 PDF 文档的强大能力。此功能简化了 XML 数据操作的过程，允许无缝的文档转换，从而提高您应用程序的生产力和效率。利用此功能来简化您的工作流程并改善数据呈现",
    "author": {
        "@type": "Person",
