---
title: 使用 C# 操作 PDF 书签
linktitle: 书签
type: docs
ai_search_scope: pdf_net
ai_search_endpoint: https://docsearch.api.aspose.cloud/ask
weight: 30
url: /zh/net/bookmarks/
description: 了解如何使用 Aspose.PDF 在 .NET 中操作 PDF 书签，以便轻松进行文档导航和组织。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现 Aspose.PDF for .NET 的新功能，使用户能够高效管理 PDF 文档中的书签。此功能允许无缝添加、删除和检索书签，增强 PDF 文件内的导航和可访问性。",
    "author": {
        "@type": "Person",
    ...
    "description": "本节解释如何使用 Aspose.PDF for .NET 添加、删除和获取书签。"
}
</script>
