...
weight: 140
url: /zh/net/navigation-and-interaction/
description: 本节描述了与链接、操作和书签相关的功能。
lastmod: "2022-02-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "abstract": "发现使用C#以编程方式管理PDF文档中的链接的新功能。此功能允许您轻松添加内部页面链接和外部网站超链接，从而增强PDF中的导航和交互性。非常适合希望简化PDF管理流程的开发人员！",
    "author": {
        "@type": "Person",
...
- [链接](/pdf/net/links/) - 您可以轻松地使用C#创建、更新和提取链接。
- [操作](/pdf/net/actions/) - 可以向PDF文件添加和获取超链接。此外，在本文中，您将学习如何从PDF文件中删除文档打开操作以及如何在查看文档时指定PDF页面。
- [书签](/pdf/net/bookmarks/) - 大型出版物通常包括一个书签框架，可以在书签窗格中轻松查看和选择，允许您单击书签跳转到其所代表的页面或章节。书签窗格是一个内容感知元素，仅在打开的PDF文档包含书签结构时在侧边栏中可见。
