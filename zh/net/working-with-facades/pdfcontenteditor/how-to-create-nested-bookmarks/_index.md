...
description: 本节解释如何使用 PdfContentEditor 类创建嵌套书签。
lastmod: "2021-06-05"
draft: false
---
<script type="application/ld+json">
{
    ...
    "abstract": "使用 Aspose.Pdf.Facades 中的 PdfContentEditor 类，通过新的嵌套书签功能增强您的 PDF 文档。此功能允许您创建层次书签，有效组织您的内容，使用户能够轻松浏览 PDF 中的章节和相关页面。通过这一复杂的书签解决方案简化文档导航并改善用户体验。",
    "author": {
        "@type": "Person",
...
除了创建简单书签外，有时您需要以章节的形式创建书签，在章节书签内嵌套单个书签，以便当您点击章节的 + 符号时，可以看到书签展开时的页面，如下图所示。
