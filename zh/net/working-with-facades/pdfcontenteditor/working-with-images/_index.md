...
description: 本节解释如何使用 PdfContentEditor 类通过 Aspose.PDF Facades 添加和删除图像。
lastmod: "2021-06-24"
---
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET 现在通过 PdfContentEditor 类提供增强的图像管理功能，使用户能够轻松删除指定页面上的特定图像或完全从 PDF 文件中删除所有图像。此外，该功能允许无缝替换图像，简化编辑过程并改善文档定制",
    "author": {
        "@type": "Person",
