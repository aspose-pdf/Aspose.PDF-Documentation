...
[Aspose.PDF for .NET](/pdf/zh/net/) 是一个功能丰富的组件，涉及 PDF 文档的编辑。正如我们所知，XFDF 是 PDF 表单操作的重要方面，[Aspose.Pdf.Facades 命名空间](https://reference.aspose.com/pdf/zh/net/aspose.pdf.facades) 在 [Aspose.PDF for .NET](/pdf/zh/net/) 中对此进行了很好的考虑，并提供了将注释数据导入和导出到 XFDF 文件的方法。
