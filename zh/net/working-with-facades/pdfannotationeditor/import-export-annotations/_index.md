...
[Aspose.PDF for .NET](/pdf/zh/net/)是一个功能丰富的组件，当涉及到编辑PDF文档时。 ```
As we know XFDF is an important aspect of PDF forms manipulation, [Aspose.Pdf.Facades namespace](https://reference.aspose.com/pdf/net/aspose.pdf.facades) in [Aspose.PDF for .NET](/pdf/zh/net/) has considered this very well, and have provided methods to import and export annotations data to XFDF files.
...
```
正如我们所知，XFDF 是 PDF 表单操作的重要方面，[Aspose.Pdf.Facades 命名空间](https://reference.aspose.com/pdf/net/aspose.pdf.facades) 在 [Aspose.PDF for .NET](/pdf/zh/net/) 中对此进行了充分考虑，并提供了将注释数据导入和导出到 XFDF 文件的方法。
