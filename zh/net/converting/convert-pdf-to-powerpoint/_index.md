...
<script type="application/ld+json">
{
    ...
    "abstract": "Aspose.PDF for .NET 引入了一项强大的功能，使 PDF 文档无缝转换为 PowerPoint（PPTX）格式，允许每个 PDF 页面转换为一个独立的幻灯片。 通过将文本呈现为可选择或图像的选项，用户可以轻松自定义他们的演示文稿，同时有效跟踪转换进度。 通过利用这一创新功能来优化您的文档工作流程，以提高生产力。",
    "author": {
        "@type": "Person",
...
- [将 PDF 转换为 PowerPoint](#csharp-pdf-to-powerpoint)

以下代码片段也适用于 [Aspose.PDF.Drawing](/pdf/zh/net/drawing/) 库。

## C# PDF 到 PowerPoint 和 PPTX 转换

<a name="csharp-convert-pdf-to-powerpoint" id="csharp-convert-pdf-to-powerpoint"><strong>将 PDF 转换为 PowerPoint</strong></a>
...
在 PDF 到 <abbr title="Microsoft PowerPoint 2007 XML Presentation">PPTX</abbr> 转换过程中，文本被呈现为可选择的文本，您可以选择/更新它。 请注意，为了将 PDF 文件转换为 PPTX 格式，Aspose.PDF 提供了一个名为 [`PptxSaveOptions`](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 的类。 PptxSaveOptions 类的对象作为第二个参数传递给 [`Document.Save(..) 方法`](https://reference.aspose.com/pdf/zh/net/aspose.pdf/document/methods/save)。 以下代码片段展示了将 PDF 文件转换为 PPTX 格式的过程。

## 使用 C# 和 Aspose.PDF .NET 进行简单的 PDF 到 PowerPoint 转换

为了将 PDF 转换为 PPTX，Aspose.PDF for .NET 建议使用以下代码步骤。

<a name="csharp-pdf-to-powerpoint"><strong>将 PDF 转换为 PowerPoint</strong></a>

1. 创建 [Document](https://reference.aspose.com/pdf/zh/net/aspose.pdf/document) 类的实例。
2. 创建 [PptxSaveOptions](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 类的实例。
...
如果您需要将可搜索的 PDF 转换为 PPTX 图像而不是可选择的文本，Aspose.PDF 通过 [Aspose.Pdf.PptxSaveOptions](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 类提供了这样的功能。 为此，将 [PptxSaveOptios](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 类的属性 [SlidesAsImages](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions/properties/slidesasimages) 设置为 'true'，如下所示的代码示例。
...
Aspose.PDF for .NET 让您跟踪 PDF 到 PPTX 转换的进度。 [Aspose.Pdf.PptxSaveOptions](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 类提供了 [CustomProgressHandler](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions/properties/customprogresshandler) 属性，可以指定为自定义方法，以跟踪转换的进度，如以下代码示例所示。
