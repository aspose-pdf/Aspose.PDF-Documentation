...
Aspose.PDF for .NET 让您跟踪 PDF 到 PPTX 转换的进度。 [Aspose.Pdf.PptxSaveOptions](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions) 类提供了 [CustomProgressHandler](https://reference.aspose.com/pdf/zh/net/aspose.pdf/pptxsaveoptions/properties/customprogresshandler) 属性，可以指定为自定义方法以跟踪转换的进度，如以下代码示例所示。
