...
我们将在此应用中使用**复杂示例**中的代码。请跟随[此链接](/pdf/zh/net/complex-pdf-example/)了解更多详细说明。

1. 在 `wwwroot` 文件夹中创建 `images` 文件夹并放入图片 `logo.png`。您可以从[这里](/pdf/zh/net/docker/logo.png)下载此图片
