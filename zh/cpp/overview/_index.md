...
让我们查看文档页面以获取更多详细信息：[优化 PDF](/pdf/cpp/optimize-pdf/)
### 表格创建与操作
...
让我们查看下一部分以获取更多详细信息：[使用表格](/pdf/cpp/working-with-tables/)
...
让我们查看文档页面以获取更多详细信息：[使用图形](/pdf/cpp/graphs/)
...
让我们查看下一节以获取更多详细信息：[Actions](/pdf/cpp/actions/)
...
让我们查看文档页面以获取更多详细信息：[安全和签名](/pdf/cpp/securing-and-signing/)
...
让我们查看下一节以获取更多详细信息：[书签](/pdf/cpp/add-and-delete-bookmark/)
...
让我们查看文档页面以获取更多详细信息：[与目录一起工作](/pdf/cpp/manipulate-pdf-document/)

### 添加、更新、删除附件和注释

添加附件和注释使 PDF 文档对读者更具互动性和吸引力。用户可以与文档中嵌入的其他内容（如多媒体文件、链接或评论）进行交互，从而增强他们的阅读体验。

Aspose.PDF for C++ 库有多种关于[注释](/pdf/cpp/annotations/)的操作。您可以添加以下类型：
...
有关更多详细信息，请查看以下[文档页面](/pdf/cpp/attachments/)。
...
使用**Aspose.PDF for C++**库可以轻松快速地管理PDF文档中的[元数据](/pdf/cpp/pdf-file-metadata/)。
...
您还可以添加、更改位置、删除图像，并在PDF中进行更多[复杂操作](/pdf/cpp/working-with-images/)。

### 拆分、连接、提取或插入页面
The [处理 PDF 页面](/pdf/cpp/working-with-pages/) 部分在文档中解释了如何添加、移动、删除、旋转或拆分 PDF 页。
...
Aspose.PDF 库使用 DocumentDevice 或 ImageDevice 类进行 PDF 到图像的转换。[将 PDF 转换为不同的图像格式](/pdf/cpp/convert-pdf-to-images-format/)。
...
让我们查看下一节以了解更多详细信息：[打印 PDF 文档](/pdf/cpp/printing-document/)。

此外，Aspose.PDF for C++ 可以轻松将文本、图像、SVG、HTML 转换为 PDF，并以卓越的性能和良好的质量将 PDF 转换为各种文档格式。

## Pricing and Policies

请访问 [Licensing](/pdf/cpp/licensing/) 页面了解许可证信息，并查看 [Pricing Information](https://purchase.aspose.com/pricing/pdf/family/) 页面了解定价详情。

## Technical Support

有关 Aspose.PDF 技术支持的更多信息，请查看 [Support page](/pdf/cpp/technical-support/)。

了解更多关于：

- [Supported File Formats](/pdf/cpp/supported-file-formats/)
- [Aspose.PDF 的主要特点](/pdf/cpp/key-features/)
- [系统要求](/pdf/cpp/system-requirements/)
- [安装](/pdf/cpp/installation/)
- [许可](/pdf/cpp/licensing/)
- [技术支持](/pdf/cpp/technical-support/)