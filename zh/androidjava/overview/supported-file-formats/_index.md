...
description: 此页面显示 Aspose.PDF for Android via Java 可以加载和保存的文件格式。
lastmod: "2026-07-01"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
下表指示 Aspose.PDF for Android via Java 可以加载和保存的文件格式。

|**格式**|**描述**|**加载**|**保存**|**备注**|
| :- | :- | :- | :- | :- |
|[PDF](https://docs.fileformat.com/pdf/)|可移植 文档格式|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[XLS](https://docs.fileformat.com/spreadsheet/xls/)|将文档保存为 Microsoft Excel 电子表格| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|将文档保存为 JPEG 格式| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|增强型图元文件格式（EMF）| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|将文档保存为 PNG 格式| |{{< emoticons/tick >}}| |
|[位图](https://docs.fileformat.com/image/bmp/)|将文档保存为 BMP 格式| |{{< emoticons/tick >}}| |
...
|[DICOM ](https://docs.fileformat.com/image/dicom/)|在 PDF 文档中添加 DICOM 图像| |{{< emoticons/tick >}}| |
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|将文档保存为 CSV 格式| |{{< emoticons/tick >}}| |
|[文本](https://docs.fileformat.com/word-processing/txt/)|将文档保存为 int 文本格式| |{{< emoticons/tick >}}| |
