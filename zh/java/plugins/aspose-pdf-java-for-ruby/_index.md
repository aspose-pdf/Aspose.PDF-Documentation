...
- [下载和配置 Ruby 中的 Aspose.Pdf](/pdf/zh/java/download-and-configure-aspose-pdf-in-ruby/)
- [Ruby 程序员指南](/pdf/zh/java/ruby-programmers-guide/)
  - [在 Ruby 中处理文档对象](/pdf/zh/java/working-with-document-object-in-ruby/)
    ...
    - [在 Ruby 中为现有 PDF 添加目录](/pdf/zh/java/add-toc-to-existing-pdf-in-ruby/)
- [获取文档窗口和页面显示属性（Ruby）](/pdf/zh/java/get-document-window-and-page-display-properties-in-ruby/)
- [获取 PDF 文件信息（Ruby）](/pdf/zh/java/get-pdf-file-information-in-ruby/)
- [从 PDF 文件获取 XMP 元数据（Ruby）](/pdf/zh/java/get-xmp-metadata-from-pdf-file-in-ruby/)
- [优化 PDF 文档以用于网络（Ruby）](/pdf/zh/java/optimize-pdf-document-for-the-web-in-ruby/)
- [优化 PDF 文件大小（Ruby）](/pdf/zh/java/optimize-pdf-file-size-in-ruby/)
- [从 PDF 中移除元数据（Ruby）](/pdf/zh/java/remove-metadata-from-pdf-in-ruby/)
- [设置文档窗口和页面显示属性（Ruby）](/pdf/zh/java/set-document-window-and-page-display-properties-in-ruby/)
- [设置 PDF 过期时间（Ruby）](/pdf/zh/java/set-pdf-expiration-in-ruby/)
- [设置 PDF 文件信息（Ruby）](/pdf/zh/java/set-pdf-file-information-in-ruby/)
- [在 Ruby 中处理页面](/pdf/zh/java/working-with-pages-in-ruby/)

  - [合并 PDF 文件（Ruby）](/pdf/zh/java/concatenate-pdf-files-in-ruby/)
- [从 PDF 文件中删除特定页面在 Ruby 中](/pdf/zh/java/delete-a-particular-page-from-the-pdf-file-in-ruby/)
- [在 Ruby 中获取 PDF 文件中的特定页面](/pdf/zh/java/get-a-particular-page-in-a-pdf-file-in-ruby/)
- [在 Ruby 中获取 PDF 页数](/pdf/zh/java/get-page-count-of-pdf-in-ruby/)
- [在 Ruby 中获取页面属性](/pdf/zh/java/get-page-properties-in-ruby/)
- [在 Ruby 中在 PDF 文件末尾插入一个空白页面](/pdf/zh/java/insert-an-empty-page-at-end-of-pdf-file-in-ruby/)
- [在 Ruby 中将空白页面插入 PDF 文件](/pdf/zh/java/insert-an-empty-page-into-a-pdf-file-in-ruby/)
...
- [从 PDF 文档的所有页面提取文本在 Ruby 中](/pdf/zh/java/extract-text-from-all-the-pages-of-a-pdf-document-in-ruby/)
...
- [支持、扩展和贡献 Aspose.Pdf 在 Ruby 中](/pdf/zh/java/support-extend-and-contribute-to-aspose-pdf-in-ruby/)