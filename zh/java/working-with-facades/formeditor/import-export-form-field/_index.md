...
Aspose.PDF for Java 提供了在 PDF 文档中创建/操作表单字段的强大功能。使用此 API，您可以通过[将数据从 FDF 导出到 PDF 文件](/pdf/zh/java/export-data-into-a-pdf-file-facades/)和[从 XFDF 导入数据到 PDF 文件](/pdf/zh/java/import-data-into-a-pdf-file-facades/)以编程方式填充 PDF 文件中的表单字段。
