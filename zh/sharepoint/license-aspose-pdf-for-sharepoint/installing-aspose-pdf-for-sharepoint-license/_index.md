...
lastmod: "2026-08-13"
description: 一旦您对评估感到满意，您可以购买 PDF SharePoint API 许可证并按照安装说明进行应用。
---
...
订单付款后，许可证将通过电子邮件发送给您。该许可证是包含常规 SharePoint 解决方案包的 .zip 存档。
...
stsadm.exe -o 部署解决方案-名称 Aspose.PDF.SharePoint.License.wsp -immediate -force
