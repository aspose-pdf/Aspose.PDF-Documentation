---
title: 在 SharePoint 中将条形码添加到 PDF 文件
linktitle: 将条形码添加到 PDF 文件
type: docs
weight: 40
...
![将条形码添加到 PDF 文件 - 示例 1](add-barcode-to-a-pdf-file_1.png)
...
![将条形码添加到 PDF 文件 - 示例 2](add-barcode-to-a-pdf-file_2.png)
