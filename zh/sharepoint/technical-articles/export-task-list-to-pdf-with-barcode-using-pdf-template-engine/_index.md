---
title: 使用PDF模板引擎将任务列表导出为带有条形码的PDF
type: docs
weight: 40
url: zh/sharepoint/export-task-list-to-pdf-with-barcode-using-pdf-template-engine/
lastmod: "2020-12-16"
description: PDF SharePoint API可以使用PDF模板引擎将任务列表导出为带有条形码的PDF。
---

{{% alert color="primary" %}}

本文介绍了如何使用Aspose.PDF for SharePoint设置并将任务列表导出为带有条形码的PDF。

{{% /alert %}}

要使用模板引擎将任务列表导出为带有条形码的PDF，请执行以下步骤：
...
2. 创建模板后，点击列表中的 **Add New Item** 并上传 XML 文件。
