...
In case you want to extract text from PDF document, you can use [ExtractText](https://reference.aspose.com/pdf/go-cpp/convert/extracttext/) function.
...
1. [ExtractText](https://reference.aspose.com/pdf/go-cpp/convert/extracttext/) extracts the text content from the PDF document.
