...
As informações neste tópico aplicam-se a cenários nos quais você deseja usar [Aspose.PDF para .NET](/pdf/net/) via COM Interop em qualquer uma das seguintes linguagens de programação:
