...
Esta é uma aplicação ASP simples que mostra como criar um arquivo PDF com texto de exemplo usando [Aspose.PDF para .NET](/pdf/net/) e VBScript via COM Interop.
