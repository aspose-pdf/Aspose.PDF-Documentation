---
title: Adicionar, Deletar e Obter Anotação
linktitle: Adicionar, Deletar e Obter Anotação
type: docs
weight: 20
url: /net/add-delete-and-get-annotation/
description: Com Aspose.PDF para .NET você pode adicionar, deletar e obter anotações de seu arquivo PDF. Confira todas as listas de anotações para resolver sua tarefa.
lastmod: "2022-02-17"
sitemap:
    changefreq: "monthly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Adicionar, Deletar e Obter Anotação",
    "alternativeHeadline": "Trabalhando com Anotações em arquivo PDF",
    "author": {
        "@type": "Person",
    ...
    "keywords": "pdf, c#, adicionar anotação, obter anotação, deletar anotação",
    "wordcount": "302",
...
Agrupamos os diferentes tipos de anotação disponíveis para a biblioteca Aspose.PDF for .NET em grupos:
...
- [Anotações Adesivas PDF](/pdf/net/sticky-annotations/)
