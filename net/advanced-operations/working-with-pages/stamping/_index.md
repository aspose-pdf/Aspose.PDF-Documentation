...
- [Add Text stamps in PDF File](/pdf/net/text-stamps-in-the-pdf-file/) - add text stamp, define alignment for TextStamp object, fill stroke text as stamp in PDF file.
- [Page stamps in PDF File](/pdf/net/page-stamps-in-the-pdf-file/) - add a page stamp to PDF document using the PdfPageStamp class.
