...
- .NET environment required.
- Supports Windows forms and ASP.NET applications.
- API reference in HTML and Microsoft help formats.
- Supported .NET Frameworks: 2.0, 3.5, 3.5 Client Profile, 4.0, and 4.0 Client Profile, 4.5.0, 4.5.1, 4.6.0, 4.6.2, 4.7, 4.7.2.
- .NET Standard 2.0 (.NET Core 2.0/2.1)
- 32-bit OS support.
- 64-bit OS support.
### **Fonts**
