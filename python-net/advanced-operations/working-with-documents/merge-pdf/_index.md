...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "How to Merge PDF using Python",
    "alternativeHeadline": "Combine PDF documents via Python",
    "author": {
        "@type": "Person",
    ...
    "description": "This page explain how to merge PDF documents into a single PDF file with Python via .NET."
}
</script>
...
1. Then call the [PageCollection](https://reference.aspose.com/pdf/python-net/aspose.pdf/pagecollection/) collection’s Add method for the Document object you want to add the other PDF file to.
