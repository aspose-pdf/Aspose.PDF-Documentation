...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Add Page Number to PDF with Python",
    ...
    "description": "Aspose.PDF for Python via .NET allows you to add Page Number Stamp to your PDF file using PageNumberStamp class."
}
</script>
