...
description: This section describes how to add and extract a table, how to manipulate and integrate a table using the Python library.
lastmod: "2023-09-17"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
<script type="application/ld+json">
{
    ...
    "@type": "TechArticle",
    "headline": "Working with Tables in PDF using Python",
    "alternativeHeadline": "Working with Tables",
    "author": {
        "@type": "Person",
    ...
    "description": "This article describes how to add and extract a table, how to manipulate and integrate a table using the Python library."
}
</script>
