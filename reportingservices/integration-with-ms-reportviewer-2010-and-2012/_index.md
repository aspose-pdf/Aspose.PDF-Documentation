...
This page demonstrates how to export report from ReportViewer 2010, 2012 or ReportViewer 2015 to PDF format using Aspose.PDF for Reporting Services.
...
In order to support ReportViewer 2012 or 2015, please try using following code snippet for integration
    ...
    class PdfExportHelper

        {
            ...
            public static void EnableRplRenderExtension(ReportViewer reportViewer)
            {
                ...
                if (!rplExportEnabled)
                    throw new Exception("Can't enable RPL export. Please, make sure that you are using ReportViewer 2010, 2012 or 2015.");
            }
            /// <summary>
            /// Renders specific page to RPL
            /// </summary>
