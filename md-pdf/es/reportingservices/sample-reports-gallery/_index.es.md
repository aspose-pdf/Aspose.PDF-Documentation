...
Esta galería demuestra informes PDF exportados por Aspose.Pdf para Reporting Services.
...
![Informe de Ventas de la Empresa en PDF](sample-reports-gallery_1.png)

## Resumen de Ventas de Empleados

![Informe de Resumen de Ventas de Empleados en PDF](sample-reports-gallery_2.png)

## Catálogo de Productos

![Informe de Catálogo de Productos en PDF](sample-reports-gallery_3.png)

## Ventas de Línea de Productos

![Informe de Ventas de Línea de Productos en PDF](sample-reports-gallery_4.png)

## Detalle de Pedido de Venta

![Informe de Detalle de Pedido de Venta en PDF](sample-reports-gallery_5.png)