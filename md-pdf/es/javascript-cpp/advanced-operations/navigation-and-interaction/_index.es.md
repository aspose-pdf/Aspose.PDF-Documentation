...
- [Marcadores](/pdf/javascript-cpp/bookmark/)- las publicaciones grandes suelen incluir un marco de marcadores que se pueden ver y seleccionar fácilmente en el Panel de Marcadores, lo que le permite hacer clic en un marcador para saltar a la página o capítulo que representa. El Panel de Marcadores es un elemento consciente del contenido y es visible en la barra lateral solo si el documento PDF abierto contiene una estructura de marcadores.