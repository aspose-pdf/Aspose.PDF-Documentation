...
Следующая таблица показывает форматы файлов, которые Aspose.PDF for PHP via Java может загружать и сохранять.
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|Формат файла LaTex|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[EMF](https://docs.fileformat.com/image/emf/)|Расширенный метафайловый формат (EMF)| |{{< emoticons/tick >}}| |
