---
title: Funcionalidades Principais do Aspose.PDF
...
- Aspose.PDF para Android via Java suporta qualquer dispositivo móvel que execute o runtime Java, incluindo
- API oferece criptografia de 40 bits ou 128 bits

## Versões de PDF Suportadas

Aspose.PDF para Android via Java suporta as versões PDF 1.2, 1.3, 1.4, 1.5, 1.6 e 1.7.
...
- Gráficos podem ser rotacionados, escalados ou preenchidos, e estilos de linha tracejada e poli-tracejada podem ser definidos.
- Gráficos são desenhados com base em coordenadas e têm posição obsoleta em vez de relativa.
- Espaços de cores CMYK e Cinza são suportados.
...
- Excluir imagens.
- Substituir imagens.
- Extrair imagens (do PDF inteiro, uma página específica ou um intervalo de páginas).
...
- Fazer NUp de PDF.
- Fazer livreto de PDF.
- Dividir páginas PDF (da primeira, ao final, em massa, para páginas individuais).
...
- Obter fachada de campo de formulário (os atributos visuais do campo).
- Excluir campo.
...
- Imprimir PDF em uma impressora especificada.
- Imprimir PDF para impressora física ou virtual.
- Imprimir PDF para impressora XPS.
- Imprimir PDF para arquivo XPS.
- Ocultar diálogo de impressão ao imprimir PDF.

## Diversos

- Obter informações da versão de build.
- Alterar o espaço de cor do documento PDF
