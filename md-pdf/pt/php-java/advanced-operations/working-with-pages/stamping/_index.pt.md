...
Um carimbo em um documento PDF é análogo à aplicação de um carimbo de borracha em um documento de papel. O Carimbo no arquivo PDF fornece informações adicionais para o arquivo PDF, como proteger o arquivo PDF para que não seja usado por outros e confirmar a segurança do conteúdo do arquivo PDF. **Aspose.PDF para PHP via Java** permite adicionar carimbo de imagem ou texto em seu documento PDF.
