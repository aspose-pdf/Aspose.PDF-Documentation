...
description: Esta página mostra quais formatos de arquivo o Aspose.PDF para PHP via Java pode carregar e salvar.
lastmod: "2024-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
A tabela a seguir indica os formatos de arquivo que o Aspose.PDF para PHP via Java pode carregar e salvar.
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Salva o documento como imagem TIFF de uma ou várias páginas| |{{< emoticons/tick >}}| |
|[Text](https://docs.fileformat.com/word-processing/txt/)|Salva o documento no formato de texto| |{{< emoticons/tick >}}| |