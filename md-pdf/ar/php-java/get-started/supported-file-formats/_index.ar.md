...
يشير الجدول التالي إلى تنسيقات الملفات التي يمكن لـ Aspose.PDF for PHP عبر Java تحميلها وحفظها.

|**التنسيق**|**الوصف**|**تحميل**|**حفظ**|**ملاحظات**|
| :- | :- | :- | :- | :- |
|[PDF](https://docs.fileformat.com/pdf/)|تنسيق المستندات المحمولة|{{< emoticons/tick >}}|{{< emoticons/tick >}} | |
|[CGM](https://docs.fileformat.com/page-description-language/cgm/)|ملف التعريف الرسومي للكمبيوتر للرسوميات المتجهية ثنائية الأبعاد|{{< emoticons/tick >}}| | |
...
|[TeX](https://docs.fileformat.com/page-description-language/tex/)|تنسيق ملف تنضيد LaTex|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[MHT](https://docs.fileformat.com/web/mhtml/)|وثيقة MHTML|{{< emoticons/tick >}}| | |
|[PCL](https://docs.fileformat.com/page-description-language/pcl/)|ملفات لغة التحكم في الطابعة|{{< emoticons/tick >}}| | |
|[PS](https://docs.fileformat.com/page-description-language/ps/)|ملفات Postscript|{{< emoticons/tick >}}| | |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسوميات متجهية قابلة للتوسع (تنسيق صورة متجهية يعتمد على XML)|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[XSLFO](https://docs.fileformat.com/page-description-language/xslfo/)|XSL-FO جزء من ملف XSL الذي يُستخدم لتحويل وتنسيق بيانات XML|{{< emoticons/tick >}}| | |
...
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق Enhanced metafile format (EMF)| |{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|يحفظ المستند كصورة TIFF بصفحة واحدة أو متعددة الصفحات| |{{< emoticons/tick >}}| |
