...
<script type="application/ld+json">
{
    ...
    "keywords": "pdf, c#, تحديد فاصل السطر",
    "wordcount": "302",
...
يقدم Aspose.PDF لـ .NET تسجيل (تتبع) معالجة الخلفية (كسر الخطوط) لأجزاء النص المتعددة الأسطر في سيناريوهات إضافة النص. يمكنك استخدام الطريقة [GetNotifications](https://reference.aspose.com/pdf/net/aspose.pdf/page/methods/getnotifications)() من فئة [Page](https://reference.aspose.com/pdf/net/aspose.pdf/page) على النحو التالي، من أجل تتبع كسر الخطوط لجزء النص:
