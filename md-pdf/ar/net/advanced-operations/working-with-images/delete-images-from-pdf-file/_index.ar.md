...
1. إنشاء كائن Document وفتح ملف PDF الإدخال.
1. الحصول على الصفحة التي تحتوي على الصورة من مجموعة صفحات كائن Document.
1. الصور موجودة في مجموعة الصور، الموجودة في مجموعة موارد الصفحة.
1. حذف صورة باستخدام طريقة Delete الخاصة بمجموعة الصور.
1. حفظ الناتج باستخدام طريقة Save الخاصة بكائن Document.

يعرض الكود التالي كيفية حذف صورة من ملف PDF.
