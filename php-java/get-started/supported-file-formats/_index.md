...
description: This page shows which Aspose.PDF for PHP via Java can load and save file formats.
lastmod: "2024-06-05"
sitemap:
    changefreq: "weekly"
    priority: 0.7
...
The following table indicates the file formats that Aspose.PDF for PHP via Java can load and Save.
