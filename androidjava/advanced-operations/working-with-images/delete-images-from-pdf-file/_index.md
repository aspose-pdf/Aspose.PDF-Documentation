...
1. Get the Page that holds the image from the [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) object’s [Pages](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Page) collection.
1. Images are held in the Images collection, found in the page’s [Resources](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Resources) collection.
